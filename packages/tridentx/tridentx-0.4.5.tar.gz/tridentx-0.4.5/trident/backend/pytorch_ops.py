...
__all__ = ['reshape','argmax','log_sum_exp','reduce_max','reduce_min','reduce_mean','reduce_sum','expand_dims','shuffle','random_choice','meshgrid','element_cosine_distance','gram_matrix','get_rotation_matrix2d','warp_affine','binary_crossentropy']
...
def log_sum_exp(x,axis=1)-> torch.Tensor:
