...
def DenseNetFcn(blocks=(4, 5, 7, 10, 12),
    ...
    model = ImageSegmentationModel(input_shape=input_shape, output=_DenseNetFcn(blocks=blocks,
...
class _DenseNetFcn(Layer):
    def __init__(self, blocks=(4, 5, 7, 10, 12),
             ...
             name='',
             **kwargs):
        super(_DenseNetFcn, self).__init__()
        self.blocks=blocks
        ...
        self.upsample= Upsampling2d(scale_factor=2)
        self.last_layer=Conv2d((1, 1), num_filters=self.num_classes, strides=1, activation='softmax')
