...
def SecretGroupSecretInfo(secret_group_map_vo):
    info = {
        ...
        'environment': change_struct_type(secret_group_map_vo.environment),
        'labels': change_list_value_type(secret_group_map_vo.labels),
...
def SecretGroupInfo(secret_group_vo: SecretGroup, minimal=False):
    ...
    if minimal is False:
        info.update({
            'environment': change_struct_type(secret_group_vo.environment),
