...
class SecretGroupService(BaseService):
    ...
    def add_secret(self, params):
        ...
        secret_group_map_vo = self.secret_group_mgr.add_secret(secret_group_vo, {
            'secret': secret_vo,
    ...
    def update_secret(self, params):
        ...
        if 'environment' in params:
            update_params['environment'] = params['environment']
        else:
            update_params['environment'] = secret_vo.environment

        if 'labels' in params:
            update_params['labels'] = params['labels']
        else:
            update_params['labels'] = secret_vo.labels
        ...
        secret_group_map_vo = self.secret_group_mgr.add_secret(secret_group_vo, update_params)
    ...
    @append_query_filter(['secret_group_id', 'secret_id', 'name', 'domain_id'])
