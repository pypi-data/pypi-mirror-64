...
class SecretGroupManager(BaseManager):
    ...
    def get_secret_group(self, secret_group_id, domain_id):
        return self.secret_group_model.get(secret_group_id=secret_group_id, domain_id=domain_id)
    ...
    @staticmethod
    def add_secret(secret_group_vo, params):
        return secret_group_vo.append('secrets', params)
