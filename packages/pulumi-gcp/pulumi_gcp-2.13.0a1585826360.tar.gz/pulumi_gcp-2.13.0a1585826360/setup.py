...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v2.13.0-alpha.1585826360+g21e5c737'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v2.13.0-alpha.1585826360+g21e5c737`
                """)
            else:
                raise
