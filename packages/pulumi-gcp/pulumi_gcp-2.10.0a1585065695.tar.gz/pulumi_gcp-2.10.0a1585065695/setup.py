...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v2.10.0-alpha.1585065695+g283f1c01'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v2.10.0-alpha.1585065695+g283f1c01`
                """)
            else:
                raise
