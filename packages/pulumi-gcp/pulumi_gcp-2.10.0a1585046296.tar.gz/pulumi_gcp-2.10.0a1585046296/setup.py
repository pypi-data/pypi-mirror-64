...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v2.10.0-alpha.1585046296+g926ed1a5'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v2.10.0-alpha.1585046296+g926ed1a5`
                """)
            else:
                raise
