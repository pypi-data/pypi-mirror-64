...
from akeyless_uam_api.models.rsa_decrypt_creds import RSADecryptCreds  # noqa: E501
...
class TestRSADecryptCreds(unittest.TestCase):
    ...
    def testRSADecryptCreds(self):
        ...
        # model = akeyless_uam_api.models.rsa_decrypt_creds.RSADecryptCreds()  # noqa: E501
        pass
