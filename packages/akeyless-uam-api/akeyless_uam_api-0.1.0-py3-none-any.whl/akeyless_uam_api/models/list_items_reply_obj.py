...
class ListItemsReplyObj(object):
    ...
    def __init__(self, items=None):  # noqa: E501
        """ListItemsReplyObj - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def items(self):
        """Gets the items of this ListItemsReplyObj.  # noqa: E501

        List of the accessible items  # noqa: E501

        :return: The items of this ListItemsReplyObj.  # noqa: E501
    ...
    def items(self, items):
        """Sets the items of this ListItemsReplyObj.

        List of the accessible items  # noqa: E501

        :param items: The items of this ListItemsReplyObj.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ListItemsReplyObj, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListItemsReplyObj):
            return False
