...
class RecurrencePopover:
    ...
    def connect_popover_closed_signals(self, function):
        """This connects the given function to the signal specified"""
        self._popover.connect('closed', function)

    def connect_recurrence_changed_signal(self, function):
        ...
        self._day_of_month_set_button.connect('clicked', function)
        self._day_of_month_menu.connect('changed', function)
        self._day_of_month_position_menu.connect('changed', function)
        self._day_of_month_clear_button.connect('clicked', function)
        self._stop_type_menu.connect('changed', function)
        self._stop_date_picker.picker.connect_datetime_changed_signal(function)
