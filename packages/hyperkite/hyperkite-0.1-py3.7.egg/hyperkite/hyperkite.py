    ...
    def new_trial(self):
        ...
        if response.ok:
            try:
                ...
                # Check output
                if trial_key == '':
                    print('WARNING: Received empty trial key...')
                    return None
                if type(trial_key) is not str:
                    print('WARNING: Trial key is not a string...')
                    return None
                if values == '':
                    print('WARNING: Received empty values...')
                    return None
                if type(values) is not dict:
                    print('WARNING: Arguments are a dict...')
                    return None
