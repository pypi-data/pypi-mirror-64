...
class RayvisionDownload(object):
    ...
    def download(self, task_id_list=None,
                 ...
                 local_path=None, custom_server_output_path=None):
        ...
        Args:
            ...
            custom_server_output_path (str or list): The user customizes the file structure to be downloaded from
        ...
        """
        self.check_params(task_id_list, custom_server_output_path)
        ...
        self._run_download(task_id_list, local_path, max_speed, print_log,
                          download_filename_format, custom_server_output_path)
    ...
    def _run_download(self, task_id_list, local_path, max_speed=None,
                     ...
                     custom_server_output_path=None):
        ...
        Args:
            ...
            download_filename_format: File download local save style,
                "true": tape task ID and scene name,
                "false" : download directly without doing processing.
            custom_server_output_path (str / list): The user customizes the file structure to be downloaded from
                the output server, and all file structures are downloaded by default,
                example: "18164087_test/l_layer".
        ...
        if not custom_server_output_path:
            ...
            if isinstance(custom_server_output_path, str):
                output_file_names = [custom_server_output_path]
            elif isinstance(custom_server_output_path, list):
                isinstance(custom_server_output_path, list)
                output_file_names = custom_server_output_path
            else:
