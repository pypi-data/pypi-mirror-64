    ...
    if os.name == "nt":
        ...
        def install (self, update = False):
            ...
            try:
                ...
                service_script = '{}.service'.format (name)
                with open (service_script, 'w') as f:
                    f.write (script)
                print ('install failed, you can install manually,')
                print ('  sudo mv {} to /etc/systemd/system'.format (service_script))
                print ("  sudo systemctl daemon-reload")
                print ("  sudo systemctl enable {}".format (name))
