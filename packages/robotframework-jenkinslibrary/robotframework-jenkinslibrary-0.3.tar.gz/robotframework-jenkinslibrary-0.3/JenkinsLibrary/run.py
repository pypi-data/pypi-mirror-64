...
job_name = 'job/truemoney-batch-common/job/truemoney-batch-common-truemoney-poi-settlement-qa-run-pipeline'



jenkins = JenkinsFace(protocol, url, username, password)

# GET JOB DETAUL
job_detail = jenkins.get_job(job_name)
...
# job_detail = jenkins.get_job_build(job_name, build_number=18)
# print(job_detail['building'])