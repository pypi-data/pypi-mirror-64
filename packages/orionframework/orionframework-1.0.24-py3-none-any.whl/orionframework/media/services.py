...
from orionframework.media.settings import Document, Image, PREVIEW_ENABLED, PREVIEW_WIDTH, PREVIEW_HEIGHT
    ...
    def create(self, file, category=None, **kwargs):
        ...
        if PREVIEW_ENABLED and not kwargs.get("preview"):
            ...
            try:
                ...
                temp_source_name = default_storage.save(file.name, file)
                temp_source_path = default_storage.path(temp_source_name)
