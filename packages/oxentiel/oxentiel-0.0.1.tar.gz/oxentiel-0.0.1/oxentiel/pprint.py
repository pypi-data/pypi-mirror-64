...
# pylint: disable=redefined-builtin, len-as-condition, too-many-lines, invalid-name
# pylint: disable=missing-function-docstring, unused-variable, missing-class-docstring
# pylint: disable=attribute-defined-outside-init, unused-argument, no-else-return
