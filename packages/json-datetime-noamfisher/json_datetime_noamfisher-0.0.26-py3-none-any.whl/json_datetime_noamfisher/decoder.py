...
from json_datetime_noamfisher.consts import (VALUE_KEY, TYPE_KEY, DATE_TYPES, DATE_CLS_TYPES)
...
class JsonDatetimeDecoder(json.JSONDecoder):
    ...
    def _get_obj_datetime_cls(self, obj_type: str) -> Optional[DATE_CLS_TYPES]:
        for cls in DATE_TYPES.__args__:
