...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', 'v1.5.0-alpha.1584954858+gf0d1f26'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta v1.5.0-alpha.1584954858+gf0d1f26`
                """)
            else:
                raise
