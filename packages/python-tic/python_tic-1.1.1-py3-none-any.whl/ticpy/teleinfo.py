...
from ticpy.const import ADCO_DESCRIPTION, OPTARIF_DESCRIPTION, ISOUSC_DESCRIPTION, UNIT_A, UNIT_WH, UNIT_VA, UNIT_NONE, \
...
class Teleinfo:
    ...
    def __init__(self, port = "/dev/ttyUSB", mode:Mode = Mode.HISTORY, timeout=1):
    ...
    def validate_checksum(self, frame, checksum):
        ...
        datas = ' '.join(frame.split()[0:2]).encode()
