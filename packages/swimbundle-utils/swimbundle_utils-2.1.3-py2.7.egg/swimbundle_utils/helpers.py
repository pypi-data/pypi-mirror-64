...
def asset_parser(context_asset, host_name="host", username="username",
                 password="password", auth=None, base_api_endpoint=""):
    ...
    Args:
        ...
        base_api_endpoint: The base URL path of the API
