...
addlab=            ttk.Button(salesframe,  text = "Add labour to an order",     command=addlabs)
...
addlabtoorder =    ttk.Button(salesframe,  text=  "Add labour to order",        command= addlabourtoorder)
