...
"""
A small but hopefully growing collection of possibly bogus
subcircuits for use with I{pingspice}.

B{Remember}, unless required by applicable law or agreed to in
writing, this software (including these models) is distributed on an
"AS IS" BASIS, WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either
express or implied. See the U{Apache 2.0
License<http://www.apache.org/licenses/LICENSE-2.0>} for the specific
