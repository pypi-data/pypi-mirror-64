...
from irbench.utils import utils as utils 
from irbench.irsys.global_descriptor import GlobalDescriptorIRHelper as GDIR
from irbench.irsys.local_descriptor import LocalDescriptorIRHelper as LDIR
...
class IRBench():
    ...
    def feed_query_from_path(
        ...
        '''
        unique_id_list = utils.load_unique_id_list_from_path(path)
        if max_num != -1:
