...
import irbench.utils as U
from irbench.evals.evaluate import (PureInstanceRetrieval,
...
class EvalHelper(object):
    ...
    def feed_gt_from_path(
        ...
        gt_dict = U.load_dict_from_path(path)
    ...
    def feed_rank_from_path(
        ...
        path):
        print('load json file from {}'.format(path))
        rank_dict = U.load_dict_from_path(path)
