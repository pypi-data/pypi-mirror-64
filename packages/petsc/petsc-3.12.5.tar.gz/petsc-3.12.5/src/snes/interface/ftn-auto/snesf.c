...
PETSC_EXTERN void PETSC_STDCALL  snessetjacobiandomainerror_(SNES snes, int *__ierr){
*__ierr = SNESSetJacobianDomainError(
	(SNES)PetscToPointer((snes) ));
}
PETSC_EXTERN void PETSC_STDCALL  snessetcheckjacobiandomainerror_(SNES snes,PetscBool *flg, int *__ierr){
*__ierr = SNESSetCheckJacobianDomainError(
	(SNES)PetscToPointer((snes) ),*flg);
}
PETSC_EXTERN void PETSC_STDCALL  snesgetcheckjacobiandomainerror_(SNES snes,PetscBool *flg, int *__ierr){
...
PETSC_EXTERN void PETSC_STDCALL  snesgetjacobiandomainerror_(SNES snes,PetscBool *domainerror, int *__ierr){
...
PETSC_EXTERN void PETSC_STDCALL  snesgetupdatenorm_(SNES snes,PetscReal *ynorm, int *__ierr){
*__ierr = SNESGetUpdateNorm(
	(SNES)PetscToPointer((snes) ),ynorm);
}
PETSC_EXTERN void PETSC_STDCALL  snesgetsolutionnorm_(SNES snes,PetscReal *xnorm, int *__ierr){
