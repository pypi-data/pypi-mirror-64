...
PETSC_EXTERN void PETSC_STDCALL  petscfecopyquadrature_(PetscFE sfe,PetscFE tfe, int *__ierr){
...
PETSC_EXTERN void PETSC_STDCALL  petscfegetheightsubspace_(PetscFE fe,PetscInt *height,PetscFE *subfe, int *__ierr){
