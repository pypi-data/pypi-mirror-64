...
PETSC_EXTERN void PETSC_STDCALL  petscdsgethybrid_(PetscDS prob,PetscBool *isHybrid, int *__ierr){
*__ierr = PetscDSGetHybrid(
	(PetscDS)PetscToPointer((prob) ),isHybrid);
}
PETSC_EXTERN void PETSC_STDCALL  petscdssethybrid_(PetscDS prob,PetscBool *isHybrid, int *__ierr){
