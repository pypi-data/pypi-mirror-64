...
extern "C" {
#endif
PETSC_EXTERN void PETSC_STDCALL  petscspacetensorsetnumsubspaces_(PetscSpace sp,PetscInt *numTensSpaces, int *__ierr){
*__ierr = PetscSpaceTensorSetNumSubspaces(
	(PetscSpace)PetscToPointer((sp) ),*numTensSpaces);
}
PETSC_EXTERN void PETSC_STDCALL  petscspacetensorgetnumsubspaces_(PetscSpace sp,PetscInt *numTensSpaces, int *__ierr){
*__ierr = PetscSpaceTensorGetNumSubspaces(
	(PetscSpace)PetscToPointer((sp) ),numTensSpaces);
}
PETSC_EXTERN void PETSC_STDCALL  petscspacetensorsetsubspace_(PetscSpace sp,PetscInt *s,PetscSpace subsp, int *__ierr){
*__ierr = PetscSpaceTensorSetSubspace(
	(PetscSpace)PetscToPointer((sp) ),*s,
	(PetscSpace)PetscToPointer((subsp) ));
}
PETSC_EXTERN void PETSC_STDCALL  petscspacetensorgetsubspace_(PetscSpace sp,PetscInt *s,PetscSpace *subsp, int *__ierr){
