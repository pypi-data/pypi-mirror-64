...
PETSC_EXTERN void PETSC_STDCALL  petscspacesetnumvariables_(PetscSpace sp,PetscInt *n, int *__ierr){
*__ierr = PetscSpaceSetNumVariables(
	(PetscSpace)PetscToPointer((sp) ),*n);
}
PETSC_EXTERN void PETSC_STDCALL  petscspacegetnumvariables_(PetscSpace sp,PetscInt *n, int *__ierr){
*__ierr = PetscSpaceGetNumVariables(
	(PetscSpace)PetscToPointer((sp) ),n);
}
