...
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
#define petscdualspacecreatesection_ PETSCDUALSPACECREATESECTION
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define petscdualspacecreatesection_ petscdualspacecreatesection
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
...
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
#define petscdualspacegetallpoints_ PETSCDUALSPACEGETALLPOINTS
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define petscdualspacegetallpoints_ petscdualspacegetallpoints
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
#define petscdualspacecreateallpointsdefault_ PETSCDUALSPACECREATEALLPOINTSDEFAULT
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define petscdualspacecreateallpointsdefault_ petscdualspacecreateallpointsdefault
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
...
PETSC_EXTERN void PETSC_STDCALL  petscdualspacecreatesection_(PetscDualSpace sp,PetscSection *section, int *__ierr){
*__ierr = PetscDualSpaceCreateSection(
...
PETSC_EXTERN void PETSC_STDCALL  petscdualspacegetallpoints_(PetscDualSpace sp,PetscQuadrature *allPoints, int *__ierr){
*__ierr = PetscDualSpaceGetAllPoints(
	(PetscDualSpace)PetscToPointer((sp) ),allPoints);
}
PETSC_EXTERN void PETSC_STDCALL  petscdualspacecreateallpointsdefault_(PetscDualSpace sp,PetscQuadrature *allPoints, int *__ierr){
*__ierr = PetscDualSpaceCreateAllPointsDefault(
	(PetscDualSpace)PetscToPointer((sp) ),allPoints);
}
...
PETSC_EXTERN void PETSC_STDCALL  petscdualspacegetderahm_(PetscDualSpace dsp,PetscInt *k, int *__ierr){
