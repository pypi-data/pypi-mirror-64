...
PETSC_EXTERN void PETSC_STDCALL  dmnetworksetsizes_(DM dm,PetscInt *Nsubnet,PetscInt nV[],PetscInt nE[],PetscInt *NsubnetCouple,PetscInt nec[], int *__ierr){
...
PETSC_EXTERN void PETSC_STDCALL  dmnetworkgetvertexlocaltoglobalordering_(DM dm,PetscInt *vloc,PetscInt *vg, int *__ierr){
*__ierr = DMNetworkGetVertexLocalToGlobalOrdering(
	(DM)PetscToPointer((dm) ),*vloc,vg);
}
PETSC_EXTERN void PETSC_STDCALL  dmnetworksetvertexlocaltoglobalordering_(DM dm, int *__ierr){
