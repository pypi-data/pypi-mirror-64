...
PETSC_EXTERN void PETSC_STDCALL  dmplexgetconerecursivevertices_(DM dm,IS points,IS *expandedPoints, int *__ierr){
*__ierr = DMPlexGetConeRecursiveVertices(
	(DM)PetscToPointer((dm) ),
	(IS)PetscToPointer((points) ),expandedPoints);
}
PETSC_EXTERN void PETSC_STDCALL  dmplexgetconerecursive_(DM dm,IS points,PetscInt *depth,IS *expandedPoints[],PetscSection *sections[], int *__ierr){
*__ierr = DMPlexGetConeRecursive(
	(DM)PetscToPointer((dm) ),
	(IS)PetscToPointer((points) ),depth,expandedPoints,sections);
}
PETSC_EXTERN void PETSC_STDCALL  dmplexrestoreconerecursive_(DM dm,IS points,PetscInt *depth,IS *expandedPoints[],PetscSection *sections[], int *__ierr){
...
PETSC_EXTERN void PETSC_STDCALL  dmplexsetclosurepermutationtensor_(DM dm,PetscInt *point,PetscSection section, int *__ierr){
...
PETSC_EXTERN void PETSC_STDCALL  dmplexcheckskeleton_(DM dm,PetscInt *cellHeight, int *__ierr){
*__ierr = DMPlexCheckSkeleton(
	(DM)PetscToPointer((dm) ),*cellHeight);
}
PETSC_EXTERN void PETSC_STDCALL  dmplexcheckfaces_(DM dm,PetscInt *cellHeight, int *__ierr){
...
PETSC_EXTERN void PETSC_STDCALL  dmplexcheckcellshape_(DM dm,PetscBool *output,PetscReal *condLimit, int *__ierr){
