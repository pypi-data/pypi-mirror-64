...
PETSC_EXTERN void PETSC_STDCALL  dmplexrebalancesharedpoints_(DM dm,PetscInt *entityDepth,PetscBool *useInitialGuess,PetscBool *parallel,PetscBool *success, int *__ierr){
