...
PETSC_EXTERN void PETSC_STDCALL  dmplexcreatefromcelllistparallel_(MPI_Fint * comm,PetscInt *dim,PetscInt *numCells,PetscInt *numVertices,PetscInt *numCorners,PetscBool *interpolate, int cells[],PetscInt *spaceDim, PetscReal vertexCoords[],PetscSF *vertexSF,DM *dm, int *__ierr){
...
PETSC_EXTERN void PETSC_STDCALL  dmplexcreatefromcelllist_(MPI_Fint * comm,PetscInt *dim,PetscInt *numCells,PetscInt *numVertices,PetscInt *numCorners,PetscBool *interpolate, int cells[],PetscInt *spaceDim, double vertexCoords[],DM *dm, int *__ierr){
