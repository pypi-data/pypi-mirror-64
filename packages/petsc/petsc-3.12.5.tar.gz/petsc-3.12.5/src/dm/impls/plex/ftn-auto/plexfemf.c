...
PETSC_EXTERN void PETSC_STDCALL  dmplexglobaltolocalbasis_(DM dm,Vec lv, int *__ierr){
*__ierr = DMPlexGlobalToLocalBasis(
	(DM)PetscToPointer((dm) ),
	(Vec)PetscToPointer((lv) ));
}
PETSC_EXTERN void PETSC_STDCALL  dmplexlocaltoglobalbasis_(DM dm,Vec lv, int *__ierr){
*__ierr = DMPlexLocalToGlobalBasis(
	(DM)PetscToPointer((dm) ),
	(Vec)PetscToPointer((lv) ));
}
PETSC_EXTERN void PETSC_STDCALL  dmplexcreatebasisrotation_(DM dm,PetscReal *alpha,PetscReal *beta,PetscReal *gamma, int *__ierr){
