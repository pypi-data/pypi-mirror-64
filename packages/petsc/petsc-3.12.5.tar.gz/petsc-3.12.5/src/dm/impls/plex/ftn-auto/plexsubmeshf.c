...
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
#define dmplexgetauxiliarypoint_ DMPLEXGETAUXILIARYPOINT
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define dmplexgetauxiliarypoint_ dmplexgetauxiliarypoint
#endif
...
PETSC_EXTERN void PETSC_STDCALL  dmplexgetauxiliarypoint_(DM dm,DM dmAux,PetscInt *p,PetscInt *subp, int *__ierr){
*__ierr = DMPlexGetAuxiliaryPoint(
	(DM)PetscToPointer((dm) ),
	(DM)PetscToPointer((dmAux) ),*p,subp);
}
#if defined(__cplusplus)
}
#endif
