...
PETSC_EXTERN void PETSC_STDCALL  matcomputeoperator_(Mat inmat,MatType *mattype,Mat *mat, int *__ierr){
*__ierr = MatComputeOperator(
	(Mat)PetscToPointer((inmat) ),*mattype,mat);
}
PETSC_EXTERN void PETSC_STDCALL  matcomputeoperatortranspose_(Mat inmat,MatType *mattype,Mat *mat, int *__ierr){
