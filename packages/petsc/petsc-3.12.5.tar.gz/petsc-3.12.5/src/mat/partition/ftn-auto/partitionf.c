...
PETSC_EXTERN void PETSC_STDCALL  matpartitioningsetuseedgeweights_(MatPartitioning part,PetscBool *use_edge_weights, int *__ierr){
*__ierr = MatPartitioningSetUseEdgeWeights(
	(MatPartitioning)PetscToPointer((part) ),*use_edge_weights);
}
PETSC_EXTERN void PETSC_STDCALL  matpartitioninggetuseedgeweights_(MatPartitioning part,PetscBool *use_edge_weights, int *__ierr){
