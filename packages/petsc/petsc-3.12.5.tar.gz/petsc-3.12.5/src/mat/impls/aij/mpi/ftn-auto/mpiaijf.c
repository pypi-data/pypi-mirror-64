...
PETSC_EXTERN void PETSC_STDCALL  matupdatempiaijwitharrays_(Mat mat,PetscInt *m,PetscInt *n,PetscInt *M,PetscInt *N, PetscInt Ii[], PetscInt J[], PetscScalar v[], int *__ierr){
