...
PETSC_EXTERN void PETSC_STDCALL  matcompositegettype_(Mat mat,MatCompositeType *type, int *__ierr){
*__ierr = MatCompositeGetType(
	(Mat)PetscToPointer((mat) ),type);
}
PETSC_EXTERN void PETSC_STDCALL  matcompositesetmatstructure_(Mat mat,MatStructure *str, int *__ierr){
*__ierr = MatCompositeSetMatStructure(
	(Mat)PetscToPointer((mat) ),*str);
}
PETSC_EXTERN void PETSC_STDCALL  matcompositegetmatstructure_(Mat mat,MatStructure *str, int *__ierr){
*__ierr = MatCompositeGetMatStructure(
	(Mat)PetscToPointer((mat) ),str);
}
PETSC_EXTERN void PETSC_STDCALL  matcompositesetmergetype_(Mat mat,MatCompositeMergeType *type, int *__ierr){
...
PETSC_EXTERN void PETSC_STDCALL  matcompositegetnumbermat_(Mat mat,PetscInt *nmat, int *__ierr){
*__ierr = MatCompositeGetNumberMat(
	(Mat)PetscToPointer((mat) ),nmat);
}
PETSC_EXTERN void PETSC_STDCALL  matcompositegetmat_(Mat mat,PetscInt *i,Mat *Ai, int *__ierr){
*__ierr = MatCompositeGetMat(
	(Mat)PetscToPointer((mat) ),*i,Ai);
}
PETSC_EXTERN void PETSC_STDCALL  matcompositesetscalings_(Mat mat, PetscScalar *scalings, int *__ierr){
