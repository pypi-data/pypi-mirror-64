...
PETSC_EXTERN void PETSC_STDCALL  petscviewerreadable_(PetscViewer viewer,PetscBool *flg, int *__ierr){
*__ierr = PetscViewerReadable(
	(PetscViewer)PetscToPointer((viewer) ),flg);
}
PETSC_EXTERN void PETSC_STDCALL  petscviewerwritable_(PetscViewer viewer,PetscBool *flg, int *__ierr){
*__ierr = PetscViewerWritable(
	(PetscViewer)PetscToPointer((viewer) ),flg);
}
PETSC_EXTERN void PETSC_STDCALL  petscviewercheckreadable_(PetscViewer viewer, int *__ierr){
*__ierr = PetscViewerCheckReadable(
	(PetscViewer)PetscToPointer((viewer) ));
}
PETSC_EXTERN void PETSC_STDCALL  petscviewercheckwritable_(PetscViewer viewer, int *__ierr){
