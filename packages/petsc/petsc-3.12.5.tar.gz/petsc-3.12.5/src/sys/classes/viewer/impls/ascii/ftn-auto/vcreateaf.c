...
extern "C" {
#endif
PETSC_EXTERN void PETSC_STDCALL  petscviewerasciigetstdout_(MPI_Fint * comm,PetscViewer *viewer, int *__ierr){
*__ierr = PetscViewerASCIIGetStdout(
	MPI_Comm_f2c(*(comm)),viewer);
}
PETSC_EXTERN void PETSC_STDCALL  petscviewerasciigetstderr_(MPI_Fint * comm,PetscViewer *viewer, int *__ierr){
