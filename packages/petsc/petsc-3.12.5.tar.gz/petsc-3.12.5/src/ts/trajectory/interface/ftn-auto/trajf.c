...
extern "C" {
#endif
PETSC_EXTERN void PETSC_STDCALL  tstrajectoryset_(TSTrajectory tj,TS ts,PetscInt *stepnum,PetscReal *time,Vec X, int *__ierr){
*__ierr = TSTrajectorySet(
	(TSTrajectory)PetscToPointer((tj) ),
	(TS)PetscToPointer((ts) ),*stepnum,*time,
	(Vec)PetscToPointer((X) ));
}
PETSC_EXTERN void PETSC_STDCALL  tstrajectorygetnumsteps_(TSTrajectory tj,PetscInt *steps, int *__ierr){
*__ierr = TSTrajectoryGetNumSteps(
	(TSTrajectory)PetscToPointer((tj) ),steps);
}
PETSC_EXTERN void PETSC_STDCALL  tstrajectoryget_(TSTrajectory tj,TS ts,PetscInt *stepnum,PetscReal *time, int *__ierr){
*__ierr = TSTrajectoryGet(
	(TSTrajectory)PetscToPointer((tj) ),
	(TS)PetscToPointer((ts) ),*stepnum,time);
}
PETSC_EXTERN void PETSC_STDCALL  tstrajectorygetvecs_(TSTrajectory tj,TS ts,PetscInt *stepnum,PetscReal *time,Vec U,Vec Udot, int *__ierr){
...
PETSC_EXTERN void PETSC_STDCALL  tstrajectorysetusehistory_(TSTrajectory tj,PetscBool *flg, int *__ierr){
...
PETSC_EXTERN void PETSC_STDCALL  tstrajectorysetsolutiononly_(TSTrajectory tj,PetscBool *solution_only, int *__ierr){
*__ierr = TSTrajectorySetSolutionOnly(
	(TSTrajectory)PetscToPointer((tj) ),*solution_only);
}
PETSC_EXTERN void PETSC_STDCALL  tstrajectorygetsolutiononly_(TSTrajectory tj,PetscBool *solution_only, int *__ierr){
*__ierr = TSTrajectoryGetSolutionOnly(
	(TSTrajectory)PetscToPointer((tj) ),solution_only);
}
PETSC_EXTERN void PETSC_STDCALL  tstrajectorygetupdatedhistoryvecs_(TSTrajectory tj,TS ts,PetscReal *time,Vec *U,Vec *Udot, int *__ierr){
*__ierr = TSTrajectoryGetUpdatedHistoryVecs(
	(TSTrajectory)PetscToPointer((tj) ),
	(TS)PetscToPointer((ts) ),*time,U,Udot);
}
PETSC_EXTERN void PETSC_STDCALL  tstrajectoryrestoreupdatedhistoryvecs_(TSTrajectory tj,Vec *U,Vec *Udot, int *__ierr){
