...
PETSC_EXTERN void PETSC_STDCALL  tsadaptsetmaxignore_(TSAdapt adapt,PetscReal *max_ignore, int *__ierr){
*__ierr = TSAdaptSetMaxIgnore(
	(TSAdapt)PetscToPointer((adapt) ),*max_ignore);
}
PETSC_EXTERN void PETSC_STDCALL  tsadaptgetmaxignore_(TSAdapt adapt,PetscReal *max_ignore, int *__ierr){
