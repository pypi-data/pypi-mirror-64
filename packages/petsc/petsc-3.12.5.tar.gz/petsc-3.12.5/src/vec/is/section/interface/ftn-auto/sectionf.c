...
PETSC_EXTERN void PETSC_STDCALL  petscsectionsetupbc_(PetscSection s, int *__ierr){
...
PETSC_EXTERN void PETSC_STDCALL  petscsectiongetpointlayout_(MPI_Fint * comm,PetscSection s,PetscLayout *layout, int *__ierr){
...
PETSC_EXTERN void PETSC_STDCALL  petscsectiongetfieldpointoffset_(PetscSection s,PetscInt *point,PetscInt *field,PetscInt *offset, int *__ierr){
...
PETSC_EXTERN void PETSC_STDCALL  petscsectioncreatesubsection_(PetscSection s,PetscInt *len, PetscInt fields[],PetscSection *subs, int *__ierr){
*__ierr = PetscSectionCreateSubsection(
	(PetscSection)PetscToPointer((s) ),*len,fields,subs);
}
PETSC_EXTERN void PETSC_STDCALL  petscsectioncreatesupersection_(PetscSection s[],PetscInt *len,PetscSection *supers, int *__ierr){
*__ierr = PetscSectionCreateSupersection(s,*len,supers);
}
PETSC_EXTERN void PETSC_STDCALL  petscsectioncreatesubmeshsection_(PetscSection s,IS subpointMap,PetscSection *subs, int *__ierr){
