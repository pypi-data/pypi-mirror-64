...
PETSC_EXTERN void PETSC_STDCALL  petscsfsetgraphwithpattern_(PetscSF sf,PetscLayout map,PetscSFPattern *pattern, int *__ierr){
...
PETSC_EXTERN void PETSC_STDCALL  petscsfcomposeinverse_(PetscSF sfA,PetscSF sfB,PetscSF *sfBA, int *__ierr){
