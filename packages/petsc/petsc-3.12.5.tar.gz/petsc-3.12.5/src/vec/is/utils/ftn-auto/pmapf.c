...
PETSC_EXTERN void PETSC_STDCALL  petsclayoutcreatefromsizes_(MPI_Fint * comm,PetscInt *n,PetscInt *N,PetscInt *bs,PetscLayout *map, int *__ierr){
...
PETSC_EXTERN void PETSC_STDCALL  petsclayoutcreatefromranges_(MPI_Fint * comm, PetscInt range[],PetscCopyMode *mode,PetscInt *bs,PetscLayout *newmap, int *__ierr){
