...
PETSC_EXTERN void PETSC_STDCALL  pcfieldsplitsetgkbtol_(PC pc,PetscReal *tolerance, int *__ierr){
*__ierr = PCFieldSplitSetGKBTol(
	(PC)PetscToPointer((pc) ),*tolerance);
}
PETSC_EXTERN void PETSC_STDCALL  pcfieldsplitsetgkbmaxit_(PC pc,PetscInt *maxit, int *__ierr){
*__ierr = PCFieldSplitSetGKBMaxit(
	(PC)PetscToPointer((pc) ),*maxit);
}
PETSC_EXTERN void PETSC_STDCALL  pcfieldsplitsetgkbdelay_(PC pc,PetscInt *delay, int *__ierr){
*__ierr = PCFieldSplitSetGKBDelay(
	(PC)PetscToPointer((pc) ),*delay);
}
PETSC_EXTERN void PETSC_STDCALL  pcfieldsplitsetgkbnu_(PC pc,PetscReal *nu, int *__ierr){
