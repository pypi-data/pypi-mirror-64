...
PETSC_EXTERN void PETSC_STDCALL  pctelescopegetusecoarsedm_(PC pc,PetscBool *v, int *__ierr){
*__ierr = PCTelescopeGetUseCoarseDM(
	(PC)PetscToPointer((pc) ),v);
}
PETSC_EXTERN void PETSC_STDCALL  pctelescopesetusecoarsedm_(PC pc,PetscBool *v, int *__ierr){
