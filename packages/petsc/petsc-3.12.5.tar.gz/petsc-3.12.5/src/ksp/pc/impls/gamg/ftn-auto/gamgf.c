...
PETSC_EXTERN void PETSC_STDCALL  pcgamgsetcpupincoarsegrids_(PC pc,PetscBool *flg, int *__ierr){
*__ierr = PCGAMGSetCpuPinCoarseGrids(
	(PC)PetscToPointer((pc) ),*flg);
}
PETSC_EXTERN void PETSC_STDCALL  pcgamgsetcoarsegridlayouttype_(PC pc,PCGAMGLayoutType *flg, int *__ierr){
