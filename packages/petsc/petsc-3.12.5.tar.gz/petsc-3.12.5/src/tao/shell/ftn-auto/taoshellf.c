...
extern "C" {
#endif
PETSC_EXTERN void PETSC_STDCALL  taoshellgetcontext_(Tao tao,void**ctx, int *__ierr){
*__ierr = TaoShellGetContext(
	(Tao)PetscToPointer((tao) ),ctx);
}
PETSC_EXTERN void PETSC_STDCALL  taoshellsetcontext_(Tao tao,void*ctx, int *__ierr){
