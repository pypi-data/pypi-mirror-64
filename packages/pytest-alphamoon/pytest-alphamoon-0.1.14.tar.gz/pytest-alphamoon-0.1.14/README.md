...
| [annotation-check](pytest_alphamoon/annotation_check.py) | Checks integration tests class definition (all class defined under `integration_tests`) has decorator `@integration_test` |
