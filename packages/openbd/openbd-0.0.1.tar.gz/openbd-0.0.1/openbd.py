...
def book_info(isbn, has_data=False, dup=False):
    ...
    authors = get_authors(onix, 'DescriptiveDetail/Contributor',
                          'PersonName/content', 'ContributorRole')
    ...
    price = get_price(onix, 'ProductSupply/SupplyDetail/Price/#0',
    ...
    return BookInfo(isbn_, title, subtitle, series, authors, publish, date, price,
                    page, size, content, image, data if has_data else None)


_dcp = {'A01': '著', 'B01': '編集', 'B20': '監修', 'B06': '翻訳', 'A12': 'イラスト',
        'A38': '原著', 'A10': '企画原案', 'A08': '写真', 'A21': '解説', 'E07': '朗読'}
_dcs = {'B108': 'A5判', 'B109': 'B5判', 'B110': 'B6判', 'B111': '文庫',
        'B112': '新書', 'B119': '四六判', 'B120': '四六変形', 'B121': 'A4判',
        'B122': 'A4変形', 'B123': 'A5変形', 'B124': 'B5変形', 'B125': 'B6変形',
        'B126': 'AB判', 'B127': 'B7判', 'B128': '菊判', 'B129': '菊変形', 'B130': 'B4判'}
