...
class _ServiceKeys(object):
    ...
    API_DISCOVERY_KEY = "api"  # The one to rule them all
    ...
    @classmethod
    def initialize(cls):
        cls.register_discovery_url(cls.ARTIFACTS, cls.API_DISCOVERY_KEY)
        cls.register_discovery_url(cls.RUN_HISTORY, cls.API_DISCOVERY_KEY)
        cls.register_discovery_url(cls.METRICS, cls.API_DISCOVERY_KEY)
        cls.register_discovery_url(cls.JASMINE, cls.API_DISCOVERY_KEY)
        cls.register_discovery_url(cls.ASSETS, cls.API_DISCOVERY_KEY)
        cls.register_discovery_url(cls.EXECUTION, cls.API_DISCOVERY_KEY)
        cls.register_discovery_url(cls.RL_SERVICE, cls.API_DISCOVERY_KEY)
        cls.register_discovery_url(cls.EXPERIMENTATION, cls.API_DISCOVERY_KEY)
        cls.register_discovery_url(cls.ENVIRONMENT, cls.API_DISCOVERY_KEY)
        cls.register_discovery_url(cls.CREDENTIAL, cls.API_DISCOVERY_KEY)
        cls.register_discovery_url(cls.HYPERDRIVE, cls.API_DISCOVERY_KEY)
        cls.register_discovery_url(cls.PIPELINES, cls.API_DISCOVERY_KEY)
        cls.register_discovery_url(cls.PROJECT_CONTENT, cls.API_DISCOVERY_KEY)
