...
def _copy_sources():
    ...
    shutil.copytree(os.path.join(SRC_DIR_REPO, 'src'), os.path.join(SRC_DIR_LOCAL, 'src'),
            ignore=lambda src, names: ['python'] if os.path.split(os.fspath(src))[1] == 'api' else [])
...
setup(
    name='z3-solver-crosshair',
    version=_z3_version(),
    description='A fork of the Z3 SMT solver library for use in CrossHair.',
    author="The Z3 Theorem Prover Project",
    maintainer='Phillip Schanely',
    maintainer_email='pschanely@gmail.com',
