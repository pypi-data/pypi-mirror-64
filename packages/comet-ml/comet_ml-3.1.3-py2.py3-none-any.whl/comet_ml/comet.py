...
from ._typing import List, Optional, Tuple, Union
...
class BaseStreamer(threading.Thread):
    ...
    def getn(self, n):
        # type: (int) -> Optional[List[Tuple[Union[Message, UploadFileMessage, UploadInMemoryMessage, OsPackagesMessage, CloseMessage], int]]]
        """
