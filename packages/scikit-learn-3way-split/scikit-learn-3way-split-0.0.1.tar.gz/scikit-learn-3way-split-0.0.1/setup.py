...
DISTNAME = 'scikit-learn-3way-split'
DESCRIPTION = 'Added new function train_test_val_split that returns three subsets for train, test and validation.'
with open('README.rst') as f:
    LONG_DESCRIPTION = f.read()
MAINTAINER = 'Shekhar Singh'
MAINTAINER_EMAIL = 'shekharsingh8811@gmail.com'
URL = 'http://scikit-learn.org'
DOWNLOAD_URL = 'https://test.pypi.org/project/scikit-learn-3way-split/'
LICENSE = 'new BSD'
PROJECT_URLS = {
...
def check_package_status(package, min_version):
    ...
    req_str = "scikit-learn-3way-split requires {} >= {}.\n".format(
        package, min_version)
...
def setup_package():
    ...
    if len(sys.argv) == 1 or (
        ...
        if sys.version_info < (3, 6):
            raise RuntimeError(
                "Scikit-learn-3way-split requires Python 3.6 or later. The"
