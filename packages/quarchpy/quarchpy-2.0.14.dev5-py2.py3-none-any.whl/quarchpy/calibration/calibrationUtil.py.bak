...
def main(argstring):
    ...
    parser.add_argument('-l', '--logging',  help=argparse.SUPPRESS, choices=['warning', 'error', 'debug'], type=str.lower,default='warning') #Logging level to print to console Internal Use
