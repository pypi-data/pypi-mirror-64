...
def captureImageFromCamAndSave(tag,folder="train",camSerial=None):
    '''
    captureImageFromCamAndSave(tag,folder="train")
...
def predictCam(camSerial=None,skipFranmes=1,outputFileName=""):
    '''
        predictCam(camSerial=None,outputFileName="")
...
if __name__ == "__main__":
    ...
    '''
    loadDB(folder='train')
    predictCam(camSerial=1,outputFileName="result.txt")
