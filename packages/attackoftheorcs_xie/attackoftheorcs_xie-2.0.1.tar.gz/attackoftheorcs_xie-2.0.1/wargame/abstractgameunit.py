...
class TestAbstractGameUnit(AbstractGameUnit):
    def __init__(self, name=''):
        super().__init__(name=name)
        self.max_hp = 100
        self.health_meter = self.max_hp
        self.unit_type = 'testunit'
        self.hut_number = 0

    def info(self):
        """Print basic information about this character"""
        print("This is a abstract class test class.")

if __name__ == '__main__':
    testunit = TestAbstractGameUnit()
    print(testunit.max_hp)
    print(testunit.health_meter)
    print(testunit.unit_type)
    print(testunit.hut_number)
    print(testunit.info())