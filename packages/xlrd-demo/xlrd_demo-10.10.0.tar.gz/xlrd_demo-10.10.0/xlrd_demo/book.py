...
class Name(BaseObject):
    ...
    #: :class:`~xlrd_demo.formula.Operand` class.
    #
    result = None
    ...
    def cell(self):
        ...
        :returns: An instance of the :class:`~xlrd_demo.sheet.Cell` class.

        :raises xlrd_demo.biffh.XLRDError:
...
class Book(BaseObject):
    ...
    .. warning::
      ...
      object that was returned when you called :func:`~xlrd_demo.open_workbook`.
    """
    ...
    #: A list of :class:`~xlrd_demo.formatting.Font` class instances,
    #: each corresponding to a FONT record.
    #:
    #: .. versionadded:: 0.6.1
    font_list = []

    #: A list of :class:`~xlrd_demo.formatting.XF` class instances,
    #: each corresponding to an ``XF`` record.
    #:
    #: .. versionadded:: 0.6.1
    xf_list = []

    #: A list of :class:`~xlrd_demo.formatting.Format` objects, each corresponding to
    ...
    ##
    #: The mapping from :attr:`~xlrd_demo.formatting.XF.format_key` to
    #: :class:`~xlrd_demo.formatting.Format` object.
    #:
    #: .. versionadded:: 0.6.1
    format_map = {}
    ...
    def sheet_by_index(self, sheetx):
        ...
        :returns: A :class:`~xlrd_demo.sheet.Sheet`.
        """
    ...
    def __getitem__(self, item):
        ...
        :return: :class:`~xlrd_demo.sheet.Sheet`.
        """
