...
def open_workbook(filename=None,
    ...
    :param formatting_info:
      ...
      cells.
      Only :meth:`~xlrd_demo.sheet.Sheet.cell_value` and
      :meth:`~xlrd_demo.sheet.Sheet.cell_type` are available.
    ...
    :param ragged_rows:
      ...
      :attr:`~xlrd_demo.sheet.Sheet.ncols`.

      ``True`` means that there are no empty cells at the ends of rows.
      This can result in substantial memory savings if rows are of widely
      varying sizes. See also the :meth:`~xlrd_demo.sheet.Sheet.row_len` method.
    ...
    :returns: An instance of the :class:`~xlrd_demo.book.Book` class.
    """
