...
def xldate_as_tuple(xldate, datemode):
    ...
    :raises xlrd_demo.xldate.XLDateNegative:
    :raises xlrd_demo.xldate.XLDateAmbiguous:

    :raises xlrd_demo.xldate.XLDateTooLarge:
    :raises xlrd_demo.xldate.XLDateBadDatemode:
    :raises xlrd_demo.xldate.XLDateError:
    ...
    .. warning::
      ...
      should pass in the :attr:`~xlrd_demo.book.Book.datemode`
...
def xldate_from_date_tuple(date_tuple, datemode):
    ...
    :raises xlrd_demo.xldate.XLDateAmbiguous:
    :raises xlrd_demo.xldate.XLDateBadDatemode:
    :raises xlrd_demo.xldate.XLDateBadTuple:
...
def xldate_from_time_tuple(time_tuple):
    ...
    :raises xlrd_demo.xldate.XLDateBadTuple: Out-of-range hour, minute, or second
    """
