...
class TestXlsxParse(unittest.TestCase):
    ...
    def test_for_github_issue_75(self):
        ...
        # https://github.com/python-excel/xlrd_demo/issues/75
        workbook = xlrd_demo.open_workbook(from_this_dir('apachepoi_52348.xlsx'))
        worksheet = workbook.sheet_by_index(0)

        # Test an empty inlineStr cell.
        cell = worksheet.cell(0, 0)
        self.assertEqual(cell.value, '')
        self.assertEqual(cell.ctype, xlrd_demo.book.XL_CELL_EMPTY)

        # Test a non-empty inlineStr cell.
        cell = worksheet.cell(1, 2)
        self.assertEqual(cell.value, 'Category')
        self.assertEqual(cell.ctype, xlrd_demo.book.XL_CELL_TEXT)

    def test_for_github_issue_96(self):
        # Test for non-Excel file with forward slash file separator and
        # lowercase names. https://github.com/python-excel/xlrd_demo/issues/96
        workbook = xlrd_demo.open_workbook(from_this_dir('apachepoi_49609.xlsx'))
        worksheet = workbook.sheet_by_index(0)
        ...
        self.assertEqual(cell.ctype, xlrd_demo.book.XL_CELL_NUMBER)

    def test_for_github_issue_101(self):
        # Test for non-Excel file with forward slash file separator
        # https://github.com/python-excel/xlrd_demo/issues/101
        workbook = xlrd_demo.open_workbook(from_this_dir('self_evaluation_report_2014-05-19.xlsx'))
        worksheet = workbook.sheet_by_index(0)
    ...
    def test_for_github_issue_150(self):
        ...
        # https://github.com/python-excel/xlrd_demo/issues/150
        workbook = xlrd_demo.open_workbook(from_this_dir('issue150.xlsx'))
        worksheet = workbook.sheet_by_index(0)
