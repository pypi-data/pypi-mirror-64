...
class Sheet(BaseObject):
    ...
    .. warning::
      ...
      objects via the :class:`~xlrd_demo.book.Book` object that
      was returned when you called :func:`xlrd_demo.open_workbook`.
    """

    #: Name of sheet.
    name = ''

    #: A reference to the :class:`~xlrd_demo.book.Book` object to which this sheet
    #: belongs.
    #:
    ...
    #: See also the ``ragged_rows`` parameter to :func:`~xlrd_demo.open_workbook`
    #: and :meth:`~xlrd_demo.sheet.Sheet.row_len`.
    ncols = 0
    ...
    #:
    #: .. note::
    #:   xlrd_demo ignores the entry for the non-existent
    #:   257th column.
    #:
    ...
    #: :attr:`~xlrd_demo.sheet.Sheet.hyperlink_list`.
    ...
    def __init__(self, book, position, name, number):
        ...
        # Values calculated by xlrd_demo to predict the mag factors that
    ...
    def cell_xf_index(self, rowx, colx):
        ...
        This is an index into :attr:`~xlrd_demo.book.Book.xf_list`.
...
class Cell(BaseObject):
    ...
    .. warning::
      ...
      :class:`~xlrd_demo.book.Book` object that was returned when you called
      :func:`~xlrd_demo.open_workbook`
...
class Colinfo(BaseObject):
    ...
    xlrd_demo goes with the GCW version of the story.
...
class Rowinfo(BaseObject):
    ...
    def __init__(self):
        ...
        #: parsed by xlrd_demo), *and* is collapsed.
        ...
        #: Index to default :class:`~xlrd_demo.formatting.XF` record for empty cells
