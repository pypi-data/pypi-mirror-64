...
setuptools.setup(
    ...
    install_requires=[
        ...
        "PySimpleGUI",
        "youtube-dl",
        # "build-essential", # a dependency for py3exiv2
        # "python-all-dev",  # a dependency for py3exiv2
        # "libexiv2-dev",    # a dependency for py3exiv2
        # "libboost-python-dev",  # a dependency for py3exiv2
        # "py3exiv2",
    ],
    python_requires='>=3.6',
)
