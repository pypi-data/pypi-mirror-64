...
class EmbeddedNamespaceRegistrationTransactionBuilder(EmbeddedTransactionBuilder):
    ...
    def __init__(self,  signerPublicKey: KeyDto,  version: int,  network: NetworkTypeDto,  type_: EntityTypeDto,  id_: NamespaceIdDto,  name: bytes,  duration: BlockDurationDto,  parentId: NamespaceIdDto):
    ...
    def loadFromBinary(cls, payload: bytes) -> EmbeddedNamespaceRegistrationTransactionBuilder:
        ...
        return EmbeddedNamespaceRegistrationTransactionBuilder(superObject.signerPublicKey, superObject.version, superObject.network, superObject.type_, namespaceRegistrationTransactionBody.id_, namespaceRegistrationTransactionBody.name, namespaceRegistrationTransactionBody.duration, namespaceRegistrationTransactionBody.parentId)
