...
class DiagnosticsApi(object):
    ...
    def get_logs(self, org_id, **kwargs):  # noqa: E501
        """Retrieve application logs  # noqa: E501

        Retrieve application dignostic logs. These are the output from stdout/stderr (stream).   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_logs(org_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_logs_with_http_info(org_id, **kwargs)  # noqa: E501

    def get_logs_with_http_info(self, org_id, **kwargs):  # noqa: E501
        """Retrieve application logs  # noqa: E501

        Retrieve application dignostic logs. These are the output from stdout/stderr (stream).   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_logs_with_http_info(org_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('org_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `org_id` when calling `get_logs`")  # noqa: E501
