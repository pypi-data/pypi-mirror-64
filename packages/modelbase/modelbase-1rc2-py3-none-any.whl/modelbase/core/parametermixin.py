...
class ParameterMixin:
    ...
    def update_parameter(self, parameter_name, parameter_value, **meta_info):
        ...
        if parameter_name not in self.parameters:
            warnings.warn(
                f"Key {parameter_name} is not in the model. Please use the add_parameters method"
            )
        self.add_and_update_parameter(
            parameter_name=parameter_name, parameter_value=parameter_value, **meta_info
        )
    ...
    def add_and_update_parameter(self, parameter_name, parameter_value, **meta_info):
        ...
        self.meta_info.setdefault("parameters", {}).setdefault(
            parameter_name, Parameter(**meta_info)
        )
    ...
    def add_derived_parameter(self, parameter_name, function, parameters=None):
        ...
        self.add_parameter(
            ...
            parameter_value=function(*(self.parameters[i] for i in parameters)),
        )
