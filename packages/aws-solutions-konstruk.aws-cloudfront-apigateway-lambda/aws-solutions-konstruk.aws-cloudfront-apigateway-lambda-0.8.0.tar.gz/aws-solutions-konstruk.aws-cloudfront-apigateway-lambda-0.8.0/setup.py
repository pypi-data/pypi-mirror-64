...
kwargs = json.loads("""
{
    ...
    "package_data": {
        "aws_solutions_konstruk.aws_cloudfront_apigateway_lambda._jsii": [
            "aws-cloudfront-apigateway-lambda@0.8.0.jsii.tgz"
        ],
        "aws_solutions_konstruk.aws_cloudfront_apigateway_lambda": [
            "py.typed"
        ]
    ...
    "install_requires": [
        "jsii~=0.22.0",
        "publication>=0.0.3",
        "aws-cdk.aws-apigateway>=1.25.0, <1.26.0",
        "aws-cdk.aws-cloudfront>=1.25.0, <1.26.0",
        "aws-cdk.aws-lambda>=1.25.0, <1.26.0",
        "aws-cdk.aws-logs>=1.25.0, <1.26.0",
        "aws-cdk.core>=1.25.0, <1.26.0",
        "aws-solutions-konstruk.aws-cloudfront-apigateway>=0.8.0, <0.9.0",
