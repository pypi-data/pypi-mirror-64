...
def single_inference_model(weights, num_classes, image_shape=(480, 640),
    ...
    boxes_, scores_, classes_ = yolo_eval_serving(yolo_model.outputs, anchors, num_classes, image_shape, 20,
                                                  score_threshold,
                                                  iou_threshold)
...
if __name__ == '__main__':
    ...
    for i, file in enumerate(files[:100]):
        ...
        # serving_model_export(model, r"E:\Temp\test\yolo",auto_incre_version=False)
        tf_saved_model_to_lite(r"E:\Temp\test\yolo\1", r"E:\Temp\test\yolo.tflite", input_shape=[None, 416, 416, 3])
        import time
