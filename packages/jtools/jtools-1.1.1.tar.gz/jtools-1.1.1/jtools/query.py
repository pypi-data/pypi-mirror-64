...
class Query:
    ...
    def __init__(self,
        ...
        :param fallback: A fallback value that will be used if field cannot be found for a given object
        """
    ...
    def many(self, items: List[Union[list, dict]]) -> Union[List[Any], List[List[Any]]]:
        ...
        :return: A list of values, or a list of list of values, depending on whether one or multiple queries are present
        """
