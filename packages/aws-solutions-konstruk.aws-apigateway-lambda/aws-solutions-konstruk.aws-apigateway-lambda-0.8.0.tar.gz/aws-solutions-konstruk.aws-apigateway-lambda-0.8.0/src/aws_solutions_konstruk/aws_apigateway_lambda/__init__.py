...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-solutions-konstruk/aws-apigateway-lambda", "0.8.0", __name__, "aws-apigateway-lambda@0.8.0.jsii.tgz")
...
class ApiGatewayToLambdaProps():
    def __init__(self, *, deploy_lambda: bool, api_gateway_props: typing.Any=None, existing_lambda_obj: typing.Optional[aws_cdk.aws_lambda.Function]=None, lambda_function_props: typing.Any=None):
...
__all__ = ["ApiGatewayToLambda", "ApiGatewayToLambdaProps", "__jsii_assembly__"]
