...
%              brille.parse_arguments (args, keyval_def)
%
% Specify the number of required parameters and number of optional parameters:
%   >> [...] = brille.parse_arguments (args, npar_req, npar_opt, keyval_def)
%
...
%                          If not all arguments are passed to brille.parse_arguments
%                          then if an error is found at the third position
%                          in args, the error message that brille.parse_arguments
...
%
%       % Parse input:
%       [par, keyval, present] = brille.parse_arguments...
...
%
%       % Parse input:
%       [par,argout,present] = brille.parse_arguments(varargin,...
