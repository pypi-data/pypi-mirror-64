...
def get_merged_config(create_if_needed=True, local_overrides_path=None, suppress_warning=False, mini=False):
    ...
    # central location for mini flag is here
    config.mini_mode = mini
    ...
    fn_default =  constants.CONFIG_FN
    if mini:
        fn_default = fn_default.replace("xt", "txt")

    fn_overrides = local_overrides_path if local_overrides_path else fn_default
