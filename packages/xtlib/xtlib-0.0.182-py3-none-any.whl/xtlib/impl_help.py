...
class ImplHelp(ImplBase):
    ...
    def set_mini_mode(self, value):
        ...
        self.name = "txt" if value else "xt"
    ...
    def command_summary(self):
        ...
        console.print()
        console.print("{} ({})".format(self.name.upper(), constants.BUILD))
        
        console.print("Usage: {} [FLAGS] COMMAND [ARGS]...".format(self.name))
        console.print()
        
        if self.mini_mode:
            console.print("  TXT is used to manage and scale ML experiments.   Most command ")
