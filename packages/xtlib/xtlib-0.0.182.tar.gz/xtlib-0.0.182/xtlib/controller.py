...
class XTController(rpyc.Service):
    ...
    def bg_queue_worker(self):
        ...
        while True:
            ...
            try:
                ...
                # for debugging, raise exception and view stack trace
                raise ex
    ...
    def cancel_core(self, run_info, wrapup=True):
        result = None
        status = None
        ...
        with run_info.lock:
            result, status, before_status = run_info.kill(wrapup)
    ...
    def cancel_all(self, wrapup=True):
        to_kill = []
        results = []
        ...
        while True:
            ...
            while len(to_kill):
                ...
                result, status, before_status = self.cancel_core(run_info, wrapup=wrapup)
