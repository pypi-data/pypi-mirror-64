...
class ImplStorage(ImplBase):
    ...
    @option(name="range-alpha", type=float, default=.3, help="the alpha blending factor used to draw the range area")
    ...
    @option(name="max-runs", type=int, default=32, help="the maximum number of runs to plot")
    ...
    # command
    def plot(self, runs, col_list, x, layout, break_on, title, colors, show_legend, plot_titles, legend_titles, 
        smoothing_factor, plot_type, marker_size, marker_shape, alpha, edge_color, workspace, timeout, aggregate, 
        range_type, range_alpha, style, show_toolbar, max_runs, group_by):
