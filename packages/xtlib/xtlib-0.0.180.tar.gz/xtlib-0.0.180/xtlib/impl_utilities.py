...
class ImplUtilities(ImplBase):
    ...
    def create_demo(self, destination, response):
        ...
        if create:
            ...
            # console.print each dir as it is copied
            # def log_copy_dir(path):
            #     console.print("  {}".format(path))
            #     return []   # nothing will be ignored

            console.print("creating demo files:")

            #shutil.copytree(from_dir, dest_dir, ignore=log_copy_dir)
