...
class AzureML(BackendBase):
        ...
        for i, box_runs in enumerate(job_runs):
            ...
            if not wrapped_parts:
                ...
                sh_parts = super().wrap_user_command(cmd_parts, snapshot_dir, store_data_dir, data_action, 
                    ...
                    install_blobfuse=True, setup=setup, args=args)
    ...
    def submit_job(self, job_id, job_runs, workspace, compute_def, resume_name, 
        ...
        for i, node_runs in enumerate(job_runs):
            self.submit_node_runs(job_id, node_runs, workspace, aml_ws_name, experiment, aml_exper_name, compute_def, resume_name, 
    ...
    def run_aml_job(self, job_id, workspace, aml_ws_name, trainer, experiment, xt_exper_name, aml_exper_name, compute_target, cwd, run_name, box_name, 
        ...
        # copy to submit-logs
        utils.copy_data_to_submit_logs(args, trainer, "aml_submit.json")
