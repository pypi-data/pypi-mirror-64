...
class ImplCompute(ImplBase):
    ...
    @command(help="displays the status of the specified compute target")
    def view_status(self, run_name, tensorboard, mirror, target, workspace, job, monitor, escape_secs, auto_start, 
        ...
        '''The status command is used to display status information about the XT controller process
