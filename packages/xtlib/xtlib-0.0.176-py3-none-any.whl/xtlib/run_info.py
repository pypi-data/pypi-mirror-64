...
from .store import store_from_context
...
class RunInfo():
    def __init__(self, run_name, workspace, cmd_parts, run_script, repeat, context, status, show_output=True, parent_name=None, 
        parent_prep_needed=False, mirror_close_func=None, aml_run=None):
        ...
        self.is_aml = (self.aml_run is not None)
    ...
    def run_wrapup(self):
        ...
        store.wrapup_run(context.ws, run_name, context.aggregate_dest, context.dest_name, 
            ...
            capture_files=context.after_upload, job_id=self.job_id, is_parent = is_parent)
