...
from pumpkin_instrument.psu.types import PowerSupplyProtectionMode, PowerSupplyProtectionModeAll, PowerSupplyCapability, \
    PowerSupplyChannelCapability, PowerSupply
from pumpkin_instrument.types import InstrumentType, Instrument, Instruments, InstrumentChannelCapability, \
