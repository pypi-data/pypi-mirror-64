...
from pumpkin_instrument.load.types import Load, LoadMode, LoadCapability, LoadChannelCapability
from pumpkin_instrument.types import Instrument, InstrumentType
...
class TekPower3410A(Instrument):
    @classmethod
    def instrument_capabilities(cls) -> LoadCapability:
        return LoadCapability()

    @classmethod
    def channel_capabilities(cls) -> List[LoadChannelCapability]:
        """
