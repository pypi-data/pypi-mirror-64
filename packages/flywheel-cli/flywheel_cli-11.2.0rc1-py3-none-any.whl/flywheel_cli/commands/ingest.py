...
def add_commands(subparsers):
    ...
    IngestCommand(strategies.DicomConfig, subparsers, "dicom", help="Ingest dicom files")
    # ingest w folder strategy
    IngestCommand(strategies.FolderConfig, subparsers, "folder", help="Ingest a folder")
    # ingest w template strategy
    IngestCommand(strategies.TemplateConfig, subparsers, "template", help="Ingest a folder using a template")
...
class IngestCommand(Command):
    ...
    def run_local_ingest(self):
        ...
        try:
            reporter.Reporter(ingest_db, self.config.reporter).run()
