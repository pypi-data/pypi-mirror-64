...
class Task(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, state=None, name=None, started_at=None, finished_at=None, error=None, worker=None, progress_reports=None, created_resources=None, reserved_resources_record=None, local_vars_configuration=None):  # noqa: E501
