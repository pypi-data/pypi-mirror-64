            ...
            for pattern, replacement in log_label_obfuscate["body"].items():
                if re.search(pattern, body):
                    try:
                        ...
                        logger.error("Unable to obfuscate the body: {}".format(str(ex)))
            ...
            for pattern, replacement in log_label_obfuscate["response"].items():
                if re.search(pattern, response):
                    try:
                        ...
                        logger.error("Unable to obfuscate the response: {}".format(str(ex)))
            ...
            for pattern, replacement in log_label_obfuscate["url"].items():
                if re.search(pattern, url):
                    try:
                        ...
                        logger.error("Unable to obfuscate the url: {}".format(str(ex)))
