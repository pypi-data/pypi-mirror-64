...
class CollectorStub(object):
  ...
  def __init__(self, channel):
    ...
    self.add_schedule = channel.unary_unary(
        ...
        response_deserializer=spaceone_dot_api_dot_inventory_dot_v1_dot_collector__pb2.SchedulerInfo.FromString,
        )
    ...
    self.list_schedules = channel.unary_unary(
        ...
        request_serializer=spaceone_dot_api_dot_inventory_dot_v1_dot_collector__pb2.SchedulerQuery.SerializeToString,
        response_deserializer=spaceone_dot_api_dot_inventory_dot_v1_dot_collector__pb2.SchedulersInfo.FromString,
        )
...
def add_CollectorServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'add_schedule': grpc.unary_unary_rpc_method_handler(
          ...
          response_serializer=spaceone_dot_api_dot_inventory_dot_v1_dot_collector__pb2.SchedulerInfo.SerializeToString,
      ),
      ...
      'list_schedules': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=spaceone_dot_api_dot_inventory_dot_v1_dot_collector__pb2.SchedulerQuery.FromString,
          response_serializer=spaceone_dot_api_dot_inventory_dot_v1_dot_collector__pb2.SchedulersInfo.SerializeToString,
      ),
  }
