...
_VERIFYREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='credentials', full_name='spaceone.api.identity.plugin.VerifyRequest.credentials', index=1,
...
_FINDREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='credentials', full_name='spaceone.api.identity.plugin.FindRequest.credentials', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LOGINREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='credentials', full_name='spaceone.api.identity.plugin.LoginRequest.credentials', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_VERIFYREQUEST.fields_by_name['credentials'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT
_FINDREQUEST.fields_by_name['options'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT
_FINDREQUEST.fields_by_name['credentials'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT
_LOGINREQUEST.fields_by_name['options'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT
_LOGINREQUEST.fields_by_name['credentials'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT
