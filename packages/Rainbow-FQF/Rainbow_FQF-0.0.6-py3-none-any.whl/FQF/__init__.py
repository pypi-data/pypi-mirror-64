...
class FQF:
    ...
    def write_net_hist(self):
        self.writer.add_histogram(
            "fc/fc1", self.main_net.fc1.weight.cpu().detach().numpy(), int(self.current_episode/50))
        self.writer.add_histogram(
            "fc/fc2", self.main_net.fc2.weight.cpu().detach().numpy(), int(self.current_episode/50))
        self.writer.add_histogram(
            "fc/supports", self.main_net.support.weight.cpu().detach().numpy(),
            int(self.current_episode/50))
        self.writer.add_histogram(
