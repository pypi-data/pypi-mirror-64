...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-solutions-konstruk/aws-cognito-apigateway-lambda", "0.8.0", __name__, "aws-cognito-apigateway-lambda@0.8.0.jsii.tgz")
...
__all__ = ["CognitoToApiGatewayToLambda", "CognitoToApiGatewayToLambdaProps", "__jsii_assembly__"]
