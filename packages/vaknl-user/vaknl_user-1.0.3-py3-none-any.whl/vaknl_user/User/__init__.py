...
#     global _project_id, _firestore_client
#     _project_id = name
#     _firestore_client = create_firestore_client(project_id)  # Recreate firestore client
#
#
# def set_firestore_collection_source(name: str):
#     # Sets global variable firestore_collection_source.
#     global _firestore_collection_source
#     _firestore_collection_source = name
#
#
# def set_firestore_collection_destination(name: str):
#     # Sets global variable firestore_collection_destination.
#     global _firestore_collection_destination
#     _firestore_collection_destination = name
...
# ----------------------------------------------------------------------------------------------------------------------
_project_id = 'vaknldev'
_firestore_collection_source = u'in_website_clickstream'
_firestore_collection_destination = u'dmp_users_TEST'
_firestore_client = create_firestore_client(_project_id)
