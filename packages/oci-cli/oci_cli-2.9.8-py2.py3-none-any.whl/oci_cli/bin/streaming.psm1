...
function GetOciCommandsToLongParams_streaming() {
    $ociCommandsToLongParams = @{
        ...
        'streaming admin stream-pool update' = 'defined-tags force freeform-tags from-json help if-match kafka-settings max-wait-seconds name stream-pool-id wait-for-state wait-interval-seconds'
