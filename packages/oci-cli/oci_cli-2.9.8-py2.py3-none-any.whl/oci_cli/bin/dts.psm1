...
function GetOciCommandsToLongParams_dts() {
    $ociCommandsToLongParams = @{
        ...
        'dts job create' = 'bucket compartment-id defined-tags device-type display-name freeform-tags from-json help max-wait-seconds setup-notifications wait-for-state wait-interval-seconds'
