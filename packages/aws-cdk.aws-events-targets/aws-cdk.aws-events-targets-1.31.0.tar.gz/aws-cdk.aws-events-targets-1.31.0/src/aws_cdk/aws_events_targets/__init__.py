...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-events-targets", "1.31.0", __name__, "aws-events-targets@1.31.0.jsii.tgz")
...
class BatchJob(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-events-targets.BatchJob"):
    ...
    """
    def __init__(self, job_queue: aws_cdk.aws_batch.IJobQueue, job_definition: aws_cdk.aws_batch.IJobDefinition, *, attempts: typing.Optional[jsii.Number]=None, event: typing.Optional[aws_cdk.aws_events.RuleTargetInput]=None, size: typing.Optional[jsii.Number]=None) -> None:
        """
        :param job_queue: -
        ...
        :stability: experimental
        """
        props = BatchJobProps(attempts=attempts, event=event, size=size)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-events-targets.BatchJobProps", jsii_struct_bases=[], name_mapping={'attempts': 'attempts', 'event': 'event', 'size': 'size'})
class BatchJobProps():
    def __init__(self, *, attempts: typing.Optional[jsii.Number]=None, event: typing.Optional[aws_cdk.aws_events.RuleTargetInput]=None, size: typing.Optional[jsii.Number]=None):
