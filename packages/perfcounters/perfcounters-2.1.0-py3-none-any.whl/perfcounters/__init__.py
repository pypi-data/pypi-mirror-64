...
from .report import process_counters
from .report import VALUE, TIME, LAP
from .report import VALUE_COUNTERS, TIME_COUNTERS, LAPS_COUNTERS  # noqa
from . import display
...
class PerfCounters():
    ...
    def get_all(self):
        ...
        Returns:
            dict: all counters as [type][counter_name][value]
        """
        return process_counters(self.counters, self.laps)
