...
class RepositoriesDebVersionsApi(object):
    ...
    def list(self, deb_repository_href, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_with_http_info(deb_repository_href, **kwargs)  # noqa: E501

    def list_with_http_info(self, deb_repository_href, **kwargs):  # noqa: E501
        """List repository versions  # noqa: E501

        DebRepositoryVersion represents a single deb repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_with_http_info(deb_repository_href, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['deb_repository_href', 'ordering', 'number', 'number__lt', 'number__lte', 'number__gt', 'number__gte', 'number__range', 'pulp_created__lt', 'pulp_created__lte', 'pulp_created__gt', 'pulp_created__gte', 'pulp_created__range', 'content', 'pulp_created', 'limit', 'offset', 'fields', 'exclude_fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('deb_repository_href' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `deb_repository_href` when calling `list`")  # noqa: E501
