...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v2.2.0-alpha.1585060933+gc6a5353f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v2.2.0-alpha.1585060933+gc6a5353f`
                """)
            else:
                raise
