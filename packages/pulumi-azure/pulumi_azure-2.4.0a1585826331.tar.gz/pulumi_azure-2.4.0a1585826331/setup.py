...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v2.4.0-alpha.1585826331+ge6f80256'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v2.4.0-alpha.1585826331+ge6f80256`
                """)
            else:
                raise
