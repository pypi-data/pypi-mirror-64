...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v2.2.0-alpha.1585046273+gb7156dc7'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v2.2.0-alpha.1585046273+gb7156dc7`
                """)
            else:
                raise
