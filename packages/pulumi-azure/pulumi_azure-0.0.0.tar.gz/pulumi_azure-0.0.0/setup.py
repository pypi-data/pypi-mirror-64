...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v2.3.0-alpha.1585230912+g7563f3e5'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v2.3.0-alpha.1585230912+g7563f3e5`
                """)
            else:
                raise
