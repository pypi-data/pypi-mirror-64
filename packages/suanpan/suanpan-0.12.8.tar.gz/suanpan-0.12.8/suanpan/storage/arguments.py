...
class Json(Data):
    ...
    def transform(self, value):
        filePath = super(Json, self).transform(value)
        if not filePath:
            return None
    ...
    def save(self, result):
        ...
        return super(Json, self).save(Result.froms(value=self.filePath))
...
class Csv(Data):
    ...
    def transform(self, value):
        filePath = super(Csv, self).transform(value)
        if not filePath:
            return None
    ...
    def save(self, result):
        ...
        return super(Csv, self).save(Result.froms(value=self.filePath))
...
class Excel(Data):
    ...
    def transform(self, value):
        value = super(Excel, self).transform(value)
        if self.filePath:
    ...
    def save(self, result):
        ...
        return super(Excel, self).save(Result.froms(value=self.filePath))
...
class Npy(Data):
    ...
    def transform(self, value):
        filePath = super(Npy, self).transform(value)
        if not filePath:
            return None
    ...
    def save(self, result):
        ...
        return super(Npy, self).save(Result.froms(value=self.filePath))
...
class String(Data):
    ...
    def transform(self, value):
        filePath = super(String, self).transform(value)
        if not filePath:
            return None
    ...
    def save(self, result):
        ...
        return super(String, self).save(Result.froms(value=self.filePath))
...
class Image(File):
    ...
    def transform(self, value):
        filePath = super(Image, self).transform(value)
        if not filePath:
            return None
    ...
    def save(self, result):
        ...
        return super(Image, self).save(Result.froms(value=self.filePath))
