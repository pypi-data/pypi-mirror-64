...
class SimulatorConfiguration(_AbstractRunConfigElement):
    ...
    :param health_check_timeout: The time lapse between health checks in seconds.
    ...
    _field_to_info_dict = collections.OrderedDict([
        ...
        ("health_check_timeout", _FieldInfo(int, "The time lapse between health checks in seconds",
