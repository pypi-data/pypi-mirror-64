...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'random', 'v1.8.0-alpha.1585825686+g381e0ac'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource random v1.8.0-alpha.1585825686+g381e0ac`
                """)
            else:
                raise
