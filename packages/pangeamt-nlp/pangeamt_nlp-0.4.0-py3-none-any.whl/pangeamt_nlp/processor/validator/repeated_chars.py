...
class PlaceholdersCounter(ValidatorBase):
    NAME = "repeated_chars"

    DESCRIPTION_TRAINING = """
            Remove pairs with chars repeated more than 10 times
        """
    ...
    def __init__(self, src_lang: str, tgt_lang: str, length_factor: float) -> None:
