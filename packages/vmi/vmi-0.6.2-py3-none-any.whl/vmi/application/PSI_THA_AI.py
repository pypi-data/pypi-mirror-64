...
def init_pelvis():
    ...
    if td_pts[0].sum() != 0 and td_pts[1].sum() != 0:
        ...
        voi_ary[voi_ary < 200] = -1024
        voi_ary[voi_ary >= 200] = 3200
        seg_pre[0][seg_pre[0] < 200] = -1024
        seg_pre[0][seg_pre[0] >= 200] = 3200
        seg_pre[1][seg_pre[1] < 200] = -1024
        seg_pre[1][seg_pre[1] >= 200] = 3200
