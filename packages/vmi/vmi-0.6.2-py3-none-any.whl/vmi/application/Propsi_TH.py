...
def case_sync():
    ...
    with tempfile.TemporaryDirectory() as p:
        case_vti = {'voi_vti': voi_volume.data()}
        for kw in case_vti:
        ...
        print(psi_match_prop.data().GetNumberOfCells())
        print(psi_arm_prop.data().GetNumberOfCells())
        print(psi_mold_prop.data().GetNumberOfCells())
        ...
        case = vmi.application.skyward.case_sync(case, ['product_name', 'product_model', 'pelvis_dicom', 'surgical_side'])
