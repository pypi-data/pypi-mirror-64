...
def contactOrientations(volBin, volLab, watershed="ITK", peakDistance=5, markerShrink=True):
    ...
    if watershed == "RW":
        ...
        localMaxi = skimage.feature.peak_local_max(distanceMap, min_distance=peakDistance, indices=False, exclude_border=True, labels=volBin, num_peaks=2)
        ...
        if numMarkers != 2:
            markers = _markerCorrection(markers, numMarkers, distanceMap, volBin, peakDistance=peakDistance)
