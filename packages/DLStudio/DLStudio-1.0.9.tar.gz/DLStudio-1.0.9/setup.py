...
setup(name='DLStudio',
      ...
      url='https://engineering.purdue.edu/kak/distDLS/DLStudio-1.0.9.html',
      download_url='https://engineering.purdue.edu/kak/distDLS/DLStudio-1.0.9.tar.gz',
      description='An educational module that is being developed to make it easier to design experimental deep-learning networks in PyTorch',
      long_description='''

Consult the module API page at

      https://engineering.purdue.edu/kak/distDLS/DLStudio-1.0.9.html
