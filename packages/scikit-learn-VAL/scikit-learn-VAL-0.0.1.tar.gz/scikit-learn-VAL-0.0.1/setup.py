...
MAINTAINER = 'Rishabh Garg'
#MAINTAINER_EMAIL = 'amueller@ais.uni-bonn.de'
MAINTAINER_EMAIL = 'rishabhatulgarg@gmail.com'
URL = 'http://scikit-learn.org'
#DOWNLOAD_URL = 'https://pypi.org/project/scikit-learn/#files'
DOWNLOAD_URL = 'https://test.pypi.org/project/scikit-learn-VAL/'
LICENSE = 'new BSD'
PROJECT_URLS = {
...
def check_package_status(package, min_version):
    ...
    #    package, min_version)
    req_str = "scikit-learn-VAL requires {} >= {}.\n".format(
        package, min_version)
    ...
    if len(sys.argv) == 1 or (
        ...
        if sys.version_info < (3, 6):
            raise RuntimeError(
                ...
                "Scikit-learn-VAL requires Python 3.6 or later. The current"
