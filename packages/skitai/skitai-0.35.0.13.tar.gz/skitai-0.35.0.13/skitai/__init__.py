...
argopt.add_option (None, '--user=SERVICE_USER', desc = "run service with user privileges")
...
def get_command ():
    ...
    if "-d" in options:
        ...
        for cmd_ in ("start", "stop", "status", "restart", 'install', 'uninstall', 'remove', 'update'):
