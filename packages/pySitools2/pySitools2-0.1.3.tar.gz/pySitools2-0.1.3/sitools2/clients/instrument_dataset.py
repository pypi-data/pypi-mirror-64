...
class SdoDataset(Dataset):
    """Class getting instance of the SDO hmi datasets.
    ...
    instance of the IDOC/MEDOC client dataset for the SDO 'hmi'
    series.
...
class SdoAiaDataset(Dataset):
    """Class getting instance of the SDO aia.lev1 dataset.

    This class is inherited from the class Dataset which is a set of
    instances. The class SdoAiaDataset is specially used to have an
    instance of the IDOC/MEDOC client dataset for the SDO 'aia.lev1'
    series.
