...
ALLOWED_SERVER_LIST = ['http://idoc-medoc.ias.u-psud.fr',
...
SDO_ALLOWED_SERIE_LIST = ['aia.lev1',
                          'hmi.ic_720s',
...
SOHO_ALLOWED_DETECTOR_LIST = ['CDS/NIS', 'CDS/GIS', 'CELIAS/CTOF',
                              'CELIAS/DPU', 'CELIA/HSTOF', 'CELIA/MTOF',
                              'CELIA/PM', 'CELIA/SEM', 'CELIA/STOF',
...
# Allowed parameters which can be given as args in search() method
# for SOHO client
SOHO_ALLOWED_SEARCH_PARAMS = ['DATES', 'DETECTORS', 'NB_RES_MAX']

# Allowed parameters which can be given as args in search() method
# for STEREO client
STEREO_ALLOWED_SEARCH_PARAMS = ['DATES', 'DETECTORS', 'NB_RES_MAX']
