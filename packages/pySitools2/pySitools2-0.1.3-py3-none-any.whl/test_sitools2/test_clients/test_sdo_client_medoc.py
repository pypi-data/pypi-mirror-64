...
class TestSdoClientMedoc:
    ...
    def test_get_data_primary_key_list(self):
        ...
        sdo_data_list = self.sdo_data_list
        assert [775321065, 775321055] == self.sdo.get_data_primary_key_list(sdo_data_list)

    def test_get_plugin_id(self):
        """Tests get_plugin_id()"""
        assert 'plugin02' == self.sdo.get_plugin_id(download_type='tar')

    def test_get_plugin_id1(self):
        """Tests get_plugin_id()"""
        assert 'plugin03' == self.sdo.get_plugin_id(download_type='')
