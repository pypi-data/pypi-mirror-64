...
class Rediz(RedizConventions):
    ...
    def difficulty(self,write_key):
        try:
            return self.difficulty(write_key)
        except:
            return 0 
    ...
    def set( self, name, value, write_key, budget=10 ):
        ...
        if self.difficulty(write_key)<self.min_len:
    ...
    def cset(self, names:NameList, values:ValueList, budgets:List[int], write_key=None, write_keys=None):
        if self.difficulty(write_key) < self.min_len+1:
...
# --------------------------------------------------------------------------
    ...
    def distance_to_bankruptcy(self,write_key):
        level   = self.bankruptcy( self.difficulty(write_key) )
