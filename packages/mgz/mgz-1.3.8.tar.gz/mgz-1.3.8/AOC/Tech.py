...
class Tech(object):
    ...
    # Tech
    def LastStateChange(self): return self._tab.Get(flatbuffers.number_types.Uint32Flags, self._tab.Pos + flatbuffers.number_types.UOffsetTFlags.py_type(4))
    # Tech
...
def CreateTech(builder, idIndex, idGame, lastStateChange, state):
    builder.Prep(4, 12)
    builder.Pad(3)
    builder.PrependInt8(state)
    builder.PrependUint32(lastStateChange)
