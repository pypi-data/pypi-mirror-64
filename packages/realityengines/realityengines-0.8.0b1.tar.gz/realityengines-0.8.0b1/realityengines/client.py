...
class ReClient():
    ...
    def predict(self, deployment_token: str, deployment_id: str, query_data: dict = None, **kwargs):
        '''    '''
    ...
    def get_recommendations(self, deployment_token: str, deployment_id: str, query_data: dict, num_items: int = '50', page: int = '1', include_filters: list = None, exclude_filters: list = None):
        '''    '''
    ...
    def get_related_items(self, deployment_token: str, deployment_id: str, query_data: dict, page: int = '1', include_filters: list = None, exclude_filters: list = None):
        '''    '''
    ...
    def batch_predict(self, deployment_id: str, input_location: str, output_location: str):
        '''    '''
        return self._call_api('batchPredict', 'POST', body={'deploymentId': deployment_id, 'inputLocation': input_location, 'outputLocation': output_location}, parse_type=BatchPrediction)
