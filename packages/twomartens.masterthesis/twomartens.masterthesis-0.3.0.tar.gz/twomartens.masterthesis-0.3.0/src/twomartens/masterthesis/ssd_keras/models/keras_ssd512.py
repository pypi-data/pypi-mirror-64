...
def ssd_512(image_size,
    ...
    fc7 = tf.keras.layers.Conv2D(1024, (1, 1), activation='relu', padding='same',
    ...
    conv8_2 = tf.keras.layers.Conv2D(256, (3, 3), strides=(2, 2), activation='relu', padding='valid',
                                     kernel_initializer='he_normal',
    ...
    conv9_2 = tf.keras.layers.Conv2D(256, (3, 3), strides=(2, 2), activation='relu', padding='valid',
                                     kernel_initializer='he_normal',
                                     kernel_regularizer=tf.keras.regularizers.l2(l2_reg), name='conv9_2')(conv9_1)
    
    conv10_1 = tf.keras.layers.Conv2D(128, (1, 1), activation='relu', padding='same', kernel_initializer='he_normal',
                                      kernel_regularizer=tf.keras.regularizers.l2(l2_reg), name='conv10_1')(conv9_2)
    conv10_1 = tf.keras.layers.ZeroPadding2D(padding=((1, 1), (1, 1)), name='conv10_padding')(conv10_1)
    conv10_2 = tf.keras.layers.Conv2D(256, (4, 4), strides=(1, 1), activation='relu', padding='valid',
                                      kernel_initializer='he_normal',
                                      kernel_regularizer=tf.keras.regularizers.l2(l2_reg), name='conv10_2')(conv10_1)
    ...
    conv10_2_mbox_conf = tf.keras.layers.Conv2D(n_boxes[6] * n_classes, (3, 3), padding='same',
                                                kernel_initializer='he_normal',
                                                kernel_regularizer=tf.keras.regularizers.l2(l2_reg),
    ...
    conv10_2_mbox_loc = tf.keras.layers.Conv2D(n_boxes[6] * 4, (3, 3), padding='same', kernel_initializer='he_normal',
                                               kernel_regularizer=tf.keras.regularizers.l2(l2_reg),
    ...
    conv10_2_mbox_priorbox = keras_layer_AnchorBoxes.AnchorBoxes(img_height, img_width, this_scale=scales[6],
                                                                 next_scale=scales[7], aspect_ratios=aspect_ratios[6],
                                                                 two_boxes_for_ar1=two_boxes_for_ar1,
                                                                 this_steps=steps[6], this_offsets=offsets[6],
                                                                 clip_boxes=clip_boxes,
                                                                 variances=variances, coords=coords,
                                                                 normalize_coords=normalize_coords,
    ...
    conv9_2_mbox_conf_reshape = tf.keras.layers.Reshape((-1, n_classes), name='conv9_2_mbox_conf_reshape')(
        conv9_2_mbox_conf)
    conv10_2_mbox_conf_reshape = tf.keras.layers.Reshape((-1, n_classes), name='conv10_2_mbox_conf_reshape')(
        conv10_2_mbox_conf)
    ...
    conv10_2_mbox_priorbox_reshape = tf.keras.layers.Reshape((-1, 8), name='conv10_2_mbox_priorbox_reshape')(
    ...
    if return_predictor_sizes:
        predictor_sizes = np.array([conv4_3_norm_mbox_conf.int_shape()[1:3],
                                    ...
                                    conv10_2_mbox_conf.int_shape()[1:3]])
