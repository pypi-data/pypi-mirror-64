...
class DataAugmentationVariableInputSize:
    ...
    def __init__(self,
        ...
        self.convert_to_3_channels = photometric_ops.ConvertTo3Channels()  # Make sure all images end up having 3
        # channels.
        ...
        self.random_patch = patch_sampling_ops.RandomPatch(patch_coord_generator=self.patch_coord_generator,
