        ...
        def filter_predictions(batch_item):
            ...
            def filter_single_class(index):
                ...
                def perform_nms():
                    ...
                    # xmax)`.
                    _xmin = tf.expand_dims(single_class[..., -4], axis=-1)
                    _ymin = tf.expand_dims(single_class[..., -3], axis=-1)
                    _xmax = tf.expand_dims(single_class[..., -2], axis=-1)
                    _ymax = tf.expand_dims(single_class[..., -1], axis=-1)
