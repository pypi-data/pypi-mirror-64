...
class Schema:
    ...
    def __eq__(self, other):
        return isinstance(other, Schema) and self.column_attributes.to_list() == other.column_attributes.to_list()


class ColumnAttribute:
    def __init__(self, name=None, column_type=None, element_type=None, is_feature=True, properties=None):
