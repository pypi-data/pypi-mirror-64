...
class FolderBasedImageDirectory(ImageDirectory):
    ...
    def parse_images_in_one_folder(cls, load_from_dir):
        ...
        image_list = [{
            ...
            ImageSchema.DEFAULT_CLASSIFICATION_COL: None,
        } for f in files]
        label_attr = ColumnAttribute(
            ImageSchema.DEFAULT_CLASSIFICATION_COL,
            column_type=ColumnTypeName.STRING, element_type=ElementTypeName.STRING,
            is_feature=False, properties={ImageSchema.ANNOTATION_KEY: None},
        )
        ...
        schema = ImageSchema.get_default_schema_coco(annotation_type=None, attr=label_attr)
        schema.column_attributes[ImageSchema.DEFAULT_ID_COL] = id_attr
