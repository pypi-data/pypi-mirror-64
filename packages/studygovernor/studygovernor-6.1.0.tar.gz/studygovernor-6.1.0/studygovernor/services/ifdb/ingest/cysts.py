...
class Cysts(AbstractIngestionAdapter):
    _LABELS = ['Cyst']
    ...
    def do_ingestion(self, ifdb, field_parser, incidental_findings, label_mappings, experiment_id, generator_url):
        self._auto_findings(incidental_findings, 'cysts', field_parser, ifdb, label_mappings[self._LABELS[0]], experiment_id, generator_url)
