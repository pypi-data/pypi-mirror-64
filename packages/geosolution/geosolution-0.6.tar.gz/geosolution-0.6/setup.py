...
setup(
  ...
  url = 'https://github.com/abirraihan/geodesign',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/abiraihan/geodesign/archive/0.1.tar.gz',    # I explain this later on
  keywords = ['Experimental Design', 'Geospatial Data Science', 'Spatial Analysis'],   # Keywords that define your package best
  install_requires=[
      'math',
      'glob',
      'time',
