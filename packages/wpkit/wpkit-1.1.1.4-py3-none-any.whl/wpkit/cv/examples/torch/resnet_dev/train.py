...
def train(
        data_dir=None,train_dir=None,batch_size=32,num_epochs=50,patience=50,lr=0.001,step_size=15,momentum=0.9,gamma=0.1,num_classes=None,val_dir=None,model_save_dir=None,model_save_path=None,pretrained_model_path=None,model_type='resnet50',use_default_pretrained_or_download=True
):
    if not train_dir:
