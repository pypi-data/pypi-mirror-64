"""
Module to test brownout packet delay functionality of DUT/SUT
"""
import os
import sys
import time
...
class ResiliencyLinkBrownoutPacketDelay(SdWanTest):
    """
    Class for test case ResiliencyLinkBrownoutPacketDelay
    """
    ...
    def run(self):
        ...
        if self.error_info:
            ...
            logger.console_info("done")
        ############################################################################
        # Make packets delay>200ms by SNE, then traffic should switch to Mpls link #
        ############################################################################
