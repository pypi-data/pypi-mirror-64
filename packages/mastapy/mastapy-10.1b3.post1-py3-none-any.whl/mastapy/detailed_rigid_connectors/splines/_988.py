...
from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _1003
...
class SAESplineHalfDesign(_1000.StandardSplineHalfDesign):
    '''SAESplineHalfDesign
    ...
    @property
    def sae_accuracy_and_tolerance(self) -> '_1003.SAESplineTolerances':
        ...
        return constructor.new(_1003.SAESplineTolerances)(self.wrapped.SAEAccuracyAndTolerance) if self.wrapped.SAEAccuracyAndTolerance else None
