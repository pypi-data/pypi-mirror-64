...
from mastapy.detailed_rigid_connectors.splines import _976, _1001
...
class SAESplineJointDesign(_1001.StandardSplineJointDesign):
    '''SAESplineJointDesign
    ...
    @property
    def fit_type(self) -> '_976.FitTypes':
        '''FitTypes: 'FitType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FitType)
        return constructor.new(_976.FitTypes)(value) if value else None

    @fit_type.setter
    def fit_type(self, value: '_976.FitTypes'):
