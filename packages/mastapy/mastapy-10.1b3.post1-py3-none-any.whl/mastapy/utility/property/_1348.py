...
from mastapy.utility.units_and_measurements.measurements import _1218
...
class DutyCyclePropertySummaryPercentage(_1346.DutyCyclePropertySummary['_1218.Percentage', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryPercentage
