...
from mastapy.utility.databases import _1340, _1337, _1336
...
class SQLDatabase(_1336.Database['TKey', 'TValue'], Generic[TKey, TValue]):
    '''SQLDatabase
    ...
    def save(self, item: '_1340.NamedDatabaseItem'):
    ...
    def delete(self, key: '_1337.DatabaseKey'):
