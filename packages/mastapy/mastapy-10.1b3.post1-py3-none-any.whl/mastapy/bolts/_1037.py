...
from mastapy.bolts import _1052, _1033
...
class BoltMaterial(_1033.BoltedJointMaterial):
    '''BoltMaterial
    ...
    @property
    def strength_grade(self) -> '_1052.StrengthGrades':
        ...
        return constructor.new(_1052.StrengthGrades)(value) if value else None

    @strength_grade.setter
    def strength_grade(self, value: '_1052.StrengthGrades'):
