...
from mastapy.bolts import _1033
...
class ClampedSection(_0.APIBase):
    ...
    @property
    def material(self) -> '_1033.BoltedJointMaterial':
        ...
        return constructor.new(_1033.BoltedJointMaterial)(self.wrapped.Material) if self.wrapped.Material else None
