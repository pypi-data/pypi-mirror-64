...
class StraightBevelGearMeshAdvancedSystemDeflection(_6247.BevelGearMeshAdvancedSystemDeflection):
    '''StraightBevelGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6186.StraightBevelGearMeshLoadCase':
        ...
        return constructor.new(_6186.StraightBevelGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2317.StraightBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2317.StraightBevelGearMeshSystemDeflection))
        return value
