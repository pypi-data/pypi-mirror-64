...
class PartToPartShearCouplingConnectionAdvancedSystemDeflection(_6268.CouplingConnectionAdvancedSystemDeflection):
    '''PartToPartShearCouplingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6153.PartToPartShearCouplingConnectionLoadCase':
        ...
        return constructor.new(_6153.PartToPartShearCouplingConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2290.PartToPartShearCouplingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2290.PartToPartShearCouplingConnectionSystemDeflection))
        return value
