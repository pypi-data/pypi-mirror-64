...
class PartModalAnalysesAtSpeeds(_6491.PartStaticLoadAnalysisCase):
    '''PartModalAnalysesAtSpeeds
    ...
    @property
    def modal_analyses_at_speeds(self) -> '_4063.StabilityAnalysis':
        ...
        return constructor.new(_4063.StabilityAnalysis)(self.wrapped.ModalAnalysesAtSpeeds) if self.wrapped.ModalAnalysesAtSpeeds else None
