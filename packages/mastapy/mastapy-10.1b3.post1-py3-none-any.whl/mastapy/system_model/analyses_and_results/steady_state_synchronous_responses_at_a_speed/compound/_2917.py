...
from mastapy.system_model.connections_and_sockets import _1846
...
class PlanetaryConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_2929.ShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponseAtASpeed):
    '''PlanetaryConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_design(self) -> '_1846.PlanetaryConnection':
    ...
    @property
    def connection_design(self) -> '_1846.PlanetaryConnection':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2795.PlanetaryConnectionSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2795.PlanetaryConnectionSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def connection_steady_state_synchronous_response_at_a_speed_load_cases(self) -> 'List[_2795.PlanetaryConnectionSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSteadyStateSynchronousResponseAtASpeedLoadCases, constructor.new(_2795.PlanetaryConnectionSteadyStateSynchronousResponseAtASpeed))
        return value
