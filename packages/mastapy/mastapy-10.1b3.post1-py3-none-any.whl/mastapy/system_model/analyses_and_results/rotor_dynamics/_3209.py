...
from mastapy.utility.units_and_measurements.measurements import _1204, _1158
...
class ShaftForcedComplexShape(_3208.ShaftComplexShape['_1204.LengthVeryShort', '_1158.AngleSmall']):
    '''ShaftForcedComplexShape
