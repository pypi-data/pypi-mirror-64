...
from mastapy.system_model.analyses_and_results.system_deflections import _2223, _2323
...
class SynchroniserHalfSystemDeflection(_2323.SynchroniserPartSystemDeflection):
    '''SynchroniserHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3321.SynchroniserHalfPowerFlow':
