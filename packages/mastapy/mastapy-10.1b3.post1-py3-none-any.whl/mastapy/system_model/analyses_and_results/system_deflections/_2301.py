...
from mastapy.system_model.analyses_and_results.system_deflections import _2326, _2228, _2209
...
class RootAssemblySystemDeflection(_2209.AssemblySystemDeflection):
    '''RootAssemblySystemDeflection
    ...
    @property
    def system_deflection_inputs(self) -> '_2326.SystemDeflection':
        ...
        return constructor.new(_2326.SystemDeflection)(self.wrapped.SystemDeflectionInputs) if self.wrapped.SystemDeflectionInputs else None

    @property
    def power_flow_results(self) -> '_3302.RootAssemblyPowerFlow':
    ...
    @property
    def shaft_deflection_results(self) -> 'List[_2228.ConcentricPartGroupCombinationSystemDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDeflectionResults, constructor.new(_2228.ConcentricPartGroupCombinationSystemDeflectionResults))
        return value
