...
from mastapy.system_model.analyses_and_results.system_deflections import _2322, _2307
...
class SynchroniserSystemDeflection(_2307.SpecialisedAssemblySystemDeflection):
    '''SynchroniserSystemDeflection
    ...
    @property
    def assembly_load_case(self) -> '_6191.SynchroniserLoadCase':
        ...
        return constructor.new(_6191.SynchroniserLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None

    @property
    def power_flow_results(self) -> '_3323.SynchroniserPowerFlow':
    ...
    @property
    def cones(self) -> 'List[_2322.SynchroniserHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2322.SynchroniserHalfSystemDeflection))
        return value
