...
class KlingelnbergCycloPalloidHypoidGearSystemDeflection(_2275.KlingelnbergCycloPalloidConicalGearSystemDeflection):
    '''KlingelnbergCycloPalloidHypoidGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3278.KlingelnbergCycloPalloidHypoidGearPowerFlow':
