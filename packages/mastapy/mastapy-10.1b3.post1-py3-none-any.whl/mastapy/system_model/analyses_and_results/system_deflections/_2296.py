...
from mastapy.system_model.analyses_and_results.system_deflections import _2334, _2336
...
class PowerLoadSystemDeflection(_2336.VirtualComponentSystemDeflection):
    '''PowerLoadSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3297.PowerLoadPowerFlow':
    ...
    @property
    def transmission_error_to_other_power_loads(self) -> 'List[_2334.TransmissionErrorResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TransmissionErrorToOtherPowerLoads, constructor.new(_2334.TransmissionErrorResult))
        return value
