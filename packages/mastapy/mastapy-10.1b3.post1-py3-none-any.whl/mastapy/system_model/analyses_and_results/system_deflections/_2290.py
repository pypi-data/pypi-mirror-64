...
class PartToPartShearCouplingConnectionSystemDeflection(_2241.CouplingConnectionSystemDeflection):
    '''PartToPartShearCouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3288.PartToPartShearCouplingConnectionPowerFlow':
