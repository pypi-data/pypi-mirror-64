...
class CVTPulleySystemDeflection(_2297.PulleySystemDeflection):
    '''CVTPulleySystemDeflection
    ...
    @property
    def component_design(self) -> '_2118.CVTPulley':
    ...
    @property
    def power_flow_results(self) -> '_3253.CVTPulleyPowerFlow':
    ...
    @property
    def fixed_sheave_contact_results(self) -> 'List[_1113.NodeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FixedSheaveContactResults, constructor.new(_1113.NodeResults))
        return value

    @property
    def moving_sheave_contact_results(self) -> 'List[_1113.NodeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MovingSheaveContactResults, constructor.new(_1113.NodeResults))
        return value
