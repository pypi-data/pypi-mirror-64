...
from mastapy.nodal_analysis import _1374, _1362
...
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2346
...
class CylindricalGearMeshSystemDeflection(_2264.GearMeshSystemDeflection):
    '''CylindricalGearMeshSystemDeflection
    ...
    @property
    def loaded_flank(self) -> '_1374.GearMeshContactStatus':
        ...
        return constructor.new(_1374.GearMeshContactStatus)(value) if value else None
    ...
    @property
    def chart_of_effective_change_in_operating_centre_distance(self) -> '_6501.SMTBitmap':
        ...
        return constructor.new(_6501.SMTBitmap)(self.wrapped.ChartOfEffectiveChangeInOperatingCentreDistance) if self.wrapped.ChartOfEffectiveChangeInOperatingCentreDistance else None
    ...
    @property
    def power_flow_results(self) -> '_3255.CylindricalGearMeshPowerFlow':
    ...
    @property
    def gear_a(self) -> '_2253.CylindricalGearSystemDeflection':
    ...
    @property
    def gear_b(self) -> '_2253.CylindricalGearSystemDeflection':
    ...
    @property
    def misalignment_data(self) -> '_1362.CylindricalMisalignmentCalculator':
        ...
        return constructor.new(_1362.CylindricalMisalignmentCalculator)(self.wrapped.MisalignmentData) if self.wrapped.MisalignmentData else None

    @property
    def misalignment_data_left_flank(self) -> '_1362.CylindricalMisalignmentCalculator':
        ...
        return constructor.new(_1362.CylindricalMisalignmentCalculator)(self.wrapped.MisalignmentDataLeftFlank) if self.wrapped.MisalignmentDataLeftFlank else None

    @property
    def misalignment_data_right_flank(self) -> '_1362.CylindricalMisalignmentCalculator':
        ...
        return constructor.new(_1362.CylindricalMisalignmentCalculator)(self.wrapped.MisalignmentDataRightFlank) if self.wrapped.MisalignmentDataRightFlank else None
    ...
    @property
    def cylindrical_gears(self) -> 'List[_2253.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2253.CylindricalGearSystemDeflection))
        return value

    @property
    def mesh_deflections_left_flank(self) -> 'List[_2346.MeshDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshDeflectionsLeftFlank, constructor.new(_2346.MeshDeflectionResults))
        return value

    @property
    def mesh_deflections_right_flank(self) -> 'List[_2346.MeshDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshDeflectionsRightFlank, constructor.new(_2346.MeshDeflectionResults))
        return value
