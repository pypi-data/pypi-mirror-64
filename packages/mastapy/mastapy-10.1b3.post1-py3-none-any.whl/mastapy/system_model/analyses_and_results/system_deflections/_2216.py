...
class BevelDifferentialPlanetGearSystemDeflection(_2215.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialPlanetGearSystemDeflection
    ...
    @property
    def component_design(self) -> '_2053.BevelDifferentialPlanetGear':
    ...
    @property
    def power_flow_results(self) -> '_3225.BevelDifferentialPlanetGearPowerFlow':
