...
from mastapy.system_model.drawing import _1826, _1824
...
class SystemDeflectionDrawStyle(_1824.ContourDrawStyle):
    '''SystemDeflectionDrawStyle
    ...
    @property
    def force_arrow_scaling(self) -> '_1826.ScalingDrawStyle':
        ...
        return constructor.new(_1826.ScalingDrawStyle)(self.wrapped.ForceArrowScaling) if self.wrapped.ForceArrowScaling else None
