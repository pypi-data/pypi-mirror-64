...
class CylindricalGearSetSystemDeflectionWithLTCAResults(_2250.CylindricalGearSetSystemDeflection):
    '''CylindricalGearSetSystemDeflectionWithLTCAResults
    ...
    def basic_ltca_results(self) -> '_631.CylindricalGearSetLoadDistributionAnalysis':
        ...
        return constructor.new(_631.CylindricalGearSetLoadDistributionAnalysis)(self.wrapped.BasicLTCAResults) if self.wrapped.BasicLTCAResults else None
    ...
    def basic_ltca_results_only_first_planetary_mesh(self) -> '_631.CylindricalGearSetLoadDistributionAnalysis':
        ...
        return constructor.new(_631.CylindricalGearSetLoadDistributionAnalysis)(self.wrapped.BasicLTCAResultsOnlyFirstPlanetaryMesh) if self.wrapped.BasicLTCAResultsOnlyFirstPlanetaryMesh else None
    ...
    def advanced_ltca_results(self) -> '_631.CylindricalGearSetLoadDistributionAnalysis':
        ...
        return constructor.new(_631.CylindricalGearSetLoadDistributionAnalysis)(self.wrapped.AdvancedLTCAResults) if self.wrapped.AdvancedLTCAResults else None
    ...
    def advanced_ltca_results_only_first_planetary_mesh(self) -> '_631.CylindricalGearSetLoadDistributionAnalysis':
        ...
        return constructor.new(_631.CylindricalGearSetLoadDistributionAnalysis)(self.wrapped.AdvancedLTCAResultsOnlyFirstPlanetaryMesh) if self.wrapped.AdvancedLTCAResultsOnlyFirstPlanetaryMesh else None
