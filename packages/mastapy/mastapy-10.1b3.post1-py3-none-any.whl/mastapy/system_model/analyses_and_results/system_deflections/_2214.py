...
from mastapy.system_model.analyses_and_results.system_deflections import _2215, _2213, _2219
...
class BevelDifferentialGearSetSystemDeflection(_2219.BevelGearSetSystemDeflection):
    '''BevelDifferentialGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3224.BevelDifferentialGearSetPowerFlow':
    ...
    @property
    def bevel_differential_gears_system_deflection(self) -> 'List[_2215.BevelDifferentialGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsSystemDeflection, constructor.new(_2215.BevelDifferentialGearSystemDeflection))
        return value

    @property
    def bevel_differential_meshes_system_deflection(self) -> 'List[_2213.BevelDifferentialGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesSystemDeflection, constructor.new(_2213.BevelDifferentialGearMeshSystemDeflection))
        return value
