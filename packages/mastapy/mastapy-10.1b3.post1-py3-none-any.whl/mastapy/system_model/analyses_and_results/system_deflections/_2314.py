...
class StraightBevelDiffGearMeshSystemDeflection(_2218.BevelGearMeshSystemDeflection):
    '''StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3313.StraightBevelDiffGearMeshPowerFlow':
