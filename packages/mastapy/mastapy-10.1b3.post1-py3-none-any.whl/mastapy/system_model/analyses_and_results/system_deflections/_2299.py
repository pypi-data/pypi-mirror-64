...
class RollingRingConnectionSystemDeflection(_2272.InterMountableComponentConnectionSystemDeflection):
    '''RollingRingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3300.RollingRingConnectionPowerFlow':
