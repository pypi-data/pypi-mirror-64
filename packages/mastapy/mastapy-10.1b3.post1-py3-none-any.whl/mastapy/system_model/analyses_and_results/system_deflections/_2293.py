...
class PlanetaryConnectionSystemDeflection(_2306.ShaftToMountableComponentConnectionSystemDeflection):
    '''PlanetaryConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3291.PlanetaryConnectionPowerFlow':
