...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3540, _3537
...
class ParametricStudyVariable(_2175.AnalysisCaseVariable):
    '''ParametricStudyVariable
    ...
    @property
    def dimension(self) -> '_3540.ParametricStudyDimension':
        ...
        return constructor.new(_3540.ParametricStudyDimension)(value) if value else None

    @dimension.setter
    def dimension(self, value: '_3540.ParametricStudyDimension'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Dimension = value

    @property
    def distribution(self) -> '_3537.MonteCarloDistribution':
        ...
        return constructor.new(_3537.MonteCarloDistribution)(value) if value else None

    @distribution.setter
    def distribution(self, value: '_3537.MonteCarloDistribution'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
