...
class BearingParametricStudyTool(_3494.ConnectorParametricStudyTool):
    '''BearingParametricStudyTool
    ...
    @property
    def bearing_duty_cycle_results(self) -> 'List[_1568.LoadedBearingDutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingDutyCycleResults, constructor.new(_1568.LoadedBearingDutyCycle))
        return value
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2210.BearingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2210.BearingSystemDeflection))
        return value
