...
class ParametricStudyDOEResultVariable(_1104.ParetoOptimisationVariableBase):
    '''ParametricStudyDOEResultVariable
    ...
    @property
    def target(self) -> '_1106.PropertyTargetForDominantCandidateSearch':
    ...
    @target.setter
    def target(self, value: '_1106.PropertyTargetForDominantCandidateSearch'):
