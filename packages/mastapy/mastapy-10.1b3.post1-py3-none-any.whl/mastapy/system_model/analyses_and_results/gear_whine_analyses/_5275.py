...
class ConceptCouplingConnectionGearWhineAnalysis(_5286.CouplingConnectionGearWhineAnalysis):
    '''ConceptCouplingConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2229.ConceptCouplingConnectionSystemDeflection':
