...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses import _5434, _5432, _5457
...
class ConceptGearSetSingleMeshWhineAnalysis(_5457.GearSetSingleMeshWhineAnalysis):
    '''ConceptGearSetSingleMeshWhineAnalysis
    ...
    @property
    def concept_gears_single_mesh_whine_analysis(self) -> 'List[_5434.ConceptGearSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsSingleMeshWhineAnalysis, constructor.new(_5434.ConceptGearSingleMeshWhineAnalysis))
        return value

    @property
    def concept_meshes_single_mesh_whine_analysis(self) -> 'List[_5432.ConceptGearMeshSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesSingleMeshWhineAnalysis, constructor.new(_5432.ConceptGearMeshSingleMeshWhineAnalysis))
        return value
