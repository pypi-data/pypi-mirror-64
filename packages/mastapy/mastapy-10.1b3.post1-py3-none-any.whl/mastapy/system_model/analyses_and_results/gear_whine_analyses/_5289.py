...
class CVTBeltConnectionGearWhineAnalysis(_5257.BeltConnectionGearWhineAnalysis):
    '''CVTBeltConnectionGearWhineAnalysis
    ...
    @property
    def connection_design(self) -> '_1835.CVTBeltConnection':
    ...
    @property
    def system_deflection_results(self) -> '_2244.CVTBeltConnectionSystemDeflection':
