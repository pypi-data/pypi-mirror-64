...
class BevelDifferentialSunGearGearWhineAnalysis(_5259.BevelDifferentialGearGearWhineAnalysis):
    '''BevelDifferentialSunGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2217.BevelDifferentialSunGearSystemDeflection':
