...
class PartToPartShearCouplingConnectionGearWhineAnalysis(_5286.CouplingConnectionGearWhineAnalysis):
    '''PartToPartShearCouplingConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2290.PartToPartShearCouplingConnectionSystemDeflection':
