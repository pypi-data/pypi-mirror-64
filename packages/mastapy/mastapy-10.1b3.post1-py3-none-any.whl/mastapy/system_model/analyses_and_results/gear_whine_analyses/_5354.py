...
class RollingRingAssemblyGearWhineAnalysis(_5362.SpecialisedAssemblyGearWhineAnalysis):
    '''RollingRingAssemblyGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2298.RollingRingAssemblySystemDeflection':
