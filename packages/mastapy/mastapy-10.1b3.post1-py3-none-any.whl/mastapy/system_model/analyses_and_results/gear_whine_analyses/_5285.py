...
class ConnectorGearWhineAnalysis(_5341.MountableComponentGearWhineAnalysis):
    '''ConnectorGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2240.ConnectorSystemDeflection':
