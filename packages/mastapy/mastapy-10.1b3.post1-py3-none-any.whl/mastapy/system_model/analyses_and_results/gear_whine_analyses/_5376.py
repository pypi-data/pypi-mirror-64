...
class StraightBevelPlanetGearGearWhineAnalysis(_5370.StraightBevelDiffGearGearWhineAnalysis):
    '''StraightBevelPlanetGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2320.StraightBevelPlanetGearSystemDeflection':
