...
class KlingelnbergCycloPalloidConicalGearGearWhineAnalysis(_5281.ConicalGearGearWhineAnalysis):
    '''KlingelnbergCycloPalloidConicalGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2275.KlingelnbergCycloPalloidConicalGearSystemDeflection':
