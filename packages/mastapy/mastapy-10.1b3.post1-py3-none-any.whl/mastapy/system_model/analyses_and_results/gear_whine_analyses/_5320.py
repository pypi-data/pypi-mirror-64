...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.whine_analyses_results import _5398
...
class GearWhineAnalysisFEExportOptions(_0.APIBase):
    ...
    @property
    def excitation_options(self) -> '_5398.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5398.ExcitationSourceSelectionGroup)(self.wrapped.ExcitationOptions) if self.wrapped.ExcitationOptions else None

    @property
    def analysis_options(self) -> '_5321.GearWhineAnalysisOptions':
        ...
        return constructor.new(_5321.GearWhineAnalysisOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None
    ...
    @property
    def eigenvalue_options(self) -> '_1451.EigenvalueOptions':
        ...
        return constructor.new(_1451.EigenvalueOptions)(self.wrapped.EigenvalueOptions) if self.wrapped.EigenvalueOptions else None
