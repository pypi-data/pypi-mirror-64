...
class GearMeshGearWhineAnalysis(_5329.InterMountableComponentConnectionGearWhineAnalysis):
    '''GearMeshGearWhineAnalysis
    ...
    @property
    def tooth_passing_harmonics(self) -> 'List[_3325.ToothPassingHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothPassingHarmonics, constructor.new(_3325.ToothPassingHarmonic))
        return value

    @property
    def system_deflection_results(self) -> '_2264.GearMeshSystemDeflection':
