...
class ShaftGearWhineAnalysis(_5251.AbstractShaftOrHousingGearWhineAnalysis):
    '''ShaftGearWhineAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4791.ShaftModalAnalysis':
    ...
    @property
    def system_deflection_results(self) -> '_2305.ShaftSystemDeflection':
