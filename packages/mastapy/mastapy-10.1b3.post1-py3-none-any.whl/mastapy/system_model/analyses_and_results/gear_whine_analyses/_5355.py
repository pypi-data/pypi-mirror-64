...
class RollingRingConnectionGearWhineAnalysis(_5329.InterMountableComponentConnectionGearWhineAnalysis):
    '''RollingRingConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2299.RollingRingConnectionSystemDeflection':
