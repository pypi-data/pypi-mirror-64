...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5320, _5251
...
class ImportedFEComponentGearWhineAnalysis(_5251.AbstractShaftOrHousingGearWhineAnalysis):
    '''ImportedFEComponentGearWhineAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4756.ImportedFEComponentModalAnalysis':
    ...
    @property
    def export(self) -> '_5320.GearWhineAnalysisFEExportOptions':
        ...
        return constructor.new(_5320.GearWhineAnalysisFEExportOptions)(self.wrapped.Export) if self.wrapped.Export else None
    ...
    @property
    def system_deflection_results(self) -> '_2271.ImportedFEComponentSystemDeflection':
