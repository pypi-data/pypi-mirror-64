...
class BevelDifferentialGearMeshGearWhineAnalysis(_5265.BevelGearMeshGearWhineAnalysis):
    '''BevelDifferentialGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2213.BevelDifferentialGearMeshSystemDeflection':
