...
class TorqueConverterConnectionGearWhineAnalysis(_5286.CouplingConnectionGearWhineAnalysis):
    '''TorqueConverterConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2329.TorqueConverterConnectionSystemDeflection':
