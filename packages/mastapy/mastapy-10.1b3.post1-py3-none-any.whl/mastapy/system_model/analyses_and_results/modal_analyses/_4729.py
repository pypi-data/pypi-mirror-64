...
class ConnectionModalAnalysis(_6484.ConnectionStaticLoadAnalysisCase):
    '''ConnectionModalAnalysis
    ...
    @property
    def modal_analysis(self) -> '_4769.ModalAnalysis':
        ...
        return constructor.new(_4769.ModalAnalysis)(self.wrapped.ModalAnalysis) if self.wrapped.ModalAnalysis else None

    @property
    def excited_modes_summary(self) -> 'List[_4840.SingleExcitationResultsModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitedModesSummary, constructor.new(_4840.SingleExcitationResultsModalAnalysis))
        return value
