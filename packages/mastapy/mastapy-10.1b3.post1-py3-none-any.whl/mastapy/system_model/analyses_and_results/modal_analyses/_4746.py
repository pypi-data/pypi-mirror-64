...
from mastapy.system_model.analyses_and_results.modal_analyses import _4745, _4744, _4751
...
class FaceGearSetModalAnalysis(_4751.GearSetModalAnalysis):
    ...
    @property
    def face_gears_modal_analysis(self) -> 'List[_4745.FaceGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsModalAnalysis, constructor.new(_4745.FaceGearModalAnalysis))
        return value

    @property
    def face_meshes_modal_analysis(self) -> 'List[_4744.FaceGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesModalAnalysis, constructor.new(_4744.FaceGearMeshModalAnalysis))
        return value
