...
from mastapy.nodal_analysis import _1360, _1359
...
class ModalAnalysisBarModelFEExportOptions(_0.APIBase):
    ...
    @property
    def analysis_type(self) -> '_1359.BarModelAnalysisType':
        ...
        return constructor.new(_1359.BarModelAnalysisType)(value) if value else None

    @analysis_type.setter
    def analysis_type(self, value: '_1359.BarModelAnalysisType'):
    ...
    @property
    def mode_options(self) -> '_1451.EigenvalueOptions':
        ...
        return constructor.new(_1451.EigenvalueOptions)(self.wrapped.ModeOptions) if self.wrapped.ModeOptions else None
