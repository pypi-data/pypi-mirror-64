...
class AGMAGleasonConicalGearMeshModalAnalysis(_4726.ConicalGearMeshModalAnalysis):
    '''AGMAGleasonConicalGearMeshModalAnalysis
    ...
    @property
    def connection_design(self) -> '_1858.AGMAGleasonConicalGearMesh':
    ...
    @property
    def system_deflection_results(self) -> '_2206.AGMAGleasonConicalGearMeshSystemDeflection':
