...
from mastapy.system_model.analyses_and_results.modal_analyses import _4724, _4723, _4751
...
class ConceptGearSetModalAnalysis(_4751.GearSetModalAnalysis):
    ...
    @property
    def concept_gears_modal_analysis(self) -> 'List[_4724.ConceptGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsModalAnalysis, constructor.new(_4724.ConceptGearModalAnalysis))
        return value

    @property
    def concept_meshes_modal_analysis(self) -> 'List[_4723.ConceptGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesModalAnalysis, constructor.new(_4723.ConceptGearMeshModalAnalysis))
        return value
