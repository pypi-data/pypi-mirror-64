...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _5915
...
class SpecialisedAssemblyCompoundDynamicAnalysis(_5915.AbstractAssemblyCompoundDynamicAnalysis):
    '''SpecialisedAssemblyCompoundDynamicAnalysis
