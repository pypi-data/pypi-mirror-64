...
class PlanetaryGearSetLoadCase(_6092.CylindricalGearSetLoadCase):
    '''PlanetaryGearSetLoadCase
    ...
    @property
    def include_gear_blank_elastic_distortion(self) -> '_1135.LoadCaseOverrideOption':
    ...
    def include_gear_blank_elastic_distortion(self, value: '_1135.LoadCaseOverrideOption'):
    ...
    @property
    def assembly_design(self) -> '_2078.PlanetaryGearSet':
