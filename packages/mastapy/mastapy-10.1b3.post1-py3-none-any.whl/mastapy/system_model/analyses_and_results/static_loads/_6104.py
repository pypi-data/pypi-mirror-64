...
from mastapy.system_model.analyses_and_results.static_loads import _6100, _6106
...
T = TypeVar('T', bound='_6106.ElectricMachineHarmonicLoadImportOptionsBase')


class ElectricMachineHarmonicLoadDataFromMotorPackages(_6100.ElectricMachineHarmonicLoadData, Generic[T]):
    '''ElectricMachineHarmonicLoadDataFromMotorPackages
