...
from mastapy.nodal_analysis.varying_input_components import _1397, _1396, _1401
from mastapy.math_utility.control import _1122
from mastapy.system_model.analyses_and_results.static_loads import _6181, _6092, _6050
...
class RootAssemblyLoadCase(_6050.AssemblyLoadCase):
    '''RootAssemblyLoadCase
    ...
    @property
    def brake_force_input_values(self) -> '_1397.ForceInputComponent':
        ...
        return constructor.new(_1397.ForceInputComponent)(self.wrapped.BrakeForceInputValues) if self.wrapped.BrakeForceInputValues else None

    @property
    def road_incline_input_values(self) -> '_1396.AngleInputComponent':
        ...
        return constructor.new(_1396.AngleInputComponent)(self.wrapped.RoadInclineInputValues) if self.wrapped.RoadInclineInputValues else None

    @property
    def drive_cycle_pid_control_settings(self) -> '_1122.PIDControlSettings':
        ...
        return constructor.new(_1122.PIDControlSettings)(self.wrapped.DriveCyclePIDControlSettings) if self.wrapped.DriveCyclePIDControlSettings else None

    @property
    def target_vehicle_speed(self) -> '_1401.VelocityInputComponent':
        ...
        return constructor.new(_1401.VelocityInputComponent)(self.wrapped.TargetVehicleSpeed) if self.wrapped.TargetVehicleSpeed else None

    @property
    def load_case(self) -> '_6181.StaticLoadCase':
        ...
        return constructor.new(_6181.StaticLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None

    @property
    def supercharger_rotor_sets(self) -> 'List[_6092.CylindricalGearSetLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SuperchargerRotorSets, constructor.new(_6092.CylindricalGearSetLoadCase))
        return value
