...
from mastapy.math_utility import _1066, _1071
...
class PointLoadHarmonicLoadData(_6174.SpeedDependentHarmonicLoadData):
    '''PointLoadHarmonicLoadData
    ...
    @property
    def degree_of_freedom(self) -> '_1066.DegreesOfFreedom':
        ...
        return constructor.new(_1066.DegreesOfFreedom)(value) if value else None

    @degree_of_freedom.setter
    def degree_of_freedom(self, value: '_1066.DegreesOfFreedom'):
