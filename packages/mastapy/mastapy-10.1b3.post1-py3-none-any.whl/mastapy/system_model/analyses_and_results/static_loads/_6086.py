...
from mastapy.system_model.analyses_and_results.static_loads import _6087, _6053
...
class CVTLoadCase(_6053.BeltDriveLoadCase):
    '''CVTLoadCase
    ...
    @property
    def pulleys(self) -> 'List[_6087.CVTPulleyLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_6087.CVTPulleyLoadCase))
        return value
