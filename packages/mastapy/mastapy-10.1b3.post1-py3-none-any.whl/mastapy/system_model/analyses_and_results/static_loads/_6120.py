...
class GearSetLoadCase(_6173.SpecialisedAssemblyLoadCase):
    '''GearSetLoadCase
    ...
    @property
    def gear_mesh_stiffness_model(self) -> '_5018.GearMeshStiffnessModel':
        ...
        return constructor.new(_5018.GearMeshStiffnessModel)(value) if value else None

    @gear_mesh_stiffness_model.setter
    def gear_mesh_stiffness_model(self, value: '_5018.GearMeshStiffnessModel'):
