...
from mastapy.system_model.analyses_and_results.static_loads import _6200, _6129, _6174
...
class ElectricMachineHarmonicLoadData(_6174.SpeedDependentHarmonicLoadData):
    '''ElectricMachineHarmonicLoadData
    ...
    @property
    def force_distribution(self) -> '_6501.SMTBitmap':
        ...
        return constructor.new(_6501.SMTBitmap)(self.wrapped.ForceDistribution) if self.wrapped.ForceDistribution else None
