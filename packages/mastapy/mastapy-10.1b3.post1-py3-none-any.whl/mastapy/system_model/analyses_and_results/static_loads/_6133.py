...
from mastapy.system_model.imported_fes import _1910, _1932
...
class ImportedFEComponentLoadCase(_6044.AbstractShaftOrHousingLoadCase):
    '''ImportedFEComponentLoadCase
    ...
    @property
    def angle_source(self) -> '_1910.AngleSource':
        ...
        return constructor.new(_1910.AngleSource)(value) if value else None
