...
from mastapy.system_model.analyses_and_results.static_loads import _6076, _6115
...
class ConicalGearLoadCase(_6115.GearLoadCase):
    '''ConicalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6076.ConicalGearManufactureError':
