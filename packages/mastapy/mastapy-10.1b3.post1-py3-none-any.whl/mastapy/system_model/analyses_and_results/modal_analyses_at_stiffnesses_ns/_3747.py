...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3746, _3745, _3772
...
class ConceptGearSetModalAnalysesAtStiffnesses(_3772.GearSetModalAnalysesAtStiffnesses):
    '''ConceptGearSetModalAnalysesAtStiffnesses
    ...
    @property
    def concept_gears_modal_analyses_at_stiffnesses(self) -> 'List[_3746.ConceptGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsModalAnalysesAtStiffnesses, constructor.new(_3746.ConceptGearModalAnalysesAtStiffnesses))
        return value

    @property
    def concept_meshes_modal_analyses_at_stiffnesses(self) -> 'List[_3745.ConceptGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesModalAnalysesAtStiffnesses, constructor.new(_3745.ConceptGearMeshModalAnalysesAtStiffnesses))
        return value
