...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5091, _5001
...
class TorqueConverterConnectionMultiBodyDynamicsAnalysis(_5001.CouplingConnectionMultiBodyDynamicsAnalysis):
    '''TorqueConverterConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def locking_status(self) -> '_5091.TorqueConverterStatus':
        ...
        return constructor.new(_5091.TorqueConverterStatus)(value) if value else None
