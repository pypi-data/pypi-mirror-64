...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5104, _5106
...
class ShaftHubConnectionMultiBodyDynamicsAnalysis(_5000.ConnectorMultiBodyDynamicsAnalysis):
    '''ShaftHubConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def peak_dynamic_force(self) -> '_5104.DynamicForceVector3DResult':
        ...
        return constructor.new(_5104.DynamicForceVector3DResult)(self.wrapped.PeakDynamicForce) if self.wrapped.PeakDynamicForce else None

    @property
    def peak_dynamic_force_angular(self) -> '_5106.DynamicTorqueVector3DResult':
        ...
        return constructor.new(_5106.DynamicTorqueVector3DResult)(self.wrapped.PeakDynamicForceAngular) if self.wrapped.PeakDynamicForceAngular else None
