...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5029, _5067, _5062
from mastapy._internal.implicit import list_with_selected_item
from mastapy.system_model.analyses_and_results.analysis_cases import _6479
...
class MBDRunUpAnalysisOptions(_6479.AbstractAnalysisOptions['_6195.TimeSeriesLoadCase']):
    '''MBDRunUpAnalysisOptions
    ...
    @property
    def input_velocity_processing_type(self) -> '_5029.InputVelocityForRunUpProcessingType':
        ...
        return constructor.new(_5029.InputVelocityForRunUpProcessingType)(value) if value else None

    @input_velocity_processing_type.setter
    def input_velocity_processing_type(self, value: '_5029.InputVelocityForRunUpProcessingType'):
    ...
    @property
    def shape_of_initial_acceleration_period(self) -> '_5067.ShapeOfInitialAccelerationPeriodForRunUp':
        ...
        return constructor.new(_5067.ShapeOfInitialAccelerationPeriodForRunUp)(value) if value else None

    @shape_of_initial_acceleration_period.setter
    def shape_of_initial_acceleration_period(self, value: '_5067.ShapeOfInitialAccelerationPeriodForRunUp'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ShapeOfInitialAccelerationPeriod = value

    @property
    def run_up_driving_mode(self) -> '_5062.RunUpDrivingMode':
        ...
        return constructor.new(_5062.RunUpDrivingMode)(value) if value else None

    @run_up_driving_mode.setter
    def run_up_driving_mode(self, value: '_5062.RunUpDrivingMode'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
