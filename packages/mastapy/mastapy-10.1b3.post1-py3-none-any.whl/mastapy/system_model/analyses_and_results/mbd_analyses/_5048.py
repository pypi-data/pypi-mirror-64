...
class PartMultiBodyDynamicsAnalysis(_6492.PartTimeSeriesLoadAnalysisCase):
    '''PartMultiBodyDynamicsAnalysis
    ...
    @property
    def multi_body_dynamics_analysis(self) -> '_5046.MultiBodyDynamicsAnalysis':
        ...
        return constructor.new(_5046.MultiBodyDynamicsAnalysis)(self.wrapped.MultiBodyDynamicsAnalysis) if self.wrapped.MultiBodyDynamicsAnalysis else None
