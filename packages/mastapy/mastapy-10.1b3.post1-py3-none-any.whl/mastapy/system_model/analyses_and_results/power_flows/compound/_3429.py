...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3338
...
class SpecialisedAssemblyCompoundPowerFlow(_3338.AbstractAssemblyCompoundPowerFlow):
    '''SpecialisedAssemblyCompoundPowerFlow
