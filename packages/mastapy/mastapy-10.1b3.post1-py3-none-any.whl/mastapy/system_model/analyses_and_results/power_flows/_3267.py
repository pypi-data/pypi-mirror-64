...
from mastapy.system_model.analyses_and_results.power_flows import _3265, _3266, _3306
...
class GearSetPowerFlow(_3306.SpecialisedAssemblyPowerFlow):
    '''GearSetPowerFlow
    ...
    @property
    def meshes_power_flow(self) -> 'List[_3265.GearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3265.GearMeshPowerFlow))
        return value

    @property
    def gears_power_flow(self) -> 'List[_3266.GearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3266.GearPowerFlow))
        return value
