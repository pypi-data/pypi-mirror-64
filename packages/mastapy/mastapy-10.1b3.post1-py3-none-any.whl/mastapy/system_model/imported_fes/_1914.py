...
from mastapy.system_model.imported_fes import _1915
...
class BearingRaceNodeLink(_0.APIBase):
    ...
    @property
    def race_position(self) -> '_1915.BearingRacePosition':
        ...
        return constructor.new(_1915.BearingRacePosition)(value) if value else None
