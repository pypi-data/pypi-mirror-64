...
from mastapy.system_model.imported_fes import _1908, _1914
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self) -> '_1908.AlignmentMethodForRaceBearing':
        ...
        return constructor.new(_1908.AlignmentMethodForRaceBearing)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_1908.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_1914.BearingRaceNodeLink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1914.BearingRaceNodeLink))
        return value
