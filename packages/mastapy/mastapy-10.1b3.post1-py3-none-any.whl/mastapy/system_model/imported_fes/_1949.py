...
from mastapy.nodal_analysis.dev_tools_analyses import _1460, _1451
...
class ImportedFEWithSelectionModalAnalysis(_1946.ImportedFEWithSelection):
    '''ImportedFEWithSelectionModalAnalysis
    ...
    @property
    def modal_draw_style(self) -> '_1460.FEModelModalAnalysisDrawStyle':
        ...
        return constructor.new(_1460.FEModelModalAnalysisDrawStyle)(self.wrapped.ModalDrawStyle) if self.wrapped.ModalDrawStyle else None
    ...
    @property
    def fe_modal_frequencies(self) -> 'List[_1368.FEModalFrequencyComparison]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEModalFrequencies, constructor.new(_1368.FEModalFrequencyComparison))
        return value
