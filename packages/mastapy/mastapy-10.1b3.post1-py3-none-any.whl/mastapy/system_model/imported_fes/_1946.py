...
class ImportedFEWithSelection(_1911.BaseFEWithSelection):
    '''ImportedFEWithSelection
    ...
    @property
    def imported_fe(self) -> '_1932.ImportedFE':
        ...
        return constructor.new(_1932.ImportedFE)(self.wrapped.ImportedFE) if self.wrapped.ImportedFE else None

    @property
    def element_face_groups(self) -> 'List[_1924.ElementFaceGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_1924.ElementFaceGroupWithSelection))
        return value

    @property
    def node_groups(self) -> 'List[_1957.NodeGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeGroups, constructor.new(_1957.NodeGroupWithSelection))
        return value
