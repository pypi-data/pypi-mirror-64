...
class FaceGearMesh(_1872.GearMesh):
    '''FaceGearMesh
    ...
    @property
    def face_gear_mesh_design(self) -> '_754.FaceGearMeshDesign':
        ...
        return constructor.new(_754.FaceGearMeshDesign)(self.wrapped.FaceGearMeshDesign) if self.wrapped.FaceGearMeshDesign else None
