...
from mastapy.gears.gear_designs.concept import _909
...
class ConceptGearMesh(_1872.GearMesh):
    '''ConceptGearMesh
    ...
    @property
    def concept_gear_mesh_design(self) -> '_909.ConceptGearMeshDesign':
        ...
        return constructor.new(_909.ConceptGearMeshDesign)(self.wrapped.ConceptGearMeshDesign) if self.wrapped.ConceptGearMeshDesign else None
