...
from mastapy.system_model.part_model.gears import _2062, _2061
...
class CylindricalGearMesh(_1872.GearMesh):
    '''CylindricalGearMesh
    ...
    @property
    def cylindrical_gear_set(self) -> '_2062.CylindricalGearSet':
        ...
        return constructor.new(_2062.CylindricalGearSet)(self.wrapped.CylindricalGearSet) if self.wrapped.CylindricalGearSet else None

    @property
    def centre_distance_range(self) -> '_1117.ShortLengthRange':
        ...
        return constructor.new(_1117.ShortLengthRange)(self.wrapped.CentreDistanceRange) if self.wrapped.CentreDistanceRange else None
