...
class SpringDamperConnection(_1896.CouplingConnection):
    '''SpringDamperConnection
    ...
    @property
    def damping_option(self) -> '_1791.ComponentDampingOption':
        ...
        return constructor.new(_1791.ComponentDampingOption)(value) if value else None

    @damping_option.setter
    def damping_option(self, value: '_1791.ComponentDampingOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DampingOption = value

    @property
    def damping(self) -> '_1377.LinearDampingConnectionProperties':
        ...
        return constructor.new(_1377.LinearDampingConnectionProperties)(self.wrapped.Damping) if self.wrapped.Damping else None
