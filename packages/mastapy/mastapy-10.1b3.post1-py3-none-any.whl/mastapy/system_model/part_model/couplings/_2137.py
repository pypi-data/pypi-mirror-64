...
from mastapy.system_model.part_model.couplings import _2138, _2140, _2115
...
class TorqueConverter(_2115.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2138.TorqueConverterPump':
        ...
        return constructor.new(_2138.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump else None

    @property
    def turbine(self) -> '_2140.TorqueConverterTurbine':
        ...
        return constructor.new(_2140.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine else None
