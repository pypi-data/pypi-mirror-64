...
from mastapy.math_utility import _1061, _1062
from mastapy.system_model.connections_and_sockets import _1832, _1849
...
class Component(_2006.Part):
    ...
    @property
    def twod_drawing_full_model(self) -> '_6501.SMTBitmap':
        ...
        return constructor.new(_6501.SMTBitmap)(self.wrapped.TwoDDrawingFullModel) if self.wrapped.TwoDDrawingFullModel else None
    ...
    @property
    def local_coordinate_system(self) -> '_1061.CoordinateSystem3D':
        ...
        return constructor.new(_1061.CoordinateSystem3D)(self.wrapped.LocalCoordinateSystem) if self.wrapped.LocalCoordinateSystem else None

    @property
    def component_connections(self) -> 'List[_1832.ComponentConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentConnections, constructor.new(_1832.ComponentConnection))
        return value
    ...
    def set_position_and_rotation_of_component_and_connected_components(self, new_coordinate_system: '_1061.CoordinateSystem3D') -> '_1849.RealignmentResult':
        ...
        return constructor.new(_1849.RealignmentResult)(method_result) if method_result else None

    def set_position_of_component_and_connected_components(self, position: 'Vector3D') -> '_1849.RealignmentResult':
    ...
    def create_coordinate_system_editor(self) -> '_1062.CoordinateSystemEditor':
        ...
        return constructor.new(_1062.CoordinateSystemEditor)(method_result) if method_result else None
