...
class FlexiblePinAssembly(_2014.SpecialisedAssembly):
    '''FlexiblePinAssembly
    ...
    @property
    def planet_gear(self) -> '_2061.CylindricalGear':
        ...
        return constructor.new(_2061.CylindricalGear)(self.wrapped.PlanetGear) if self.wrapped.PlanetGear else None
