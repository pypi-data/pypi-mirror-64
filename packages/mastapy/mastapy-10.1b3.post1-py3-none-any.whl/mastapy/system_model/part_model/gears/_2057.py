...
class ConceptGear(_2066.Gear):
    ...
    @property
    def active_gear_design(self) -> '_908.ConceptGearDesign':
    ...
    @property
    def concept_gear_design(self) -> '_908.ConceptGearDesign':
        ...
        return constructor.new(_908.ConceptGearDesign)(self.wrapped.ConceptGearDesign) if self.wrapped.ConceptGearDesign else None
