...
from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2099
from mastapy.system_model.part_model.gears import _2061, _2068
...
class CylindricalGearSet(_2068.GearSet):
    '''CylindricalGearSet
    ...
    def cylindrical_gear_set_design(self) -> '_785.CylindricalGearSetDesign':
        ...
        return constructor.new(_785.CylindricalGearSetDesign)(self.wrapped.CylindricalGearSetDesign) if self.wrapped.CylindricalGearSetDesign else None

    @property
    def supercharger_rotor_set(self) -> '_2099.SuperchargerRotorSet':
        ...
        return constructor.new(_2099.SuperchargerRotorSet)(self.wrapped.SuperchargerRotorSet) if self.wrapped.SuperchargerRotorSet else None

    @property
    def cylindrical_gears(self) -> 'List[_2061.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2061.CylindricalGear))
        return value

    @property
    def cylindrical_meshes(self) -> 'List[_1868.CylindricalGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_1868.CylindricalGearMesh))
        return value
