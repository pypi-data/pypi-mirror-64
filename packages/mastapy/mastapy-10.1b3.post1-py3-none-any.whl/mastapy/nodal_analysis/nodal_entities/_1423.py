...
class Bar(_1438.NodalComponent):
    '''Bar
    ...
    @property
    def bar_geometry(self) -> '_1358.BarGeometry':
        ...
        return constructor.new(_1358.BarGeometry)(self.wrapped.BarGeometry) if self.wrapped.BarGeometry else None
