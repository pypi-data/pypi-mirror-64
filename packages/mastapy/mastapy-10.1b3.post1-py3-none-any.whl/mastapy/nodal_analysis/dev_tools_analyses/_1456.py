...
class FEModel(_0.APIBase):
    ...
    @property
    def rigid_element_properties(self) -> 'List[_1479.ElementPropertiesRigid]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidElementProperties, constructor.new(_1479.ElementPropertiesRigid))
        return value

    @property
    def solid_element_properties(self) -> 'List[_1481.ElementPropertiesSolid]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SolidElementProperties, constructor.new(_1481.ElementPropertiesSolid))
        return value

    @property
    def shell_element_properties(self) -> 'List[_1480.ElementPropertiesShell]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShellElementProperties, constructor.new(_1480.ElementPropertiesShell))
        return value

    @property
    def beam_element_properties(self) -> 'List[_1476.ElementPropertiesBeam]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeamElementProperties, constructor.new(_1476.ElementPropertiesBeam))
        return value

    @property
    def spring_dashpot_element_properties(self) -> 'List[_1482.ElementPropertiesSpringDashpot]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpringDashpotElementProperties, constructor.new(_1482.ElementPropertiesSpringDashpot))
        return value

    @property
    def mass_element_properties(self) -> 'List[_1478.ElementPropertiesMass]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MassElementProperties, constructor.new(_1478.ElementPropertiesMass))
        return value

    @property
    def interface_element_properties(self) -> 'List[_1477.ElementPropertiesInterface]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InterfaceElementProperties, constructor.new(_1477.ElementPropertiesInterface))
        return value

    @property
    def other_element_properties(self) -> 'List[_1475.ElementPropertiesBase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OtherElementProperties, constructor.new(_1475.ElementPropertiesBase))
        return value

    @property
    def materials(self) -> 'List[_1484.MaterialPropertiesReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Materials, constructor.new(_1484.MaterialPropertiesReporting))
        return value

    @property
    def contact_pairs(self) -> 'List[_1473.ContactPairReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ContactPairs, constructor.new(_1473.ContactPairReporting))
        return value
