...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _962
...
class ElementPropertiesBeam(_1483.ElementPropertiesWithMaterial):
    '''ElementPropertiesBeam
    ...
    @property
    def section_type(self) -> '_962.BeamSectionType':
        ...
        return constructor.new(_962.BeamSectionType)(value) if value else None
