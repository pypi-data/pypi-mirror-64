...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1485, _1475
...
class ElementPropertiesRigid(_1475.ElementPropertiesBase):
    '''ElementPropertiesRigid
    ...
    @property
    def degrees_of_freedom_list(self) -> 'List[_1485.RigidElementNodeDegreesOfFreedom]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DegreesOfFreedomList, constructor.new(_1485.RigidElementNodeDegreesOfFreedom))
        return value
