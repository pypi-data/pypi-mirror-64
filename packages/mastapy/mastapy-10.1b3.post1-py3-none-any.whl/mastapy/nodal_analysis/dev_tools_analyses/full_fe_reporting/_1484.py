...
from mastapy.fe_tools.enums import _967
...
class MaterialPropertiesReporting(_0.APIBase):
    ...
    @property
    def class_(self) -> '_967.MaterialPropertyClass':
        ...
        return constructor.new(_967.MaterialPropertyClass)(value) if value else None
