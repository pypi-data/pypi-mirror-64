...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _965
...
class ElementPropertiesShell(_1483.ElementPropertiesWithMaterial):
    '''ElementPropertiesShell
    ...
    @property
    def wall_type(self) -> '_965.ElementPropertiesShellWallType':
        ...
        return constructor.new(_965.ElementPropertiesShellWallType)(value) if value else None
