...
from mastapy.nodal_analysis import _1375, _1383
...
class FEStiffness(_0.APIBase):
    ...
    @property
    def gravity_force_source(self) -> '_1375.GravityForceSource':
        ...
        return constructor.new(_1375.GravityForceSource)(value) if value else None
    ...
    @property
    def stiffness_in_fe_coordinate_system_mn_rad(self) -> '_1383.NodalMatrix':
        ...
        return constructor.new(_1383.NodalMatrix)(self.wrapped.StiffnessInFECoordinateSystemMNRad) if self.wrapped.StiffnessInFECoordinateSystemMNRad else None

    @property
    def mass_matrix_mn_rad_s_kg(self) -> '_1383.NodalMatrix':
        ...
        return constructor.new(_1383.NodalMatrix)(self.wrapped.MassMatrixMNRadSKg) if self.wrapped.MassMatrixMNRadSKg else None
    ...
    @property
    def stiffness_matrix(self) -> '_1383.NodalMatrix':
        ...
        return constructor.new(_1383.NodalMatrix)(self.wrapped.StiffnessMatrix) if self.wrapped.StiffnessMatrix else None
