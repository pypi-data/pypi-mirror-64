...
class CustomTableAndChart(_1300.CustomTable):
    '''CustomTableAndChart
    ...
    @property
    def primary_axis_range(self) -> '_1055.Range':
        ...
        return constructor.new(_1055.Range)(self.wrapped.PrimaryAxisRange) if self.wrapped.PrimaryAxisRange else None
