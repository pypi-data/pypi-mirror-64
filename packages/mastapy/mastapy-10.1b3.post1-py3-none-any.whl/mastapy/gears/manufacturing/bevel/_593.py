...
class Wheel(_0.APIBase):
    ...
    def basic_conical_gear_machine_settings(self) -> '_603.BasicConicalGearMachineSettings':
        ...
        return constructor.new(_603.BasicConicalGearMachineSettings)(self.wrapped.BasicConicalGearMachineSettings) if self.wrapped.BasicConicalGearMachineSettings else None
    ...
    def basic_conical_gear_machine_settings_of_type_basic_conical_gear_machine_settings_formate(self) -> '_604.BasicConicalGearMachineSettingsFormate':
        ...
        return constructor.new(_604.BasicConicalGearMachineSettingsFormate)(self.wrapped.BasicConicalGearMachineSettings) if self.wrapped.BasicConicalGearMachineSettings else None
    ...
    def basic_conical_gear_machine_settings_of_type_basic_conical_gear_machine_settings_generated(self) -> '_605.BasicConicalGearMachineSettingsGenerated':
        ...
        return constructor.new(_605.BasicConicalGearMachineSettingsGenerated)(self.wrapped.BasicConicalGearMachineSettings) if self.wrapped.BasicConicalGearMachineSettings else None
