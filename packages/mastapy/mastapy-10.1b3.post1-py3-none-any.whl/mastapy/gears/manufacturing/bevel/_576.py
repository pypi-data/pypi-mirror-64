...
class ConicalWheelManufacturingConfig(_558.ConicalGearManufacturingConfig):
    ...
    def specified_machine_settings(self) -> '_603.BasicConicalGearMachineSettings':
        ...
        return constructor.new(_603.BasicConicalGearMachineSettings)(self.wrapped.SpecifiedMachineSettings) if self.wrapped.SpecifiedMachineSettings else None
    ...
    def specified_machine_settings_of_type_basic_conical_gear_machine_settings_formate(self) -> '_604.BasicConicalGearMachineSettingsFormate':
        ...
        return constructor.new(_604.BasicConicalGearMachineSettingsFormate)(self.wrapped.SpecifiedMachineSettings) if self.wrapped.SpecifiedMachineSettings else None
    ...
    def specified_machine_settings_of_type_basic_conical_gear_machine_settings_generated(self) -> '_605.BasicConicalGearMachineSettingsGenerated':
        ...
        return constructor.new(_605.BasicConicalGearMachineSettingsGenerated)(self.wrapped.SpecifiedMachineSettings) if self.wrapped.SpecifiedMachineSettings else None
