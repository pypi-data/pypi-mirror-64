...
class ConicalMeshFlankManufacturingConfig(_564.ConicalMeshFlankMicroGeometryConfig):
    ...
    def control_parameters(self) -> '_599.ConicalGearManufacturingControlParameters':
        ...
        return constructor.new(_599.ConicalGearManufacturingControlParameters)(self.wrapped.ControlParameters) if self.wrapped.ControlParameters else None
    ...
    def control_parameters_of_type_conical_manufacturing_sgm_control_parameters(self) -> '_600.ConicalManufacturingSGMControlParameters':
        ...
        return constructor.new(_600.ConicalManufacturingSGMControlParameters)(self.wrapped.ControlParameters) if self.wrapped.ControlParameters else None
    ...
    def control_parameters_of_type_conical_manufacturing_sgt_control_parameters(self) -> '_601.ConicalManufacturingSGTControlParameters':
        ...
        return constructor.new(_601.ConicalManufacturingSGTControlParameters)(self.wrapped.ControlParameters) if self.wrapped.ControlParameters else None
    ...
    def control_parameters_of_type_conical_manufacturing_smt_control_parameters(self) -> '_602.ConicalManufacturingSMTControlParameters':
        ...
        return constructor.new(_602.ConicalManufacturingSMTControlParameters)(self.wrapped.ControlParameters) if self.wrapped.ControlParameters else None
