...
from mastapy.gears.gear_designs.cylindrical import _832, _799, _831
...
class CylindricalGearSpecification(_0.APIBase):
    ...
    @property
    def tooth_thickness_specification(self) -> '_832.ToothThicknessSpecificationBase':
        ...
        return constructor.new(_832.ToothThicknessSpecificationBase)(self.wrapped.ToothThicknessSpecification) if self.wrapped.ToothThicknessSpecification else None
    ...
    def tooth_thickness_specification_of_type_finish_tooth_thickness_design_specification(self) -> '_799.FinishToothThicknessDesignSpecification':
        ...
        return constructor.new(_799.FinishToothThicknessDesignSpecification)(self.wrapped.ToothThicknessSpecification) if self.wrapped.ToothThicknessSpecification else None

    @property
    def tooth_thickness_specification_of_type_tooth_thickness_specification(self) -> '_831.ToothThicknessSpecification':
        ...
        if _831.ToothThicknessSpecification.TYPE not in self.wrapped.ToothThicknessSpecification.__class__.__mro__:
        ...
        return constructor.new(_831.ToothThicknessSpecification)(self.wrapped.ToothThicknessSpecification) if self.wrapped.ToothThicknessSpecification else None
