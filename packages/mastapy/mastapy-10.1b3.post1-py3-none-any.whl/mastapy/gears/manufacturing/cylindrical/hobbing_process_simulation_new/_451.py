...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _443, _449
...
class HobbingProcessLeadCalculation(_449.HobbingProcessCalculation):
    '''HobbingProcessLeadCalculation
