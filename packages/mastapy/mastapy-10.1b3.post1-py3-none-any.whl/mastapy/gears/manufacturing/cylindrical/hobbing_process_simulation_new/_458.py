...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _449
...
class HobbingProcessTotalModificationCalculation(_449.HobbingProcessCalculation):
    '''HobbingProcessTotalModificationCalculation
