...
T = TypeVar('T', bound='_468.ProcessSimulationInput')
...
class ProcessSimulationNew(_0.APIBase, Generic[T]):
    ...
    @property
    def lead_calculation(self) -> '_465.ProcessLeadCalculation':
        ...
        return constructor.new(_465.ProcessLeadCalculation)(self.wrapped.LeadCalculation) if self.wrapped.LeadCalculation else None

    @property
    def profile_calculation(self) -> '_467.ProcessProfileCalculation':
        ...
        return constructor.new(_467.ProcessProfileCalculation)(self.wrapped.ProfileCalculation) if self.wrapped.ProfileCalculation else None

    @property
    def pitch_calculation(self) -> '_466.ProcessPitchCalculation':
        ...
        return constructor.new(_466.ProcessPitchCalculation)(self.wrapped.PitchCalculation) if self.wrapped.PitchCalculation else None

    @property
    def gear_tooth_shape_calculation(self) -> '_464.ProcessGearShape':
        ...
        return constructor.new(_464.ProcessGearShape)(self.wrapped.GearToothShapeCalculation) if self.wrapped.GearToothShapeCalculation else None

    @property
    def total_modification_calculation(self) -> '_471.ProcessTotalModificationCalculation':
        ...
        return constructor.new(_471.ProcessTotalModificationCalculation)(self.wrapped.TotalModificationCalculation) if self.wrapped.TotalModificationCalculation else None
