...
class CylindricalGearShaper(_518.InvoluteCutterDesign):
    ...
    @property
    def shaper_edge_type(self) -> '_822.ShaperEdgeTypes':
        ...
        return constructor.new(_822.ShaperEdgeTypes)(value) if value else None

    @shaper_edge_type.setter
    def shaper_edge_type(self, value: '_822.ShaperEdgeTypes'):
