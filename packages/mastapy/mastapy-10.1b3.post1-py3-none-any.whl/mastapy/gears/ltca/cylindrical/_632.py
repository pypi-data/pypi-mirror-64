...
class CylindricalMeshLoadDistributionAtRotation(_615.GearMeshLoadDistributionAtRotation):
    ...
    @property
    def mesh_alignment(self) -> '_857.MeshAlignment':
        ...
        return constructor.new(_857.MeshAlignment)(self.wrapped.MeshAlignment) if self.wrapped.MeshAlignment else None
