...
class GearMeshLoadDistributionAnalysis(_952.GearMeshImplementationAnalysis):
    '''GearMeshLoadDistributionAnalysis
    ...
    @property
    def transmission_error_fourier_series(self) -> '_1071.FourierSeries':
        ...
        return constructor.new(_1071.FourierSeries)(self.wrapped.TransmissionErrorFourierSeries) if self.wrapped.TransmissionErrorFourierSeries else None
    ...
    def maximum_root_stress_with_flanks(self, gear: '_613.GearLoadDistributionAnalysis', flank: '_129.GearFlanks', stress_type: '_1389.StressResultsType') -> 'float':
    ...
    def maximum_root_stress(self, gear: '_613.GearLoadDistributionAnalysis', stress_type: '_1389.StressResultsType') -> 'float':
        ''' 'MaximumRootStress' is the original name of this method.
