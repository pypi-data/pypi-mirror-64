...
from mastapy.gears.materials import _385, _377
...
class CylindricalGearMaterial(_377.GearMaterial):
    '''CylindricalGearMaterial
    ...
    @property
    def heat_treatment_process_development(self) -> '_385.ManufactureRating':
        ...
        return constructor.new(_385.ManufactureRating)(value) if value else None

    @heat_treatment_process_development.setter
    def heat_treatment_process_development(self, value: '_385.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HeatTreatmentProcessDevelopment = value

    @property
    def heat_treatment_distortion_control(self) -> '_385.ManufactureRating':
    ...
    def heat_treatment_distortion_control(self, value: '_385.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HeatTreatmentDistortionControl = value

    @property
    def machine_process_development(self) -> '_385.ManufactureRating':
    ...
    def machine_process_development(self, value: '_385.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MachineProcessDevelopment = value

    @property
    def manufacturability(self) -> '_385.ManufactureRating':
    ...
    def manufacturability(self, value: '_385.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
