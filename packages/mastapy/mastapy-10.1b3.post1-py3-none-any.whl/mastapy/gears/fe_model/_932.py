...
from mastapy.gears.fe_model import _930, _929
...
class GearSetFEModel(_960.GearSetImplementationDetail):
    '''GearSetFEModel
    ...
    @property
    def mesh_fe_models(self) -> 'List[_930.GearMeshFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshFEModels, constructor.new(_930.GearMeshFEModel))
        return value

    @property
    def gear_fe_models(self) -> 'List[_929.GearFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearFEModels, constructor.new(_929.GearFEModel))
        return value
