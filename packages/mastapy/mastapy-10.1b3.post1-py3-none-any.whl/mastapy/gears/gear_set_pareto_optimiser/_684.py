...
class MicroGeometryDesignSpaceSearchChartInformation(_670.ChartInfoBase['_631.CylindricalGearSetLoadDistributionAnalysis', '_683.MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearchChartInformation
    ...
    @property
    def optimiser(self) -> '_682.MicroGeometryDesignSpaceSearch':
