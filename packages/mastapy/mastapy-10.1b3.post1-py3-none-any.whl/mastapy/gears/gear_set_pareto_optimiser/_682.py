...
from mastapy.gears.ltca.cylindrical import _628, _627, _631
from mastapy._internal import constructor, conversion
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _849
from mastapy.gears.gear_set_pareto_optimiser import _672, _683
...
class MicroGeometryDesignSpaceSearch(_672.DesignSpaceSearchBase['_631.CylindricalGearSetLoadDistributionAnalysis', '_683.MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearch
    ...
    def load_case_duty_cycle(self) -> '_631.CylindricalGearSetLoadDistributionAnalysis':
        ...
        return constructor.new(_631.CylindricalGearSetLoadDistributionAnalysis)(self.wrapped.LoadCaseDutyCycle) if self.wrapped.LoadCaseDutyCycle else None

    @property
    def selected_candidate_micro_geometry(self) -> '_849.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_849.CylindricalGearSetMicroGeometry)(self.wrapped.SelectedCandidateMicroGeometry) if self.wrapped.SelectedCandidateMicroGeometry else None

    @property
    def candidate_gear_sets(self) -> 'List[_849.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_849.CylindricalGearSetMicroGeometry))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_849.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_849.CylindricalGearSetMicroGeometry))
        return value
