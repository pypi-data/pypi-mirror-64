...
class KlingelnbergCycloPalloidHypoidGearRating(_215.KlingelnbergCycloPalloidConicalGearRating):
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear(self) -> '_740.KlingelnbergCycloPalloidHypoidGearDesign':
        ...
        return constructor.new(_740.KlingelnbergCycloPalloidHypoidGearDesign)(self.wrapped.KlingelnbergCycloPalloidHypoidGear) if self.wrapped.KlingelnbergCycloPalloidHypoidGear else None
