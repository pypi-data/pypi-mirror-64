...
class ZerolBevelGearRating(_339.BevelGearRating):
    ...
    @property
    def zerol_bevel_gear(self) -> '_715.ZerolBevelGearDesign':
        ...
        return constructor.new(_715.ZerolBevelGearDesign)(self.wrapped.ZerolBevelGear) if self.wrapped.ZerolBevelGear else None
