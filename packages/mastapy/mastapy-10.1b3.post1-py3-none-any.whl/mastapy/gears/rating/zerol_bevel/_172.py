...
class ZerolBevelGearMeshRating(_338.BevelGearMeshRating):
    ...
    @property
    def zerol_bevel_gear_mesh(self) -> '_716.ZerolBevelGearMeshDesign':
        ...
        return constructor.new(_716.ZerolBevelGearMeshDesign)(self.wrapped.ZerolBevelGearMesh) if self.wrapped.ZerolBevelGearMesh else None
