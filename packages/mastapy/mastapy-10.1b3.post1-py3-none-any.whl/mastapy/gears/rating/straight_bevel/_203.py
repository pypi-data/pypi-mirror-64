...
class StraightBevelGearRating(_339.BevelGearRating):
    ...
    @property
    def straight_bevel_gear(self) -> '_728.StraightBevelGearDesign':
        ...
        return constructor.new(_728.StraightBevelGearDesign)(self.wrapped.StraightBevelGear) if self.wrapped.StraightBevelGear else None
