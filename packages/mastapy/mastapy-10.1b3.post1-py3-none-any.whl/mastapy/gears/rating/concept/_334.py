...
class ConceptGearMeshRating(_163.GearMeshRating):
    ...
    @property
    def concept_gear_mesh(self) -> '_909.ConceptGearMeshDesign':
        ...
        return constructor.new(_909.ConceptGearMeshDesign)(self.wrapped.ConceptGearMesh) if self.wrapped.ConceptGearMesh else None
