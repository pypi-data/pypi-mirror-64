...
class WormGearMeshRating(_163.GearMeshRating):
    ...
    @property
    def worm_gear_mesh(self) -> '_721.WormGearMeshDesign':
        ...
        return constructor.new(_721.WormGearMeshDesign)(self.wrapped.WormGearMesh) if self.wrapped.WormGearMesh else None
