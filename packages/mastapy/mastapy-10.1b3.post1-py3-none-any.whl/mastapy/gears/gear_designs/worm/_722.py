...
from mastapy.gears.gear_designs.worm import _720, _721
...
class WormGearSetDesign(_713.GearSetDesign):
    '''WormGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_720.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_720.WormGearDesign))
        return value
    ...
    @property
    def worm_meshes(self) -> 'List[_721.WormGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshes, constructor.new(_721.WormGearMeshDesign))
        return value
