...
from mastapy.gears.gear_designs.face import _753, _752
...
class FaceGearWheelDesign(_752.FaceGearDesign):
    '''FaceGearWheelDesign
    ...
    @property
    def face_width_and_diameters_specification_method(self) -> '_753.FaceGearDiameterFaceWidthSpecificationMethod':
        ...
        return constructor.new(_753.FaceGearDiameterFaceWidthSpecificationMethod)(value) if value else None

    @face_width_and_diameters_specification_method.setter
    def face_width_and_diameters_specification_method(self, value: '_753.FaceGearDiameterFaceWidthSpecificationMethod'):
