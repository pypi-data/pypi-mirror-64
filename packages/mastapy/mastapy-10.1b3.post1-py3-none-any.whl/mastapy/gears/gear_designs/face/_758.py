...
class FaceGearSetDesign(_713.GearSetDesign):
    '''FaceGearSetDesign
    ...
    @property
    def pinion(self) -> '_757.FaceGearPinionDesign':
        ...
        return constructor.new(_757.FaceGearPinionDesign)(self.wrapped.Pinion) if self.wrapped.Pinion else None

    @property
    def face_gear(self) -> '_760.FaceGearWheelDesign':
        ...
        return constructor.new(_760.FaceGearWheelDesign)(self.wrapped.FaceGear) if self.wrapped.FaceGear else None

    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_759.FaceGearSetMicroGeometry':
        ...
        return constructor.new(_759.FaceGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry else None

    @property
    def gears(self) -> 'List[_752.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_752.FaceGearDesign))
        return value

    @property
    def face_gears(self) -> 'List[_752.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGears, constructor.new(_752.FaceGearDesign))
        return value

    @property
    def face_meshes(self) -> 'List[_754.FaceGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshes, constructor.new(_754.FaceGearMeshDesign))
        return value
