...
from mastapy.gears.gear_designs.face import _758, _752
...
class FaceGearMeshDesign(_712.GearMeshDesign):
    '''FaceGearMeshDesign
    ...
    @property
    def face_gear_set(self) -> '_758.FaceGearSetDesign':
        ...
        return constructor.new(_758.FaceGearSetDesign)(self.wrapped.FaceGearSet) if self.wrapped.FaceGearSet else None
