...
from mastapy.gears.gear_designs.hypoid import _748, _749
...
class HypoidGearSetDesign(_927.AGMAGleasonConicalGearSetDesign):
    '''HypoidGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_748.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_748.HypoidGearDesign))
        return value
    ...
    @property
    def meshes(self) -> 'List[_749.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_749.HypoidGearMeshDesign))
        return value

    @property
    def hypoid_meshes(self) -> 'List[_749.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshes, constructor.new(_749.HypoidGearMeshDesign))
        return value
