...
from mastapy.utility import _1124
...
class CaseHardeningPropertiesForFEAnalysis(_1124.CachedIndependentReportablePropertiesBase['CaseHardeningPropertiesForFEAnalysis']):
    '''CaseHardeningPropertiesForFEAnalysis
