...
from mastapy.gears.gear_designs.cylindrical import _783, _812
...
class CylindricalGearDesignSettings(_1137.PerMachineSettings):
    '''CylindricalGearDesignSettings
    ...
    @property
    def tolerance_rounding_system(self) -> '_1150.MeasurementSystem':
        ...
        return constructor.new(_1150.MeasurementSystem)(value) if value else None

    @tolerance_rounding_system.setter
    def tolerance_rounding_system(self, value: '_1150.MeasurementSystem'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def micro_geometry_lead_relief_definition(self) -> '_812.MicroGeometryConvention':
        ...
        return constructor.new(_812.MicroGeometryConvention)(value) if value else None

    @micro_geometry_lead_relief_definition.setter
    def micro_geometry_lead_relief_definition(self, value: '_812.MicroGeometryConvention'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
