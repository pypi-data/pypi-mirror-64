...
class CylindricalGearDesign(_710.GearDesign):
    '''CylindricalGearDesign
    ...
    @property
    def iso6336_geometry(self) -> '_807.ISO6336GeometryBase':
        ...
        return constructor.new(_807.ISO6336GeometryBase)(self.wrapped.ISO6336Geometry) if self.wrapped.ISO6336Geometry else None

    @property
    def iso6336_geometry_of_type_iso6336_geometry(self) -> '_806.ISO6336Geometry':
        ...
        if _806.ISO6336Geometry.TYPE not in self.wrapped.ISO6336Geometry.__class__.__mro__:
        ...
        return constructor.new(_806.ISO6336Geometry)(self.wrapped.ISO6336Geometry) if self.wrapped.ISO6336Geometry else None

    @property
    def iso6336_geometry_of_type_iso6336_geometry_for_shaped_gears(self) -> '_808.ISO6336GeometryForShapedGears':
        ...
        if _808.ISO6336GeometryForShapedGears.TYPE not in self.wrapped.ISO6336Geometry.__class__.__mro__:
        ...
        return constructor.new(_808.ISO6336GeometryForShapedGears)(self.wrapped.ISO6336Geometry) if self.wrapped.ISO6336Geometry else None

    @property
    def iso6336_geometry_of_type_iso6336_geometry_manufactured(self) -> '_809.ISO6336GeometryManufactured':
        ...
        if _809.ISO6336GeometryManufactured.TYPE not in self.wrapped.ISO6336Geometry.__class__.__mro__:
        ...
        return constructor.new(_809.ISO6336GeometryManufactured)(self.wrapped.ISO6336Geometry) if self.wrapped.ISO6336Geometry else None

    @property
    def surface_roughness(self) -> '_825.SurfaceRoughness':
        ...
        return constructor.new(_825.SurfaceRoughness)(self.wrapped.SurfaceRoughness) if self.wrapped.SurfaceRoughness else None
    ...
    def cylindrical_gear_set(self) -> '_785.CylindricalGearSetDesign':
        ...
        return constructor.new(_785.CylindricalGearSetDesign)(self.wrapped.CylindricalGearSet) if self.wrapped.CylindricalGearSet else None

    @property
    def cylindrical_gear_micro_geometry(self) -> '_844.CylindricalGearMicroGeometry':
        ...
        return constructor.new(_844.CylindricalGearMicroGeometry)(self.wrapped.CylindricalGearMicroGeometry) if self.wrapped.CylindricalGearMicroGeometry else None
    ...
    def material(self) -> '_377.GearMaterial':
        ...
        return constructor.new(_377.GearMaterial)(self.wrapped.Material) if self.wrapped.Material else None
    ...
    def material_of_type_bevel_gear_iso_material(self) -> '_368.BevelGearISOMaterial':
        ...
        return constructor.new(_368.BevelGearISOMaterial)(self.wrapped.Material) if self.wrapped.Material else None
    ...
    def material_of_type_bevel_gear_material(self) -> '_370.BevelGearMaterial':
        ...
        return constructor.new(_370.BevelGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None
    ...
    def material_of_type_cylindrical_gear_material(self) -> '_374.CylindricalGearMaterial':
        ...
        return constructor.new(_374.CylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None
    ...
    def material_of_type_iso_cylindrical_gear_material(self) -> '_380.ISOCylindricalGearMaterial':
        ...
        return constructor.new(_380.ISOCylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None
    ...
    def material_of_type_klingelnberg_cyclo_palloid_conical_gear_material(self) -> '_384.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        return constructor.new(_384.KlingelnbergCycloPalloidConicalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None
    ...
    def material_of_type_plastic_cylindrical_gear_material(self) -> '_386.PlasticCylindricalGearMaterial':
        ...
        return constructor.new(_386.PlasticCylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def system_of_gear_fits(self) -> '_874.DIN3967SystemOfGearFits':
        ...
        return constructor.new(_874.DIN3967SystemOfGearFits)(self.wrapped.SystemOfGearFits) if self.wrapped.SystemOfGearFits else None

    @property
    def iso_accuracy_grade(self) -> '_877.ISO1328AccuracyGrades':
        ...
        return constructor.new(_877.ISO1328AccuracyGrades)(self.wrapped.ISOAccuracyGrade) if self.wrapped.ISOAccuracyGrade else None

    @property
    def agma_accuracy_grade(self) -> '_869.AGMA20151AccuracyGrades':
        ...
        return constructor.new(_869.AGMA20151AccuracyGrades)(self.wrapped.AGMAAccuracyGrade) if self.wrapped.AGMAAccuracyGrade else None

    @property
    def accuracy_grade_allowances_and_tolerances(self) -> '_871.CylindricalAccuracyGrader':
        ...
        return constructor.new(_871.CylindricalAccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grade_allowances_and_tolerances_of_type_agma2000_accuracy_grader(self) -> '_867.AGMA2000AccuracyGrader':
        ...
        if _867.AGMA2000AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
        ...
        return constructor.new(_867.AGMA2000AccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grade_allowances_and_tolerances_of_type_agma20151_accuracy_grader(self) -> '_868.AGMA20151AccuracyGrader':
        ...
        if _868.AGMA20151AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
        ...
        return constructor.new(_868.AGMA20151AccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grade_allowances_and_tolerances_of_type_agmaiso13282013_accuracy_grader(self) -> '_870.AGMAISO13282013AccuracyGrader':
        ...
        if _870.AGMAISO13282013AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
        ...
        return constructor.new(_870.AGMAISO13282013AccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grade_allowances_and_tolerances_of_type_cylindrical_accuracy_grader_with_profile_form_and_slope(self) -> '_872.CylindricalAccuracyGraderWithProfileFormAndSlope':
        ...
        if _872.CylindricalAccuracyGraderWithProfileFormAndSlope.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
        ...
        return constructor.new(_872.CylindricalAccuracyGraderWithProfileFormAndSlope)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grade_allowances_and_tolerances_of_type_iso13282013_accuracy_grader(self) -> '_875.ISO13282013AccuracyGrader':
        ...
        if _875.ISO13282013AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
        ...
        return constructor.new(_875.ISO13282013AccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None

    @property
    def accuracy_grade_allowances_and_tolerances_of_type_iso1328_accuracy_grader(self) -> '_876.ISO1328AccuracyGrader':
        ...
        if _876.ISO1328AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
        ...
        return constructor.new(_876.ISO1328AccuracyGrader)(self.wrapped.AccuracyGradeAllowancesAndTolerances) if self.wrapped.AccuracyGradeAllowancesAndTolerances else None
    ...
    @property
    def accuracy_grades_specified_accuracy_of_type_agma20151_accuracy_grades(self) -> '_869.AGMA20151AccuracyGrades':
        ...
        if _869.AGMA20151AccuracyGrades.TYPE not in self.wrapped.AccuracyGradesSpecifiedAccuracy.__class__.__mro__:
        ...
        return constructor.new(_869.AGMA20151AccuracyGrades)(self.wrapped.AccuracyGradesSpecifiedAccuracy) if self.wrapped.AccuracyGradesSpecifiedAccuracy else None

    @property
    def accuracy_grades_specified_accuracy_of_type_cylindrical_accuracy_grades(self) -> '_873.CylindricalAccuracyGrades':
        ...
        if _873.CylindricalAccuracyGrades.TYPE not in self.wrapped.AccuracyGradesSpecifiedAccuracy.__class__.__mro__:
        ...
        return constructor.new(_873.CylindricalAccuracyGrades)(self.wrapped.AccuracyGradesSpecifiedAccuracy) if self.wrapped.AccuracyGradesSpecifiedAccuracy else None

    @property
    def accuracy_grades_specified_accuracy_of_type_iso1328_accuracy_grades(self) -> '_877.ISO1328AccuracyGrades':
        ...
        if _877.ISO1328AccuracyGrades.TYPE not in self.wrapped.AccuracyGradesSpecifiedAccuracy.__class__.__mro__:
        ...
        return constructor.new(_877.ISO1328AccuracyGrades)(self.wrapped.AccuracyGradesSpecifiedAccuracy) if self.wrapped.AccuracyGradesSpecifiedAccuracy else None

    @property
    def accuracy_grades_specified_accuracy_of_type_agma_gleason_conical_accuracy_grades(self) -> '_924.AGMAGleasonConicalAccuracyGrades':
        ...
        if _924.AGMAGleasonConicalAccuracyGrades.TYPE not in self.wrapped.AccuracyGradesSpecifiedAccuracy.__class__.__mro__:
        ...
        return constructor.new(_924.AGMAGleasonConicalAccuracyGrades)(self.wrapped.AccuracyGradesSpecifiedAccuracy) if self.wrapped.AccuracyGradesSpecifiedAccuracy else None
    ...
    @property
    def tiff_analysis_settings(self) -> '_827.TiffAnalysisSettings':
        ...
        return constructor.new(_827.TiffAnalysisSettings)(self.wrapped.TIFFAnalysisSettings) if self.wrapped.TIFFAnalysisSettings else None
    ...
    @property
    def rough_tooth_thickness_specification(self) -> '_831.ToothThicknessSpecification':
        ...
        return constructor.new(_831.ToothThicknessSpecification)(self.wrapped.RoughToothThicknessSpecification) if self.wrapped.RoughToothThicknessSpecification else None
