...
from mastapy.math_utility.measured_ranges import _1117
...
class CylindricalGearMeshDesign(_712.GearMeshDesign):
    '''CylindricalGearMeshDesign
    ...
    @property
    def type_of_mechanism_housing(self) -> '_833.TypeOfMechanismHousing':
        ...
        return constructor.new(_833.TypeOfMechanismHousing)(value) if value else None

    @type_of_mechanism_housing.setter
    def type_of_mechanism_housing(self, value: '_833.TypeOfMechanismHousing'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def backlash_specification(self) -> '_762.BacklashSpecification':
        ...
        return constructor.new(_762.BacklashSpecification)(self.wrapped.BacklashSpecification) if self.wrapped.BacklashSpecification else None

    @property
    def valid_normal_module_range(self) -> '_1117.ShortLengthRange':
        ...
        return constructor.new(_1117.ShortLengthRange)(self.wrapped.ValidNormalModuleRange) if self.wrapped.ValidNormalModuleRange else None
    ...
    def gear_a(self) -> '_774.CylindricalGearDesign':
        ...
        return constructor.new(_774.CylindricalGearDesign)(self.wrapped.GearA) if self.wrapped.GearA else None
    ...
    def gear_b(self) -> '_774.CylindricalGearDesign':
        ...
        return constructor.new(_774.CylindricalGearDesign)(self.wrapped.GearB) if self.wrapped.GearB else None
