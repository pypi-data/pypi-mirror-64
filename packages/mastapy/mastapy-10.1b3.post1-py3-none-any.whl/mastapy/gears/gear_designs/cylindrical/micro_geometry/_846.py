...
class CylindricalGearMicroGeometryMap(_0.APIBase):
    ...
    @property
    def measured_map_data_type(self) -> '_856.MeasuredMapDataTypes':
        ...
        return constructor.new(_856.MeasuredMapDataTypes)(value) if value else None

    @measured_map_data_type.setter
    def measured_map_data_type(self, value: '_856.MeasuredMapDataTypes'):
