...
from mastapy.gears.gear_designs.cylindrical import _774, _782
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _839, _859
...
class CylindricalGearMicroGeometry(_950.GearImplementationDetail):
    '''CylindricalGearMicroGeometry
    ...
    def cylindrical_gear(self) -> '_774.CylindricalGearDesign':
        ...
        return constructor.new(_774.CylindricalGearDesign)(self.wrapped.CylindricalGear) if self.wrapped.CylindricalGear else None

    @property
    def left_flank(self) -> '_839.CylindricalGearFlankMicroGeometry':
        ...
        return constructor.new(_839.CylindricalGearFlankMicroGeometry)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None

    @property
    def right_flank(self) -> '_839.CylindricalGearFlankMicroGeometry':
        ...
        return constructor.new(_839.CylindricalGearFlankMicroGeometry)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None
    ...
    @property
    def flanks(self) -> 'List[_839.CylindricalGearFlankMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_839.CylindricalGearFlankMicroGeometry))
        return value

    @property
    def meshed_gears(self) -> 'List[_859.MeshedCylindricalGearMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_859.MeshedCylindricalGearMicroGeometry))
        return value
