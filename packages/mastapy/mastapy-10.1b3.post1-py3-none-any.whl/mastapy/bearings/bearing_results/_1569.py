...
class LoadedBearingResults(_1508.BearingLoadCaseResultsLightweight):
    '''LoadedBearingResults
    ...
    @property
    def force_on_inner_race(self) -> '_1116.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1116.VectorWithLinearAndAngularComponents)(self.wrapped.ForceOnInnerRace) if self.wrapped.ForceOnInnerRace else None

    @property
    def bearing(self) -> '_1728.BearingDesign':
        ...
        return constructor.new(_1728.BearingDesign)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_detailed_bearing(self) -> '_1729.DetailedBearing':
        ...
        if _1729.DetailedBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1729.DetailedBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_dummy_rolling_bearing(self) -> '_1730.DummyRollingBearing':
        ...
        if _1730.DummyRollingBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1730.DummyRollingBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_linear_bearing(self) -> '_1731.LinearBearing':
        ...
        if _1731.LinearBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
            raise CastException('Failed to cast bearing to LinearBearing. Expected: {}.'.format(self.wrapped.Bearing.__class__.__qualname__))

        return constructor.new(_1731.LinearBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_non_linear_bearing(self) -> '_1732.NonLinearBearing':
        ...
        if _1732.NonLinearBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1732.NonLinearBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_angular_contact_ball_bearing(self) -> '_1733.AngularContactBallBearing':
        ...
        if _1733.AngularContactBallBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1733.AngularContactBallBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_angular_contact_thrust_ball_bearing(self) -> '_1734.AngularContactThrustBallBearing':
        ...
        if _1734.AngularContactThrustBallBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1734.AngularContactThrustBallBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_asymmetric_spherical_roller_bearing(self) -> '_1735.AsymmetricSphericalRollerBearing':
        ...
        if _1735.AsymmetricSphericalRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1735.AsymmetricSphericalRollerBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_axial_thrust_cylindrical_roller_bearing(self) -> '_1736.AxialThrustCylindricalRollerBearing':
        ...
        if _1736.AxialThrustCylindricalRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1736.AxialThrustCylindricalRollerBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_axial_thrust_needle_roller_bearing(self) -> '_1737.AxialThrustNeedleRollerBearing':
        ...
        if _1737.AxialThrustNeedleRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1737.AxialThrustNeedleRollerBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_ball_bearing(self) -> '_1738.BallBearing':
        ...
        if _1738.BallBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
            raise CastException('Failed to cast bearing to BallBearing. Expected: {}.'.format(self.wrapped.Bearing.__class__.__qualname__))

        return constructor.new(_1738.BallBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_barrel_roller_bearing(self) -> '_1740.BarrelRollerBearing':
        ...
        if _1740.BarrelRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1740.BarrelRollerBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_cylindrical_roller_bearing(self) -> '_1745.CylindricalRollerBearing':
        ...
        if _1745.CylindricalRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1745.CylindricalRollerBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_deep_groove_ball_bearing(self) -> '_1746.DeepGrooveBallBearing':
        ...
        if _1746.DeepGrooveBallBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1746.DeepGrooveBallBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_four_point_contact_ball_bearing(self) -> '_1748.FourPointContactBallBearing':
        ...
        if _1748.FourPointContactBallBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1748.FourPointContactBallBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_multi_point_contact_ball_bearing(self) -> '_1750.MultiPointContactBallBearing':
        ...
        if _1750.MultiPointContactBallBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1750.MultiPointContactBallBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_needle_roller_bearing(self) -> '_1751.NeedleRollerBearing':
        ...
        if _1751.NeedleRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1751.NeedleRollerBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_non_barrel_roller_bearing(self) -> '_1752.NonBarrelRollerBearing':
        ...
        if _1752.NonBarrelRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1752.NonBarrelRollerBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_roller_bearing(self) -> '_1753.RollerBearing':
        ...
        if _1753.RollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
            raise CastException('Failed to cast bearing to RollerBearing. Expected: {}.'.format(self.wrapped.Bearing.__class__.__qualname__))

        return constructor.new(_1753.RollerBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_rolling_bearing(self) -> '_1756.RollingBearing':
        ...
        if _1756.RollingBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
            raise CastException('Failed to cast bearing to RollingBearing. Expected: {}.'.format(self.wrapped.Bearing.__class__.__qualname__))

        return constructor.new(_1756.RollingBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_self_aligning_ball_bearing(self) -> '_1757.SelfAligningBallBearing':
        ...
        if _1757.SelfAligningBallBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1757.SelfAligningBallBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_spherical_roller_bearing(self) -> '_1759.SphericalRollerBearing':
        ...
        if _1759.SphericalRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1759.SphericalRollerBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_spherical_roller_thrust_bearing(self) -> '_1760.SphericalRollerThrustBearing':
        ...
        if _1760.SphericalRollerThrustBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1760.SphericalRollerThrustBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_taper_roller_bearing(self) -> '_1761.TaperRollerBearing':
        ...
        if _1761.TaperRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1761.TaperRollerBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_three_point_contact_ball_bearing(self) -> '_1762.ThreePointContactBallBearing':
        ...
        if _1762.ThreePointContactBallBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1762.ThreePointContactBallBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_thrust_ball_bearing(self) -> '_1763.ThrustBallBearing':
        ...
        if _1763.ThrustBallBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1763.ThrustBallBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_toroidal_roller_bearing(self) -> '_1764.ToroidalRollerBearing':
        ...
        if _1764.ToroidalRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1764.ToroidalRollerBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_pad_fluid_film_bearing(self) -> '_1777.PadFluidFilmBearing':
        ...
        if _1777.PadFluidFilmBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1777.PadFluidFilmBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_plain_grease_filled_journal_bearing(self) -> '_1779.PlainGreaseFilledJournalBearing':
        ...
        if _1779.PlainGreaseFilledJournalBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1779.PlainGreaseFilledJournalBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_plain_journal_bearing(self) -> '_1781.PlainJournalBearing':
        ...
        if _1781.PlainJournalBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1781.PlainJournalBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_plain_oil_fed_journal_bearing(self) -> '_1783.PlainOilFedJournalBearing':
        ...
        if _1783.PlainOilFedJournalBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1783.PlainOilFedJournalBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_tilting_pad_journal_bearing(self) -> '_1784.TiltingPadJournalBearing':
        ...
        if _1784.TiltingPadJournalBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1784.TiltingPadJournalBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_tilting_pad_thrust_bearing(self) -> '_1785.TiltingPadThrustBearing':
        ...
        if _1785.TiltingPadThrustBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1785.TiltingPadThrustBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_concept_axial_clearance_bearing(self) -> '_1787.ConceptAxialClearanceBearing':
        ...
        if _1787.ConceptAxialClearanceBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1787.ConceptAxialClearanceBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_concept_clearance_bearing(self) -> '_1788.ConceptClearanceBearing':
        ...
        if _1788.ConceptClearanceBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1788.ConceptClearanceBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_concept_radial_clearance_bearing(self) -> '_1789.ConceptRadialClearanceBearing':
        ...
        if _1789.ConceptRadialClearanceBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
        ...
        return constructor.new(_1789.ConceptRadialClearanceBearing)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def ring_results(self) -> 'List[_1679.RingForceAndDisplacement]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RingResults, constructor.new(_1679.RingForceAndDisplacement))
        return value
