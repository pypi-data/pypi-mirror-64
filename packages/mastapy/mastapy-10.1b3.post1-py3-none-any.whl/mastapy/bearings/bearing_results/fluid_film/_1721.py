...
from mastapy.bearings import _1511
...
class LoadedPlainJournalBearingRow(_0.APIBase):
    ...
    def row(self) -> '_1511.BearingRow':
        ...
        return constructor.new(_1511.BearingRow)(value) if value else None
    ...
    @property
    def journal_bearing_loading_chart(self) -> '_6501.SMTBitmap':
        ...
        return constructor.new(_6501.SMTBitmap)(self.wrapped.JournalBearingLoadingChart) if self.wrapped.JournalBearingLoadingChart else None
