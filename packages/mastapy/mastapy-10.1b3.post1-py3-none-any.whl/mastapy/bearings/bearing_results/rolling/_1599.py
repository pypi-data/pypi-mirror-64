...
from mastapy.bearings.bearing_results.rolling import _1598, _1596
...
class LoadedAngularContactThrustBallBearingRow(_1596.LoadedAngularContactBallBearingRow):
    '''LoadedAngularContactThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1598.LoadedAngularContactThrustBallBearingResults':
