...
from mastapy.bearings.bearing_results.rolling import _1645, _1615
...
class LoadedSelfAligningBallBearingRow(_1615.LoadedBallBearingRow):
    '''LoadedSelfAligningBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1645.LoadedSelfAligningBallBearingResults':
