...
from mastapy.bearings.bearing_results.rolling import _1658, _1634
...
class LoadedTaperRollerBearingRow(_1634.LoadedNonBarrelRollerBearingRow):
    '''LoadedTaperRollerBearingRow
    ...
    @property
    def major_rib_normal_contact_stress(self) -> '_6501.SMTBitmap':
        ...
        return constructor.new(_6501.SMTBitmap)(self.wrapped.MajorRibNormalContactStress) if self.wrapped.MajorRibNormalContactStress else None

    @property
    def loaded_bearing(self) -> '_1658.LoadedTaperRollerBearingResults':
