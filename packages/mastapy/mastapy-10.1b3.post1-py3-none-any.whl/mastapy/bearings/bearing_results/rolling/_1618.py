...
from mastapy.bearings.bearing_results.rolling import _1682, _1633
...
class LoadedCylindricalRollerBearingResults(_1633.LoadedNonBarrelRollerBearingResults):
    '''LoadedCylindricalRollerBearingResults
    ...
    @property
    def skf_maximal_constantly_acting_axial_load(self) -> '_1682.SKFMaximalConstantlyActingAxialLoadResults':
        ...
        return constructor.new(_1682.SKFMaximalConstantlyActingAxialLoadResults)(self.wrapped.SKFMaximalConstantlyActingAxialLoad) if self.wrapped.SKFMaximalConstantlyActingAxialLoad else None
