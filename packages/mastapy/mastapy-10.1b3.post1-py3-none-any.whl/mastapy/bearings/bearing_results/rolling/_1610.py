...
class LoadedAxialThrustNeedleRollerBearingRow(_1607.LoadedAxialThrustCylindricalRollerBearingRow):
    '''LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1609.LoadedAxialThrustNeedleRollerBearingResults':
