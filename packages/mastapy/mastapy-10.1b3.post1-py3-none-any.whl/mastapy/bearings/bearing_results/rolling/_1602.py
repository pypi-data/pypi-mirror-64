...
from mastapy.bearings.bearing_results.rolling import _1601, _1639
...
class LoadedAsymmetricSphericalRollerBearingRow(_1639.LoadedRollerBearingRow):
    '''LoadedAsymmetricSphericalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1601.LoadedAsymmetricSphericalRollerBearingResults':
