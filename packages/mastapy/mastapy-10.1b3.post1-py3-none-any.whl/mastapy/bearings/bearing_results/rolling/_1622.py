...
from mastapy.bearings.bearing_results.rolling import _1621, _1615
...
class LoadedDeepGrooveBallBearingRow(_1615.LoadedBallBearingRow):
    '''LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1621.LoadedDeepGrooveBallBearingResults':
