...
class ISO14179SettingsPerBearingType(_1132.IndependentReportablePropertiesBase['ISO14179SettingsPerBearingType']):
    '''ISO14179SettingsPerBearingType
    ...
    @property
    def rolling_bearing_type(self) -> '_1527.RollingBearingType':
        ...
        return constructor.new(_1527.RollingBearingType)(value) if value else None
