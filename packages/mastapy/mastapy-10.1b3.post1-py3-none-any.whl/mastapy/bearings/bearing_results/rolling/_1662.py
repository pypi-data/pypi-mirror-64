...
from mastapy.bearings.bearing_results.rolling import _1661, _1615
...
class LoadedThreePointContactBallBearingRow(_1615.LoadedBallBearingRow):
    '''LoadedThreePointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1661.LoadedThreePointContactBallBearingResults':
