...
from mastapy.bearings.bearing_results.rolling import _1652, _1639
...
class LoadedSphericalRollerThrustBearingRow(_1639.LoadedRollerBearingRow):
    '''LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1652.LoadedSphericalRollerThrustBearingResults':
