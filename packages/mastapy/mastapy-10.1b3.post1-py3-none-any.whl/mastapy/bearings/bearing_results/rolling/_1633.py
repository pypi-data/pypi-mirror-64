...
from mastapy.bearings.bearing_results.rolling import _1683, _1638
...
class LoadedNonBarrelRollerBearingResults(_1638.LoadedRollerBearingResults):
    '''LoadedNonBarrelRollerBearingResults
    ...
    @property
    def smt_rib_stress(self) -> '_1683.SMTRibStressResults':
        ...
        return constructor.new(_1683.SMTRibStressResults)(self.wrapped.SMTRibStress) if self.wrapped.SMTRibStress else None
