...
from mastapy.bearings.bearing_results.rolling import _1630, _1619
...
class LoadedNeedleRollerBearingRow(_1619.LoadedCylindricalRollerBearingRow):
    '''LoadedNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1630.LoadedNeedleRollerBearingResults':
