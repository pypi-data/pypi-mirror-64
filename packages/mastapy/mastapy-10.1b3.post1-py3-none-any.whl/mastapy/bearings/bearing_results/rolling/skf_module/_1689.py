...
from mastapy.bearings.bearing_results.rolling.skf_module import _1699, _1703
...
class BearingRatingLife(_1703.SKFCalculationResult):
    '''BearingRatingLife
    ...
    @property
    def life_model(self) -> '_1699.LifeModel':
        ...
        return constructor.new(_1699.LifeModel)(self.wrapped.LifeModel) if self.wrapped.LifeModel else None
