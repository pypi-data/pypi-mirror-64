...
from mastapy.bearings.bearing_results.rolling.skf_module import _1701, _1703
...
class Viscosities(_1703.SKFCalculationResult):
    '''Viscosities
    ...
    @property
    def operating_viscosity(self) -> '_1701.OperatingViscosity':
        ...
        return constructor.new(_1701.OperatingViscosity)(self.wrapped.OperatingViscosity) if self.wrapped.OperatingViscosity else None
