...
from mastapy.bearings.bearing_results.rolling import _1685, _1642
...
class LoadedBallBearingResults(_1642.LoadedRollingBearingResults):
    '''LoadedBallBearingResults
    ...
    @property
    def track_truncation(self) -> '_1685.TrackTruncationSafetyFactorResults':
        ...
        return constructor.new(_1685.TrackTruncationSafetyFactorResults)(self.wrapped.TrackTruncation) if self.wrapped.TrackTruncation else None
