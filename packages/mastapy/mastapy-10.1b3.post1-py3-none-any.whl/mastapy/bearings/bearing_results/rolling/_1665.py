...
from mastapy.bearings.bearing_results.rolling import _1664, _1615
...
class LoadedThrustBallBearingRow(_1615.LoadedBallBearingRow):
    '''LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1664.LoadedThrustBallBearingResults':
