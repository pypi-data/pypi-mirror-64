...
from mastapy.bearings.bearing_results.rolling import _1595, _1615
...
class LoadedAngularContactBallBearingRow(_1615.LoadedBallBearingRow):
    '''LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1595.LoadedAngularContactBallBearingResults':
