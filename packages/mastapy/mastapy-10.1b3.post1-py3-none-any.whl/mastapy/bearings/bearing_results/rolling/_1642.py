...
class LoadedRollingBearingResults(_1574.LoadedDetailedBearingResults):
    '''LoadedRollingBearingResults
    ...
    @property
    def fluid_film_temperature_source(self) -> '_1515.FluidFilmTemperatureOptions':
        ...
        return constructor.new(_1515.FluidFilmTemperatureOptions)(value) if value else None
    ...
    @property
    def outer_race_fitting_at_assembly(self) -> '_1674.OuterRaceFittingThermalResults':
        ...
        return constructor.new(_1674.OuterRaceFittingThermalResults)(self.wrapped.OuterRaceFittingAtAssembly) if self.wrapped.OuterRaceFittingAtAssembly else None

    @property
    def outer_race_fitting_at_operating_conditions(self) -> '_1674.OuterRaceFittingThermalResults':
        ...
        return constructor.new(_1674.OuterRaceFittingThermalResults)(self.wrapped.OuterRaceFittingAtOperatingConditions) if self.wrapped.OuterRaceFittingAtOperatingConditions else None

    @property
    def inner_race_fitting_at_assembly(self) -> '_1589.InnerRaceFittingThermalResults':
        ...
        return constructor.new(_1589.InnerRaceFittingThermalResults)(self.wrapped.InnerRaceFittingAtAssembly) if self.wrapped.InnerRaceFittingAtAssembly else None

    @property
    def inner_race_fitting_at_operating_conditions(self) -> '_1589.InnerRaceFittingThermalResults':
        ...
        return constructor.new(_1589.InnerRaceFittingThermalResults)(self.wrapped.InnerRaceFittingAtOperatingConditions) if self.wrapped.InnerRaceFittingAtOperatingConditions else None

    @property
    def din732(self) -> '_1587.DIN732Results':
        ...
        return constructor.new(_1587.DIN732Results)(self.wrapped.DIN732) if self.wrapped.DIN732 else None

    @property
    def iso2812007(self) -> '_1710.ISO2812007Results':
        ...
        return constructor.new(_1710.ISO2812007Results)(self.wrapped.ISO2812007) if self.wrapped.ISO2812007 else None

    @property
    def iso2812007_of_type_ball_iso2812007_results(self) -> '_1708.BallISO2812007Results':
        ...
        if _1708.BallISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
        ...
        return constructor.new(_1708.BallISO2812007Results)(self.wrapped.ISO2812007) if self.wrapped.ISO2812007 else None

    @property
    def iso2812007_of_type_roller_iso2812007_results(self) -> '_1714.RollerISO2812007Results':
        ...
        if _1714.RollerISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
        ...
        return constructor.new(_1714.RollerISO2812007Results)(self.wrapped.ISO2812007) if self.wrapped.ISO2812007 else None

    @property
    def isots162812008(self) -> '_1713.ISOTS162812008Results':
        ...
        return constructor.new(_1713.ISOTS162812008Results)(self.wrapped.ISOTS162812008) if self.wrapped.ISOTS162812008 else None

    @property
    def isots162812008_of_type_ball_isots162812008_results(self) -> '_1709.BallISOTS162812008Results':
        ...
        if _1709.BallISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
        ...
        return constructor.new(_1709.BallISOTS162812008Results)(self.wrapped.ISOTS162812008) if self.wrapped.ISOTS162812008 else None

    @property
    def isots162812008_of_type_roller_isots162812008_results(self) -> '_1715.RollerISOTS162812008Results':
        ...
        if _1715.RollerISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
        ...
        return constructor.new(_1715.RollerISOTS162812008Results)(self.wrapped.ISOTS162812008) if self.wrapped.ISOTS162812008 else None

    @property
    def iso762006(self) -> '_1711.ISO762006Results':
        ...
        return constructor.new(_1711.ISO762006Results)(self.wrapped.ISO762006) if self.wrapped.ISO762006 else None

    @property
    def maximum_static_contact_stress(self) -> '_1670.MaximumStaticContactStress':
        ...
        return constructor.new(_1670.MaximumStaticContactStress)(self.wrapped.MaximumStaticContactStress) if self.wrapped.MaximumStaticContactStress else None

    @property
    def skf_module_results(self) -> '_1705.SKFModuleResults':
        ...
        return constructor.new(_1705.SKFModuleResults)(self.wrapped.SKFModuleResults) if self.wrapped.SKFModuleResults else None

    @property
    def rows(self) -> 'List[_1643.LoadedRollingBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Rows, constructor.new(_1643.LoadedRollingBearingRow))
        return value

    @property
    def all_mounting_results(self) -> 'List[_1677.RaceFittingThermalResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllMountingResults, constructor.new(_1677.RaceFittingThermalResults))
        return value
