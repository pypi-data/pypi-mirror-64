...
from mastapy.bearings.tolerances import _1533, _1530
...
class InterferenceTolerance(_1530.BearingConnectionComponent):
    '''InterferenceTolerance
    ...
    @property
    def definition_option(self) -> '_1533.BearingToleranceDefinitionOptions':
    ...
    def definition_option(self, value: '_1533.BearingToleranceDefinitionOptions'):
    ...
    @property
    def mounting_point_surface_finish(self) -> '_1519.MountingPointSurfaceFinishes':
        ...
        return constructor.new(_1519.MountingPointSurfaceFinishes)(value) if value else None

    @mounting_point_surface_finish.setter
    def mounting_point_surface_finish(self, value: '_1519.MountingPointSurfaceFinishes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
