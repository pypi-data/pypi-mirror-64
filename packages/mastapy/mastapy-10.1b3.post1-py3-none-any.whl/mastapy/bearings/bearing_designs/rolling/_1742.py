...
from mastapy.bearings.bearing_designs.rolling import _1743
...
class BearingProtectionDetailsModifier(_0.APIBase):
    ...
    @property
    def current_protection_level(self) -> '_1743.BearingProtectionLevel':
        ...
        return constructor.new(_1743.BearingProtectionLevel)(value) if value else None

    @property
    def new_protection_level(self) -> '_1743.BearingProtectionLevel':
    ...
    def new_protection_level(self, value: '_1743.BearingProtectionLevel'):
