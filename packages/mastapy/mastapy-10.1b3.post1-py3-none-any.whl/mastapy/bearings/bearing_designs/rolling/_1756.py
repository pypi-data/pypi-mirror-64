...
from mastapy.bearings import (
    _1523, _1526, _1502, _1503,
    _1504, _1505
)
from mastapy.bearings.bearing_designs.rolling import (
    _1765, _1749, _1747, _1744,
    _1758, _1741
)
...
class RollingBearing(_1729.DetailedBearing):
    '''RollingBearing
    ...
    @property
    def catalogue(self) -> '_1502.BearingCatalog':
        ...
        return constructor.new(_1502.BearingCatalog)(value) if value else None
    ...
    @property
    def type_information(self) -> '_1744.BearingTypeExtraInformation':
        ...
        return constructor.new(_1744.BearingTypeExtraInformation)(value) if value else None
    ...
    @property
    def cage_material(self) -> '_1505.BearingCageMaterial':
        ...
        return constructor.new(_1505.BearingCageMaterial)(value) if value else None

    @cage_material.setter
    def cage_material(self, value: '_1505.BearingCageMaterial'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CageMaterial = value

    @property
    def sleeve_type(self) -> '_1758.SleeveType':
        ...
        return constructor.new(_1758.SleeveType)(value) if value else None
    ...
    @property
    def history(self) -> '_1129.FileHistory':
        ...
        return constructor.new(_1129.FileHistory)(self.wrapped.History) if self.wrapped.History else None

    @property
    def protection(self) -> '_1741.BearingProtection':
        ...
        return constructor.new(_1741.BearingProtection)(self.wrapped.Protection) if self.wrapped.Protection else None
