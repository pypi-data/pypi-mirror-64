...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1767, _1766
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self) -> 'List[_1767.BearingImportFile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Files, constructor.new(_1767.BearingImportFile))
        return value

    @property
    def variables(self) -> 'List[_1766.AbstractXmlVariableAssignment]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Variables, constructor.new(_1766.AbstractXmlVariableAssignment))
        return value
