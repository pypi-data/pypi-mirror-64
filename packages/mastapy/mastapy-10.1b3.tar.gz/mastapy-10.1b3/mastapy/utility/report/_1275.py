...
from mastapy.utility.report import _1276, _1279
...
TItem = TypeVar('TItem', bound='_1279.CustomReportPropertyItem')


class CustomReportMultiPropertyItem(_1276.CustomReportMultiPropertyItemBase, Generic[TItem]):
    '''CustomReportMultiPropertyItem
