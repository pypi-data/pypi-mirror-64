...
from mastapy.utility.report import _1291, _1284
...
class UserTextRow(_1284.CustomRow):
    '''UserTextRow
    ...
    @property
    def heading_size(self) -> '_1291.HeadingSize':
        '''HeadingSize: 'HeadingSize' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingSize)
        return constructor.new(_1291.HeadingSize)(value) if value else None

    @heading_size.setter
    def heading_size(self, value: '_1291.HeadingSize'):
