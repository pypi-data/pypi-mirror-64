...
class GeneralTransmissionProperties(_0.APIBase):
    ...
    @property
    def transmission_application(self) -> '_91.TransmissionApplications':
        ...
        return constructor.new(_91.TransmissionApplications)(value) if value else None

    @transmission_application.setter
    def transmission_application(self, value: '_91.TransmissionApplications'):
    ...
    @property
    def wind_turbine_standard(self) -> '_94.WindTurbineStandards':
        ...
        return constructor.new(_94.WindTurbineStandards)(value) if value else None

    @wind_turbine_standard.setter
    def wind_turbine_standard(self, value: '_94.WindTurbineStandards'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def driving_machine_characteristics(self) -> '_95.WorkingCharacteristics':
        ...
        return constructor.new(_95.WorkingCharacteristics)(value) if value else None

    @driving_machine_characteristics.setter
    def driving_machine_characteristics(self, value: '_95.WorkingCharacteristics'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DrivingMachineCharacteristics = value

    @property
    def driven_machine_characteristics(self) -> '_95.WorkingCharacteristics':
    ...
    def driven_machine_characteristics(self, value: '_95.WorkingCharacteristics'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def vehicle_dynamics(self) -> '_93.VehicleDynamicsProperties':
        ...
        return constructor.new(_93.VehicleDynamicsProperties)(self.wrapped.VehicleDynamics) if self.wrapped.VehicleDynamics else None
