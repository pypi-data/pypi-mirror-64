...
from mastapy.materials import _78, _65
...
class Material(_1322.NamedDatabaseItem):
    '''Material
    ...
    @property
    def standard(self) -> '_78.MaterialStandards':
        '''MaterialStandards: 'Standard' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Standard)
        return constructor.new(_78.MaterialStandards)(value) if value else None

    @standard.setter
    def standard(self, value: '_78.MaterialStandards'):
