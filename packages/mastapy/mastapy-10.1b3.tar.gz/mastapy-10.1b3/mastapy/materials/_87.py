...
from mastapy.materials import _88
...
class SoundPressureEnclosure(_0.APIBase):
    ...
    @property
    def enclosure_type(self) -> '_88.SoundPressureEnclosureType':
        ...
        return constructor.new(_88.SoundPressureEnclosureType)(value) if value else None

    @enclosure_type.setter
    def enclosure_type(self, value: '_88.SoundPressureEnclosureType'):
