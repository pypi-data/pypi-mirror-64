...
class OilPumpDetail(_1120.IndependentReportablePropertiesBase['OilPumpDetail']):
    '''OilPumpDetail
    ...
    @property
    def oil_pump_drive_type(self) -> '_103.OilPumpDriveType':
        ...
        return constructor.new(_103.OilPumpDriveType)(value) if value else None

    @oil_pump_drive_type.setter
    def oil_pump_drive_type(self, value: '_103.OilPumpDriveType'):
