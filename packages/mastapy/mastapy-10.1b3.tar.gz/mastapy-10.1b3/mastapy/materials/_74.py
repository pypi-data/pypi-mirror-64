...
class LubricationDetail(_1322.NamedDatabaseItem):
    '''LubricationDetail
    ...
    @property
    def pressure_viscosity_coefficient_method(self) -> '_81.PressureViscosityCoefficientMethod':
        ...
        return constructor.new(_81.PressureViscosityCoefficientMethod)(value) if value else None

    @pressure_viscosity_coefficient_method.setter
    def pressure_viscosity_coefficient_method(self, value: '_81.PressureViscosityCoefficientMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def oil_filtration_and_contamination(self) -> '_80.OilFiltrationOptions':
        ...
        return constructor.new(_80.OilFiltrationOptions)(value) if value else None

    @oil_filtration_and_contamination.setter
    def oil_filtration_and_contamination(self, value: '_80.OilFiltrationOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
