...
class ComponentMaterialDatabase(_0.APIBase):
    '''ComponentMaterialDatabase
    ...
    def item(self) -> '_76.Material':
        ...
        return constructor.new(_76.Material)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_76.Material':
        ...
        return constructor.new(_76.Material)(method_result) if method_result else None

    def can_be_removed(self, material: '_76.Material') -> 'bool':
    ...
    def rename(self, material: '_76.Material', new_name: 'str') -> 'bool':
    ...
    def remove(self, material: '_76.Material'):
    ...
    def get_all_items(self) -> 'Iterable[_76.Material]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_76.Material))

    def save_changes(self, material: '_76.Material'):
