...
from mastapy.math_utility.optimisation import _1097, _1096
...
class ParetoOptimisationVariableBase(_0.APIBase):
    ...
    @property
    def specification_type(self) -> '_1097.TargetingPropertyTo':
        ...
        return constructor.new(_1097.TargetingPropertyTo)(value) if value else None

    @specification_type.setter
    def specification_type(self, value: '_1097.TargetingPropertyTo'):
