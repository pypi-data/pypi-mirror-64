...
from mastapy.math_utility.optimisation import _1094, _1092
...
class ParetoOptimistaionVariable(_1092.ParetoOptimisationVariableBase):
    '''ParetoOptimistaionVariable
    ...
    @property
    def property_target_for_dominant_candidate_search(self) -> '_1094.PropertyTargetForDominantCandidateSearch':
        ...
        return constructor.new(_1094.PropertyTargetForDominantCandidateSearch)(value) if value else None

    @property_target_for_dominant_candidate_search.setter
    def property_target_for_dominant_candidate_search(self, value: '_1094.PropertyTargetForDominantCandidateSearch'):
