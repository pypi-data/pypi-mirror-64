...
class ParetoOptimisationStrategyChartInformation(_0.APIBase):
    ...
    @property
    def bars(self) -> 'List[_1090.ParetoOptimisationStrategyBars]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Bars, constructor.new(_1090.ParetoOptimisationStrategyBars))
        return value
