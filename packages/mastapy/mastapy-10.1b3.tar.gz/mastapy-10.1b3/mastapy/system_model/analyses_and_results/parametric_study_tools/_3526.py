...
from mastapy.system_model.analyses_and_results.static_loads import _6029, _6131
from mastapy.system_model import _1777
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3527, _3528
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    @property
    def parametric_study_type(self) -> '_6131.ParametricStudyType':
        ...
        return constructor.new(_6131.ParametricStudyType)(value) if value else None

    @parametric_study_type.setter
    def parametric_study_type(self, value: '_6131.ParametricStudyType'):
    ...
    @property
    def external_full_fe_loader(self) -> '_1777.ExternalFullFELoader':
        ...
        return constructor.new(_1777.ExternalFullFELoader)(self.wrapped.ExternalFullFELoader) if self.wrapped.ExternalFullFELoader else None

    @property
    def step_results(self) -> 'List[_3527.ParametricStudyToolStepResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StepResults, constructor.new(_3527.ParametricStudyToolStepResult))
        return value

    @property
    def study_variables(self) -> 'List[_3528.ParametricStudyVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StudyVariables, constructor.new(_3528.ParametricStudyVariable))
        return value
