...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3520, _3517
from mastapy._internal.implicit import list_with_selected_item
from mastapy.system_model.analyses_and_results import _2155
...
class ParametricStudyVariable(_2155.AnalysisCaseVariable):
    '''ParametricStudyVariable
    ...
    @property
    def dimension(self) -> '_3520.ParametricStudyDimension':
        ...
        return constructor.new(_3520.ParametricStudyDimension)(value) if value else None

    @dimension.setter
    def dimension(self, value: '_3520.ParametricStudyDimension'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Dimension = value

    @property
    def distribution(self) -> '_3517.MonteCarloDistribution':
        ...
        return constructor.new(_3517.MonteCarloDistribution)(value) if value else None

    @distribution.setter
    def distribution(self, value: '_3517.MonteCarloDistribution'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
