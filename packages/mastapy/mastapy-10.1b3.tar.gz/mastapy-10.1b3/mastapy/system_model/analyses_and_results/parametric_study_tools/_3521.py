...
class ParametricStudyDOEResultVariable(_1092.ParetoOptimisationVariableBase):
    '''ParametricStudyDOEResultVariable
    ...
    @property
    def target(self) -> '_1094.PropertyTargetForDominantCandidateSearch':
    ...
    @target.setter
    def target(self, value: '_1094.PropertyTargetForDominantCandidateSearch'):
