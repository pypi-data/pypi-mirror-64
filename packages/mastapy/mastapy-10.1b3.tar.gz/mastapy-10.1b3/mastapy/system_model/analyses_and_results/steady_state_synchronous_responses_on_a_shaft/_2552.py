...
class SteadyStateSynchronousResponseOnAShaft(_6473.StaticLoadAnalysisCase):
    '''SteadyStateSynchronousResponseOnAShaft
    ...
    def options(self) -> '_3041.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3041.SteadyStateSynchronousResponseOptions)(self.wrapped.Options) if self.wrapped.Options else None
