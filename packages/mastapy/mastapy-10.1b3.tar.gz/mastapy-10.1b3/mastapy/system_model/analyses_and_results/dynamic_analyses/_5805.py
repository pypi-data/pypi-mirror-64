...
class ConnectionDynamicAnalysis(_6463.ConnectionFEAnalysis):
    '''ConnectionDynamicAnalysis
    ...
    @property
    def dynamic_analysis(self) -> '_5818.DynamicAnalysis':
        ...
        return constructor.new(_5818.DynamicAnalysis)(self.wrapped.DynamicAnalysis) if self.wrapped.DynamicAnalysis else None
