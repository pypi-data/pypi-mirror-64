...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5772
...
class SpecialisedAssemblyDynamicAnalysis(_5772.AbstractAssemblyDynamicAnalysis):
    '''SpecialisedAssemblyDynamicAnalysis
