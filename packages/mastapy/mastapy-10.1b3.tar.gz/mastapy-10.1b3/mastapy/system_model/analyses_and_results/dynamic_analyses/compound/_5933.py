...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _5902
...
class CVTBeltConnectionCompoundDynamicAnalysis(_5902.BeltConnectionCompoundDynamicAnalysis):
    '''CVTBeltConnectionCompoundDynamicAnalysis
