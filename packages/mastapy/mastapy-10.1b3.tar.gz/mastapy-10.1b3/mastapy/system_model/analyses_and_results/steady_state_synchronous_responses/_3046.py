...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3047, _3045, _2956
...
class StraightBevelGearSetSteadyStateSynchronousResponse(_2956.BevelGearSetSteadyStateSynchronousResponse):
    '''StraightBevelGearSetSteadyStateSynchronousResponse
    ...
    def straight_bevel_gears_steady_state_synchronous_response(self) -> 'List[_3047.StraightBevelGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsSteadyStateSynchronousResponse, constructor.new(_3047.StraightBevelGearSteadyStateSynchronousResponse))
        return value
    ...
    def straight_bevel_meshes_steady_state_synchronous_response(self) -> 'List[_3045.StraightBevelGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesSteadyStateSynchronousResponse, constructor.new(_3045.StraightBevelGearMeshSteadyStateSynchronousResponse))
        return value
