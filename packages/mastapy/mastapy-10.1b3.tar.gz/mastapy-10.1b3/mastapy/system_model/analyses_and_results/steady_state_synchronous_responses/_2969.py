...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2970, _2968, _2994
...
class ConceptGearSetSteadyStateSynchronousResponse(_2994.GearSetSteadyStateSynchronousResponse):
    ...
    @property
    def concept_gears_steady_state_synchronous_response(self) -> 'List[_2970.ConceptGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsSteadyStateSynchronousResponse, constructor.new(_2970.ConceptGearSteadyStateSynchronousResponse))
        return value

    @property
    def concept_meshes_steady_state_synchronous_response(self) -> 'List[_2968.ConceptGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesSteadyStateSynchronousResponse, constructor.new(_2968.ConceptGearMeshSteadyStateSynchronousResponse))
        return value
