...
class SteadyStateSynchronousResponse(_6460.CompoundAnalysisCase):
    '''SteadyStateSynchronousResponse
    ...
    def steady_state_analysis_options(self) -> '_3041.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3041.SteadyStateSynchronousResponseOptions)(self.wrapped.SteadyStateAnalysisOptions) if self.wrapped.SteadyStateAnalysisOptions else None
