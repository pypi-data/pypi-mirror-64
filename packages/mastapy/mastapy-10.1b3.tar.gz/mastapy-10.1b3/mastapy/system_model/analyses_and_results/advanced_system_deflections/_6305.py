...
class SpiralBevelGearAdvancedSystemDeflection(_6226.BevelGearAdvancedSystemDeflection):
    '''SpiralBevelGearAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6155.SpiralBevelGearLoadCase':
        ...
        return constructor.new(_6155.SpiralBevelGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2290.SpiralBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2290.SpiralBevelGearSystemDeflection))
        return value
