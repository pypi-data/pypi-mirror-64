...
class PartToPartShearCouplingHalfAdvancedSystemDeflection(_6249.CouplingHalfAdvancedSystemDeflection):
    '''PartToPartShearCouplingHalfAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6134.PartToPartShearCouplingHalfLoadCase':
        ...
        return constructor.new(_6134.PartToPartShearCouplingHalfLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_system_deflection_results(self) -> 'List[_2271.PartToPartShearCouplingHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2271.PartToPartShearCouplingHalfSystemDeflection))
        return value
