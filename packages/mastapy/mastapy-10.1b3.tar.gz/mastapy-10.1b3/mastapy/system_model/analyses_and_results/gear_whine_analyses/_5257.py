...
class ConceptCouplingHalfGearWhineAnalysis(_5268.CouplingHalfGearWhineAnalysis):
    '''ConceptCouplingHalfGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2210.ConceptCouplingHalfSystemDeflection':
