...
class ShaftGearWhineAnalysis(_5231.AbstractShaftOrHousingGearWhineAnalysis):
    '''ShaftGearWhineAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4771.ShaftModalAnalysis':
    ...
    @property
    def system_deflection_results(self) -> '_2285.ShaftSystemDeflection':
