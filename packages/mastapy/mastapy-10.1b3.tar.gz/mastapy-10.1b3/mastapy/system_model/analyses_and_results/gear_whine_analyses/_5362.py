...
class TorqueConverterConnectionGearWhineAnalysis(_5266.CouplingConnectionGearWhineAnalysis):
    '''TorqueConverterConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2309.TorqueConverterConnectionSystemDeflection':
