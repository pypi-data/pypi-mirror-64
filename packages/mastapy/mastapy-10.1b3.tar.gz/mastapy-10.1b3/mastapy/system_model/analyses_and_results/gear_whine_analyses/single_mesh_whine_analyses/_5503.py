...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses import _5504, _5502, _5437
...
class WormGearSetSingleMeshWhineAnalysis(_5437.GearSetSingleMeshWhineAnalysis):
    '''WormGearSetSingleMeshWhineAnalysis
    ...
    @property
    def worm_gears_single_mesh_whine_analysis(self) -> 'List[_5504.WormGearSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsSingleMeshWhineAnalysis, constructor.new(_5504.WormGearSingleMeshWhineAnalysis))
        return value

    @property
    def worm_meshes_single_mesh_whine_analysis(self) -> 'List[_5502.WormGearMeshSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesSingleMeshWhineAnalysis, constructor.new(_5502.WormGearMeshSingleMeshWhineAnalysis))
        return value
