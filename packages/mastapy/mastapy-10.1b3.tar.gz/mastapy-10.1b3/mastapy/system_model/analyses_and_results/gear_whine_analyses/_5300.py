...
class GearWhineAnalysisFEExportOptions(_0.APIBase):
    ...
    @property
    def excitation_options(self) -> '_5378.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5378.ExcitationSourceSelectionGroup)(self.wrapped.ExcitationOptions) if self.wrapped.ExcitationOptions else None

    @property
    def analysis_options(self) -> '_5301.GearWhineAnalysisOptions':
        ...
        return constructor.new(_5301.GearWhineAnalysisOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None
