...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5343, _5294
...
class GearWhineAnalysisOptions(_0.APIBase):
    ...
    @property
    def modal_analysis_options(self) -> '_4752.ModalAnalysisOptions':
        ...
        return constructor.new(_4752.ModalAnalysisOptions)(self.wrapped.ModalAnalysisOptions) if self.wrapped.ModalAnalysisOptions else None
