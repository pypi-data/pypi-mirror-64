...
class StraightBevelSunGearGearWhineAnalysis(_5350.StraightBevelDiffGearGearWhineAnalysis):
    '''StraightBevelSunGearGearWhineAnalysis
    ...
    @property
    def component_design(self) -> '_2066.StraightBevelSunGear':
    ...
    @property
    def system_deflection_results(self) -> '_2301.StraightBevelSunGearSystemDeflection':
