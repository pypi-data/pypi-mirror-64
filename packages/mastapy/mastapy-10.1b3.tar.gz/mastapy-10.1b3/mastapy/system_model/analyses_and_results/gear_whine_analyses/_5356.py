...
class StraightBevelPlanetGearGearWhineAnalysis(_5350.StraightBevelDiffGearGearWhineAnalysis):
    '''StraightBevelPlanetGearGearWhineAnalysis
    ...
    @property
    def component_design(self) -> '_2065.StraightBevelPlanetGear':
    ...
    @property
    def system_deflection_results(self) -> '_2300.StraightBevelPlanetGearSystemDeflection':
