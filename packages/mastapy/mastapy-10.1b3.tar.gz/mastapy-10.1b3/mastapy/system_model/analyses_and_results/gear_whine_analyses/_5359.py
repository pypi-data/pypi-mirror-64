...
class SynchroniserHalfGearWhineAnalysis(_5360.SynchroniserPartGearWhineAnalysis):
    '''SynchroniserHalfGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2302.SynchroniserHalfSystemDeflection':
