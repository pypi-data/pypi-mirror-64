...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5300, _5231
...
class ImportedFEComponentGearWhineAnalysis(_5231.AbstractShaftOrHousingGearWhineAnalysis):
    '''ImportedFEComponentGearWhineAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4736.ImportedFEComponentModalAnalysis':
    ...
    @property
    def export(self) -> '_5300.GearWhineAnalysisFEExportOptions':
        ...
        return constructor.new(_5300.GearWhineAnalysisFEExportOptions)(self.wrapped.Export) if self.wrapped.Export else None
    ...
    @property
    def system_deflection_results(self) -> '_2251.ImportedFEComponentSystemDeflection':
