...
from mastapy.system_model.analyses_and_results.system_deflections import _2286, _2206, _2273
...
class ShaftToMountableComponentConnectionGearWhineAnalysis(_5264.ConnectionGearWhineAnalysis):
    '''ShaftToMountableComponentConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2286.ShaftToMountableComponentConnectionSystemDeflection':
