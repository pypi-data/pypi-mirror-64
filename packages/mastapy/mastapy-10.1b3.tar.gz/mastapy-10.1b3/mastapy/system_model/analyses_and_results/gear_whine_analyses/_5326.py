...
class PartToPartShearCouplingHalfGearWhineAnalysis(_5268.CouplingHalfGearWhineAnalysis):
    '''PartToPartShearCouplingHalfGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2271.PartToPartShearCouplingHalfSystemDeflection':
