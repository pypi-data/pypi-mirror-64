...
class SynchroniserSleeveGearWhineAnalysis(_5360.SynchroniserPartGearWhineAnalysis):
    '''SynchroniserSleeveGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2304.SynchroniserSleeveSystemDeflection':
