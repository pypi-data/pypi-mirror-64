...
class PartToPartShearCouplingHalfSystemDeflection(_2222.CouplingHalfSystemDeflection):
    '''PartToPartShearCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3269.PartToPartShearCouplingHalfPowerFlow':
