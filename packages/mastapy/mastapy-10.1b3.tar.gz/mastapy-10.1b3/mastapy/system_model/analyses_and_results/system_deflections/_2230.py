...
from mastapy.system_model.analyses_and_results.system_deflections import _2233, _2227, _2245
...
class CylindricalGearSetSystemDeflection(_2245.GearSetSystemDeflection):
    '''CylindricalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3237.CylindricalGearSetPowerFlow':
    ...
    @property
    def manufacturing_analysis(self) -> '_399.CylindricalManufacturedGearSetLoadCase':
        ...
        return constructor.new(_399.CylindricalManufacturedGearSetLoadCase)(self.wrapped.ManufacturingAnalysis) if self.wrapped.ManufacturingAnalysis else None

    @property
    def cylindrical_gears_system_deflection(self) -> 'List[_2233.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsSystemDeflection, constructor.new(_2233.CylindricalGearSystemDeflection))
        return value

    @property
    def cylindrical_meshes_system_deflection(self) -> 'List[_2227.CylindricalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesSystemDeflection, constructor.new(_2227.CylindricalGearMeshSystemDeflection))
        return value
