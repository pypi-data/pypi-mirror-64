...
class StraightBevelDiffGearMeshSystemDeflection(_2198.BevelGearMeshSystemDeflection):
    '''StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3293.StraightBevelDiffGearMeshPowerFlow':
