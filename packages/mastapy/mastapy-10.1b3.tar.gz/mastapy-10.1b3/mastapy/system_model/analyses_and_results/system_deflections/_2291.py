...
class SpringDamperConnectionSystemDeflection(_2221.CouplingConnectionSystemDeflection):
    '''SpringDamperConnectionSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6158.SpringDamperConnectionLoadCase':
        ...
        return constructor.new(_6158.SpringDamperConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def power_flow_results(self) -> '_3290.SpringDamperConnectionPowerFlow':
