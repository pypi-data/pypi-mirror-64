...
from mastapy.system_model.analyses_and_results.system_deflections import _2242, _2240, _2245
...
class FaceGearSetSystemDeflection(_2245.GearSetSystemDeflection):
    '''FaceGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3243.FaceGearSetPowerFlow':
    ...
    @property
    def face_gears_system_deflection(self) -> 'List[_2242.FaceGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsSystemDeflection, constructor.new(_2242.FaceGearSystemDeflection))
        return value

    @property
    def face_meshes_system_deflection(self) -> 'List[_2240.FaceGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesSystemDeflection, constructor.new(_2240.FaceGearMeshSystemDeflection))
        return value
