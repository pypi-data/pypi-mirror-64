...
class PartToPartShearCouplingConnectionSystemDeflection(_2221.CouplingConnectionSystemDeflection):
    '''PartToPartShearCouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3268.PartToPartShearCouplingConnectionPowerFlow':
