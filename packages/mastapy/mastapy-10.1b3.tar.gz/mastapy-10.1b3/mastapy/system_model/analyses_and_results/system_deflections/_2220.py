...
class ConnectorSystemDeflection(_2266.MountableComponentSystemDeflection):
    '''ConnectorSystemDeflection
    ...
    @property
    def outer_imported_fe(self) -> '_2251.ImportedFEComponentSystemDeflection':
        ...
        return constructor.new(_2251.ImportedFEComponentSystemDeflection)(self.wrapped.OuterImportedFE) if self.wrapped.OuterImportedFE else None

    @property
    def force_on_outer_support_in_wcs(self) -> '_1104.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1104.VectorWithLinearAndAngularComponents)(self.wrapped.ForceOnOuterSupportInWCS) if self.wrapped.ForceOnOuterSupportInWCS else None

    @property
    def force_on_outer_support_in_lcs(self) -> '_1104.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1104.VectorWithLinearAndAngularComponents)(self.wrapped.ForceOnOuterSupportInLCS) if self.wrapped.ForceOnOuterSupportInLCS else None

    @property
    def outer_imported_fe_nodes(self) -> 'List[_1924.ImportedFEStiffnessNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OuterImportedFENodes, constructor.new(_1924.ImportedFEStiffnessNode))
        return value

    @property
    def power_flow_results(self) -> '_3227.ConnectorPowerFlow':
