...
from mastapy.system_model.drawing import _1806, _1804
...
class SystemDeflectionDrawStyle(_1804.ContourDrawStyle):
    '''SystemDeflectionDrawStyle
    ...
    @property
    def force_arrow_scaling(self) -> '_1806.ScalingDrawStyle':
        ...
        return constructor.new(_1806.ScalingDrawStyle)(self.wrapped.ForceArrowScaling) if self.wrapped.ForceArrowScaling else None
