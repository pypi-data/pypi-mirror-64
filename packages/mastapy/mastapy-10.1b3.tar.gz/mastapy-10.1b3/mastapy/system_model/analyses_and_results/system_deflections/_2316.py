...
class VirtualComponentSystemDeflection(_2266.MountableComponentSystemDeflection):
    '''VirtualComponentSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3311.VirtualComponentPowerFlow':
