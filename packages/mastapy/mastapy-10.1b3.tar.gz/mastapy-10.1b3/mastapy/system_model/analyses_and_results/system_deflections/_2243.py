...
from mastapy.system_model.analyses_and_results.system_deflections import (
    _2285, _2230, _2231, _2232,
    _2282, _2267, _2262, _2233,
    _2190, _2287
)
...
class FlexiblePinAssemblySystemDeflection(_2287.SpecialisedAssemblySystemDeflection):
    '''FlexiblePinAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3244.FlexiblePinAssemblyPowerFlow':
    ...
    @property
    def pin_analysis(self) -> '_2285.ShaftSystemDeflection':
        ...
        return constructor.new(_2285.ShaftSystemDeflection)(self.wrapped.PinAnalysis) if self.wrapped.PinAnalysis else None

    @property
    def spindle_analyses(self) -> '_2285.ShaftSystemDeflection':
        ...
        return constructor.new(_2285.ShaftSystemDeflection)(self.wrapped.SpindleAnalyses) if self.wrapped.SpindleAnalyses else None

    @property
    def separate_gear_set_details(self) -> '_2230.CylindricalGearSetSystemDeflection':
        ...
        return constructor.new(_2230.CylindricalGearSetSystemDeflection)(self.wrapped.SeparateGearSetDetails) if self.wrapped.SeparateGearSetDetails else None

    @property
    def separate_gear_set_details_of_type_cylindrical_gear_set_system_deflection_timestep(self) -> '_2231.CylindricalGearSetSystemDeflectionTimestep':
        ...
        if _2231.CylindricalGearSetSystemDeflectionTimestep.TYPE not in self.wrapped.SeparateGearSetDetails.__class__.__mro__:
        ...
        return constructor.new(_2231.CylindricalGearSetSystemDeflectionTimestep)(self.wrapped.SeparateGearSetDetails) if self.wrapped.SeparateGearSetDetails else None

    @property
    def separate_gear_set_details_of_type_cylindrical_gear_set_system_deflection_with_ltca_results(self) -> '_2232.CylindricalGearSetSystemDeflectionWithLTCAResults':
        ...
        if _2232.CylindricalGearSetSystemDeflectionWithLTCAResults.TYPE not in self.wrapped.SeparateGearSetDetails.__class__.__mro__:
        ...
        return constructor.new(_2232.CylindricalGearSetSystemDeflectionWithLTCAResults)(self.wrapped.SeparateGearSetDetails) if self.wrapped.SeparateGearSetDetails else None

    @property
    def flexible_pin_shaft_details(self) -> '_2285.ShaftSystemDeflection':
        ...
        return constructor.new(_2285.ShaftSystemDeflection)(self.wrapped.FlexiblePinShaftDetails) if self.wrapped.FlexiblePinShaftDetails else None

    @property
    def pin_spindle_fit_analyses(self) -> 'List[_2282.ShaftHubConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PinSpindleFitAnalyses, constructor.new(_2282.ShaftHubConnectionSystemDeflection))
        return value

    @property
    def observed_pin_stiffness_reporters(self) -> 'List[_2267.ObservedPinStiffnessReporter]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ObservedPinStiffnessReporters, constructor.new(_2267.ObservedPinStiffnessReporter))
        return value
    ...
    @property
    def planet_gear_system_deflections(self) -> 'List[_2233.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetGearSystemDeflections, constructor.new(_2233.CylindricalGearSystemDeflection))
        return value

    @property
    def flexible_pin_fit_details(self) -> 'List[_2282.ShaftHubConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FlexiblePinFitDetails, constructor.new(_2282.ShaftHubConnectionSystemDeflection))
        return value

    @property
    def bearing_static_analyses(self) -> 'List[_2190.BearingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingStaticAnalyses, constructor.new(_2190.BearingSystemDeflection))
        return value
