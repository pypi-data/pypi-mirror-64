...
from mastapy.system_model.analyses_and_results.static_loads import _6075, _6106, _6087
...
class HarmonicLoadDataJMAGImport(_6106.HarmonicLoadDataImportFromMotorPackages['_6087.ElectricMachineHarmonicLoadJMAGImportOptions']):
    '''HarmonicLoadDataJMAGImport
    ...
    @property
    def electric_machine_data_per_speed(self) -> 'List[_6075.DataFromJMAGPerSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElectricMachineDataPerSpeed, constructor.new(_6075.DataFromJMAGPerSpeed))
        return value
