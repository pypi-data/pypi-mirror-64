...
from mastapy.system_model.imported_fes import _1890, _1912
...
class ImportedFEComponentLoadCase(_6024.AbstractShaftOrHousingLoadCase):
    '''ImportedFEComponentLoadCase
    ...
    @property
    def angle_source(self) -> '_1890.AngleSource':
        ...
        return constructor.new(_1890.AngleSource)(value) if value else None
