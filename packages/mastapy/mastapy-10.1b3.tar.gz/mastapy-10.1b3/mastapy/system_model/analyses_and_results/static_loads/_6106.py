...
from mastapy.system_model.analyses_and_results.static_loads import _6109, _6105, _6086
...
class HarmonicLoadDataImportFromMotorPackages(_6105.HarmonicLoadDataImportBase['T'], Generic[T]):
    '''HarmonicLoadDataImportFromMotorPackages
