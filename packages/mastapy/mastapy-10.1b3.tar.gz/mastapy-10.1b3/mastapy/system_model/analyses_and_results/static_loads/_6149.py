...
from mastapy.nodal_analysis.varying_input_components import _1378, _1377, _1382
from mastapy.math_utility.control import _1110
from mastapy.system_model.analyses_and_results.static_loads import _6161, _6072, _6030
...
class RootAssemblyLoadCase(_6030.AssemblyLoadCase):
    '''RootAssemblyLoadCase
    ...
    @property
    def brake_force_input_values(self) -> '_1378.ForceInputComponent':
        ...
        return constructor.new(_1378.ForceInputComponent)(self.wrapped.BrakeForceInputValues) if self.wrapped.BrakeForceInputValues else None

    @property
    def road_incline_input_values(self) -> '_1377.AngleInputComponent':
        ...
        return constructor.new(_1377.AngleInputComponent)(self.wrapped.RoadInclineInputValues) if self.wrapped.RoadInclineInputValues else None

    @property
    def drive_cycle_pid_control_settings(self) -> '_1110.PIDControlSettings':
        ...
        return constructor.new(_1110.PIDControlSettings)(self.wrapped.DriveCyclePIDControlSettings) if self.wrapped.DriveCyclePIDControlSettings else None

    @property
    def target_vehicle_speed(self) -> '_1382.VelocityInputComponent':
        ...
        return constructor.new(_1382.VelocityInputComponent)(self.wrapped.TargetVehicleSpeed) if self.wrapped.TargetVehicleSpeed else None
    ...
    @property
    def supercharger_rotor_sets(self) -> 'List[_6072.CylindricalGearSetLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SuperchargerRotorSets, constructor.new(_6072.CylindricalGearSetLoadCase))
        return value
