...
from mastapy.math_utility import _1057, _1062
...
class PointLoadHarmonicLoadData(_6154.SpeedDependentHarmonicLoadData):
    '''PointLoadHarmonicLoadData
    ...
    @property
    def degree_of_freedom(self) -> '_1057.DegreesOfFreedom':
        ...
        return constructor.new(_1057.DegreesOfFreedom)(value) if value else None

    @degree_of_freedom.setter
    def degree_of_freedom(self, value: '_1057.DegreesOfFreedom'):
