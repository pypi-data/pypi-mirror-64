...
from mastapy.system_model.analyses_and_results.static_loads import _6129, _6105, _6085
...
class HarmonicLoadDataExcelImport(_6105.HarmonicLoadDataImportBase['_6085.ElectricMachineHarmonicLoadExcelImportOptions']):
    '''HarmonicLoadDataExcelImport
    ...
    @property
    def speeds(self) -> 'List[_6129.NamedSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Speeds, constructor.new(_6129.NamedSpeed))
        return value
