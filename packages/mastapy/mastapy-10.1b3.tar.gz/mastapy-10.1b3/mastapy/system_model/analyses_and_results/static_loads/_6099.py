...
from mastapy.system_model.analyses_and_results.static_loads import _6098, _6103
...
class GearSetHarmonicLoadData(_6103.HarmonicLoadDataBase):
    '''GearSetHarmonicLoadData
    ...
    @property
    def gear_mesh_te_order_type(self) -> '_6098.GearMeshTEOrderType':
        ...
        return constructor.new(_6098.GearMeshTEOrderType)(value) if value else None

    @gear_mesh_te_order_type.setter
    def gear_mesh_te_order_type(self, value: '_6098.GearMeshTEOrderType'):
