...
from mastapy.system_model.analyses_and_results.static_loads import _6138, _6128
...
class PlanetCarrierLoadCase(_6128.MountableComponentLoadCase):
    '''PlanetCarrierLoadCase
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6138.PlanetarySocketManufactureError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetManufactureErrors, constructor.new(_6138.PlanetarySocketManufactureError))
        return value
