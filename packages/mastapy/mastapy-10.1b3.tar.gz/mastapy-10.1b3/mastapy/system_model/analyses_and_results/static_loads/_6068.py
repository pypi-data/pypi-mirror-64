...
from mastapy.system_model.analyses_and_results.static_loads import _6069, _6095
...
class CylindricalGearLoadCase(_6095.GearLoadCase):
    '''CylindricalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6069.CylindricalGearManufactureError':
    ...
    @property
    def overridden_micro_geometry(self) -> '_836.CylindricalGearMicroGeometry':
        ...
        return constructor.new(_836.CylindricalGearMicroGeometry)(self.wrapped.OverriddenMicroGeometry) if self.wrapped.OverriddenMicroGeometry else None
