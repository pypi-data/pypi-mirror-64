...
from mastapy.system_model.analyses_and_results.static_loads import _6056, _6095
...
class ConicalGearLoadCase(_6095.GearLoadCase):
    '''ConicalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6056.ConicalGearManufactureError':
