...
from mastapy.system_model.analyses_and_results.static_loads import _6080, _6086
...
T = TypeVar('T', bound='_6086.ElectricMachineHarmonicLoadImportOptionsBase')


class ElectricMachineHarmonicLoadDataFromMotorPackages(_6080.ElectricMachineHarmonicLoadData, Generic[T]):
    '''ElectricMachineHarmonicLoadDataFromMotorPackages
