...
from mastapy.system_model.analyses_and_results.load_case_groups import _5212, _5213, _5214
...
class StaticLoadCase(_6022.LoadCase):
    '''StaticLoadCase
    ...
    @property
    def gear_whine_harmonic_excitation_analysis_options(self) -> '_5301.GearWhineAnalysisOptions':
        ...
        return constructor.new(_5301.GearWhineAnalysisOptions)(self.wrapped.GearWhineHarmonicExcitationAnalysisOptions) if self.wrapped.GearWhineHarmonicExcitationAnalysisOptions else None

    @property
    def clutch_engagements(self) -> 'List[_5212.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClutchEngagements, constructor.new(_5212.ClutchEngagementStatus))
        return value

    @property
    def concept_clutch_engagements(self) -> 'List[_5213.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptClutchEngagements, constructor.new(_5213.ConceptSynchroGearEngagementStatus))
        return value

    def duplicate(self, new_design_state_group: '_5214.DesignState', name: Optional['str'] = 'None') -> 'StaticLoadCase':
