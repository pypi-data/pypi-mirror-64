...
from mastapy.system_model.analyses_and_results.static_loads import _6180, _6109, _6154
...
class ElectricMachineHarmonicLoadData(_6154.SpeedDependentHarmonicLoadData):
    '''ElectricMachineHarmonicLoadData
    ...
    @property
    def force_distribution(self) -> '_6481.SMTBitmap':
        ...
        return constructor.new(_6481.SMTBitmap)(self.wrapped.ForceDistribution) if self.wrapped.ForceDistribution else None
