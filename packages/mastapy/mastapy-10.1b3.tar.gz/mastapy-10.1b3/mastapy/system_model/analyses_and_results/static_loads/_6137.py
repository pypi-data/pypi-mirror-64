...
class PlanetaryGearSetLoadCase(_6072.CylindricalGearSetLoadCase):
    '''PlanetaryGearSetLoadCase
    ...
    @property
    def include_gear_blank_elastic_distortion(self) -> '_1123.LoadCaseOverrideOption':
    ...
    def include_gear_blank_elastic_distortion(self, value: '_1123.LoadCaseOverrideOption'):
    ...
    @property
    def assembly_design(self) -> '_2058.PlanetaryGearSet':
