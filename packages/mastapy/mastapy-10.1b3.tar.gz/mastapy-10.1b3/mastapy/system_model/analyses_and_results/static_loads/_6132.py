...
class PartLoadCase(_2161.PartAnalysis):
    '''PartLoadCase
    ...
    @property
    def static_load_case(self) -> '_6161.StaticLoadCase':
        ...
        return constructor.new(_6161.StaticLoadCase)(self.wrapped.StaticLoadCase) if self.wrapped.StaticLoadCase else None
    ...
    def get_harmonic_load_data_for_import(self) -> '_6103.HarmonicLoadDataBase':
        ...
        return constructor.new(_6103.HarmonicLoadDataBase)(method_result) if method_result else None
