...
from mastapy.system_model import _1782, _1783, _1784
from mastapy.system_model.analyses_and_results.mbd_analyses import _5075
from mastapy.system_model.analyses_and_results.static_loads import _6181, _6080, _6185
from mastapy.system_model.imported_fes import _1902
from mastapy.system_model.part_model import _1990
from mastapy.math_utility.control import _1110
from mastapy.nodal_analysis.varying_input_components import _1380
...
class PowerLoadLoadCase(_6185.VirtualComponentLoadCase):
    '''PowerLoadLoadCase
    ...
    @property
    def drag_torque_specification_method(self) -> '_1782.PowerLoadDragTorqueSpecificationMethod':
        ...
        return constructor.new(_1782.PowerLoadDragTorqueSpecificationMethod)(value) if value else None

    @drag_torque_specification_method.setter
    def drag_torque_specification_method(self, value: '_1782.PowerLoadDragTorqueSpecificationMethod'):
    ...
    @property
    def wheel_slip_model(self) -> '_5075.WheelSlipType':
        ...
        return constructor.new(_5075.WheelSlipType)(value) if value else None

    @wheel_slip_model.setter
    def wheel_slip_model(self, value: '_5075.WheelSlipType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def target_speed_input_type(self) -> '_1784.PowerLoadPIDControlSpeedInputType':
        ...
        return constructor.new(_1784.PowerLoadPIDControlSpeedInputType)(value) if value else None

    @target_speed_input_type.setter
    def target_speed_input_type(self, value: '_1784.PowerLoadPIDControlSpeedInputType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def engine_idle_speed_control_pid_settings(self) -> '_1110.PIDControlSettings':
        ...
        return constructor.new(_1110.PIDControlSettings)(self.wrapped.EngineIdleSpeedControlPIDSettings) if self.wrapped.EngineIdleSpeedControlPIDSettings else None

    @property
    def coefficient_of_friction_with_ground(self) -> '_1380.NonDimensionalInputComponent':
        ...
        return constructor.new(_1380.NonDimensionalInputComponent)(self.wrapped.CoefficientOfFrictionWithGround) if self.wrapped.CoefficientOfFrictionWithGround else None

    @property
    def pid_control_settings(self) -> '_1110.PIDControlSettings':
        ...
        return constructor.new(_1110.PIDControlSettings)(self.wrapped.PIDControlSettings) if self.wrapped.PIDControlSettings else None

    def get_harmonic_load_data_for_import(self) -> '_6080.ElectricMachineHarmonicLoadData':
        ...
        return constructor.new(_6080.ElectricMachineHarmonicLoadData)(method_result) if method_result else None
