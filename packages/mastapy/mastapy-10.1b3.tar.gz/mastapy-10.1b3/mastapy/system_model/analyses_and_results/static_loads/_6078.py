...
from mastapy.utility.enums import _1318
...
class ElectricMachineDetail(_1322.NamedDatabaseItem):
    '''ElectricMachineDetail
    ...
    @property
    def flow_rate_specification_method(self) -> '_1318.PropertySpecificationMethod':
        ...
        return constructor.new(_1318.PropertySpecificationMethod)(value) if value else None

    @flow_rate_specification_method.setter
    def flow_rate_specification_method(self, value: '_1318.PropertySpecificationMethod'):
