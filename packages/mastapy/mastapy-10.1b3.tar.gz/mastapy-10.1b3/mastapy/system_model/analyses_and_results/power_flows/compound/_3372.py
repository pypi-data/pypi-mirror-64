...
class GearSetCompoundPowerFlow(_3409.SpecialisedAssemblyCompoundPowerFlow):
    '''GearSetCompoundPowerFlow
    ...
    def gear_set_duty_cycle_rating_of_type_concept_gear_set_duty_cycle_rating(self) -> '_335.ConceptGearSetDutyCycleRating':
        ...
        return constructor.new(_335.ConceptGearSetDutyCycleRating)(self.wrapped.GearSetDutyCycleRating) if self.wrapped.GearSetDutyCycleRating else None
