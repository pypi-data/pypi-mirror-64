...
from mastapy.system_model.analyses_and_results.power_flows import _3301, _3286
...
class SynchroniserPowerFlow(_3286.SpecialisedAssemblyPowerFlow):
    '''SynchroniserPowerFlow
    ...
    @property
    def cones(self) -> 'List[_3301.SynchroniserHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_3301.SynchroniserHalfPowerFlow))
        return value
