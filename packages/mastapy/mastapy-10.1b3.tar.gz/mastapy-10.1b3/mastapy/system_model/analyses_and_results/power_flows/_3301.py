...
from mastapy.system_model.analyses_and_results.power_flows import _3212, _3302
...
class SynchroniserHalfPowerFlow(_3302.SynchroniserPartPowerFlow):
    '''SynchroniserHalfPowerFlow
    ...
    @property
    def clutch_connection(self) -> '_3212.ClutchConnectionPowerFlow':
        ...
        return constructor.new(_3212.ClutchConnectionPowerFlow)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
