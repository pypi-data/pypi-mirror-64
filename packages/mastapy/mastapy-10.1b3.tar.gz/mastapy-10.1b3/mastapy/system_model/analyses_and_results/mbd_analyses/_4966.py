...
from mastapy.system_model.analyses_and_results.mbd_analyses import _4964, _4983
...
class ClutchMultiBodyDynamicsAnalysis(_4983.CouplingMultiBodyDynamicsAnalysis):
    '''ClutchMultiBodyDynamicsAnalysis
    ...
    @property
    def clutch_connection(self) -> '_4964.ClutchConnectionMultiBodyDynamicsAnalysis':
        ...
        return constructor.new(_4964.ClutchConnectionMultiBodyDynamicsAnalysis)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
