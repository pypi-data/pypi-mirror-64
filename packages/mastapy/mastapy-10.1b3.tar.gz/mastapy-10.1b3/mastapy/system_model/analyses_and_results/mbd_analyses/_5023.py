...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5009, _5047, _5042
...
class MBDRunUpAnalysisOptions(_6459.AbstractAnalysisOptions['_6175.TimeSeriesLoadCase']):
    '''MBDRunUpAnalysisOptions
    ...
    @property
    def input_velocity_processing_type(self) -> '_5009.InputVelocityForRunUpProcessingType':
        ...
        return constructor.new(_5009.InputVelocityForRunUpProcessingType)(value) if value else None

    @input_velocity_processing_type.setter
    def input_velocity_processing_type(self, value: '_5009.InputVelocityForRunUpProcessingType'):
    ...
    @property
    def shape_of_initial_acceleration_period(self) -> '_5047.ShapeOfInitialAccelerationPeriodForRunUp':
        ...
        return constructor.new(_5047.ShapeOfInitialAccelerationPeriodForRunUp)(value) if value else None

    @shape_of_initial_acceleration_period.setter
    def shape_of_initial_acceleration_period(self, value: '_5047.ShapeOfInitialAccelerationPeriodForRunUp'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ShapeOfInitialAccelerationPeriod = value

    @property
    def run_up_driving_mode(self) -> '_5042.RunUpDrivingMode':
        ...
        return constructor.new(_5042.RunUpDrivingMode)(value) if value else None

    @run_up_driving_mode.setter
    def run_up_driving_mode(self, value: '_5042.RunUpDrivingMode'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
