...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5071, _4981
...
class TorqueConverterConnectionMultiBodyDynamicsAnalysis(_4981.CouplingConnectionMultiBodyDynamicsAnalysis):
    '''TorqueConverterConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def locking_status(self) -> '_5071.TorqueConverterStatus':
        ...
        return constructor.new(_5071.TorqueConverterStatus)(value) if value else None
