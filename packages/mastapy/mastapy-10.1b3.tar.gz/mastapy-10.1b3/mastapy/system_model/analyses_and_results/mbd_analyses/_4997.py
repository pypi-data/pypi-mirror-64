...
from mastapy.nodal_analysis import _1355
...
class GearMeshMultiBodyDynamicsAnalysis(_5010.InterMountableComponentConnectionMultiBodyDynamicsAnalysis):
    '''GearMeshMultiBodyDynamicsAnalysis
    ...
    @property
    def contact_status(self) -> '_1355.GearMeshContactStatus':
