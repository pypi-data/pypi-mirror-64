...
from mastapy.nodal_analysis import _1341, _1340
...
class ModalAnalysisBarModelFEExportOptions(_0.APIBase):
    ...
    @property
    def analysis_type(self) -> '_1340.BarModelAnalysisType':
        ...
        return constructor.new(_1340.BarModelAnalysisType)(value) if value else None

    @analysis_type.setter
    def analysis_type(self, value: '_1340.BarModelAnalysisType'):
    ...
    @property
    def mode_options(self) -> '_1432.EigenvalueOptions':
        ...
        return constructor.new(_1432.EigenvalueOptions)(self.wrapped.ModeOptions) if self.wrapped.ModeOptions else None
