...
from mastapy.system_model.connections_and_sockets.gears import _1856
...
class KlingelnbergSpiralBevelGearTeethSocket(_1856.KlingelnbergConicalGearTeethSocket):
    '''KlingelnbergSpiralBevelGearTeethSocket
