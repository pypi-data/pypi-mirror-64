...
class IndependentMastaCreatedCondensationNode(_0.APIBase):
    ...
    @property
    def rigid_coupling_type(self) -> '_1453.RigidCouplingType':
        ...
        return constructor.new(_1453.RigidCouplingType)(value) if value else None

    @rigid_coupling_type.setter
    def rigid_coupling_type(self, value: '_1453.RigidCouplingType'):
    ...
    @property
    def imported_fe_node(self) -> '_1924.ImportedFEStiffnessNode':
        ...
        return constructor.new(_1924.ImportedFEStiffnessNode)(self.wrapped.ImportedFENode) if self.wrapped.ImportedFENode else None
