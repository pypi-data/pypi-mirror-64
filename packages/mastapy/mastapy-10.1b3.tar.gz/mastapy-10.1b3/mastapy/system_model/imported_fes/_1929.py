...
from mastapy.nodal_analysis.dev_tools_analyses import _1441, _1432
from mastapy.nodal_analysis import _1349
...
class ImportedFEWithSelectionModalAnalysis(_1926.ImportedFEWithSelection):
    '''ImportedFEWithSelectionModalAnalysis
    ...
    @property
    def modal_draw_style(self) -> '_1441.FEModelModalAnalysisDrawStyle':
        ...
        return constructor.new(_1441.FEModelModalAnalysisDrawStyle)(self.wrapped.ModalDrawStyle) if self.wrapped.ModalDrawStyle else None

    @property
    def eigenvalue_options(self) -> '_1432.EigenvalueOptions':
        ...
        return constructor.new(_1432.EigenvalueOptions)(self.wrapped.EigenvalueOptions) if self.wrapped.EigenvalueOptions else None

    @property
    def fe_modal_frequencies(self) -> 'List[_1349.FEModalFrequencyComparison]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEModalFrequencies, constructor.new(_1349.FEModalFrequencyComparison))
        return value
