...
from mastapy.system_model.imported_fes import _1903, _1918
...
class ImportedFEElectricMachineStatorLink(_1918.ImportedFEMultiNodeLink):
    '''ImportedFEElectricMachineStatorLink
    ...
    @property
    def electric_machine_dynamic_load_data(self) -> '_1903.ElectricMachineDynamicLoadData':
        ...
        return constructor.new(_1903.ElectricMachineDynamicLoadData)(self.wrapped.ElectricMachineDynamicLoadData) if self.wrapped.ElectricMachineDynamicLoadData else None
