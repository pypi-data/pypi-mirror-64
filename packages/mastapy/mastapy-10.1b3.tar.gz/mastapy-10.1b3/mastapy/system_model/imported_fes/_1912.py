...
from mastapy.system_model.imported_fes import (
    _1893, _1925, _1949, _1887,
    _1889, _1950, _1945, _1924,
    _1885, _1909, _1911, _1931,
    _1930, _1927, _1928, _1929
)
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.part_model import _1970, _1966, _1978
from mastapy.nodal_analysis import _1348, _1351
...
from mastapy.materials import _44, _87
...
class ImportedFE(_1351.FEStiffness):
    '''ImportedFE
    ...
    @property
    def bearing_node_alignment(self) -> '_1893.BearingNodeAlignmentOption':
        ...
        return constructor.new(_1893.BearingNodeAlignmentOption)(value) if value else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_1893.BearingNodeAlignmentOption'):
    ...
    @property
    def alignment_method(self) -> '_1887.AlignmentMethod':
        ...
        return constructor.new(_1887.AlignmentMethod)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_1887.AlignmentMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def fe_meshing_options(self) -> '_1348.FEMeshingOptions':
        ...
        return constructor.new(_1348.FEMeshingOptions)(self.wrapped.FEMeshingOptions) if self.wrapped.FEMeshingOptions else None

    @property
    def cms_model(self) -> '_1472.FullFEModel':
        ...
        return constructor.new(_1472.FullFEModel)(self.wrapped.CMSModel) if self.wrapped.CMSModel else None

    @property
    def alignment_to_component(self) -> '_1786.RelativeComponentAlignment[_1966.Component]':
        ...
        return constructor.new(_1786.RelativeComponentAlignment)[_1966.Component](self.wrapped.AlignmentToComponent) if self.wrapped.AlignmentToComponent else None

    @property
    def alignment_using_axial_node_positions(self) -> '_1889.AlignmentUsingAxialNodePositions':
        ...
        return constructor.new(_1889.AlignmentUsingAxialNodePositions)(self.wrapped.AlignmentUsingAxialNodePositions) if self.wrapped.AlignmentUsingAxialNodePositions else None
    ...
    @property
    def export(self) -> '_1950.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile':
        ...
        return constructor.new(_1950.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile)(self.wrapped.Export) if self.wrapped.Export else None
    ...
    @property
    def sound_pressure_enclosure(self) -> '_87.SoundPressureEnclosure':
        ...
        return constructor.new(_87.SoundPressureEnclosure)(self.wrapped.SoundPressureEnclosure) if self.wrapped.SoundPressureEnclosure else None

    @property
    def shafts_that_can_be_replaced(self) -> 'List[_1945.ReplacedShaftSelectionHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftsThatCanBeReplaced, constructor.new(_1945.ReplacedShaftSelectionHelper))
        return value
    ...
    @property
    def replaced_shafts(self) -> 'List[_1999.Shaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReplacedShafts, constructor.new(_1999.Shaft))
        return value

    @property
    def links(self) -> 'List[_1885.ImportedFELink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1885.ImportedFELink))
        return value

    @property
    def thermal_expansion_forces(self) -> 'List[_1104.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionForces, constructor.new(_1104.VectorWithLinearAndAngularComponents))
        return value

    @property
    def thermal_expansion_displacements(self) -> 'List[_1104.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionDisplacements, constructor.new(_1104.VectorWithLinearAndAngularComponents))
        return value

    @property
    def geometries(self) -> 'List[_1909.FEStiffnessGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Geometries, constructor.new(_1909.FEStiffnessGeometry))
        return value

    @property
    def gear_meshing_options(self) -> 'List[_1911.GearMeshingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshingOptions, constructor.new(_1911.GearMeshingOptions))
        return value

    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_1931.IndependentMastaCreatedCondensationNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.IndependentMastaCreatedCondensationNodes, constructor.new(_1931.IndependentMastaCreatedCondensationNode))
        return value

    @property
    def imported_fe_component(self) -> '_1978.ImportedFEComponent':
        ...
        return constructor.new(_1978.ImportedFEComponent)(self.wrapped.ImportedFEComponent) if self.wrapped.ImportedFEComponent else None
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_6478.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def create_imported_fe_with_selection_static_analysis(self) -> '_1930.ImportedFEWithSelectionStaticAnalysis':
        ...
        return constructor.new(_1930.ImportedFEWithSelectionStaticAnalysis)(method_result) if method_result else None

    def create_imported_fe_with_selection_components(self) -> '_1927.ImportedFEWithSelectionComponents':
        ...
        return constructor.new(_1927.ImportedFEWithSelectionComponents)(method_result) if method_result else None

    def create_imported_fe_with_selection_for_harmonic_analysis(self) -> '_1928.ImportedFEWithSelectionForHarmonicAnalysis':
        ...
        return constructor.new(_1928.ImportedFEWithSelectionForHarmonicAnalysis)(method_result) if method_result else None

    def create_imported_fe_with_selection_modal_analysis(self) -> '_1929.ImportedFEWithSelectionModalAnalysis':
        ...
        return constructor.new(_1929.ImportedFEWithSelectionModalAnalysis)(method_result) if method_result else None
    ...
    def links_for(self, node: '_1924.ImportedFEStiffnessNode') -> 'List[_1885.ImportedFELink]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.LinksFor(node.wrapped if node else None), constructor.new(_1885.ImportedFELink))
