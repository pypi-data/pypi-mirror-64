...
from mastapy.system_model.imported_fes import _1941, _1940
...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    @property
    def nodes(self) -> 'List[_1941.PerNodeExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_1941.PerNodeExportOptions))
        return value

    @property
    def links(self) -> 'List[_1940.PerLinkExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1940.PerLinkExportOptions))
        return value
