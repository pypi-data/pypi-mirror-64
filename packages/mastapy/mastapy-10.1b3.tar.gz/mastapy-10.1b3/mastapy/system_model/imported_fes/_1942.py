...
from mastapy.system_model.imported_fes import _1888, _1894
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self) -> '_1888.AlignmentMethodForRaceBearing':
        ...
        return constructor.new(_1888.AlignmentMethodForRaceBearing)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_1888.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_1894.BearingRaceNodeLink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1894.BearingRaceNodeLink))
        return value
