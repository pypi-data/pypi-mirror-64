...
from mastapy.system_model.part_model.couplings import _2113, _2115
...
class SynchroniserHalf(_2115.SynchroniserPart):
    '''SynchroniserHalf
    ...
    @property
    def cones(self) -> 'List[_2113.SynchroniserCone]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2113.SynchroniserCone))
        return value
