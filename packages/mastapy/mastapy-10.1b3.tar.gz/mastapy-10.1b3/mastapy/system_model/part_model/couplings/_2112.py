...
from mastapy.system_model.part_model.couplings import _2116, _2114
...
class Synchroniser(_1994.SpecialisedAssembly):
    '''Synchroniser
    ...
    @property
    def hub_and_sleeve(self) -> '_2116.SynchroniserSleeve':
        ...
        return constructor.new(_2116.SynchroniserSleeve)(self.wrapped.HubAndSleeve) if self.wrapped.HubAndSleeve else None

    @property
    def left_cone(self) -> '_2114.SynchroniserHalf':
        ...
        return constructor.new(_2114.SynchroniserHalf)(self.wrapped.LeftCone) if self.wrapped.LeftCone else None

    @property
    def right_cone(self) -> '_2114.SynchroniserHalf':
        ...
        return constructor.new(_2114.SynchroniserHalf)(self.wrapped.RightCone) if self.wrapped.RightCone else None

    @property
    def clutch_connection_left(self) -> '_1872.ClutchConnection':
        ...
        return constructor.new(_1872.ClutchConnection)(self.wrapped.ClutchConnectionLeft) if self.wrapped.ClutchConnectionLeft else None

    @property
    def clutch_connection_right(self) -> '_1872.ClutchConnection':
        ...
        return constructor.new(_1872.ClutchConnection)(self.wrapped.ClutchConnectionRight) if self.wrapped.ClutchConnectionRight else None
