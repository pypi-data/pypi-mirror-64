...
class OilSeal(_1969.Connector):
    ...
    @property
    def oil_seal_material(self) -> '_104.OilSealMaterialType':
        ...
        return constructor.new(_104.OilSealMaterialType)(value) if value else None

    @oil_seal_material.setter
    def oil_seal_material(self, value: '_104.OilSealMaterialType'):
    ...
    @property
    def oil_seal_orientation(self) -> '_1560.Orientations':
    ...
    def oil_seal_orientation(self, value: '_1560.Orientations'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
