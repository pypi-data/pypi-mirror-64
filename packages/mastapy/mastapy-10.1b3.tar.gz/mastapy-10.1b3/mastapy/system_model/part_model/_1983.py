...
class MountableComponent(_1966.Component):
    '''MountableComponent
    ...
    def mount_on(self, shaft: '_1999.Shaft', offset: Optional['float'] = float('nan')) -> '_1811.CoaxialConnection':
        ...
        return constructor.new(_1811.CoaxialConnection)(method_result) if method_result else None
