...
class OilLevelSpecification(_0.APIBase):
    ...
    @property
    def oil_volume_specification(self) -> '_105.OilVolumeSpecification':
        ...
        return constructor.new(_105.OilVolumeSpecification)(self.wrapped.OilVolumeSpecification) if self.wrapped.OilVolumeSpecification else None
