...
class ImportedFEComponent(_1959.AbstractShaftOrHousing):
    '''ImportedFEComponent
    ...
    @property
    def default_active_imported_fe(self) -> '_1912.ImportedFE':
        ...
        return constructor.new(_1912.ImportedFE)(self.wrapped.DefaultActiveImportedFE) if self.wrapped.DefaultActiveImportedFE else None
    ...
    def add_imported_fe(self) -> '_1912.ImportedFE':
        ...
        return constructor.new(_1912.ImportedFE)(method_result) if method_result else None

    def add_imported_fe_with_name(self, name: 'str') -> '_1912.ImportedFE':
        ''' 'AddImportedFE' is the original name of this method.
    ...
    def select_imported_fe(self, imported_fe: '_1912.ImportedFE'):
    ...
    def remove_imported_fe(self, imported_fe: '_1912.ImportedFE') -> 'bool':
