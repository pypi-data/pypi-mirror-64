...
class Gear(_1983.MountableComponent):
    '''Gear
    ...
    @property
    def active_gear_design(self) -> '_702.GearDesign':
        ...
        return constructor.new(_702.GearDesign)(self.wrapped.ActiveGearDesign) if self.wrapped.ActiveGearDesign else None
    ...
    @property
    def active_gear_design_of_type_worm_design(self) -> '_711.WormDesign':
        ...
        if _711.WormDesign.TYPE not in self.wrapped.ActiveGearDesign.__class__.__mro__:
        ...
        return constructor.new(_711.WormDesign)(self.wrapped.ActiveGearDesign) if self.wrapped.ActiveGearDesign else None

    @property
    def active_gear_design_of_type_worm_gear_design(self) -> '_712.WormGearDesign':
        ...
        if _712.WormGearDesign.TYPE not in self.wrapped.ActiveGearDesign.__class__.__mro__:
        ...
        return constructor.new(_712.WormGearDesign)(self.wrapped.ActiveGearDesign) if self.wrapped.ActiveGearDesign else None

    @property
    def active_gear_design_of_type_worm_wheel_design(self) -> '_715.WormWheelDesign':
        ...
        if _715.WormWheelDesign.TYPE not in self.wrapped.ActiveGearDesign.__class__.__mro__:
        ...
        return constructor.new(_715.WormWheelDesign)(self.wrapped.ActiveGearDesign) if self.wrapped.ActiveGearDesign else None
    ...
    @property
    def active_gear_design_of_type_face_gear_design(self) -> '_744.FaceGearDesign':
        ...
        if _744.FaceGearDesign.TYPE not in self.wrapped.ActiveGearDesign.__class__.__mro__:
    ...
    @property
    def active_gear_design_of_type_face_gear_pinion_design(self) -> '_749.FaceGearPinionDesign':
        ...
        if _749.FaceGearPinionDesign.TYPE not in self.wrapped.ActiveGearDesign.__class__.__mro__:
        ...
        return constructor.new(_749.FaceGearPinionDesign)(self.wrapped.ActiveGearDesign) if self.wrapped.ActiveGearDesign else None

    @property
    def active_gear_design_of_type_face_gear_wheel_design(self) -> '_752.FaceGearWheelDesign':
        ...
        if _752.FaceGearWheelDesign.TYPE not in self.wrapped.ActiveGearDesign.__class__.__mro__:
        ...
        return constructor.new(_752.FaceGearWheelDesign)(self.wrapped.ActiveGearDesign) if self.wrapped.ActiveGearDesign else None

    @property
    def active_gear_design_of_type_cylindrical_gear_design(self) -> '_766.CylindricalGearDesign':
        ...
        if _766.CylindricalGearDesign.TYPE not in self.wrapped.ActiveGearDesign.__class__.__mro__:
    ...
    @property
    def active_gear_design_of_type_cylindrical_planet_gear_design(self) -> '_787.CylindricalPlanetGearDesign':
        ...
        if _787.CylindricalPlanetGearDesign.TYPE not in self.wrapped.ActiveGearDesign.__class__.__mro__:
        ...
        return constructor.new(_787.CylindricalPlanetGearDesign)(self.wrapped.ActiveGearDesign) if self.wrapped.ActiveGearDesign else None

    @property
    def active_gear_design_of_type_conical_gear_design(self) -> '_878.ConicalGearDesign':
        ...
        if _878.ConicalGearDesign.TYPE not in self.wrapped.ActiveGearDesign.__class__.__mro__:
    ...
    @property
    def active_gear_design_of_type_concept_gear_design(self) -> '_900.ConceptGearDesign':
        ...
        if _900.ConceptGearDesign.TYPE not in self.wrapped.ActiveGearDesign.__class__.__mro__:
    ...
    def shaft(self) -> '_1999.Shaft':
        ...
        return constructor.new(_1999.Shaft)(self.wrapped.Shaft) if self.wrapped.Shaft else None
