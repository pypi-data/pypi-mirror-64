...
class SpiralBevelGear(_2035.BevelGear):
    '''SpiralBevelGear
    ...
    @property
    def bevel_gear_design(self) -> '_724.SpiralBevelGearDesign':
    ...
    @property
    def spiral_bevel_gear_design(self) -> '_724.SpiralBevelGearDesign':
        ...
        return constructor.new(_724.SpiralBevelGearDesign)(self.wrapped.SpiralBevelGearDesign) if self.wrapped.SpiralBevelGearDesign else None
