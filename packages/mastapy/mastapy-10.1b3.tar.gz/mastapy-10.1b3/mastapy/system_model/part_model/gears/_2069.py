...
class ZerolBevelGear(_2035.BevelGear):
    '''ZerolBevelGear
    ...
    @property
    def bevel_gear_design(self) -> '_707.ZerolBevelGearDesign':
    ...
    @property
    def zerol_bevel_gear_design(self) -> '_707.ZerolBevelGearDesign':
        ...
        return constructor.new(_707.ZerolBevelGearDesign)(self.wrapped.ZerolBevelGearDesign) if self.wrapped.ZerolBevelGearDesign else None
