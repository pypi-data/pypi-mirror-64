...
class StraightBevelGear(_2035.BevelGear):
    '''StraightBevelGear
    ...
    @property
    def bevel_gear_design(self) -> '_720.StraightBevelGearDesign':
    ...
    @property
    def straight_bevel_gear_design(self) -> '_720.StraightBevelGearDesign':
        ...
        return constructor.new(_720.StraightBevelGearDesign)(self.wrapped.StraightBevelGearDesign) if self.wrapped.StraightBevelGearDesign else None
