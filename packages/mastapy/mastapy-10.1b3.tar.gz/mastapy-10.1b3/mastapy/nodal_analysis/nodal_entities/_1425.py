...
from mastapy.math_utility.stiffness_calculators import _1079
...
class SurfaceToSurfaceContactStiffnessEntity(_1403.ArbitraryNodalComponent):
    '''SurfaceToSurfaceContactStiffnessEntity
    ...
    @property
    def contact(self) -> '_1079.SurfaceToSurfaceContact':
        ...
        return constructor.new(_1079.SurfaceToSurfaceContact)(self.wrapped.Contact) if self.wrapped.Contact else None
