...
class ThrustBallBearing(_1718.BallBearing):
    '''ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self) -> '_1501.OuterRingMounting':
        ...
        return constructor.new(_1501.OuterRingMounting)(value) if value else None

    @outer_ring_mounting.setter
    def outer_ring_mounting(self, value: '_1501.OuterRingMounting'):
