...
from mastapy.bearings.bearing_designs.rolling import _1735, _1732
...
class TaperRollerBearing(_1732.NonBarrelRollerBearing):
    '''TaperRollerBearing
    ...
    @property
    def bearing_measurement_type(self) -> '_1490.BearingMeasurementType':
        ...
        return constructor.new(_1490.BearingMeasurementType)(value) if value else None

    @bearing_measurement_type.setter
    def bearing_measurement_type(self, value: '_1490.BearingMeasurementType'):
    ...
    @property
    def major_rib_detail(self) -> '_1735.RollerRibDetail':
        ...
        return constructor.new(_1735.RollerRibDetail)(self.wrapped.MajorRibDetail) if self.wrapped.MajorRibDetail else None
