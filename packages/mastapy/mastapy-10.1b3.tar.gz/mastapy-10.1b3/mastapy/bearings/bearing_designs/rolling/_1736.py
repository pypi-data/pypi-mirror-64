...
from mastapy.bearings import (
    _1504, _1506, _1483, _1484,
    _1485, _1486
)
from mastapy.bearings.bearing_designs.rolling import (
    _1745, _1729, _1727, _1724,
    _1738, _1721
)
...
class RollingBearing(_1709.DetailedBearing):
    '''RollingBearing
    ...
    @property
    def catalogue(self) -> '_1483.BearingCatalog':
        ...
        return constructor.new(_1483.BearingCatalog)(value) if value else None
    ...
    @property
    def type_information(self) -> '_1724.BearingTypeExtraInformation':
        ...
        return constructor.new(_1724.BearingTypeExtraInformation)(value) if value else None
    ...
    @property
    def cage_material(self) -> '_1486.BearingCageMaterial':
        ...
        return constructor.new(_1486.BearingCageMaterial)(value) if value else None

    @cage_material.setter
    def cage_material(self, value: '_1486.BearingCageMaterial'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CageMaterial = value

    @property
    def sleeve_type(self) -> '_1738.SleeveType':
        ...
        return constructor.new(_1738.SleeveType)(value) if value else None
    ...
    @property
    def protection(self) -> '_1721.BearingProtection':
        ...
        return constructor.new(_1721.BearingProtection)(self.wrapped.Protection) if self.wrapped.Protection else None
