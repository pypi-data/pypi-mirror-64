...
from mastapy.bearings.bearing_results.rolling import _1664
...
class LoadedElement(_0.APIBase):
    ...
    @property
    def subsurface_shear_stress_distribution_inner(self) -> 'List[_1664.StressAtPosition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SubsurfaceShearStressDistributionInner, constructor.new(_1664.StressAtPosition))
        return value

    @property
    def subsurface_shear_stress_distribution_outer(self) -> 'List[_1664.StressAtPosition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SubsurfaceShearStressDistributionOuter, constructor.new(_1664.StressAtPosition))
        return value
