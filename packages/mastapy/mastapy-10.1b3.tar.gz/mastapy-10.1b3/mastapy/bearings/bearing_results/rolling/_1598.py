...
from mastapy.bearings.bearing_results.rolling import _1662, _1613
...
class LoadedCylindricalRollerBearingResults(_1613.LoadedNonBarrelRollerBearingResults):
    '''LoadedCylindricalRollerBearingResults
    ...
    @property
    def skf_maximal_constantly_acting_axial_load(self) -> '_1662.SKFMaximalConstantlyActingAxialLoadResults':
        ...
        return constructor.new(_1662.SKFMaximalConstantlyActingAxialLoadResults)(self.wrapped.SKFMaximalConstantlyActingAxialLoad) if self.wrapped.SKFMaximalConstantlyActingAxialLoad else None
