...
from mastapy.bearings.bearing_results.rolling import _1625, _1595
...
class LoadedSelfAligningBallBearingRow(_1595.LoadedBallBearingRow):
    '''LoadedSelfAligningBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1625.LoadedSelfAligningBallBearingResults':
