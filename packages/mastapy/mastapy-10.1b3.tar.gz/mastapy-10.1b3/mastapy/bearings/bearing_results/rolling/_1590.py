...
from mastapy.bearings.bearing_results.rolling import _1589, _1587
...
class LoadedAxialThrustNeedleRollerBearingRow(_1587.LoadedAxialThrustCylindricalRollerBearingRow):
    '''LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1589.LoadedAxialThrustNeedleRollerBearingResults':
