...
from mastapy.bearings.bearing_results.rolling import _1641, _1595
...
class LoadedThreePointContactBallBearingRow(_1595.LoadedBallBearingRow):
    '''LoadedThreePointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1641.LoadedThreePointContactBallBearingResults':
