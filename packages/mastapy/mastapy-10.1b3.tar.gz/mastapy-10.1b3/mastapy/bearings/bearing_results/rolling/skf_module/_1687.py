...
from mastapy.bearings.bearing_results.rolling.skf_module import _1681, _1683
...
class Viscosities(_1683.SKFCalculationResult):
    '''Viscosities
    ...
    @property
    def operating_viscosity(self) -> '_1681.OperatingViscosity':
        ...
        return constructor.new(_1681.OperatingViscosity)(self.wrapped.OperatingViscosity) if self.wrapped.OperatingViscosity else None
