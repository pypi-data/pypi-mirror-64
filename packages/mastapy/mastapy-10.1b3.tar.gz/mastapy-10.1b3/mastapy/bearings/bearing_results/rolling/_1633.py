...
from mastapy.bearings.bearing_results.rolling import _1632, _1619
...
class LoadedSphericalRollerThrustBearingRow(_1619.LoadedRollerBearingRow):
    '''LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1632.LoadedSphericalRollerThrustBearingResults':
