...
from mastapy.bearings.bearing_results.rolling import _1610, _1599
...
class LoadedNeedleRollerBearingRow(_1599.LoadedCylindricalRollerBearingRow):
    '''LoadedNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1610.LoadedNeedleRollerBearingResults':
