...
from mastapy.bearings.bearing_results.rolling import _1586, _1614
...
class LoadedAxialThrustCylindricalRollerBearingRow(_1614.LoadedNonBarrelRollerBearingRow):
    '''LoadedAxialThrustCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1586.LoadedAxialThrustCylindricalRollerBearingResults':
