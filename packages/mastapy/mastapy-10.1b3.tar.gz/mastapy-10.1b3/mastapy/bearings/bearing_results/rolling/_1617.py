...
from mastapy.bearings.bearing_results.rolling import _1658, _1603
...
class LoadedRollerBearingElement(_1603.LoadedElement):
    '''LoadedRollerBearingElement
    ...
    @property
    def results_at_roller_offsets(self) -> 'List[_1658.ResultsAtRollerOffset]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsAtRollerOffsets, constructor.new(_1658.ResultsAtRollerOffset))
        return value
