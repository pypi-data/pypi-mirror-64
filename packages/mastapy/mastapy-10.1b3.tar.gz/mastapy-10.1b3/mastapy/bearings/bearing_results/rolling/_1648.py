...
from mastapy.bearings.bearing_results.rolling import _1647, _1619
...
class LoadedToroidalRollerBearingRow(_1619.LoadedRollerBearingRow):
    '''LoadedToroidalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1647.LoadedToroidalRollerBearingResults':
