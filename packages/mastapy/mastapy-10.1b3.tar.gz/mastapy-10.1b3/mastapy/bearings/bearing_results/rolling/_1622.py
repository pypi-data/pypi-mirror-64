...
class LoadedRollingBearingResults(_1554.LoadedDetailedBearingResults):
    '''LoadedRollingBearingResults
    ...
    @property
    def fluid_film_temperature_source(self) -> '_1496.FluidFilmTemperatureOptions':
        ...
        return constructor.new(_1496.FluidFilmTemperatureOptions)(value) if value else None
    ...
    @property
    def outer_race_fitting_at_assembly(self) -> '_1654.OuterRaceFittingThermalResults':
        ...
        return constructor.new(_1654.OuterRaceFittingThermalResults)(self.wrapped.OuterRaceFittingAtAssembly) if self.wrapped.OuterRaceFittingAtAssembly else None

    @property
    def outer_race_fitting_at_operating_conditions(self) -> '_1654.OuterRaceFittingThermalResults':
        ...
        return constructor.new(_1654.OuterRaceFittingThermalResults)(self.wrapped.OuterRaceFittingAtOperatingConditions) if self.wrapped.OuterRaceFittingAtOperatingConditions else None

    @property
    def inner_race_fitting_at_assembly(self) -> '_1569.InnerRaceFittingThermalResults':
        ...
        return constructor.new(_1569.InnerRaceFittingThermalResults)(self.wrapped.InnerRaceFittingAtAssembly) if self.wrapped.InnerRaceFittingAtAssembly else None

    @property
    def inner_race_fitting_at_operating_conditions(self) -> '_1569.InnerRaceFittingThermalResults':
        ...
        return constructor.new(_1569.InnerRaceFittingThermalResults)(self.wrapped.InnerRaceFittingAtOperatingConditions) if self.wrapped.InnerRaceFittingAtOperatingConditions else None

    @property
    def din732(self) -> '_1567.DIN732Results':
        ...
        return constructor.new(_1567.DIN732Results)(self.wrapped.DIN732) if self.wrapped.DIN732 else None

    @property
    def iso2812007(self) -> '_1690.ISO2812007Results':
        ...
        return constructor.new(_1690.ISO2812007Results)(self.wrapped.ISO2812007) if self.wrapped.ISO2812007 else None

    @property
    def iso2812007_of_type_ball_iso2812007_results(self) -> '_1688.BallISO2812007Results':
        ...
        if _1688.BallISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
        ...
        return constructor.new(_1688.BallISO2812007Results)(self.wrapped.ISO2812007) if self.wrapped.ISO2812007 else None

    @property
    def iso2812007_of_type_roller_iso2812007_results(self) -> '_1694.RollerISO2812007Results':
        ...
        if _1694.RollerISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
        ...
        return constructor.new(_1694.RollerISO2812007Results)(self.wrapped.ISO2812007) if self.wrapped.ISO2812007 else None

    @property
    def isots162812008(self) -> '_1693.ISOTS162812008Results':
        ...
        return constructor.new(_1693.ISOTS162812008Results)(self.wrapped.ISOTS162812008) if self.wrapped.ISOTS162812008 else None

    @property
    def isots162812008_of_type_ball_isots162812008_results(self) -> '_1689.BallISOTS162812008Results':
        ...
        if _1689.BallISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
        ...
        return constructor.new(_1689.BallISOTS162812008Results)(self.wrapped.ISOTS162812008) if self.wrapped.ISOTS162812008 else None

    @property
    def isots162812008_of_type_roller_isots162812008_results(self) -> '_1695.RollerISOTS162812008Results':
        ...
        if _1695.RollerISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
        ...
        return constructor.new(_1695.RollerISOTS162812008Results)(self.wrapped.ISOTS162812008) if self.wrapped.ISOTS162812008 else None

    @property
    def iso762006(self) -> '_1691.ISO762006Results':
        ...
        return constructor.new(_1691.ISO762006Results)(self.wrapped.ISO762006) if self.wrapped.ISO762006 else None

    @property
    def maximum_static_contact_stress(self) -> '_1650.MaximumStaticContactStress':
        ...
        return constructor.new(_1650.MaximumStaticContactStress)(self.wrapped.MaximumStaticContactStress) if self.wrapped.MaximumStaticContactStress else None

    @property
    def skf_module_results(self) -> '_1685.SKFModuleResults':
        ...
        return constructor.new(_1685.SKFModuleResults)(self.wrapped.SKFModuleResults) if self.wrapped.SKFModuleResults else None

    @property
    def rows(self) -> 'List[_1623.LoadedRollingBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Rows, constructor.new(_1623.LoadedRollingBearingRow))
        return value

    @property
    def all_mounting_results(self) -> 'List[_1657.RaceFittingThermalResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllMountingResults, constructor.new(_1657.RaceFittingThermalResults))
        return value
