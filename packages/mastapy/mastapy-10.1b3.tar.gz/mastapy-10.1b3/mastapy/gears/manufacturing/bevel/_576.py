...
from mastapy.gears.manufacturing.bevel import _575, _589
...
class ManufacturingMachine(_1322.NamedDatabaseItem):
    '''ManufacturingMachine
    ...
    @property
    def machine_type(self) -> '_575.MachineTypes':
        '''MachineTypes: 'MachineType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.MachineType)
        return constructor.new(_575.MachineTypes)(value) if value else None

    @machine_type.setter
    def machine_type(self, value: '_575.MachineTypes'):
    ...
    @property
    def wheel_formate_machine_type(self) -> '_589.WheelFormatMachineTypes':
        ...
        return constructor.new(_589.WheelFormatMachineTypes)(value) if value else None

    @wheel_formate_machine_type.setter
    def wheel_formate_machine_type(self, value: '_589.WheelFormatMachineTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
