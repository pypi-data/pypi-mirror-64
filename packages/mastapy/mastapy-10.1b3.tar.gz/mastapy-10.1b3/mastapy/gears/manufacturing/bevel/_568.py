...
from mastapy.gears.gear_designs.conical import _882, _881
from mastapy._internal import conversion, enum_with_selected_value_runtime, constructor
from mastapy.gears.manufacturing.bevel import _553, _562, _570
...
class ConicalSetManufacturingConfig(_570.ConicalSetMicroGeometryConfigBase):
    '''ConicalSetManufacturingConfig
    ...
    @property
    def gear_manufacturing_configurations(self) -> 'List[_553.ConicalGearManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearManufacturingConfigurations, constructor.new(_553.ConicalGearManufacturingConfig))
        return value

    @property
    def meshes(self) -> 'List[_562.ConicalMeshManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_562.ConicalMeshManufacturingConfig))
        return value
