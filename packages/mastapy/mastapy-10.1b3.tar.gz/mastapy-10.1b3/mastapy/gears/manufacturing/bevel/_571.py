...
from mastapy.gears.manufacturing.bevel.cutters import _593, _592
from mastapy.gears.manufacturing.bevel.basic_machine_settings import (
    _601, _598, _599, _600
)
from mastapy._internal.cast_exception import CastException
from mastapy.gears.manufacturing.bevel import _553
...
class ConicalWheelManufacturingConfig(_553.ConicalGearManufacturingConfig):
    '''ConicalWheelManufacturingConfig
    ...
    @property
    def wheel_rough_cutter(self) -> '_593.WheelRoughCutter':
        ...
        return constructor.new(_593.WheelRoughCutter)(self.wrapped.WheelRoughCutter) if self.wrapped.WheelRoughCutter else None

    @property
    def wheel_finish_cutter(self) -> '_592.WheelFinishCutter':
        ...
        return constructor.new(_592.WheelFinishCutter)(self.wrapped.WheelFinishCutter) if self.wrapped.WheelFinishCutter else None
    ...
    @property
    def specified_machine_settings(self) -> '_598.BasicConicalGearMachineSettings':
        ...
        return constructor.new(_598.BasicConicalGearMachineSettings)(self.wrapped.SpecifiedMachineSettings) if self.wrapped.SpecifiedMachineSettings else None

    @property
    def specified_machine_settings_of_type_basic_conical_gear_machine_settings_formate(self) -> '_599.BasicConicalGearMachineSettingsFormate':
        ...
        if _599.BasicConicalGearMachineSettingsFormate.TYPE not in self.wrapped.SpecifiedMachineSettings.__class__.__mro__:
        ...
        return constructor.new(_599.BasicConicalGearMachineSettingsFormate)(self.wrapped.SpecifiedMachineSettings) if self.wrapped.SpecifiedMachineSettings else None

    @property
    def specified_machine_settings_of_type_basic_conical_gear_machine_settings_generated(self) -> '_600.BasicConicalGearMachineSettingsGenerated':
        ...
        if _600.BasicConicalGearMachineSettingsGenerated.TYPE not in self.wrapped.SpecifiedMachineSettings.__class__.__mro__:
        ...
        return constructor.new(_600.BasicConicalGearMachineSettingsGenerated)(self.wrapped.SpecifiedMachineSettings) if self.wrapped.SpecifiedMachineSettings else None
