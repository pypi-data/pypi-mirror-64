...
from mastapy.gears.manufacturing.cylindrical import _411, _415
...
class MicroGeometryInputsProfile(_411.MicroGeometryInputs['_415.ProfileModificationSegment']):
    '''MicroGeometryInputsProfile
