...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _431
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _472
...
class WormGrindingCutterCalculation(_472.WormGrindingProcessCalculation):
    '''WormGrindingCutterCalculation
    ...
    @property
    def input_gear_point_of_interest(self) -> '_431.PointOfInterest':
        ...
        return constructor.new(_431.PointOfInterest)(self.wrapped.InputGearPointOfInterest) if self.wrapped.InputGearPointOfInterest else None
