...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _440, _444
...
class HobbingProcessProfileCalculation(_444.HobbingProcessCalculation):
    '''HobbingProcessProfileCalculation
