...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _438, _444
...
class HobbingProcessLeadCalculation(_444.HobbingProcessCalculation):
    '''HobbingProcessLeadCalculation
