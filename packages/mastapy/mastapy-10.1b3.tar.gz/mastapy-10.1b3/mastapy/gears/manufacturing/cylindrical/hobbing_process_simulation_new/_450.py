...
class HobbingProcessSimulationInput(_463.ProcessSimulationInput):
    '''HobbingProcessSimulationInput
    ...
    @property
    def hob_manufacture_error(self) -> '_454.HobManufactureError':
        ...
        return constructor.new(_454.HobManufactureError)(self.wrapped.HobManufactureError) if self.wrapped.HobManufactureError else None

    @property
    def hob_resharpening_error(self) -> '_455.HobResharpeningError':
        ...
        return constructor.new(_455.HobResharpeningError)(self.wrapped.HobResharpeningError) if self.wrapped.HobResharpeningError else None
