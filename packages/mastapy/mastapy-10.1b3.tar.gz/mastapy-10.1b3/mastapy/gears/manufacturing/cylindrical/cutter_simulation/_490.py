...
class HobSimulationCalculator(_492.RackSimulationCalculator):
    '''HobSimulationCalculator
    ...
    @property
    def hob(self) -> '_520.CylindricalGearHobShape':
        ...
        return constructor.new(_520.CylindricalGearHobShape)(self.wrapped.Hob) if self.wrapped.Hob else None
