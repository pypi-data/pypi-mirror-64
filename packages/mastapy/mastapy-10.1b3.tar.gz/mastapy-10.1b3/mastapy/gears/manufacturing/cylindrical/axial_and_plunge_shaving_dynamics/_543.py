...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _539, _538, _542
...
class ShavingDynamicsCalculation(_0.APIBase, Generic[T]):
    ...
    @property
    def accuracy_level_iso6(self) -> '_539.RollAngleRangeRelativeToAccuracy':
        ...
        return constructor.new(_539.RollAngleRangeRelativeToAccuracy)(self.wrapped.AccuracyLevelISO6) if self.wrapped.AccuracyLevelISO6 else None

    @property
    def accuracy_level_iso7(self) -> '_539.RollAngleRangeRelativeToAccuracy':
        ...
        return constructor.new(_539.RollAngleRangeRelativeToAccuracy)(self.wrapped.AccuracyLevelISO7) if self.wrapped.AccuracyLevelISO7 else None

    @property
    def designed_gear(self) -> '_482.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_482.CylindricalCutterSimulatableGear)(self.wrapped.DesignedGear) if self.wrapped.DesignedGear else None

    @property
    def shaver(self) -> '_510.CylindricalGearShaver':
        ...
        return constructor.new(_510.CylindricalGearShaver)(self.wrapped.Shaver) if self.wrapped.Shaver else None

    @property
    def life_shaver(self) -> '_510.CylindricalGearShaver':
        ...
        return constructor.new(_510.CylindricalGearShaver)(self.wrapped.LifeShaver) if self.wrapped.LifeShaver else None

    @property
    def new_cutter_start_of_shaving(self) -> '_774.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_774.CylindricalGearProfileMeasurement)(self.wrapped.NewCutterStartOfShaving) if self.wrapped.NewCutterStartOfShaving else None

    @property
    def life_cutter_start_of_shaving(self) -> '_774.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_774.CylindricalGearProfileMeasurement)(self.wrapped.LifeCutterStartOfShaving) if self.wrapped.LifeCutterStartOfShaving else None
