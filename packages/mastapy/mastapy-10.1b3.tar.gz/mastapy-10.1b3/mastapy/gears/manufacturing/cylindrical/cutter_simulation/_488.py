...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _481
...
class FormWheelGrindingSimulationCalculator(_481.CutterSimulationCalc):
    '''FormWheelGrindingSimulationCalculator
    ...
    @property
    def profiled_grinding_wheel(self) -> '_519.CylindricalGearFormedWheelGrinderTangible':
        ...
        return constructor.new(_519.CylindricalGearFormedWheelGrinderTangible)(self.wrapped.ProfiledGrindingWheel) if self.wrapped.ProfiledGrindingWheel else None
