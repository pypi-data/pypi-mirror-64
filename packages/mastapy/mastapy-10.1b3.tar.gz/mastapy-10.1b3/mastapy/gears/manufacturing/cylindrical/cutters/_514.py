...
from mastapy.gears.manufacturing.cylindrical import _388
from mastapy.gears.manufacturing.cylindrical.cutters import _498
...
class MutatableCommon(_498.CurveInLinkedList):
    '''MutatableCommon
