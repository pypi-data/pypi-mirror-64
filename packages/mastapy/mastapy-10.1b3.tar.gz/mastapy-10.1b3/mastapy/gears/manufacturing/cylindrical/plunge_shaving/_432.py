...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _423, _429
...
class RealPlungeShaverOutputs(_429.PlungeShaverOutputs):
    '''RealPlungeShaverOutputs
    ...
    @property
    def left_flank_micro_geometry(self) -> '_391.CylindricalGearSpecifiedMicroGeometry':
        ...
        return constructor.new(_391.CylindricalGearSpecifiedMicroGeometry)(self.wrapped.LeftFlankMicroGeometry) if self.wrapped.LeftFlankMicroGeometry else None

    @property
    def right_flank_micro_geometry(self) -> '_391.CylindricalGearSpecifiedMicroGeometry':
        ...
        return constructor.new(_391.CylindricalGearSpecifiedMicroGeometry)(self.wrapped.RightFlankMicroGeometry) if self.wrapped.RightFlankMicroGeometry else None

    @property
    def shaver(self) -> '_505.CylindricalGearPlungeShaver':
        ...
        return constructor.new(_505.CylindricalGearPlungeShaver)(self.wrapped.Shaver) if self.wrapped.Shaver else None

    @property
    def micro_geometry(self) -> 'List[_391.CylindricalGearSpecifiedMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MicroGeometry, constructor.new(_391.CylindricalGearSpecifiedMicroGeometry))
        return value
