...
class CylindricalManufacturedGearSetDutyCycle(_951.GearSetImplementationAnalysisDutyCycle):
    '''CylindricalManufacturedGearSetDutyCycle
    ...
    @property
    def manufacturing_configuration(self) -> '_403.CylindricalSetManufacturingConfig':
        ...
        return constructor.new(_403.CylindricalSetManufacturingConfig)(self.wrapped.ManufacturingConfiguration) if self.wrapped.ManufacturingConfiguration else None
