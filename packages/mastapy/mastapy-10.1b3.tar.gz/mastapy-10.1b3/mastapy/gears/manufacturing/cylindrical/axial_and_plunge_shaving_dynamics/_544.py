...
class ShavingDynamicsCalculationForDesignedGears(_543.ShavingDynamicsCalculation['T'], Generic[T]):
    '''ShavingDynamicsCalculationForDesignedGears
    ...
    @property
    def start_of_shaving_profile(self) -> '_774.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_774.CylindricalGearProfileMeasurement)(self.wrapped.StartOfShavingProfile.Value) if self.wrapped.StartOfShavingProfile.Value else None

    @property
    def end_of_shaving_profile(self) -> '_774.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_774.CylindricalGearProfileMeasurement)(self.wrapped.EndOfShavingProfile.Value) if self.wrapped.EndOfShavingProfile.Value else None

    @property
    def redressing(self) -> '_541.ShaverRedressing[T]':
        ...
        return constructor.new(_541.ShaverRedressing)[T](self.wrapped.Redressing) if self.wrapped.Redressing else None

    @property
    def redressing_of_type_axial_shaver_redressing(self) -> '_527.AxialShaverRedressing':
        ...
        if _527.AxialShaverRedressing.TYPE not in self.wrapped.Redressing.__class__.__mro__:
        ...
        return constructor.new(_527.AxialShaverRedressing)(self.wrapped.Redressing) if self.wrapped.Redressing else None

    @property
    def redressing_of_type_plunge_shaver_redressing(self) -> '_534.PlungeShaverRedressing':
        ...
        if _534.PlungeShaverRedressing.TYPE not in self.wrapped.Redressing.__class__.__mro__:
        ...
        return constructor.new(_534.PlungeShaverRedressing)(self.wrapped.Redressing) if self.wrapped.Redressing else None
