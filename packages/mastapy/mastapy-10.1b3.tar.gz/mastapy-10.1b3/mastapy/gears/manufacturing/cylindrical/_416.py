...
class SuitableCutterSetup(_0.APIBase):
    ...
    @property
    def tool_clearances(self) -> '_491.ManufacturingOperationConstraints':
        ...
        return constructor.new(_491.ManufacturingOperationConstraints)(self.wrapped.ToolClearances) if self.wrapped.ToolClearances else None
