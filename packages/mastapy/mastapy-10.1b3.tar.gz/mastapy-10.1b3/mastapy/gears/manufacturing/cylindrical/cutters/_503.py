...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _523, _525, _520
...
class CylindricalGearGrindingWorm(_507.CylindricalGearRackDesign):
    '''CylindricalGearGrindingWorm
    ...
    @property
    def nominal_worm_grinder_shape(self) -> '_523.CylindricalGearWormGrinderShape':
        ...
        return constructor.new(_523.CylindricalGearWormGrinderShape)(self.wrapped.NominalWormGrinderShape) if self.wrapped.NominalWormGrinderShape else None
