...
from mastapy.materials import _85, _76
...
class GearMaterial(_76.Material):
    ...
    @property
    def sn_curve_contact(self) -> '_85.SNCurve':
        ...
        return constructor.new(_85.SNCurve)(self.wrapped.SNCurveContact) if self.wrapped.SNCurveContact else None

    @property
    def sn_curve_bending(self) -> '_85.SNCurve':
        ...
        return constructor.new(_85.SNCurve)(self.wrapped.SNCurveBending) if self.wrapped.SNCurveBending else None
