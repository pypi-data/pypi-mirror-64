...
from mastapy.gears.materials import _387, _374
...
class BevelGearMaterial(_374.GearMaterial):
    '''BevelGearMaterial
    ...
    @property
    def sn_curve_definition(self) -> '_387.SNCurveDefinition':
        ...
        return constructor.new(_387.SNCurveDefinition)(value) if value else None

    @sn_curve_definition.setter
    def sn_curve_definition(self, value: '_387.SNCurveDefinition'):
