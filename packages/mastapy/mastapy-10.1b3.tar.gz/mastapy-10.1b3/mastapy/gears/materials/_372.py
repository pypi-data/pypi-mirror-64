...
from mastapy.gears.materials import _381, _374
...
class CylindricalGearMaterial(_374.GearMaterial):
    '''CylindricalGearMaterial
    ...
    @property
    def heat_treatment_process_development(self) -> '_381.ManufactureRating':
        ...
        return constructor.new(_381.ManufactureRating)(value) if value else None

    @heat_treatment_process_development.setter
    def heat_treatment_process_development(self, value: '_381.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HeatTreatmentProcessDevelopment = value

    @property
    def heat_treatment_distortion_control(self) -> '_381.ManufactureRating':
    ...
    def heat_treatment_distortion_control(self, value: '_381.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HeatTreatmentDistortionControl = value

    @property
    def machine_process_development(self) -> '_381.ManufactureRating':
    ...
    def machine_process_development(self, value: '_381.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MachineProcessDevelopment = value

    @property
    def manufacturability(self) -> '_381.ManufactureRating':
    ...
    def manufacturability(self, value: '_381.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
