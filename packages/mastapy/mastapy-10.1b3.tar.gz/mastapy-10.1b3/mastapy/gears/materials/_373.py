...
class CylindricalGearPlasticMaterialDatabase(_0.APIBase):
    '''CylindricalGearPlasticMaterialDatabase
    ...
    @property
    def item(self) -> '_382.PlasticCylindricalGearMaterial':
        ...
        return constructor.new(_382.PlasticCylindricalGearMaterial)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_382.PlasticCylindricalGearMaterial':
        ...
        return constructor.new(_382.PlasticCylindricalGearMaterial)(method_result) if method_result else None

    def can_be_removed(self, plastic_cylindrical_gear_material: '_382.PlasticCylindricalGearMaterial') -> 'bool':
    ...
    def rename(self, plastic_cylindrical_gear_material: '_382.PlasticCylindricalGearMaterial', new_name: 'str') -> 'bool':
    ...
    def remove(self, plastic_cylindrical_gear_material: '_382.PlasticCylindricalGearMaterial'):
    ...
    def get_all_items(self) -> 'Iterable[_382.PlasticCylindricalGearMaterial]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_382.PlasticCylindricalGearMaterial))

    def save_changes(self, plastic_cylindrical_gear_material: '_382.PlasticCylindricalGearMaterial'):
