...
class ISOTR1417912001CoefficientOfFrictionConstantsDatabase(_0.APIBase):
    '''ISOTR1417912001CoefficientOfFrictionConstantsDatabase
    ...
    @property
    def item(self) -> '_377.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_377.ISOTR1417912001CoefficientOfFrictionConstants)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_377.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_377.ISOTR1417912001CoefficientOfFrictionConstants)(method_result) if method_result else None

    def can_be_removed(self, isotr1417912001_coefficient_of_friction_constants: '_377.ISOTR1417912001CoefficientOfFrictionConstants') -> 'bool':
    ...
    def rename(self, isotr1417912001_coefficient_of_friction_constants: '_377.ISOTR1417912001CoefficientOfFrictionConstants', new_name: 'str') -> 'bool':
    ...
    def remove(self, isotr1417912001_coefficient_of_friction_constants: '_377.ISOTR1417912001CoefficientOfFrictionConstants'):
    ...
    def get_all_items(self) -> 'Iterable[_377.ISOTR1417912001CoefficientOfFrictionConstants]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_377.ISOTR1417912001CoefficientOfFrictionConstants))

    def save_changes(self, isotr1417912001_coefficient_of_friction_constants: '_377.ISOTR1417912001CoefficientOfFrictionConstants'):
