...
class BevelGearIsoMaterialDatabase(_0.APIBase):
    '''BevelGearIsoMaterialDatabase
    ...
    @property
    def item(self) -> '_366.BevelGearISOMaterial':
        ...
        return constructor.new(_366.BevelGearISOMaterial)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_366.BevelGearISOMaterial':
        ...
        return constructor.new(_366.BevelGearISOMaterial)(method_result) if method_result else None

    def can_be_removed(self, bevel_gear_iso_material: '_366.BevelGearISOMaterial') -> 'bool':
    ...
    def rename(self, bevel_gear_iso_material: '_366.BevelGearISOMaterial', new_name: 'str') -> 'bool':
    ...
    def remove(self, bevel_gear_iso_material: '_366.BevelGearISOMaterial'):
    ...
    def get_all_items(self) -> 'Iterable[_366.BevelGearISOMaterial]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_366.BevelGearISOMaterial))

    def save_changes(self, bevel_gear_iso_material: '_366.BevelGearISOMaterial'):
