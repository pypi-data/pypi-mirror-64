...
class BevelGearISOMaterial(_368.BevelGearMaterial):
    '''BevelGearISOMaterial
    ...
    @property
    def quality_grade(self) -> '_82.QualityGrade':
        '''QualityGrade: 'QualityGrade' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.QualityGrade)
        return constructor.new(_82.QualityGrade)(value) if value else None

    @quality_grade.setter
    def quality_grade(self, value: '_82.QualityGrade'):
