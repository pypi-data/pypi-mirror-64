...
class BevelHypoidGearRatingSettings(_1125.PerMachineSettings):
    '''BevelHypoidGearRatingSettings
    ...
    @property
    def bevel_gear_rating_method(self) -> '_384.RatingMethods':
        ...
        return constructor.new(_384.RatingMethods)(value) if value else None

    @bevel_gear_rating_method.setter
    def bevel_gear_rating_method(self, value: '_384.RatingMethods'):
