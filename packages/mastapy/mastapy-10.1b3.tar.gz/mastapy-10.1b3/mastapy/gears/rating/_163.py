...
class GearRating(_156.AbstractGearRating):
    ...
    @property
    def bending_safety_factor_results(self) -> '_84.SafetyFactorItem':
        ...
        return constructor.new(_84.SafetyFactorItem)(self.wrapped.BendingSafetyFactorResults) if self.wrapped.BendingSafetyFactorResults else None

    @property
    def contact_safety_factor_results(self) -> '_84.SafetyFactorItem':
        ...
        return constructor.new(_84.SafetyFactorItem)(self.wrapped.ContactSafetyFactorResults) if self.wrapped.ContactSafetyFactorResults else None
