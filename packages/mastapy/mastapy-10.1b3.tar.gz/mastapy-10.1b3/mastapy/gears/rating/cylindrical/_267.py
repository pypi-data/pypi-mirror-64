...
from mastapy.gears.gear_designs.cylindrical import _811, _810
...
class CylindricalMeshSingleFlankRating(_168.MeshSingleFlankRating):
    ...
    @property
    def coefficient_of_friction_method_flash_temperature_method(self) -> '_811.ScuffingCoefficientOfFrictionMethods':
        ...
        return constructor.new(_811.ScuffingCoefficientOfFrictionMethods)(value) if value else None
