...
class FaceGearMeshRating(_162.GearMeshRating):
    ...
    @property
    def mesh_load_case(self) -> '_647.FaceMeshLoadCase':
    ...
    @property
    def face_gear_mesh(self) -> '_746.FaceGearMeshDesign':
        ...
        return constructor.new(_746.FaceGearMeshDesign)(self.wrapped.FaceGearMesh) if self.wrapped.FaceGearMesh else None
