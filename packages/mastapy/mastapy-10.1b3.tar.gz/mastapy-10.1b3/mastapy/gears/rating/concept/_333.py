...
class ConceptGearMeshRating(_162.GearMeshRating):
    ...
    @property
    def concept_gear_mesh(self) -> '_901.ConceptGearMeshDesign':
        ...
        return constructor.new(_901.ConceptGearMeshDesign)(self.wrapped.ConceptGearMesh) if self.wrapped.ConceptGearMesh else None
