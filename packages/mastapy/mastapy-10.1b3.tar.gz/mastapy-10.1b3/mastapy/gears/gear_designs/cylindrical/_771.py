...
from mastapy.gears.gear_designs.cylindrical import _775, _804
...
class CylindricalGearDesignSettings(_1125.PerMachineSettings):
    '''CylindricalGearDesignSettings
    ...
    @property
    def cylindrical_gear_profile_measurement(self) -> '_775.CylindricalGearProfileMeasurementType':
    ...
    def cylindrical_gear_profile_measurement(self, value: '_775.CylindricalGearProfileMeasurementType'):
    ...
    @property
    def tolerance_rounding_system(self) -> '_1138.MeasurementSystem':
        ...
        return constructor.new(_1138.MeasurementSystem)(value) if value else None

    @tolerance_rounding_system.setter
    def tolerance_rounding_system(self, value: '_1138.MeasurementSystem'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def micro_geometry_lead_relief_definition(self) -> '_804.MicroGeometryConvention':
        ...
        return constructor.new(_804.MicroGeometryConvention)(value) if value else None

    @micro_geometry_lead_relief_definition.setter
    def micro_geometry_lead_relief_definition(self, value: '_804.MicroGeometryConvention'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
