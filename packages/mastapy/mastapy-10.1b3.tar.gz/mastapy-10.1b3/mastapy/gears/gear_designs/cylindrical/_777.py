...
from mastapy.materials.efficiency import _98
...
class CylindricalGearSetDesign(_705.GearSetDesign):
    '''CylindricalGearSetDesign
    ...
    @property
    def profile_shift_distribution_rule(self) -> '_753.AddendumModificationDistributionRule':
        ...
        return constructor.new(_753.AddendumModificationDistributionRule)(value) if value else None

    @profile_shift_distribution_rule.setter
    def profile_shift_distribution_rule(self, value: '_753.AddendumModificationDistributionRule'):
    ...
    @property
    def efficiency_rating_method(self) -> '_98.EfficiencyRatingMethod':
        ...
        return constructor.new(_98.EfficiencyRatingMethod)(value) if value else None

    @efficiency_rating_method.setter
    def efficiency_rating_method(self, value: '_98.EfficiencyRatingMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def gear_fit_system(self) -> '_792.GearFitSystems':
        ...
        return constructor.new(_792.GearFitSystems)(value) if value else None

    @gear_fit_system.setter
    def gear_fit_system(self, value: '_792.GearFitSystems'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def scuffing(self) -> '_810.Scuffing':
        ...
        return constructor.new(_810.Scuffing)(self.wrapped.Scuffing) if self.wrapped.Scuffing else None

    @property
    def micropitting(self) -> '_805.Micropitting':
        ...
        return constructor.new(_805.Micropitting)(self.wrapped.Micropitting) if self.wrapped.Micropitting else None

    @property
    def usage(self) -> '_826.Usage':
        ...
        return constructor.new(_826.Usage)(self.wrapped.Usage) if self.wrapped.Usage else None

    @property
    def ltca_settings(self) -> '_803.LtcaSettings':
        ...
        return constructor.new(_803.LtcaSettings)(self.wrapped.LTCASettings) if self.wrapped.LTCASettings else None

    @property
    def cylindrical_gear_set_manufacturing_configuration(self) -> '_403.CylindricalSetManufacturingConfig':
        ...
        return constructor.new(_403.CylindricalSetManufacturingConfig)(self.wrapped.CylindricalGearSetManufacturingConfiguration) if self.wrapped.CylindricalGearSetManufacturingConfiguration else None

    @property
    def gears(self) -> 'List[_766.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_766.CylindricalGearDesign))
        return value

    @property
    def cylindrical_gears(self) -> 'List[_766.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_766.CylindricalGearDesign))
        return value
    ...
    def create_optimiser(self, duty_cycle: '_263.CylindricalGearSetDutyCycleRating') -> '_778.CylindricalGearSetMacroGeometryOptimiser':
        ...
        return constructor.new(_778.CylindricalGearSetMacroGeometryOptimiser)(method_result) if method_result else None
