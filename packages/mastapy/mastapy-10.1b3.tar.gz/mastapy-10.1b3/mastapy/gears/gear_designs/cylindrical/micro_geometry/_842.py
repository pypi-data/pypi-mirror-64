...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _835
...
class CylindricalGearSetMicroGeometryDutyCycle(_951.GearSetImplementationAnalysisDutyCycle):
    '''CylindricalGearSetMicroGeometryDutyCycle
    ...
    @property
    def meshes(self) -> 'List[_835.CylindricalGearMeshMicroGeometryDutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_835.CylindricalGearMeshMicroGeometryDutyCycle))
        return value
