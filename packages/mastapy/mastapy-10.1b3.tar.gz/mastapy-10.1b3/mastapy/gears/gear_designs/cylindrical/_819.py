...
from mastapy.gears.gear_designs.cylindrical import _757
...
class TiffAnalysisSettings(_1120.IndependentReportablePropertiesBase['TiffAnalysisSettings']):
    '''TiffAnalysisSettings
    ...
    @property
    def case_hardening_properties_for_fe_analysis(self) -> '_757.CaseHardeningPropertiesForFEAnalysis':
        ...
        return constructor.new(_757.CaseHardeningPropertiesForFEAnalysis)(self.wrapped.CaseHardeningPropertiesForFEAnalysis) if self.wrapped.CaseHardeningPropertiesForFEAnalysis else None
