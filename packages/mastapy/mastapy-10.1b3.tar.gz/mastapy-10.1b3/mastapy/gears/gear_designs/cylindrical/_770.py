...
class CylindricalGearDesignConstraintSettings(_1125.PerMachineSettings):
    '''CylindricalGearDesignConstraintSettings
    ...
    @property
    def cylindrical_gear_design_constraints(self) -> '_768.CylindricalGearDesignConstraints':
        ...
        return constructor.new(_768.CylindricalGearDesignConstraints)(self.wrapped.CylindricalGearDesignConstraints) if self.wrapped.CylindricalGearDesignConstraints else None
