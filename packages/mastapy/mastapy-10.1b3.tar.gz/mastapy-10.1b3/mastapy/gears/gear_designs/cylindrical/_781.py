...
class CylindricalGearTableWithMGCharts(_1286.CustomTable):
    '''CylindricalGearTableWithMGCharts
    ...
    @property
    def item_detail(self) -> '_780.CylindricalGearTableMGItemDetail':
        ...
        return constructor.new(_780.CylindricalGearTableMGItemDetail)(value) if value else None

    @item_detail.setter
    def item_detail(self, value: '_780.CylindricalGearTableMGItemDetail'):
