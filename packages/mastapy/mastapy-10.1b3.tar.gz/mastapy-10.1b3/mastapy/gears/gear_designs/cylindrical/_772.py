...
class CylindricalGearMeshDesign(_704.GearMeshDesign):
    '''CylindricalGearMeshDesign
    ...
    @property
    def profile_modification(self) -> '_776.CylindricalGearProfileModifications':
        ...
        return constructor.new(_776.CylindricalGearProfileModifications)(value) if value else None

    @profile_modification.setter
    def profile_modification(self, value: '_776.CylindricalGearProfileModifications'):
    ...
    @property
    def type_of_mechanism_housing(self) -> '_825.TypeOfMechanismHousing':
        ...
        return constructor.new(_825.TypeOfMechanismHousing)(value) if value else None

    @type_of_mechanism_housing.setter
    def type_of_mechanism_housing(self, value: '_825.TypeOfMechanismHousing'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def backlash_specification(self) -> '_754.BacklashSpecification':
        ...
        return constructor.new(_754.BacklashSpecification)(self.wrapped.BacklashSpecification) if self.wrapped.BacklashSpecification else None

    @property
    def valid_normal_module_range(self) -> '_1105.ShortLengthRange':
        ...
        return constructor.new(_1105.ShortLengthRange)(self.wrapped.ValidNormalModuleRange) if self.wrapped.ValidNormalModuleRange else None
    ...
    @property
    def cylindrical_meshed_gear(self) -> 'List[_784.CylindricalMeshedGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshedGear, constructor.new(_784.CylindricalMeshedGear))
        return value

    @property
    def gear_a(self) -> '_766.CylindricalGearDesign':
    ...
    @property
    def gear_b(self) -> '_766.CylindricalGearDesign':
