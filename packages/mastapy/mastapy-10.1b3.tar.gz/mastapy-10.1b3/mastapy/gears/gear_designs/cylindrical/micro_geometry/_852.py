...
class MicroGeometryViewingOptions(_0.APIBase):
    ...
    @property
    def gear_option(self) -> '_843.DrawDefiningGearOrBoth':
        ...
        return constructor.new(_843.DrawDefiningGearOrBoth)(value) if value else None

    @gear_option.setter
    def gear_option(self, value: '_843.DrawDefiningGearOrBoth'):
