...
class CylindricalGearCuttingOptions(_0.APIBase):
    ...
    @property
    def cylindrical_gear_cutter(self) -> '_762.CylindricalGearAbstractRack':
        ...
        return constructor.new(_762.CylindricalGearAbstractRack)(self.wrapped.CylindricalGearCutter) if self.wrapped.CylindricalGearCutter else None

    @property
    def cylindrical_gear_cutter_of_type_cylindrical_gear_basic_rack(self) -> '_763.CylindricalGearBasicRack':
        ...
        if _763.CylindricalGearBasicRack.TYPE not in self.wrapped.CylindricalGearCutter.__class__.__mro__:
        ...
        return constructor.new(_763.CylindricalGearBasicRack)(self.wrapped.CylindricalGearCutter) if self.wrapped.CylindricalGearCutter else None

    @property
    def cylindrical_gear_cutter_of_type_cylindrical_gear_pinion_type_cutter(self) -> '_773.CylindricalGearPinionTypeCutter':
        ...
        if _773.CylindricalGearPinionTypeCutter.TYPE not in self.wrapped.CylindricalGearCutter.__class__.__mro__:
        ...
        return constructor.new(_773.CylindricalGearPinionTypeCutter)(self.wrapped.CylindricalGearCutter) if self.wrapped.CylindricalGearCutter else None

    @property
    def cylindrical_gear_cutter_of_type_standard_rack(self) -> '_816.StandardRack':
        ...
        if _816.StandardRack.TYPE not in self.wrapped.CylindricalGearCutter.__class__.__mro__:
        ...
        return constructor.new(_816.StandardRack)(self.wrapped.CylindricalGearCutter) if self.wrapped.CylindricalGearCutter else None
    ...
    @property
    def manufacturing_configuration(self) -> '_390.CylindricalGearManufacturingConfig':
        ...
        return constructor.new(_390.CylindricalGearManufacturingConfig)(self.wrapped.ManufacturingConfiguration) if self.wrapped.ManufacturingConfiguration else None
