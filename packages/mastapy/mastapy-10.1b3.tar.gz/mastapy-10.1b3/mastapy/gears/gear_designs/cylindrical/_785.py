...
from mastapy.gears.gear_designs.cylindrical import _822, _754
...
class CylindricalMeshLinearBacklashSpecification(_822.TolerancedValueSpecification['_754.BacklashSpecification']):
    '''CylindricalMeshLinearBacklashSpecification
