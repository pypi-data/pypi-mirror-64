...
class Usage(_1120.IndependentReportablePropertiesBase['Usage']):
    '''Usage
    ...
    @property
    def spur_gear_load_sharing_code(self) -> '_815.SpurGearLoadSharingCodes':
        ...
        return constructor.new(_815.SpurGearLoadSharingCodes)(value) if value else None

    @spur_gear_load_sharing_code.setter
    def spur_gear_load_sharing_code(self, value: '_815.SpurGearLoadSharingCodes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
