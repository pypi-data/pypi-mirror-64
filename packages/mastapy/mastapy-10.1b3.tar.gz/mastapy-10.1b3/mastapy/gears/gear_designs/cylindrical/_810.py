...
from mastapy.gears.gear_designs.cylindrical import _812, _813, _811
...
class Scuffing(_1120.IndependentReportablePropertiesBase['Scuffing']):
    '''Scuffing
    ...
    @property
    def scuffing_temperature_method_agma(self) -> '_812.ScuffingTemperatureMethodsAGMA':
        ...
        return constructor.new(_812.ScuffingTemperatureMethodsAGMA)(value) if value else None

    @scuffing_temperature_method_agma.setter
    def scuffing_temperature_method_agma(self, value: '_812.ScuffingTemperatureMethodsAGMA'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ScuffingTemperatureMethodAGMA = value

    @property
    def scuffing_temperature_method_iso(self) -> '_813.ScuffingTemperatureMethodsISO':
        ...
        return constructor.new(_813.ScuffingTemperatureMethodsISO)(value) if value else None

    @scuffing_temperature_method_iso.setter
    def scuffing_temperature_method_iso(self, value: '_813.ScuffingTemperatureMethodsISO'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
