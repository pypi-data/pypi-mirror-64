...
class CylindricalGearAbstractRack(_0.APIBase):
    ...
    @property
    def gear(self) -> '_766.CylindricalGearDesign':
        ...
        return constructor.new(_766.CylindricalGearDesign)(self.wrapped.Gear) if self.wrapped.Gear else None

    @property
    def shaper_for_agma_rating(self) -> '_509.CylindricalGearShaper':
        ...
        return constructor.new(_509.CylindricalGearShaper)(self.wrapped.ShaperForAGMARating) if self.wrapped.ShaperForAGMARating else None
