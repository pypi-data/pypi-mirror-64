...
from mastapy.gears.gear_designs.face import _745, _744
...
class FaceGearWheelDesign(_744.FaceGearDesign):
    '''FaceGearWheelDesign
    ...
    @property
    def face_width_and_diameters_specification_method(self) -> '_745.FaceGearDiameterFaceWidthSpecificationMethod':
        ...
        return constructor.new(_745.FaceGearDiameterFaceWidthSpecificationMethod)(value) if value else None

    @face_width_and_diameters_specification_method.setter
    def face_width_and_diameters_specification_method(self, value: '_745.FaceGearDiameterFaceWidthSpecificationMethod'):
