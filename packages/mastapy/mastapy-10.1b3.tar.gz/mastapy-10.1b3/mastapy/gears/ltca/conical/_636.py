...
from mastapy.gears.ltca.conical import _635
...
class ConicalMeshLoadDistributionAnalysis(_609.GearMeshLoadDistributionAnalysis):
    '''ConicalMeshLoadDistributionAnalysis
    ...
    @property
    def conical_mesh_manufacturing_analysis(self) -> '_561.ConicalMeshManufacturingAnalysis':
        ...
        return constructor.new(_561.ConicalMeshManufacturingAnalysis)(self.wrapped.ConicalMeshManufacturingAnalysis) if self.wrapped.ConicalMeshManufacturingAnalysis else None

    @property
    def meshed_gears(self) -> 'List[_635.ConicalMeshedGearLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_635.ConicalMeshedGearLoadDistributionAnalysis))
        return value
