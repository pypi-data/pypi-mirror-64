...
from mastapy.gears.cylindrical import _935, _934
...
class ConicalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    @property
    def contact_charts(self) -> '_935.GearLTCAContactCharts':
        ...
        return constructor.new(_935.GearLTCAContactCharts)(self.wrapped.ContactCharts) if self.wrapped.ContactCharts else None

    @property
    def contact_charts_as_text_file(self) -> '_934.GearLTCAContactChartDataAsTextFile':
        ...
        return constructor.new(_934.GearLTCAContactChartDataAsTextFile)(self.wrapped.ContactChartsAsTextFile) if self.wrapped.ContactChartsAsTextFile else None
