...
class GearNameMapper(_0.APIBase):
    ...
    @property
    def gear_name_pickers(self) -> 'List[_671.GearNamePicker]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearNamePickers, constructor.new(_671.GearNamePicker))
        return value
