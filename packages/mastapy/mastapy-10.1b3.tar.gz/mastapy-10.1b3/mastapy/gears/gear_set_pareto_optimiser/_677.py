...
from mastapy.gears.ltca.cylindrical import _623, _622, _626
from mastapy._internal import constructor, conversion
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _841
from mastapy.gears.gear_set_pareto_optimiser import _667, _678
...
class MicroGeometryDesignSpaceSearch(_667.DesignSpaceSearchBase['_626.CylindricalGearSetLoadDistributionAnalysis', '_678.MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearch
    ...
    @property
    def load_case_duty_cycle(self) -> '_626.CylindricalGearSetLoadDistributionAnalysis':
        ...
        return constructor.new(_626.CylindricalGearSetLoadDistributionAnalysis)(self.wrapped.LoadCaseDutyCycle) if self.wrapped.LoadCaseDutyCycle else None

    @property
    def selected_candidate_micro_geometry(self) -> '_841.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_841.CylindricalGearSetMicroGeometry)(self.wrapped.SelectedCandidateMicroGeometry) if self.wrapped.SelectedCandidateMicroGeometry else None

    @property
    def candidate_gear_sets(self) -> 'List[_841.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_841.CylindricalGearSetMicroGeometry))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_841.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_841.CylindricalGearSetMicroGeometry))
        return value
