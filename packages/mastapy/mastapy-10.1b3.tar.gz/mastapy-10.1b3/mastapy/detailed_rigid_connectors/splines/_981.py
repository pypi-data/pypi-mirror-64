...
from mastapy.detailed_rigid_connectors.splines import _968, _993
...
class SAESplineJointDesign(_993.StandardSplineJointDesign):
    '''SAESplineJointDesign
    ...
    @property
    def fit_type(self) -> '_968.FitTypes':
        '''FitTypes: 'FitType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FitType)
        return constructor.new(_968.FitTypes)(value) if value else None

    @fit_type.setter
    def fit_type(self, value: '_968.FitTypes'):
