...
class SplineJointDesign(_960.DetailedRigidConnectorDesign):
    '''SplineJointDesign
    ...
    @property
    def root_type(self) -> '_978.RootTypes':
        '''RootTypes: 'RootType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.RootType)
        return constructor.new(_978.RootTypes)(value) if value else None

    @root_type.setter
    def root_type(self, value: '_978.RootTypes'):
    ...
    @property
    def torque_cycles(self) -> '_982.SAETorqueCycles':
        ...
        return constructor.new(_982.SAETorqueCycles)(value) if value else None

    @torque_cycles.setter
    def torque_cycles(self, value: '_982.SAETorqueCycles'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TorqueCycles = value

    @property
    def fatigue_life_factor_type(self) -> '_979.SAEFatigueLifeFactorTypes':
        ...
        return constructor.new(_979.SAEFatigueLifeFactorTypes)(value) if value else None

    @fatigue_life_factor_type.setter
    def fatigue_life_factor_type(self, value: '_979.SAEFatigueLifeFactorTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FatigueLifeFactorType = value

    @property
    def spline_fixture_type(self) -> '_986.SplineFixtureTypes':
        ...
        return constructor.new(_986.SplineFixtureTypes)(value) if value else None

    @spline_fixture_type.setter
    def spline_fixture_type(self, value: '_986.SplineFixtureTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def external_half(self) -> '_987.SplineHalfDesign':
        ...
        return constructor.new(_987.SplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_custom_spline_half_design(self) -> '_962.CustomSplineHalfDesign':
        ...
        if _962.CustomSplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
        ...
        return constructor.new(_962.CustomSplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_din5480_spline_half_design(self) -> '_965.DIN5480SplineHalfDesign':
        ...
        if _965.DIN5480SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
        ...
        return constructor.new(_965.DIN5480SplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_gbt3478_spline_half_design(self) -> '_969.GBT3478SplineHalfDesign':
        ...
        if _969.GBT3478SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
        ...
        return constructor.new(_969.GBT3478SplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_iso4156_spline_half_design(self) -> '_972.ISO4156SplineHalfDesign':
        ...
        if _972.ISO4156SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
        ...
        return constructor.new(_972.ISO4156SplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_sae_spline_half_design(self) -> '_980.SAESplineHalfDesign':
        ...
        if _980.SAESplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
        ...
        return constructor.new(_980.SAESplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_standard_spline_half_design(self) -> '_992.StandardSplineHalfDesign':
        ...
        if _992.StandardSplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
        ...
        return constructor.new(_992.StandardSplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def internal_half(self) -> '_987.SplineHalfDesign':
        ...
        return constructor.new(_987.SplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_custom_spline_half_design(self) -> '_962.CustomSplineHalfDesign':
        ...
        if _962.CustomSplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
        ...
        return constructor.new(_962.CustomSplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_din5480_spline_half_design(self) -> '_965.DIN5480SplineHalfDesign':
        ...
        if _965.DIN5480SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
        ...
        return constructor.new(_965.DIN5480SplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_gbt3478_spline_half_design(self) -> '_969.GBT3478SplineHalfDesign':
        ...
        if _969.GBT3478SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
        ...
        return constructor.new(_969.GBT3478SplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_iso4156_spline_half_design(self) -> '_972.ISO4156SplineHalfDesign':
        ...
        if _972.ISO4156SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
        ...
        return constructor.new(_972.ISO4156SplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_sae_spline_half_design(self) -> '_980.SAESplineHalfDesign':
        ...
        if _980.SAESplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
        ...
        return constructor.new(_980.SAESplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_standard_spline_half_design(self) -> '_992.StandardSplineHalfDesign':
        ...
        if _992.StandardSplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
        ...
        return constructor.new(_992.StandardSplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None
