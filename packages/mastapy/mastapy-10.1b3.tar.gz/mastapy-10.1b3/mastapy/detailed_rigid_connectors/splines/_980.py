...
from mastapy.detailed_rigid_connectors.splines import _992
...
class SAESplineHalfDesign(_992.StandardSplineHalfDesign):
    '''SAESplineHalfDesign
    ...
    @property
    def sae_accuracy_and_tolerance(self) -> '_995.SAESplineTolerances':
        ...
        return constructor.new(_995.SAESplineTolerances)(self.wrapped.SAEAccuracyAndTolerance) if self.wrapped.SAEAccuracyAndTolerance else None
