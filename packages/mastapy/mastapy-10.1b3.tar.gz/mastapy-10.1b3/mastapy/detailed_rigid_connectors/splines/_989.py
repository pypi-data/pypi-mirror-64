...
from mastapy.detailed_rigid_connectors.splines import _971
...
class SplineMaterial(_76.Material):
    ...
    @property
    def heat_treatment_type(self) -> '_971.HeatTreatmentTypes':
    ...
    def heat_treatment_type(self, value: '_971.HeatTreatmentTypes'):
