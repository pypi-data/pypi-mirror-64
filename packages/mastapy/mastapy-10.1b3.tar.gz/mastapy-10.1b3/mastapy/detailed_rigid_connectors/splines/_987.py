...
from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _994
...
class SplineHalfDesign(_961.DetailedRigidConnectorHalfDesign):
    '''SplineHalfDesign
    ...
    @property
    def heat_treatment(self) -> '_971.HeatTreatmentTypes':
        ...
        return constructor.new(_971.HeatTreatmentTypes)(value) if value else None

    @heat_treatment.setter
    def heat_treatment(self, value: '_971.HeatTreatmentTypes'):
    ...
    @property
    def fit_and_tolerance(self) -> '_994.FitAndTolerance':
        ...
        return constructor.new(_994.FitAndTolerance)(self.wrapped.FitAndTolerance) if self.wrapped.FitAndTolerance else None
