...
from mastapy.detailed_rigid_connectors.interference_fits import _1025, _1024, _1029
...
class InterferenceFitDesign(_968.DetailedRigidConnectorDesign):
    '''InterferenceFitDesign
    ...
    @property
    def calculation_method(self) -> '_1025.CalculationMethods':
        ...
        return constructor.new(_1025.CalculationMethods)(value) if value else None

    @calculation_method.setter
    def calculation_method(self, value: '_1025.CalculationMethods'):
    ...
    @property
    def assembly_method(self) -> '_1024.AssemblyMethods':
        ...
        return constructor.new(_1024.AssemblyMethods)(value) if value else None

    @assembly_method.setter
    def assembly_method(self, value: '_1024.AssemblyMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
