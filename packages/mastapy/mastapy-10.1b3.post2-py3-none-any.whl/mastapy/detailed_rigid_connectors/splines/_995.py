...
from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _1002
...
class SplineHalfDesign(_969.DetailedRigidConnectorHalfDesign):
    '''SplineHalfDesign
    ...
    @property
    def heat_treatment(self) -> '_979.HeatTreatmentTypes':
        ...
        return constructor.new(_979.HeatTreatmentTypes)(value) if value else None

    @heat_treatment.setter
    def heat_treatment(self, value: '_979.HeatTreatmentTypes'):
    ...
    @property
    def fit_and_tolerance(self) -> '_1002.FitAndTolerance':
        ...
        return constructor.new(_1002.FitAndTolerance)(self.wrapped.FitAndTolerance) if self.wrapped.FitAndTolerance else None
