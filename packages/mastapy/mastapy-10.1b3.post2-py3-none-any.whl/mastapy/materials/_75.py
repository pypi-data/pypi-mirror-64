...
class LubricationDetailDatabase(_0.APIBase):
    '''LubricationDetailDatabase
    ...
    @property
    def item(self) -> '_74.LubricationDetail':
        ...
        return constructor.new(_74.LubricationDetail)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_74.LubricationDetail':
        ...
        return constructor.new(_74.LubricationDetail)(method_result) if method_result else None

    def can_be_removed(self, lubrication_detail: '_74.LubricationDetail') -> 'bool':
    ...
    def rename(self, lubrication_detail: '_74.LubricationDetail', new_name: 'str') -> 'bool':
    ...
    def remove(self, lubrication_detail: '_74.LubricationDetail'):
    ...
    def get_all_items(self) -> 'Iterable[_74.LubricationDetail]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_74.LubricationDetail))

    def save_changes(self, lubrication_detail: '_74.LubricationDetail'):
