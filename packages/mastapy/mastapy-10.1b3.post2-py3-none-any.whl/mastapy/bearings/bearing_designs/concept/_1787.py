...
from mastapy.bearings.bearing_designs.concept import _1786, _1788
...
class ConceptAxialClearanceBearing(_1788.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1786.BearingNodePosition':
        ...
        return constructor.new(_1786.BearingNodePosition)(value) if value else None

    @node_position.setter
    def node_position(self, value: '_1786.BearingNodePosition'):
