...
class ThrustBallBearing(_1738.BallBearing):
    '''ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self) -> '_1520.OuterRingMounting':
        ...
        return constructor.new(_1520.OuterRingMounting)(value) if value else None

    @outer_ring_mounting.setter
    def outer_ring_mounting(self, value: '_1520.OuterRingMounting'):
