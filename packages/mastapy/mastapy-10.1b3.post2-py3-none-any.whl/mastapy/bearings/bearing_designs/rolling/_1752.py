...
from mastapy.bearings.bearing_designs.rolling import _1754, _1755, _1753
...
class NonBarrelRollerBearing(_1753.RollerBearing):
    '''NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self) -> '_1754.RollerEndShape':
        ...
        return constructor.new(_1754.RollerEndShape)(value) if value else None

    @roller_end_shape.setter
    def roller_end_shape(self, value: '_1754.RollerEndShape'):
    ...
    @property
    def ribs(self) -> 'List[_1755.RollerRibDetail]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Ribs, constructor.new(_1755.RollerRibDetail))
        return value
