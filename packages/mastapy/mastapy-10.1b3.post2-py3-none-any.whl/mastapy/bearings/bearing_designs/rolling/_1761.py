...
from mastapy.bearings.bearing_designs.rolling import _1755, _1752
...
class TaperRollerBearing(_1752.NonBarrelRollerBearing):
    '''TaperRollerBearing
    ...
    @property
    def bearing_measurement_type(self) -> '_1509.BearingMeasurementType':
        ...
        return constructor.new(_1509.BearingMeasurementType)(value) if value else None

    @bearing_measurement_type.setter
    def bearing_measurement_type(self, value: '_1509.BearingMeasurementType'):
    ...
    @property
    def major_rib_detail(self) -> '_1755.RollerRibDetail':
        ...
        return constructor.new(_1755.RollerRibDetail)(self.wrapped.MajorRibDetail) if self.wrapped.MajorRibDetail else None
