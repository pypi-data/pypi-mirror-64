...
from mastapy.bearings.bearing_designs.fluid_film import _1777
...
class TiltingPadThrustBearing(_1777.PadFluidFilmBearing):
    '''TiltingPadThrustBearing
    ...
    @property
    def tilting_pad_type(self) -> '_1529.TiltingPadTypes':
        ...
        return constructor.new(_1529.TiltingPadTypes)(value) if value else None

    @tilting_pad_type.setter
    def tilting_pad_type(self, value: '_1529.TiltingPadTypes'):
