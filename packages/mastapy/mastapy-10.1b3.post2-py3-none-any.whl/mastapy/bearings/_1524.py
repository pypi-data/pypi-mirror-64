...
class RollingBearingDatabase(_1342.SQLDatabase['_1525.RollingBearingKey', '_1756.RollingBearing']):
    '''RollingBearingDatabase
    ...
    def add_to_database(self, bearing: '_1756.RollingBearing'):
    ...
    def remove_from_database(self, bearing: '_1756.RollingBearing'):
    ...
    def search_for_rolling_bearing(self, designation: 'str', catalog: '_1502.BearingCatalog', type_: '_1527.RollingBearingType', bore_range: '_1055.Range', outer_diameter_range: '_1055.Range', width_range: '_1055.Range', dynamic_capacity_range: '_1055.Range', number_of_rows: 'int', material_type: '_1516.HybridSteelAll') -> 'List[_1756.RollingBearing]':
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(self, designation: 'str', catalog: '_1502.BearingCatalog', type_: '_1527.RollingBearingType') -> 'List[_1756.RollingBearing]':
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        type_ = conversion.mp_to_pn_enum(type_)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing(designation if designation else None, catalog, type_), constructor.new(_1756.RollingBearing))

    def search_for_rolling_bearing_with_name_and_catalog(self, designation: 'str', catalog: '_1502.BearingCatalog') -> '_1756.RollingBearing':
        ''' 'SearchForRollingBearing' is the original name of this method.
        ...
        return constructor.new(_1756.RollingBearing)(method_result) if method_result else None

    def search_for_rolling_bearing_with_catalog(self, catalog: '_1502.BearingCatalog') -> 'List[_1756.RollingBearing]':
        ''' 'SearchForRollingBearing' is the original name of this method.
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing(catalog), constructor.new(_1756.RollingBearing))

    def create_bearing(self, type_: '_1527.RollingBearingType', designation: Optional['str'] = 'None') -> '_1756.RollingBearing':
