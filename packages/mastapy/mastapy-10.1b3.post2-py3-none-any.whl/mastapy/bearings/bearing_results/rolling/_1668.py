...
from mastapy.bearings.bearing_results.rolling import _1667, _1639
...
class LoadedToroidalRollerBearingRow(_1639.LoadedRollerBearingRow):
    '''LoadedToroidalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1667.LoadedToroidalRollerBearingResults':
