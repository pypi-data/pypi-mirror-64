...
from mastapy.bearings.bearing_results.rolling import (
    _1594, _1575, _1578, _1601,
    _1606, _1625, _1641, _1644,
    _1593, _1623
)
...
class LoadedBallBearingRow(_1623.LoadedRollingBearingRow):
    '''LoadedBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1594.LoadedBallBearingResults':
    ...
    @property
    def race_results(self) -> 'List[_1593.LoadedBallBearingRaceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RaceResults, constructor.new(_1593.LoadedBallBearingRaceResults))
        return value
