...
class ParetoOptimisationStrategyChartInformation(_0.APIBase):
    ...
    @property
    def bars(self) -> 'List[_1101.ParetoOptimisationStrategyBars]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Bars, constructor.new(_1101.ParetoOptimisationStrategyBars))
        return value
