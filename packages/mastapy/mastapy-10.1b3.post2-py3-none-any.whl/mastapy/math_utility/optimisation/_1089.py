...
from mastapy.math_utility.optimisation import _1087, _1088, _1091
...
class ParetoOptimisationStrategy(_1322.NamedDatabaseItem):
    '''ParetoOptimisationStrategy
    ...
    @property
    def inputs(self) -> 'List[_1087.ParetoOptimisationInput]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Inputs, constructor.new(_1087.ParetoOptimisationInput))
        return value

    @property
    def outputs(self) -> 'List[_1088.ParetoOptimisationOutput]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Outputs, constructor.new(_1088.ParetoOptimisationOutput))
        return value

    @property
    def charts(self) -> 'List[_1091.ParetoOptimisationStrategyChartInformation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Charts, constructor.new(_1091.ParetoOptimisationStrategyChartInformation))
        return value
