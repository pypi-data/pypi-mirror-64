...
from mastapy.math_utility.optimisation import _1106, _1104
...
class ParetoOptimistaionVariable(_1104.ParetoOptimisationVariableBase):
    '''ParetoOptimistaionVariable
    ...
    @property
    def property_target_for_dominant_candidate_search(self) -> '_1106.PropertyTargetForDominantCandidateSearch':
        ...
        return constructor.new(_1106.PropertyTargetForDominantCandidateSearch)(value) if value else None

    @property_target_for_dominant_candidate_search.setter
    def property_target_for_dominant_candidate_search(self, value: '_1106.PropertyTargetForDominantCandidateSearch'):
