...
class StraightBevelGearRating(_338.BevelGearRating):
    ...
    @property
    def straight_bevel_gear(self) -> '_720.StraightBevelGearDesign':
        ...
        return constructor.new(_720.StraightBevelGearDesign)(self.wrapped.StraightBevelGear) if self.wrapped.StraightBevelGear else None
