...
class KlingelnbergCycloPalloidHypoidGearRating(_214.KlingelnbergCycloPalloidConicalGearRating):
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear(self) -> '_732.KlingelnbergCycloPalloidHypoidGearDesign':
        ...
        return constructor.new(_732.KlingelnbergCycloPalloidHypoidGearDesign)(self.wrapped.KlingelnbergCycloPalloidHypoidGear) if self.wrapped.KlingelnbergCycloPalloidHypoidGear else None
