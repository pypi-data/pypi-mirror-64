...
class SpiralBevelGearRating(_338.BevelGearRating):
    ...
    @property
    def spiral_bevel_gear(self) -> '_724.SpiralBevelGearDesign':
        ...
        return constructor.new(_724.SpiralBevelGearDesign)(self.wrapped.SpiralBevelGear) if self.wrapped.SpiralBevelGear else None
