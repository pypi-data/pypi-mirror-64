...
class ConceptGearRating(_163.GearRating):
    ...
    @property
    def concept_gear(self) -> '_900.ConceptGearDesign':
        ...
        return constructor.new(_900.ConceptGearDesign)(self.wrapped.ConceptGear) if self.wrapped.ConceptGear else None
