...
class StraightBevelDiffGearRating(_323.ConicalGearRating):
    ...
    @property
    def straight_bevel_diff_gear(self) -> '_716.StraightBevelDiffGearDesign':
        ...
        return constructor.new(_716.StraightBevelDiffGearDesign)(self.wrapped.StraightBevelDiffGear) if self.wrapped.StraightBevelDiffGear else None
