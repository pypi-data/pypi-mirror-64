...
class WormGearMeshRating(_162.GearMeshRating):
    ...
    @property
    def worm_gear_mesh(self) -> '_713.WormGearMeshDesign':
        ...
        return constructor.new(_713.WormGearMeshDesign)(self.wrapped.WormGearMesh) if self.wrapped.WormGearMesh else None
