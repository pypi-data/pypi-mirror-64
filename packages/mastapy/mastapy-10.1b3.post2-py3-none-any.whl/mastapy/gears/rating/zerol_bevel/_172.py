...
class ZerolBevelGearRating(_338.BevelGearRating):
    ...
    @property
    def zerol_bevel_gear(self) -> '_707.ZerolBevelGearDesign':
        ...
        return constructor.new(_707.ZerolBevelGearDesign)(self.wrapped.ZerolBevelGear) if self.wrapped.ZerolBevelGear else None
