...
class RawMaterialDatabase(_0.APIBase):
    '''RawMaterialDatabase
    ...
    @property
    def item(self) -> '_385.RawMaterial':
        ...
        return constructor.new(_385.RawMaterial)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_385.RawMaterial':
        ...
        return constructor.new(_385.RawMaterial)(method_result) if method_result else None

    def can_be_removed(self, raw_material: '_385.RawMaterial') -> 'bool':
    ...
    def rename(self, raw_material: '_385.RawMaterial', new_name: 'str') -> 'bool':
    ...
    def remove(self, raw_material: '_385.RawMaterial'):
    ...
    def get_all_items(self) -> 'Iterable[_385.RawMaterial]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_385.RawMaterial))

    def save_changes(self, raw_material: '_385.RawMaterial'):
