...
from mastapy.gears.materials import _368
...
class BevelGearMaterialDatabase(_0.APIBase):
    '''BevelGearMaterialDatabase
    ...
    @property
    def item(self) -> '_368.BevelGearMaterial':
        ...
        return constructor.new(_368.BevelGearMaterial)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_368.BevelGearMaterial':
        ...
        return constructor.new(_368.BevelGearMaterial)(method_result) if method_result else None

    def can_be_removed(self, bevel_gear_material: '_368.BevelGearMaterial') -> 'bool':
    ...
    def rename(self, bevel_gear_material: '_368.BevelGearMaterial', new_name: 'str') -> 'bool':
    ...
    def remove(self, bevel_gear_material: '_368.BevelGearMaterial'):
    ...
    def get_all_items(self) -> 'Iterable[_368.BevelGearMaterial]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_368.BevelGearMaterial))

    def save_changes(self, bevel_gear_material: '_368.BevelGearMaterial'):
