...
from mastapy.gears.gear_designs.concept import _908, _909
...
class ConceptGearSetDesign(_713.GearSetDesign):
    '''ConceptGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_908.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_908.ConceptGearDesign))
        return value
    ...
    @property
    def concept_meshes(self) -> 'List[_909.ConceptGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_909.ConceptGearMeshDesign))
        return value
