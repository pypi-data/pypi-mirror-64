...
class CylindricalMeshedGear(_0.APIBase):
    ...
    @property
    def start_of_active_profile(self) -> '_774.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_774.CylindricalGearProfileMeasurement)(self.wrapped.StartOfActiveProfile) if self.wrapped.StartOfActiveProfile else None

    @property
    def end_of_active_profile(self) -> '_774.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_774.CylindricalGearProfileMeasurement)(self.wrapped.EndOfActiveProfile) if self.wrapped.EndOfActiveProfile else None
