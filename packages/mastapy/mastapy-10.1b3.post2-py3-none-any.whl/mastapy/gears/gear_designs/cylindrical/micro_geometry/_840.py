...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _839
...
class CylindricalGearProfileModificationAtFaceWidthPosition(_839.CylindricalGearProfileModification):
    '''CylindricalGearProfileModificationAtFaceWidthPosition
