...
class FaceGearMicroGeometry(_950.GearImplementationDetail):
    '''FaceGearMicroGeometry
    ...
    @property
    def face_gear(self) -> '_752.FaceGearDesign':
        ...
        return constructor.new(_752.FaceGearDesign)(self.wrapped.FaceGear) if self.wrapped.FaceGear else None

    @property
    def micro_geometry(self) -> '_844.CylindricalGearMicroGeometry':
        ...
        return constructor.new(_844.CylindricalGearMicroGeometry)(self.wrapped.MicroGeometry) if self.wrapped.MicroGeometry else None
