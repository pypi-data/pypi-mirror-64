...
class CylindricalGearMeshLoadedContactPoint(_612.GearMeshLoadedContactPoint):
    '''CylindricalGearMeshLoadedContactPoint
    ...
    @property
    def gear_a_profile_measurement(self) -> '_774.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_774.CylindricalGearProfileMeasurement)(self.wrapped.GearAProfileMeasurement) if self.wrapped.GearAProfileMeasurement else None

    @property
    def gear_b_profile_measurement(self) -> '_774.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_774.CylindricalGearProfileMeasurement)(self.wrapped.GearBProfileMeasurement) if self.wrapped.GearBProfileMeasurement else None
