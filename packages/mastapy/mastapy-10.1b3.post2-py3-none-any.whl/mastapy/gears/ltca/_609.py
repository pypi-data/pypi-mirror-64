...
from mastapy.gears.ltca import _610, _608
...
class GearMeshLoadDistributionAnalysis(_944.GearMeshImplementationAnalysis):
    '''GearMeshLoadDistributionAnalysis
    ...
    @property
    def transmission_error_fourier_series(self) -> '_1062.FourierSeries':
        ...
        return constructor.new(_1062.FourierSeries)(self.wrapped.TransmissionErrorFourierSeries) if self.wrapped.TransmissionErrorFourierSeries else None

    @property
    def load_distribution_analyses_at_single_rotation(self) -> 'List[_610.GearMeshLoadDistributionAtRotation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadDistributionAnalysesAtSingleRotation, constructor.new(_610.GearMeshLoadDistributionAtRotation))
        return value

    def maximum_root_stress_with_flanks(self, gear: '_608.GearLoadDistributionAnalysis', flank: '_128.GearFlanks', stress_type: '_1370.StressResultsType') -> 'float':
    ...
    def maximum_root_stress(self, gear: '_608.GearLoadDistributionAnalysis', stress_type: '_1370.StressResultsType') -> 'float':
        ''' 'MaximumRootStress' is the original name of this method.
