...
class ShaperSimulationCalculator(_481.CutterSimulationCalc):
    '''ShaperSimulationCalculator
    ...
    @property
    def shaper(self) -> '_521.CylindricalGearShaperTangible':
        ...
        return constructor.new(_521.CylindricalGearShaperTangible)(self.wrapped.Shaper) if self.wrapped.Shaper else None
