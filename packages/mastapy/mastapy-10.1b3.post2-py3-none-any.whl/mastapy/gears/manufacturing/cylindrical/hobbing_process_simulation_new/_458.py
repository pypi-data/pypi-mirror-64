...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _463, _450, _477
...
class ProcessCalculation(_0.APIBase):
    ...
    @property
    def inputs(self) -> '_463.ProcessSimulationInput':
        ...
        return constructor.new(_463.ProcessSimulationInput)(self.wrapped.Inputs) if self.wrapped.Inputs else None

    @property
    def inputs_of_type_hobbing_process_simulation_input(self) -> '_450.HobbingProcessSimulationInput':
        ...
        if _450.HobbingProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
        ...
        return constructor.new(_450.HobbingProcessSimulationInput)(self.wrapped.Inputs) if self.wrapped.Inputs else None

    @property
    def inputs_of_type_worm_grinding_process_simulation_input(self) -> '_477.WormGrindingProcessSimulationInput':
        ...
        if _477.WormGrindingProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
        ...
        return constructor.new(_477.WormGrindingProcessSimulationInput)(self.wrapped.Inputs) if self.wrapped.Inputs else None
