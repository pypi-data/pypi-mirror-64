...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _439, _444
...
class HobbingProcessPitchCalculation(_444.HobbingProcessCalculation):
    '''HobbingProcessPitchCalculation
