...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _533, _547, _532
...
class PlungeShavingDynamicsViewModel(_547.ShavingDynamicsViewModel['_532.PlungeShaverDynamics']):
    '''PlungeShavingDynamicsViewModel
    ...
    @property
    def settings(self) -> '_533.PlungeShaverDynamicSettings':
        ...
        return constructor.new(_533.PlungeShaverDynamicSettings)(self.wrapped.Settings) if self.wrapped.Settings else None
