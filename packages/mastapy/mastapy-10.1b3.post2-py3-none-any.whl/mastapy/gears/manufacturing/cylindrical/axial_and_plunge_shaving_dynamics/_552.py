...
from mastapy.gears.gear_designs.cylindrical import _826, _783
...
class ShavingDynamicsViewModel(_553.ShavingDynamicsViewModelBase, Generic[T]):
    ...
    def calculation(self) -> '_548.ShavingDynamicsCalculation[T]':
        ...
        return constructor.new(_548.ShavingDynamicsCalculation)[T](self.wrapped.Calculation) if self.wrapped.Calculation else None
    ...
    def calculation_of_type_conventional_shaving_dynamics_calculation_for_designed_gears(self) -> '_534.ConventionalShavingDynamicsCalculationForDesignedGears':
        ...
        return constructor.new(_534.ConventionalShavingDynamicsCalculationForDesignedGears)(self.wrapped.Calculation) if self.wrapped.Calculation else None
    ...
    def calculation_of_type_conventional_shaving_dynamics_calculation_for_hobbed_gears(self) -> '_535.ConventionalShavingDynamicsCalculationForHobbedGears':
        ...
        return constructor.new(_535.ConventionalShavingDynamicsCalculationForHobbedGears)(self.wrapped.Calculation) if self.wrapped.Calculation else None
    ...
    def calculation_of_type_plunge_shaving_dynamics_calculation_for_designed_gears(self) -> '_540.PlungeShavingDynamicsCalculationForDesignedGears':
        ...
        return constructor.new(_540.PlungeShavingDynamicsCalculationForDesignedGears)(self.wrapped.Calculation) if self.wrapped.Calculation else None
    ...
    def calculation_of_type_plunge_shaving_dynamics_calculation_for_hobbed_gears(self) -> '_541.PlungeShavingDynamicsCalculationForHobbedGears':
        ...
        return constructor.new(_541.PlungeShavingDynamicsCalculationForHobbedGears)(self.wrapped.Calculation) if self.wrapped.Calculation else None
