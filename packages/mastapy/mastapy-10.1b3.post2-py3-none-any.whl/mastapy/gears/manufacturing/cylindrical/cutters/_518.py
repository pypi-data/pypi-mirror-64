...
class InvoluteCutterDesign(_513.CylindricalGearRealCutterDesign):
    ...
    @property
    def tooth_thickness(self) -> '_832.ToothThicknessSpecificationBase':
        ...
        return constructor.new(_832.ToothThicknessSpecificationBase)(self.wrapped.ToothThickness) if self.wrapped.ToothThickness else None
    ...
    def tooth_thickness_of_type_finish_tooth_thickness_design_specification(self) -> '_799.FinishToothThicknessDesignSpecification':
        ...
        return constructor.new(_799.FinishToothThicknessDesignSpecification)(self.wrapped.ToothThickness) if self.wrapped.ToothThickness else None

    @property
    def tooth_thickness_of_type_tooth_thickness_specification(self) -> '_831.ToothThicknessSpecification':
        ...
        if _831.ToothThicknessSpecification.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
        ...
        return constructor.new(_831.ToothThicknessSpecification)(self.wrapped.ToothThickness) if self.wrapped.ToothThickness else None
