...
from mastapy.system_model.optimization import _1821, _1819
...
TStep = TypeVar('TStep', bound='_1819.OptimizationStep')


class OptimizationStrategy(_1821.OptimizationStrategyBase, Generic[TStep]):
    '''OptimizationStrategy
