...
class WormGearMesh(_1872.GearMesh):
    '''WormGearMesh
    ...
    @property
    def worm_gear_mesh_design(self) -> '_721.WormGearMeshDesign':
        ...
        return constructor.new(_721.WormGearMeshDesign)(self.wrapped.WormGearMeshDesign) if self.wrapped.WormGearMeshDesign else None
