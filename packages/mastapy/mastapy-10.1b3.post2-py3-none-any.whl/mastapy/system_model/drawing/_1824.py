...
from mastapy.system_model.drawing import _1826, _1825
...
class ContourDrawStyle(_113.DrawStyleBase):
    ...
    @property
    def contour(self) -> '_1335.ThreeDViewContourOption':
        '''ThreeDViewContourOption: 'Contour' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Contour)
        return constructor.new(_1335.ThreeDViewContourOption)(value) if value else None

    @contour.setter
    def contour(self, value: '_1335.ThreeDViewContourOption'):
    ...
    @property
    def deflection_scaling(self) -> '_1826.ScalingDrawStyle':
        ...
        return constructor.new(_1826.ScalingDrawStyle)(self.wrapped.DeflectionScaling) if self.wrapped.DeflectionScaling else None

    @property
    def model_view_options(self) -> '_1825.ModelViewOptionsDrawStyle':
        ...
        return constructor.new(_1825.ModelViewOptionsDrawStyle)(self.wrapped.ModelViewOptions) if self.wrapped.ModelViewOptions else None
