...
from mastapy.math_utility.measured_vectors import _1113, _1116
...
class NodeComparisonResult(_0.APIBase):
    ...
    @property
    def original_result(self) -> '_1113.NodeResults':
        ...
        return constructor.new(_1113.NodeResults)(self.wrapped.OriginalResult) if self.wrapped.OriginalResult else None

    @property
    def new_result(self) -> '_1113.NodeResults':
        ...
        return constructor.new(_1113.NodeResults)(self.wrapped.NewResult) if self.wrapped.NewResult else None

    @property
    def displacement_change(self) -> '_1116.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1116.VectorWithLinearAndAngularComponents)(self.wrapped.DisplacementChange) if self.wrapped.DisplacementChange else None
