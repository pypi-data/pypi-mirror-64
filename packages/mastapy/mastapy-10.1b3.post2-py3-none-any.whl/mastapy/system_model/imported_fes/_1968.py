...
from mastapy.system_model.imported_fes import _1961, _1960
...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    @property
    def nodes(self) -> 'List[_1961.PerNodeExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_1961.PerNodeExportOptions))
        return value

    @property
    def links(self) -> 'List[_1960.PerLinkExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1960.PerLinkExportOptions))
        return value
