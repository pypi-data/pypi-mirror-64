...
class TimeSeriesLoadCase(_6042.LoadCase):
    '''TimeSeriesLoadCase
    ...
    @property
    def driva_analysis_options(self) -> '_5042.MBDAnalysisOptions':
        ...
        return constructor.new(_5042.MBDAnalysisOptions)(self.wrapped.DRIVAAnalysisOptions) if self.wrapped.DRIVAAnalysisOptions else None
