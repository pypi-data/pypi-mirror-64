...
from mastapy.utility.file_access_helpers import _1332
...
class MultiTimeSeriesDataInputFileOptions(_1498.DataInputFileOptions):
    '''MultiTimeSeriesDataInputFileOptions
    ...
    @property
    def delimiter_options(self) -> '_1332.TextFileDelimiterOptions':
        ...
        return constructor.new(_1332.TextFileDelimiterOptions)(self.wrapped.DelimiterOptions) if self.wrapped.DelimiterOptions else None
