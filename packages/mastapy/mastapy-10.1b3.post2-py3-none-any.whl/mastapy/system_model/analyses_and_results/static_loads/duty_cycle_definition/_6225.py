...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import (
    _6215, _6226, _6217, _6214,
    _6218, _6220, _6227, _6224,
    _6216, _6219, _6213
)
...
class TimeSeriesImporter(_0.APIBase):
    ...
    @property
    def import_type(self) -> '_6134.ImportType':
        '''ImportType: 'ImportType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ImportType)
        return constructor.new(_6134.ImportType)(value) if value else None

    @import_type.setter
    def import_type(self, value: '_6134.ImportType'):
    ...
    @property
    def time_step_input(self) -> '_6226.TimeStepInputOptions':
        ...
        return constructor.new(_6226.TimeStepInputOptions)(self.wrapped.TimeStepInput) if self.wrapped.TimeStepInput else None

    @property
    def gear_ratio_options(self) -> '_6217.GearRatioInputOptions':
        ...
        return constructor.new(_6217.GearRatioInputOptions)(self.wrapped.GearRatioOptions) if self.wrapped.GearRatioOptions else None

    @property
    def design_state_options(self) -> '_6214.DesignStateOptions':
        ...
        return constructor.new(_6214.DesignStateOptions)(self.wrapped.DesignStateOptions) if self.wrapped.DesignStateOptions else None

    @property
    def load_case_name_inputs(self) -> '_6218.LoadCaseNameOptions':
        ...
        return constructor.new(_6218.LoadCaseNameOptions)(self.wrapped.LoadCaseNameInputs) if self.wrapped.LoadCaseNameInputs else None

    @property
    def file_inputs(self) -> 'List[_6220.MultiTimeSeriesDataInputFileOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FileInputs, constructor.new(_6220.MultiTimeSeriesDataInputFileOptions))
        return value

    @property
    def torque_inputs(self) -> 'List[_6227.TorqueInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TorqueInputs, constructor.new(_6227.TorqueInputOptions))
        return value

    @property
    def speed_inputs(self) -> 'List[_6224.SpeedInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpeedInputs, constructor.new(_6224.SpeedInputOptions))
        return value

    @property
    def force_inputs(self) -> 'List[_6216.ForceInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceInputs, constructor.new(_6216.ForceInputOptions))
        return value

    @property
    def moment_inputs(self) -> 'List[_6219.MomentInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MomentInputs, constructor.new(_6219.MomentInputOptions))
        return value

    @property
    def boost_pressure_inputs(self) -> 'List[_6213.BoostPressureLoadCaseInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoostPressureInputs, constructor.new(_6213.BoostPressureLoadCaseInputOptions))
        return value

    @property
    def columns(self) -> 'List[_1331.ColumnTitle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Columns, constructor.new(_1331.ColumnTitle))
        return value
