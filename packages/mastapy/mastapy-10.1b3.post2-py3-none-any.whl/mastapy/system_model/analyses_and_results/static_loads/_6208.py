...
from mastapy.system_model.analyses_and_results.static_loads import _6206, _6207, _6120
...
class WormGearSetLoadCase(_6120.GearSetLoadCase):
    '''WormGearSetLoadCase
    ...
    @property
    def worm_gears_load_case(self) -> 'List[_6206.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsLoadCase, constructor.new(_6206.WormGearLoadCase))
        return value

    @property
    def worm_meshes_load_case(self) -> 'List[_6207.WormGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesLoadCase, constructor.new(_6207.WormGearMeshLoadCase))
        return value
