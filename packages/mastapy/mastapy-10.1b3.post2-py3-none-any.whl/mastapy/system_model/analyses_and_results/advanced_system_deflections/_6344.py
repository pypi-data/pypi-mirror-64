...
class TorqueConverterConnectionAdvancedSystemDeflection(_6268.CouplingConnectionAdvancedSystemDeflection):
    '''TorqueConverterConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6196.TorqueConverterConnectionLoadCase':
        ...
        return constructor.new(_6196.TorqueConverterConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2329.TorqueConverterConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2329.TorqueConverterConnectionSystemDeflection))
        return value
