...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6282, _6304
...
class GearSetAdvancedSystemDeflection(_6304.SpecialisedAssemblyAdvancedSystemDeflection):
    '''GearSetAdvancedSystemDeflection
    ...
    @property
    def use_ltca_in_advanced_system_deflection(self) -> '_6282.UseLtcaInAsdOption':
        ...
        return constructor.new(_6282.UseLtcaInAsdOption)(value) if value else None

    @use_ltca_in_advanced_system_deflection.setter
    def use_ltca_in_advanced_system_deflection(self, value: '_6282.UseLtcaInAsdOption'):
