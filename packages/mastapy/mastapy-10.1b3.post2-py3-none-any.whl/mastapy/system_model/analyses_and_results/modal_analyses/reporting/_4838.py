...
from mastapy.utility.modal_analysis import _1312
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2179.DesignEntityGroupAnalysis):
    '''RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    @property
    def excitation_frequencies_at_reference_speed(self) -> 'List[_1312.DesignEntityExcitationDescription]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitationFrequenciesAtReferenceSpeed, constructor.new(_1312.DesignEntityExcitationDescription))
        return value
