...
class CouplingConnectionModalAnalysis(_4737.InterMountableComponentConnectionModalAnalysis):
    '''CouplingConnectionModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2221.CouplingConnectionSystemDeflection':
