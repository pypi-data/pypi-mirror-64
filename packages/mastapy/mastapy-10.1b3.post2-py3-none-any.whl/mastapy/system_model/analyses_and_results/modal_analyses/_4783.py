...
from mastapy.system_model.analyses_and_results.modal_analyses import _4782, _4781, _4692
...
class StraightBevelDiffGearSetModalAnalysis(_4692.BevelGearSetModalAnalysis):
    '''StraightBevelDiffGearSetModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2295.StraightBevelDiffGearSetSystemDeflection':
    ...
    @property
    def straight_bevel_diff_gears_modal_analysis(self) -> 'List[_4782.StraightBevelDiffGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsModalAnalysis, constructor.new(_4782.StraightBevelDiffGearModalAnalysis))
        return value

    @property
    def straight_bevel_diff_meshes_modal_analysis(self) -> 'List[_4781.StraightBevelDiffGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesModalAnalysis, constructor.new(_4781.StraightBevelDiffGearMeshModalAnalysis))
        return value
