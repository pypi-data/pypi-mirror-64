...
from mastapy.math_utility import (
    _1069, _1085, _1060, _1077,
    _1068, _1057, _1067, _1080
)
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.system_model.analyses_and_results.modal_analyses import (
    _4731, _4820, _4819, _4775,
    _4821
)
from mastapy.system_model.analyses_and_results.gear_whine_analyses.whine_analyses_results import _5398, _5403, _5404
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5314, _5363
from mastapy.utility.units_and_measurements.measurements import (
    _1204, _1158, _1256, _1164,
    _1155, _1160, _1178, _1251,
    _1172, _1222, _1223, _1226
)
...
class WhineWaterfallSettings(_0.APIBase):
    ...
    @property
    def translation_or_rotation(self) -> '_1085.TranslationRotation':
        ...
        return constructor.new(_1085.TranslationRotation)(value) if value else None

    @translation_or_rotation.setter
    def translation_or_rotation(self, value: '_1085.TranslationRotation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TranslationOrRotation = value

    @property
    def coordinate_system(self) -> '_4731.CoordinateSystemForWhine':
        ...
        return constructor.new(_4731.CoordinateSystemForWhine)(value) if value else None

    @coordinate_system.setter
    def coordinate_system(self, value: '_4731.CoordinateSystemForWhine'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CoordinateSystem = value

    @property
    def complex_component(self) -> '_1060.ComplexPartDisplayOption':
        ...
        return constructor.new(_1060.ComplexPartDisplayOption)(value) if value else None

    @complex_component.setter
    def complex_component(self, value: '_1060.ComplexPartDisplayOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ComplexComponent = value

    @property
    def magnitude_method_for_complex_response(self) -> '_1077.ComplexMagnitudeMethod':
        ...
        return constructor.new(_1077.ComplexMagnitudeMethod)(value) if value else None

    @magnitude_method_for_complex_response.setter
    def magnitude_method_for_complex_response(self, value: '_1077.ComplexMagnitudeMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def weighting(self) -> '_1057.AcousticWeighting':
        '''AcousticWeighting: 'Weighting' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Weighting)
        return constructor.new(_1057.AcousticWeighting)(value) if value else None

    @weighting.setter
    def weighting(self, value: '_1057.AcousticWeighting'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def chart_type(self) -> '_1067.DynamicsResponse3DChartType':
        ...
        return constructor.new(_1067.DynamicsResponse3DChartType)(value) if value else None

    @chart_type.setter
    def chart_type(self, value: '_1067.DynamicsResponse3DChartType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def whine_waterfall_export_option(self) -> '_4820.WhineWaterfallExportOption':
        ...
        return constructor.new(_4820.WhineWaterfallExportOption)(value) if value else None

    @whine_waterfall_export_option.setter
    def whine_waterfall_export_option(self, value: '_4820.WhineWaterfallExportOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def selected_excitations(self) -> '_5398.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5398.ExcitationSourceSelectionGroup)(self.wrapped.SelectedExcitations) if self.wrapped.SelectedExcitations else None

    @property
    def waterfall_chart_settings(self) -> '_4819.WaterfallChartSettings':
        ...
        return constructor.new(_4819.WaterfallChartSettings)(self.wrapped.WaterfallChartSettings) if self.wrapped.WaterfallChartSettings else None

    @property
    def order_cuts_chart_settings(self) -> '_4775.OrderCutsChartSettings':
        ...
        return constructor.new(_4775.OrderCutsChartSettings)(self.wrapped.OrderCutsChartSettings) if self.wrapped.OrderCutsChartSettings else None

    @property
    def frequency_options(self) -> '_5314.FrequencyOptionsForGearWhineAnalysisResults':
        ...
        return constructor.new(_5314.FrequencyOptionsForGearWhineAnalysisResults)(self.wrapped.FrequencyOptions) if self.wrapped.FrequencyOptions else None

    @property
    def reference_speed_options(self) -> '_5363.SpeedOptionsForGearWhineAnalysisResults':
        ...
        return constructor.new(_5363.SpeedOptionsForGearWhineAnalysisResults)(self.wrapped.ReferenceSpeedOptions) if self.wrapped.ReferenceSpeedOptions else None

    @property
    def very_short_length_reference_values(self) -> '_4821.WhineWaterfallReferenceValues[_1204.LengthVeryShort]':
        ...
        return constructor.new(_4821.WhineWaterfallReferenceValues)[_1204.LengthVeryShort](self.wrapped.VeryShortLengthReferenceValues) if self.wrapped.VeryShortLengthReferenceValues else None

    @property
    def small_angle_reference_values(self) -> '_4821.WhineWaterfallReferenceValues[_1158.AngleSmall]':
        ...
        return constructor.new(_4821.WhineWaterfallReferenceValues)[_1158.AngleSmall](self.wrapped.SmallAngleReferenceValues) if self.wrapped.SmallAngleReferenceValues else None

    @property
    def small_velocity_reference_values(self) -> '_4821.WhineWaterfallReferenceValues[_1256.VelocitySmall]':
        ...
        return constructor.new(_4821.WhineWaterfallReferenceValues)[_1256.VelocitySmall](self.wrapped.SmallVelocityReferenceValues) if self.wrapped.SmallVelocityReferenceValues else None

    @property
    def angular_velocity_reference_values(self) -> '_4821.WhineWaterfallReferenceValues[_1164.AngularVelocity]':
        ...
        return constructor.new(_4821.WhineWaterfallReferenceValues)[_1164.AngularVelocity](self.wrapped.AngularVelocityReferenceValues) if self.wrapped.AngularVelocityReferenceValues else None

    @property
    def acceleration_reference_values(self) -> '_4821.WhineWaterfallReferenceValues[_1155.Acceleration]':
        ...
        return constructor.new(_4821.WhineWaterfallReferenceValues)[_1155.Acceleration](self.wrapped.AccelerationReferenceValues) if self.wrapped.AccelerationReferenceValues else None

    @property
    def angular_acceleration_reference_values(self) -> '_4821.WhineWaterfallReferenceValues[_1160.AngularAcceleration]':
        ...
        return constructor.new(_4821.WhineWaterfallReferenceValues)[_1160.AngularAcceleration](self.wrapped.AngularAccelerationReferenceValues) if self.wrapped.AngularAccelerationReferenceValues else None

    @property
    def force_reference_values(self) -> '_4821.WhineWaterfallReferenceValues[_1178.Force]':
        ...
        return constructor.new(_4821.WhineWaterfallReferenceValues)[_1178.Force](self.wrapped.ForceReferenceValues) if self.wrapped.ForceReferenceValues else None

    @property
    def torque_reference_values(self) -> '_4821.WhineWaterfallReferenceValues[_1251.Torque]':
        ...
        return constructor.new(_4821.WhineWaterfallReferenceValues)[_1251.Torque](self.wrapped.TorqueReferenceValues) if self.wrapped.TorqueReferenceValues else None

    @property
    def energy_reference_values(self) -> '_4821.WhineWaterfallReferenceValues[_1172.Energy]':
        ...
        return constructor.new(_4821.WhineWaterfallReferenceValues)[_1172.Energy](self.wrapped.EnergyReferenceValues) if self.wrapped.EnergyReferenceValues else None

    @property
    def power_small_reference_values(self) -> '_4821.WhineWaterfallReferenceValues[_1222.PowerSmall]':
        ...
        return constructor.new(_4821.WhineWaterfallReferenceValues)[_1222.PowerSmall](self.wrapped.PowerSmallReferenceValues) if self.wrapped.PowerSmallReferenceValues else None

    @property
    def power_small_per_unit_area_reference_values(self) -> '_4821.WhineWaterfallReferenceValues[_1223.PowerSmallPerArea]':
        ...
        return constructor.new(_4821.WhineWaterfallReferenceValues)[_1223.PowerSmallPerArea](self.wrapped.PowerSmallPerUnitAreaReferenceValues) if self.wrapped.PowerSmallPerUnitAreaReferenceValues else None

    @property
    def pressure_reference_values(self) -> '_4821.WhineWaterfallReferenceValues[_1226.Pressure]':
        ...
        return constructor.new(_4821.WhineWaterfallReferenceValues)[_1226.Pressure](self.wrapped.PressureReferenceValues) if self.wrapped.PressureReferenceValues else None

    @property
    def result_location_selection_groups(self) -> '_5403.ResultLocationSelectionGroups':
        ...
        return constructor.new(_5403.ResultLocationSelectionGroups)(self.wrapped.ResultLocationSelectionGroups) if self.wrapped.ResultLocationSelectionGroups else None

    @property
    def active_result_locations(self) -> 'List[_5404.ResultNodeSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ActiveResultLocations, constructor.new(_5404.ResultNodeSelection))
        return value

    @property
    def degrees_of_freedom(self) -> 'List[_1351.EnumWithBool[_1080.ResultOptionsFor3DVector]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DegreesOfFreedom, constructor.new(_1351.EnumWithBool)[_1080.ResultOptionsFor3DVector])
        return value
