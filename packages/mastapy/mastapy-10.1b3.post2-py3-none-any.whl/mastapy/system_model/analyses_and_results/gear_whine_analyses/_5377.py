...
class StraightBevelSunGearGearWhineAnalysis(_5370.StraightBevelDiffGearGearWhineAnalysis):
    '''StraightBevelSunGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2321.StraightBevelSunGearSystemDeflection':
