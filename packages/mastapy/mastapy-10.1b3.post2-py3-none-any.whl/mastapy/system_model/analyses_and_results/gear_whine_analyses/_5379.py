...
class SynchroniserHalfGearWhineAnalysis(_5380.SynchroniserPartGearWhineAnalysis):
    '''SynchroniserHalfGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2322.SynchroniserHalfSystemDeflection':
