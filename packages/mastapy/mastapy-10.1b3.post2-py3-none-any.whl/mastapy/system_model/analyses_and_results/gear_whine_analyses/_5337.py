...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5299, _5235
...
class RootAssemblyGearWhineAnalysis(_5235.AssemblyGearWhineAnalysis):
    '''RootAssemblyGearWhineAnalysis
    ...
    @property
    def gear_whine_analysis_inputs(self) -> '_5299.GearWhineAnalysis':
        ...
        return constructor.new(_5299.GearWhineAnalysis)(self.wrapped.GearWhineAnalysisInputs) if self.wrapped.GearWhineAnalysisInputs else None
