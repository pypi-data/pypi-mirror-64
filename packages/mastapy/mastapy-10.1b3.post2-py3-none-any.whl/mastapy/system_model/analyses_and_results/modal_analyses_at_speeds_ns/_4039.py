...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4038, _4037, _3959
...
class SpiralBevelGearSetModalAnalysesAtSpeeds(_3959.BevelGearSetModalAnalysesAtSpeeds):
    '''SpiralBevelGearSetModalAnalysesAtSpeeds
    ...
    @property
    def spiral_bevel_gears_modal_analyses_at_speeds(self) -> 'List[_4038.SpiralBevelGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsModalAnalysesAtSpeeds, constructor.new(_4038.SpiralBevelGearModalAnalysesAtSpeeds))
        return value

    @property
    def spiral_bevel_meshes_modal_analyses_at_speeds(self) -> 'List[_4037.SpiralBevelGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesModalAnalysesAtSpeeds, constructor.new(_4037.SpiralBevelGearMeshModalAnalysesAtSpeeds))
        return value
