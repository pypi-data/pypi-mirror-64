...
from mastapy.system_model.analyses_and_results.load_case_groups import _5232, _5233, _5229
...
class DesignState(_5229.AbstractDesignStateLoadCaseGroup):
    '''DesignState
    ...
    @property
    def clutches(self) -> 'List[_5232.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Clutches, constructor.new(_5232.ClutchEngagementStatus))
        return value

    @property
    def concept_synchro_mounted_gears(self) -> 'List[_5233.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptSynchroMountedGears, constructor.new(_5233.ConceptSynchroGearEngagementStatus))
        return value

    def clutch_engagement_status_for(self, clutch_connection: '_1892.ClutchConnection') -> '_5232.ClutchEngagementStatus':
        ...
        return constructor.new(_5232.ClutchEngagementStatus)(method_result) if method_result else None

    def concept_synchro_gear_engagement_status_for(self, gear: '_2061.CylindricalGear') -> '_5233.ConceptSynchroGearEngagementStatus':
        ...
        return constructor.new(_5233.ConceptSynchroGearEngagementStatus)(method_result) if method_result else None
    ...
    def create_load_case(self, name: Optional['str'] = 'New Static Load') -> '_6181.StaticLoadCase':
        ...
        return constructor.new(_6181.StaticLoadCase)(method_result) if method_result else None
