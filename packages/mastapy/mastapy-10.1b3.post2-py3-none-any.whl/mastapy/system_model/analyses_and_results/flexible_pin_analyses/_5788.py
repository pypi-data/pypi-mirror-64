...
class FlexiblePinAnalysisManufactureLevel(_5784.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisManufactureLevel
    ...
    @property
    def planetary_mesh_analysis(self) -> '_3501.CylindricalGearMeshParametricStudyTool':
        ...
        return constructor.new(_3501.CylindricalGearMeshParametricStudyTool)(self.wrapped.PlanetaryMeshAnalysis) if self.wrapped.PlanetaryMeshAnalysis else None
