...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3062, _3060, _2994
...
class WormGearSetSteadyStateSynchronousResponse(_2994.GearSetSteadyStateSynchronousResponse):
    ...
    def worm_gears_steady_state_synchronous_response(self) -> 'List[_3062.WormGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsSteadyStateSynchronousResponse, constructor.new(_3062.WormGearSteadyStateSynchronousResponse))
        return value
    ...
    def worm_meshes_steady_state_synchronous_response(self) -> 'List[_3060.WormGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesSteadyStateSynchronousResponse, constructor.new(_3060.WormGearMeshSteadyStateSynchronousResponse))
        return value
