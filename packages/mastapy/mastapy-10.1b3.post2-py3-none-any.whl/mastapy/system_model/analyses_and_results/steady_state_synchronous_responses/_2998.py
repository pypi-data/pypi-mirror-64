...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2999, _2997, _2944
...
class HypoidGearSetSteadyStateSynchronousResponse(_2944.AGMAGleasonConicalGearSetSteadyStateSynchronousResponse):
    '''HypoidGearSetSteadyStateSynchronousResponse
    ...
    def hypoid_gears_steady_state_synchronous_response(self) -> 'List[_2999.HypoidGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsSteadyStateSynchronousResponse, constructor.new(_2999.HypoidGearSteadyStateSynchronousResponse))
        return value
    ...
    def hypoid_meshes_steady_state_synchronous_response(self) -> 'List[_2997.HypoidGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesSteadyStateSynchronousResponse, constructor.new(_2997.HypoidGearMeshSteadyStateSynchronousResponse))
        return value
