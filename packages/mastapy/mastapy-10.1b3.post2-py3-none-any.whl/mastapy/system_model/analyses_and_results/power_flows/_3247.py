...
from mastapy.system_model.analyses_and_results.power_flows import _3245, _3246, _3286
...
class GearSetPowerFlow(_3286.SpecialisedAssemblyPowerFlow):
    '''GearSetPowerFlow
    ...
    @property
    def meshes_power_flow(self) -> 'List[_3245.GearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3245.GearMeshPowerFlow))
        return value

    @property
    def gears_power_flow(self) -> 'List[_3246.GearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3246.GearPowerFlow))
        return value
