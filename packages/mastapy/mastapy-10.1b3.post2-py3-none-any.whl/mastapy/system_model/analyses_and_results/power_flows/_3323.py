...
from mastapy.system_model.analyses_and_results.power_flows import _3321, _3306
...
class SynchroniserPowerFlow(_3306.SpecialisedAssemblyPowerFlow):
    '''SynchroniserPowerFlow
    ...
    @property
    def cones(self) -> 'List[_3321.SynchroniserHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_3321.SynchroniserHalfPowerFlow))
        return value
