...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3325
...
class CVTBeltConnectionCompoundPowerFlow(_3325.BeltConnectionCompoundPowerFlow):
    '''CVTBeltConnectionCompoundPowerFlow
