...
class TorqueConverterConnectionSystemDeflection(_2241.CouplingConnectionSystemDeflection):
    '''TorqueConverterConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3326.TorqueConverterConnectionPowerFlow':
