...
class SystemDeflection(_6487.FEAnalysis):
    '''SystemDeflection
    ...
    @property
    def analysis_options(self) -> '_2328.SystemDeflectionOptions':
        ...
        return constructor.new(_2328.SystemDeflectionOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None
