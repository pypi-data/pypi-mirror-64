...
from mastapy.system_model.analyses_and_results.power_flows import _3322, _3321, _3324
...
class SynchroniserPartSystemDeflection(_2242.CouplingHalfSystemDeflection):
    '''SynchroniserPartSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3322.SynchroniserPartPowerFlow':
