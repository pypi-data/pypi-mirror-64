...
class GearCompoundSystemDeflection(_2403.MountableComponentCompoundSystemDeflection):
    '''GearCompoundSystemDeflection
    ...
    def duty_cycle_rating_of_type_concept_gear_duty_cycle_rating(self) -> '_331.ConceptGearDutyCycleRating':
        ...
        return constructor.new(_331.ConceptGearDutyCycleRating)(self.wrapped.DutyCycleRating) if self.wrapped.DutyCycleRating else None
