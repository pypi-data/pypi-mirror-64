...
from mastapy.system_model.analyses_and_results import _2180, _2178
...
class DesignEntityCompoundAnalysis(_2178.DesignEntityAnalysis):
    '''DesignEntityCompoundAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2180.DesignEntitySingleContextAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2180.DesignEntitySingleContextAnalysis))
        return value
