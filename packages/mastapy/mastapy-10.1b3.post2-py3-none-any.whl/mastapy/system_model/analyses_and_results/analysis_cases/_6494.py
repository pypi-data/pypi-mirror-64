...
class TimeSeriesLoadAnalysisCase(_6478.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6195.TimeSeriesLoadCase':
        ...
        return constructor.new(_6195.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
