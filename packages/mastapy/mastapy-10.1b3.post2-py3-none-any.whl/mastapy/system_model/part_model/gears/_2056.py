...
class KlingelnbergCycloPalloidSpiralBevelGear(_2052.KlingelnbergCycloPalloidConicalGear):
    '''KlingelnbergCycloPalloidSpiralBevelGear
    ...
    @property
    def conical_gear_design(self) -> '_728.KlingelnbergCycloPalloidSpiralBevelGearDesign':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_design(self) -> '_728.KlingelnbergCycloPalloidSpiralBevelGearDesign':
        ...
        return constructor.new(_728.KlingelnbergCycloPalloidSpiralBevelGearDesign)(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearDesign) if self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearDesign else None
