...
class SuperchargerRotorSet(_1340.NamedDatabaseItem):
    '''SuperchargerRotorSet
    ...
    @property
    def y_variable_for_imported_data(self) -> '_2101.YVariableForImportedData':
        ...
        return constructor.new(_2101.YVariableForImportedData)(value) if value else None

    @y_variable_for_imported_data.setter
    def y_variable_for_imported_data(self, value: '_2101.YVariableForImportedData'):
    ...
    @property
    def file(self) -> '_2094.RotorSetDataInputFileOptions':
        ...
        return constructor.new(_2094.RotorSetDataInputFileOptions)(self.wrapped.File) if self.wrapped.File else None

    @property
    def rotor_speed(self) -> '_2096.RotorSpeedInputOptions':
        ...
        return constructor.new(_2096.RotorSpeedInputOptions)(self.wrapped.RotorSpeed) if self.wrapped.RotorSpeed else None

    @property
    def boost_pressure(self) -> '_2091.BoostPressureInputOptions':
        ...
        return constructor.new(_2091.BoostPressureInputOptions)(self.wrapped.BoostPressure) if self.wrapped.BoostPressure else None

    @property
    def pressure_ratio(self) -> '_2093.PressureRatioInputOptions':
        ...
        return constructor.new(_2093.PressureRatioInputOptions)(self.wrapped.PressureRatio) if self.wrapped.PressureRatio else None

    @property
    def input_power(self) -> '_2092.InputPowerInputOptions':
        ...
        return constructor.new(_2092.InputPowerInputOptions)(self.wrapped.InputPower) if self.wrapped.InputPower else None

    @property
    def measured_points(self) -> 'List[_2095.RotorSetMeasuredPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeasuredPoints, constructor.new(_2095.RotorSetMeasuredPoint))
        return value
