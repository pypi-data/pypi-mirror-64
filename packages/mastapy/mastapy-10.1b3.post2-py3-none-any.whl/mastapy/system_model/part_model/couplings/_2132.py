...
from mastapy.system_model.part_model.couplings import _2136, _2134
...
class Synchroniser(_2014.SpecialisedAssembly):
    '''Synchroniser
    ...
    @property
    def hub_and_sleeve(self) -> '_2136.SynchroniserSleeve':
        ...
        return constructor.new(_2136.SynchroniserSleeve)(self.wrapped.HubAndSleeve) if self.wrapped.HubAndSleeve else None

    @property
    def left_cone(self) -> '_2134.SynchroniserHalf':
        ...
        return constructor.new(_2134.SynchroniserHalf)(self.wrapped.LeftCone) if self.wrapped.LeftCone else None

    @property
    def right_cone(self) -> '_2134.SynchroniserHalf':
        ...
        return constructor.new(_2134.SynchroniserHalf)(self.wrapped.RightCone) if self.wrapped.RightCone else None

    @property
    def clutch_connection_left(self) -> '_1892.ClutchConnection':
        ...
        return constructor.new(_1892.ClutchConnection)(self.wrapped.ClutchConnectionLeft) if self.wrapped.ClutchConnectionLeft else None

    @property
    def clutch_connection_right(self) -> '_1892.ClutchConnection':
        ...
        return constructor.new(_1892.ClutchConnection)(self.wrapped.ClutchConnectionRight) if self.wrapped.ClutchConnectionRight else None
