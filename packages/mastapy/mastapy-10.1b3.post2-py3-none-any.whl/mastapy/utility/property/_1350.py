...
from mastapy.utility.units_and_measurements.measurements import _1240
...
class DutyCyclePropertySummaryStress(_1346.DutyCyclePropertySummary['_1240.Stress', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryStress
