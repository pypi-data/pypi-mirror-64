...
class MeasurementBase(_0.APIBase):
    ...
    @property
    def rounding_method(self) -> '_1141.RoundingMethods':
        ...
        return constructor.new(_1141.RoundingMethods)(value) if value else None

    @rounding_method.setter
    def rounding_method(self, value: '_1141.RoundingMethods'):
    ...
    @property
    def current_unit(self) -> '_1153.Unit':
        ...
        return constructor.new(_1153.Unit)(self.wrapped.CurrentUnit) if self.wrapped.CurrentUnit else None
