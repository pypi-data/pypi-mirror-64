...
from mastapy.nodal_analysis.component_mode_synthesis import _1489, _1486
...
class FullFEModel(_0.APIBase):
    ...
    @property
    def fe_model(self) -> '_1456.FEModel':
        ...
        return constructor.new(_1456.FEModel)(self.wrapped.FEModel) if self.wrapped.FEModel else None

    @property
    def reduction_options(self) -> '_1489.CMSOptions':
        ...
        return constructor.new(_1489.CMSOptions)(self.wrapped.ReductionOptions) if self.wrapped.ReductionOptions else None

    @property
    def element_face_groups(self) -> 'List[_1486.CMSElementFaceGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_1486.CMSElementFaceGroup))
        return value
