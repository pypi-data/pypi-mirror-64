...
class ElementPropertiesMass(_1475.ElementPropertiesBase):
    '''ElementPropertiesMass
    ...
    @property
    def inertia(self) -> '_1074.InertiaTensor':
        ...
        return constructor.new(_1074.InertiaTensor)(self.wrapped.Inertia) if self.wrapped.Inertia else None
