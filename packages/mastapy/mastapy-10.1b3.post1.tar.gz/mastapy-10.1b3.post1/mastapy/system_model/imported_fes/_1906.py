...
from mastapy.math_utility import _1059, _1058
...
class AlignConnectedComponentOptions(_0.APIBase):
    ...
    @property
    def first_component_alignment_axis(self) -> '_1059.Axis':
        ...
        return constructor.new(_1059.Axis)(value) if value else None

    @first_component_alignment_axis.setter
    def first_component_alignment_axis(self, value: '_1059.Axis'):
    ...
    @property
    def first_fe_alignment_axis(self) -> '_1058.AlignmentAxis':
        ...
        return constructor.new(_1058.AlignmentAxis)(value) if value else None

    @first_fe_alignment_axis.setter
    def first_fe_alignment_axis(self, value: '_1058.AlignmentAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def component_direction_normal_to_surface(self) -> '_1059.Axis':
    ...
    def component_direction_normal_to_surface(self, value: '_1059.Axis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def fe_axis_approximately_in_perpendicular_direction(self) -> '_1058.AlignmentAxis':
    ...
    def fe_axis_approximately_in_perpendicular_direction(self, value: '_1058.AlignmentAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
