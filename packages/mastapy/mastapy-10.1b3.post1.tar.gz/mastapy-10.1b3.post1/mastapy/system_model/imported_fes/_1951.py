...
class IndependentMastaCreatedCondensationNode(_0.APIBase):
    ...
    @property
    def rigid_coupling_type(self) -> '_1472.RigidCouplingType':
        ...
        return constructor.new(_1472.RigidCouplingType)(value) if value else None

    @rigid_coupling_type.setter
    def rigid_coupling_type(self, value: '_1472.RigidCouplingType'):
    ...
    @property
    def imported_fe_node(self) -> '_1944.ImportedFEStiffnessNode':
        ...
        return constructor.new(_1944.ImportedFEStiffnessNode)(self.wrapped.ImportedFENode) if self.wrapped.ImportedFENode else None
