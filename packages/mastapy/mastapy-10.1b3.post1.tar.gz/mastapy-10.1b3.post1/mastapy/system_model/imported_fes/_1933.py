...
from mastapy.system_model.imported_fes import _1923, _1938
...
class ImportedFEElectricMachineStatorLink(_1938.ImportedFEMultiNodeLink):
    '''ImportedFEElectricMachineStatorLink
    ...
    @property
    def electric_machine_dynamic_load_data(self) -> '_1923.ElectricMachineDynamicLoadData':
        ...
        return constructor.new(_1923.ElectricMachineDynamicLoadData)(self.wrapped.ElectricMachineDynamicLoadData) if self.wrapped.ElectricMachineDynamicLoadData else None
