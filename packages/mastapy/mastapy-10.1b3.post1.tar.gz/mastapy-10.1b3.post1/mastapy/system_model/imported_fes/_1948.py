...
class ImportedFEWithSelectionForHarmonicAnalysis(_1946.ImportedFEWithSelection):
    '''ImportedFEWithSelectionForHarmonicAnalysis
    ...
    @property
    def harmonic_draw_style(self) -> '_1458.FEModelHarmonicAnalysisDrawStyle':
        ...
        return constructor.new(_1458.FEModelHarmonicAnalysisDrawStyle)(self.wrapped.HarmonicDrawStyle) if self.wrapped.HarmonicDrawStyle else None
