...
class BaseFEWithSelection(_0.APIBase):
    ...
    @property
    def node_selection(self) -> '_1465.FENodeSelectionDrawStyle':
        ...
        return constructor.new(_1465.FENodeSelectionDrawStyle)(self.wrapped.NodeSelection) if self.wrapped.NodeSelection else None

    @property
    def draw_style(self) -> '_1450.DrawStyleForImportedFE':
        ...
        return constructor.new(_1450.DrawStyleForImportedFE)(self.wrapped.DrawStyle) if self.wrapped.DrawStyle else None

    @property
    def transparency_draw_style(self) -> '_1464.FEModelTransparencyDrawStyle':
        ...
        return constructor.new(_1464.FEModelTransparencyDrawStyle)(self.wrapped.TransparencyDrawStyle) if self.wrapped.TransparencyDrawStyle else None

    @property
    def component_draw_style(self) -> '_1457.FEModelComponentDrawStyle':
        ...
        return constructor.new(_1457.FEModelComponentDrawStyle)(self.wrapped.ComponentDrawStyle) if self.wrapped.ComponentDrawStyle else None
