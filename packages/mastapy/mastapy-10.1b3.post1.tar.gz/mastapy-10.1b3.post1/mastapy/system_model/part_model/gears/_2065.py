...
from mastapy.system_model.part_model.gears import _2064, _2068
...
class FaceGearSet(_2068.GearSet):
    '''FaceGearSet
    ...
    @property
    def active_gear_set_design(self) -> '_758.FaceGearSetDesign':
    ...
    @property
    def face_gears(self) -> 'List[_2064.FaceGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGears, constructor.new(_2064.FaceGear))
        return value

    @property
    def face_meshes(self) -> 'List[_1870.FaceGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshes, constructor.new(_1870.FaceGearMesh))
        return value
