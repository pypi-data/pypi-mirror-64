...
from mastapy.system_model.part_model.projections import _2022
...
class RootAssembly(_1977.Assembly):
    '''RootAssembly
    ...
    @property
    def parallel_part_groups_drawing_order(self) -> 'List[_2022.SpecifiedParallelPartGroupDrawingOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelPartGroupsDrawingOrder, constructor.new(_2022.SpecifiedParallelPartGroupDrawingOrder))
        return value

    @property
    def parallel_part_groups(self) -> 'List[_2027.ParallelPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelPartGroups, constructor.new(_2027.ParallelPartGroup))
        return value
