...
class ComponentsConnectedResult(_0.APIBase):
    ...
    @property
    def created_socket_connection(self) -> '_1988.ConnectedSockets':
        ...
        return constructor.new(_1988.ConnectedSockets)(self.wrapped.CreatedSocketConnection) if self.wrapped.CreatedSocketConnection else None
