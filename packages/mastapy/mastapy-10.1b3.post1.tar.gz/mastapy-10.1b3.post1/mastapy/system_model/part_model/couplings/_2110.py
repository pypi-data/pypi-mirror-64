...
from mastapy.system_model.part_model.couplings import _2112, _2115
...
class Clutch(_2115.Coupling):
    ...
    @property
    def clutch_type(self) -> '_2112.ClutchType':
        '''ClutchType: 'ClutchType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ClutchType)
        return constructor.new(_2112.ClutchType)(value) if value else None

    @clutch_type.setter
    def clutch_type(self, value: '_2112.ClutchType'):
    ...
    @property
    def spring_type(self) -> '_4987.ClutchSpringType':
        '''ClutchSpringType: 'SpringType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.SpringType)
        return constructor.new(_4987.ClutchSpringType)(value) if value else None

    @spring_type.setter
    def spring_type(self, value: '_4987.ClutchSpringType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def clutch_connection(self) -> '_1892.ClutchConnection':
        ...
        return constructor.new(_1892.ClutchConnection)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
