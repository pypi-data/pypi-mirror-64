...
from mastapy.system_model.part_model.couplings import _2133, _2135
...
class SynchroniserHalf(_2135.SynchroniserPart):
    '''SynchroniserHalf
    ...
    @property
    def cones(self) -> 'List[_2133.SynchroniserCone]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2133.SynchroniserCone))
        return value
