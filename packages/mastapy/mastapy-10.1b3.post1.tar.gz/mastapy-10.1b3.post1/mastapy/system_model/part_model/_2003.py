...
class MountableComponent(_1986.Component):
    '''MountableComponent
    ...
    def mount_on(self, shaft: '_2019.Shaft', offset: Optional['float'] = float('nan')) -> '_1831.CoaxialConnection':
        ...
        return constructor.new(_1831.CoaxialConnection)(method_result) if method_result else None
