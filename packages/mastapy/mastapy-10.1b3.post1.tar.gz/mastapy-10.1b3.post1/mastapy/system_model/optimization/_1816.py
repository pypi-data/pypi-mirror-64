...
from mastapy.system_model.optimization import _1817
...
class CylindricalGearSetOptimizer(_0.APIBase):
    ...
    @property
    def constraints(self) -> 'List[_1817.MeasuredAndFactorViewModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Constraints, constructor.new(_1817.MeasuredAndFactorViewModel))
        return value
