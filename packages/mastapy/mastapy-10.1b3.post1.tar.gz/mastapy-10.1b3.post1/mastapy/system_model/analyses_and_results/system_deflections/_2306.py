...
from mastapy.system_model.analyses_and_results.power_flows import _3305, _3235, _3291
...
class ShaftToMountableComponentConnectionSystemDeflection(_2239.ConnectionSystemDeflection):
    '''ShaftToMountableComponentConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3305.ShaftToMountableComponentConnectionPowerFlow':
