...
from mastapy.system_model.analyses_and_results.system_deflections import _2310, _2308, _2219
...
class SpiralBevelGearSetSystemDeflection(_2219.BevelGearSetSystemDeflection):
    '''SpiralBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3309.SpiralBevelGearSetPowerFlow':
    ...
    @property
    def spiral_bevel_gears_system_deflection(self) -> 'List[_2310.SpiralBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsSystemDeflection, constructor.new(_2310.SpiralBevelGearSystemDeflection))
        return value
