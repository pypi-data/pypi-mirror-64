...
class BevelDifferentialGearMeshSystemDeflection(_2218.BevelGearMeshSystemDeflection):
    '''BevelDifferentialGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3222.BevelDifferentialGearMeshPowerFlow':
