...
from mastapy.system_model.analyses_and_results.system_deflections import _2316, _2314, _2219
...
class StraightBevelDiffGearSetSystemDeflection(_2219.BevelGearSetSystemDeflection):
    '''StraightBevelDiffGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3315.StraightBevelDiffGearSetPowerFlow':
    ...
    @property
    def straight_bevel_diff_gears_system_deflection(self) -> 'List[_2316.StraightBevelDiffGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsSystemDeflection, constructor.new(_2316.StraightBevelDiffGearSystemDeflection))
        return value

    @property
    def straight_bevel_diff_meshes_system_deflection(self) -> 'List[_2314.StraightBevelDiffGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesSystemDeflection, constructor.new(_2314.StraightBevelDiffGearMeshSystemDeflection))
        return value
