...
class BevelGearMeshSystemDeflection(_2206.AGMAGleasonConicalGearMeshSystemDeflection):
    '''BevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3227.BevelGearMeshPowerFlow':
