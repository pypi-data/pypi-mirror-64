...
class PartToPartShearCouplingHalfSystemDeflection(_2242.CouplingHalfSystemDeflection):
    '''PartToPartShearCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3289.PartToPartShearCouplingHalfPowerFlow':
