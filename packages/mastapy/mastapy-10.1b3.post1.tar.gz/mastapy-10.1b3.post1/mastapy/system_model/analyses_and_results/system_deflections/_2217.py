...
class BevelDifferentialSunGearSystemDeflection(_2215.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialSunGearSystemDeflection
    ...
    @property
    def component_design(self) -> '_2054.BevelDifferentialSunGear':
    ...
    @property
    def power_flow_results(self) -> '_3226.BevelDifferentialSunGearPowerFlow':
