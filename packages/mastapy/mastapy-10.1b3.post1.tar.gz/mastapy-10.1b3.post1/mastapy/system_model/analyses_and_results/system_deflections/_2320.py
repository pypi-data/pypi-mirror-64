...
class StraightBevelPlanetGearSystemDeflection(_2316.StraightBevelDiffGearSystemDeflection):
    '''StraightBevelPlanetGearSystemDeflection
    ...
    @property
    def component_design(self) -> '_2085.StraightBevelPlanetGear':
    ...
    @property
    def power_flow_results(self) -> '_3319.StraightBevelPlanetGearPowerFlow':
