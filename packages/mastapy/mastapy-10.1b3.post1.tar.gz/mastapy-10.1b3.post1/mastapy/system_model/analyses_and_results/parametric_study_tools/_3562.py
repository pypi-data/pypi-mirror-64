...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3545, _3465
...
class RootAssemblyParametricStudyTool(_3465.AssemblyParametricStudyTool):
    '''RootAssemblyParametricStudyTool
    ...
    @property
    def parametric_study_tool_inputs(self) -> '_3545.ParametricStudyTool':
        ...
        return constructor.new(_3545.ParametricStudyTool)(self.wrapped.ParametricStudyToolInputs) if self.wrapped.ParametricStudyToolInputs else None
