...
from mastapy.system_model.analyses_and_results.static_loads import _6049, _6151
from mastapy.system_model import _1797
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3547, _3548
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    @property
    def parametric_study_type(self) -> '_6151.ParametricStudyType':
        ...
        return constructor.new(_6151.ParametricStudyType)(value) if value else None

    @parametric_study_type.setter
    def parametric_study_type(self, value: '_6151.ParametricStudyType'):
    ...
    @property
    def external_full_fe_loader(self) -> '_1797.ExternalFullFELoader':
        ...
        return constructor.new(_1797.ExternalFullFELoader)(self.wrapped.ExternalFullFELoader) if self.wrapped.ExternalFullFELoader else None

    @property
    def step_results(self) -> 'List[_3547.ParametricStudyToolStepResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StepResults, constructor.new(_3547.ParametricStudyToolStepResult))
        return value

    @property
    def study_variables(self) -> 'List[_3548.ParametricStudyVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StudyVariables, constructor.new(_3548.ParametricStudyVariable))
        return value
