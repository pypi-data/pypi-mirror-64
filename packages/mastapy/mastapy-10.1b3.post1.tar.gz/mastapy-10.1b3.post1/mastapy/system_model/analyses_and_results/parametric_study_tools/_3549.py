...
class PartParametricStudyTool(_6488.PartAnalysisCase):
    '''PartParametricStudyTool
    ...
    @property
    def parametric_study_tool(self) -> '_3545.ParametricStudyTool':
        ...
        return constructor.new(_3545.ParametricStudyTool)(self.wrapped.ParametricStudyTool) if self.wrapped.ParametricStudyTool else None
