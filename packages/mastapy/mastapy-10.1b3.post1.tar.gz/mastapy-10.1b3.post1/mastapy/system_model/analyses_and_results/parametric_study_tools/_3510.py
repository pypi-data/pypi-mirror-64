...
class DutyCycleResultsForSingleBearing(_0.APIBase):
    ...
    @property
    def duty_cycle_results(self) -> '_1568.LoadedBearingDutyCycle':
        ...
        return constructor.new(_1568.LoadedBearingDutyCycle)(self.wrapped.DutyCycleResults) if self.wrapped.DutyCycleResults else None
