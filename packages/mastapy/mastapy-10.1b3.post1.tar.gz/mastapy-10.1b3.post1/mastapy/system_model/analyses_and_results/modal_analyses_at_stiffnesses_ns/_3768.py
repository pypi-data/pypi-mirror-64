...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3767, _3766, _3772
...
class FaceGearSetModalAnalysesAtStiffnesses(_3772.GearSetModalAnalysesAtStiffnesses):
    '''FaceGearSetModalAnalysesAtStiffnesses
    ...
    @property
    def face_gears_modal_analyses_at_stiffnesses(self) -> 'List[_3767.FaceGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsModalAnalysesAtStiffnesses, constructor.new(_3767.FaceGearModalAnalysesAtStiffnesses))
        return value

    @property
    def face_meshes_modal_analyses_at_stiffnesses(self) -> 'List[_3766.FaceGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesModalAnalysesAtStiffnesses, constructor.new(_3766.FaceGearMeshModalAnalysesAtStiffnesses))
        return value
