...
class DesignEntityAnalysis(_0.APIBase):
    ...
    @property
    def component_design(self) -> '_1793.DesignEntity':
        ...
        return constructor.new(_1793.DesignEntity)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    @property
    def component_design_of_type_connection(self) -> '_1834.Connection':
        ...
        if _1834.Connection.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_part(self) -> '_2006.Part':
        ...
        if _2006.Part.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
