...
TConnection = TypeVar('TConnection', bound='_1834.Connection')
TConnectionStaticLoad = TypeVar('TConnectionStaticLoad', bound='_6080.ConnectionLoadCase')


class ConnectionStaticLoadCaseGroup(_5246.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]):
    '''ConnectionStaticLoadCaseGroup
