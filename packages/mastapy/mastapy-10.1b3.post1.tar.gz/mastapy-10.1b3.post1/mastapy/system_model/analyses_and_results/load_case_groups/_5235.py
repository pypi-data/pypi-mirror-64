...
from mastapy.system_model.analyses_and_results.load_case_groups import _5239, _5231
...
class DutyCycle(_5231.AbstractStaticLoadCaseGroup):
    '''DutyCycle
    ...
    @property
    def duty_cycle_design_states(self) -> 'List[_5239.SubGroupInSingleDesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycleDesignStates, constructor.new(_5239.SubGroupInSingleDesignState))
        return value
    ...
    def add_static_load(self, static_load: '_6181.StaticLoadCase'):
    ...
    def remove_static_load(self, static_load: '_6181.StaticLoadCase'):
    ...
    def remove_design_state_sub_group(self, sub_group: '_5239.SubGroupInSingleDesignState'):
