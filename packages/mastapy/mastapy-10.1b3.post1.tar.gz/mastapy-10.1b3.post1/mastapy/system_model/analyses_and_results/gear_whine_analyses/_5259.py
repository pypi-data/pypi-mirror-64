...
class BevelDifferentialGearGearWhineAnalysis(_5264.BevelGearGearWhineAnalysis):
    '''BevelDifferentialGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2215.BevelDifferentialGearSystemDeflection':
