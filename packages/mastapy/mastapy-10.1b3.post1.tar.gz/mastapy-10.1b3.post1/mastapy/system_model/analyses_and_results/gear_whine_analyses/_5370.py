...
class StraightBevelDiffGearGearWhineAnalysis(_5264.BevelGearGearWhineAnalysis):
    '''StraightBevelDiffGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2316.StraightBevelDiffGearSystemDeflection':
