...
class SpringDamperConnectionGearWhineAnalysis(_5286.CouplingConnectionGearWhineAnalysis):
    '''SpringDamperConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2311.SpringDamperConnectionSystemDeflection':
