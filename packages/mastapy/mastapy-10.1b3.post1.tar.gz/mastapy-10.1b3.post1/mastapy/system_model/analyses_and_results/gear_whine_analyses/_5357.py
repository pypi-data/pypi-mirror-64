...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5319, _5255
...
class RootAssemblyGearWhineAnalysis(_5255.AssemblyGearWhineAnalysis):
    '''RootAssemblyGearWhineAnalysis
    ...
    @property
    def gear_whine_analysis_inputs(self) -> '_5319.GearWhineAnalysis':
        ...
        return constructor.new(_5319.GearWhineAnalysis)(self.wrapped.GearWhineAnalysisInputs) if self.wrapped.GearWhineAnalysisInputs else None
