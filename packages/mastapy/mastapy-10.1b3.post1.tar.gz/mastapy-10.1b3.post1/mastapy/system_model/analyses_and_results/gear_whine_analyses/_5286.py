...
class CouplingConnectionGearWhineAnalysis(_5329.InterMountableComponentConnectionGearWhineAnalysis):
    '''CouplingConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2241.CouplingConnectionSystemDeflection':
