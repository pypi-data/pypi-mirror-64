...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5363, _5314
...
class GearWhineAnalysisOptions(_0.APIBase):
    ...
    @property
    def modal_analysis_options(self) -> '_4772.ModalAnalysisOptions':
        ...
        return constructor.new(_4772.ModalAnalysisOptions)(self.wrapped.ModalAnalysisOptions) if self.wrapped.ModalAnalysisOptions else None
