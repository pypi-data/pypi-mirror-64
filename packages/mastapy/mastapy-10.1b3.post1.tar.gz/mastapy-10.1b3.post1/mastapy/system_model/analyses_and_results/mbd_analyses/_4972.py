...
class BeltConnectionMultiBodyDynamicsAnalysis(_5030.InterMountableComponentConnectionMultiBodyDynamicsAnalysis):
    '''BeltConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def loading_status(self) -> '_1379.LoadingStatus':
        ...
        return constructor.new(_1379.LoadingStatus)(value) if value else None
