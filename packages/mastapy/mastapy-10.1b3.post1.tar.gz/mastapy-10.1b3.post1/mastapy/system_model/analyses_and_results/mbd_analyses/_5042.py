...
from mastapy.system_model.analyses_and_results.mbd_analyses import (
    _4971, _5018, _4968, _5063,
    _5026, _5027, _5043
)
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.system_model.part_model import _2010
from mastapy.nodal_analysis import _1390
from mastapy.system_model.analyses_and_results.mbd_analyses.external_interfaces import _5107
...
class MBDAnalysisOptions(_0.APIBase):
    ...
    @property
    def analysis_type(self) -> '_4968.AnalysisTypes':
        '''AnalysisTypes: 'AnalysisType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.AnalysisType)
        return constructor.new(_4968.AnalysisTypes)(value) if value else None

    @analysis_type.setter
    def analysis_type(self, value: '_4968.AnalysisTypes'):
    ...
    @property
    def method_to_define_period(self) -> '_5026.InertiaAdjustedLoadCasePeriodMethod':
        ...
        return constructor.new(_5026.InertiaAdjustedLoadCasePeriodMethod)(value) if value else None

    @method_to_define_period.setter
    def method_to_define_period(self, value: '_5026.InertiaAdjustedLoadCasePeriodMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def static_load_cases_to_create(self) -> '_5027.InertiaAdjustedLoadCaseResultsToCreate':
        ...
        return constructor.new(_5027.InertiaAdjustedLoadCaseResultsToCreate)(value) if value else None

    @static_load_cases_to_create.setter
    def static_load_cases_to_create(self, value: '_5027.InertiaAdjustedLoadCaseResultsToCreate'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def transient_solver_options(self) -> '_1390.TransientSolverOptions':
        ...
        return constructor.new(_1390.TransientSolverOptions)(self.wrapped.TransientSolverOptions) if self.wrapped.TransientSolverOptions else None

    @property
    def external_interface_options(self) -> '_5107.DynamicExternalInterfaceOptions':
        ...
        return constructor.new(_5107.DynamicExternalInterfaceOptions)(self.wrapped.ExternalInterfaceOptions) if self.wrapped.ExternalInterfaceOptions else None

    @property
    def run_up_analysis_options(self) -> '_5043.MBDRunUpAnalysisOptions':
        ...
        return constructor.new(_5043.MBDRunUpAnalysisOptions)(self.wrapped.RunUpAnalysisOptions) if self.wrapped.RunUpAnalysisOptions else None

    @property
    def frequency_response_options(self) -> '_4748.FrequencyResponseAnalysisOptions':
        ...
        return constructor.new(_4748.FrequencyResponseAnalysisOptions)(self.wrapped.FrequencyResponseOptions) if self.wrapped.FrequencyResponseOptions else None
