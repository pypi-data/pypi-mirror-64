...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5057, _5068
...
class BeltDriveMultiBodyDynamicsAnalysis(_5068.SpecialisedAssemblyMultiBodyDynamicsAnalysis):
    '''BeltDriveMultiBodyDynamicsAnalysis
    ...
    @property
    def pulleys(self) -> 'List[_5057.PulleyMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_5057.PulleyMultiBodyDynamicsAnalysis))
        return value
