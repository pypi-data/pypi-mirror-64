...
class PulleyMultiBodyDynamicsAnalysis(_5002.CouplingHalfMultiBodyDynamicsAnalysis):
    '''PulleyMultiBodyDynamicsAnalysis
    ...
    @property
    def peak_pulley_torque(self) -> 'List[_5105.DynamicTorqueResultAtTime]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PeakPulleyTorque, constructor.new(_5105.DynamicTorqueResultAtTime))
        return value
