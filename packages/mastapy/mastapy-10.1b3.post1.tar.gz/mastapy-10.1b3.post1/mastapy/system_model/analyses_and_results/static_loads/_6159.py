...
from mastapy.system_model.analyses_and_results.static_loads import _6158, _6148
...
class PlanetCarrierLoadCase(_6148.MountableComponentLoadCase):
    '''PlanetCarrierLoadCase
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6158.PlanetarySocketManufactureError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetManufactureErrors, constructor.new(_6158.PlanetarySocketManufactureError))
        return value
