...
class GearSetHarmonicLoadData(_6123.HarmonicLoadDataBase):
    '''GearSetHarmonicLoadData
    ...
    @property
    def gear_mesh_te_order_type(self) -> '_6118.GearMeshTEOrderType':
        ...
        return constructor.new(_6118.GearMeshTEOrderType)(value) if value else None

    @gear_mesh_te_order_type.setter
    def gear_mesh_te_order_type(self, value: '_6118.GearMeshTEOrderType'):
