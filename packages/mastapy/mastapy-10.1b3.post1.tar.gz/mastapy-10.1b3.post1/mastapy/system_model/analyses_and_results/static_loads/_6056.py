...
from mastapy.system_model.analyses_and_results.static_loads import _6054, _6055, _6061
...
class BevelDifferentialGearSetLoadCase(_6061.BevelGearSetLoadCase):
    '''BevelDifferentialGearSetLoadCase
    ...
    @property
    def bevel_differential_gears_load_case(self) -> 'List[_6054.BevelDifferentialGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsLoadCase, constructor.new(_6054.BevelDifferentialGearLoadCase))
        return value

    @property
    def bevel_differential_meshes_load_case(self) -> 'List[_6055.BevelDifferentialGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesLoadCase, constructor.new(_6055.BevelDifferentialGearMeshLoadCase))
        return value
