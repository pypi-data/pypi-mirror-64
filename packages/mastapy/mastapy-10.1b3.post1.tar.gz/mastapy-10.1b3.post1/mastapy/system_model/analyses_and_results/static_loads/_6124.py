...
from mastapy.system_model.analyses_and_results.static_loads import _6149, _6125, _6105
...
class HarmonicLoadDataExcelImport(_6125.HarmonicLoadDataImportBase['_6105.ElectricMachineHarmonicLoadExcelImportOptions']):
    '''HarmonicLoadDataExcelImport
    ...
    @property
    def speeds(self) -> 'List[_6149.NamedSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Speeds, constructor.new(_6149.NamedSpeed))
        return value
