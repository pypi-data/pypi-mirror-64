...
class PartLoadCase(_2181.PartAnalysis):
    '''PartLoadCase
    ...
    @property
    def static_load_case(self) -> '_6181.StaticLoadCase':
        ...
        return constructor.new(_6181.StaticLoadCase)(self.wrapped.StaticLoadCase) if self.wrapped.StaticLoadCase else None

    @property
    def time_series_load_case(self) -> '_6195.TimeSeriesLoadCase':
        ...
        return constructor.new(_6195.TimeSeriesLoadCase)(self.wrapped.TimeSeriesLoadCase) if self.wrapped.TimeSeriesLoadCase else None

    def get_harmonic_load_data_for_import(self) -> '_6123.HarmonicLoadDataBase':
        ...
        return constructor.new(_6123.HarmonicLoadDataBase)(method_result) if method_result else None
