...
from mastapy.system_model import _1802, _1803, _1804
from mastapy.system_model.analyses_and_results.mbd_analyses import _5095
from mastapy.system_model.analyses_and_results.static_loads import _6201, _6100, _6205
from mastapy.system_model.imported_fes import _1922
from mastapy.system_model.part_model import _2010
from mastapy.math_utility.control import _1122
from mastapy.nodal_analysis.varying_input_components import _1399
...
class PowerLoadLoadCase(_6205.VirtualComponentLoadCase):
    '''PowerLoadLoadCase
    ...
    @property
    def drag_torque_specification_method(self) -> '_1802.PowerLoadDragTorqueSpecificationMethod':
        ...
        return constructor.new(_1802.PowerLoadDragTorqueSpecificationMethod)(value) if value else None

    @drag_torque_specification_method.setter
    def drag_torque_specification_method(self, value: '_1802.PowerLoadDragTorqueSpecificationMethod'):
    ...
    @property
    def wheel_slip_model(self) -> '_5095.WheelSlipType':
        ...
        return constructor.new(_5095.WheelSlipType)(value) if value else None

    @wheel_slip_model.setter
    def wheel_slip_model(self, value: '_5095.WheelSlipType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def target_speed_input_type(self) -> '_1804.PowerLoadPIDControlSpeedInputType':
        ...
        return constructor.new(_1804.PowerLoadPIDControlSpeedInputType)(value) if value else None

    @target_speed_input_type.setter
    def target_speed_input_type(self, value: '_1804.PowerLoadPIDControlSpeedInputType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def engine_idle_speed_control_pid_settings(self) -> '_1122.PIDControlSettings':
        ...
        return constructor.new(_1122.PIDControlSettings)(self.wrapped.EngineIdleSpeedControlPIDSettings) if self.wrapped.EngineIdleSpeedControlPIDSettings else None

    @property
    def coefficient_of_friction_with_ground(self) -> '_1399.NonDimensionalInputComponent':
        ...
        return constructor.new(_1399.NonDimensionalInputComponent)(self.wrapped.CoefficientOfFrictionWithGround) if self.wrapped.CoefficientOfFrictionWithGround else None

    @property
    def pid_control_settings(self) -> '_1122.PIDControlSettings':
        ...
        return constructor.new(_1122.PIDControlSettings)(self.wrapped.PIDControlSettings) if self.wrapped.PIDControlSettings else None

    def get_harmonic_load_data_for_import(self) -> '_6100.ElectricMachineHarmonicLoadData':
        ...
        return constructor.new(_6100.ElectricMachineHarmonicLoadData)(method_result) if method_result else None
