...
class GearLoadCase(_6148.MountableComponentLoadCase):
    '''GearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6116.GearManufactureError':
        ...
        return constructor.new(_6116.GearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors else None

    @property
    def gear_manufacture_errors_of_type_conical_gear_manufacture_error(self) -> '_6076.ConicalGearManufactureError':
        ...
        if _6076.ConicalGearManufactureError.TYPE not in self.wrapped.GearManufactureErrors.__class__.__mro__:
        ...
        return constructor.new(_6076.ConicalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors else None

    @property
    def gear_manufacture_errors_of_type_cylindrical_gear_manufacture_error(self) -> '_6089.CylindricalGearManufactureError':
        ...
        if _6089.CylindricalGearManufactureError.TYPE not in self.wrapped.GearManufactureErrors.__class__.__mro__:
        ...
        return constructor.new(_6089.CylindricalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors else None
