...
from mastapy.system_model.analyses_and_results.load_case_groups import _5232, _5233, _5234
...
class StaticLoadCase(_6042.LoadCase):
    '''StaticLoadCase
    ...
    @property
    def gear_whine_harmonic_excitation_analysis_options(self) -> '_5321.GearWhineAnalysisOptions':
        ...
        return constructor.new(_5321.GearWhineAnalysisOptions)(self.wrapped.GearWhineHarmonicExcitationAnalysisOptions) if self.wrapped.GearWhineHarmonicExcitationAnalysisOptions else None

    @property
    def clutch_engagements(self) -> 'List[_5232.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClutchEngagements, constructor.new(_5232.ClutchEngagementStatus))
        return value

    @property
    def concept_clutch_engagements(self) -> 'List[_5233.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptClutchEngagements, constructor.new(_5233.ConceptSynchroGearEngagementStatus))
        return value

    def duplicate(self, new_design_state_group: '_5234.DesignState', name: Optional['str'] = 'None') -> 'StaticLoadCase':
