...
from mastapy.system_model.analyses_and_results.static_loads import _6089, _6115
...
class CylindricalGearLoadCase(_6115.GearLoadCase):
    '''CylindricalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6089.CylindricalGearManufactureError':
    ...
    @property
    def overridden_micro_geometry(self) -> '_844.CylindricalGearMicroGeometry':
        ...
        return constructor.new(_844.CylindricalGearMicroGeometry)(self.wrapped.OverriddenMicroGeometry) if self.wrapped.OverriddenMicroGeometry else None
