...
from mastapy.utility.enums import _1333
...
class ElectricMachineDetail(_1340.NamedDatabaseItem):
    '''ElectricMachineDetail
    ...
    @property
    def flow_rate_specification_method(self) -> '_1333.PropertySpecificationMethod':
        ...
        return constructor.new(_1333.PropertySpecificationMethod)(value) if value else None

    @flow_rate_specification_method.setter
    def flow_rate_specification_method(self, value: '_1333.PropertySpecificationMethod'):
