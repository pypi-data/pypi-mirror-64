...
from mastapy.system_model.analyses_and_results.static_loads import _6129, _6125, _6106
...
class HarmonicLoadDataImportFromMotorPackages(_6125.HarmonicLoadDataImportBase['T'], Generic[T]):
    '''HarmonicLoadDataImportFromMotorPackages
