...
from mastapy.system_model.analyses_and_results.static_loads import _6095, _6126, _6107
...
class HarmonicLoadDataJMAGImport(_6126.HarmonicLoadDataImportFromMotorPackages['_6107.ElectricMachineHarmonicLoadJMAGImportOptions']):
    '''HarmonicLoadDataJMAGImport
    ...
    @property
    def electric_machine_data_per_speed(self) -> 'List[_6095.DataFromJMAGPerSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElectricMachineDataPerSpeed, constructor.new(_6095.DataFromJMAGPerSpeed))
        return value
