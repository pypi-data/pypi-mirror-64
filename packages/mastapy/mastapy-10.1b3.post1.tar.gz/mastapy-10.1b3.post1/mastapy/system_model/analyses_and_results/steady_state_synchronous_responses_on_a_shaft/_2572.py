...
class SteadyStateSynchronousResponseOnAShaft(_6493.StaticLoadAnalysisCase):
    '''SteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def options(self) -> '_3061.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3061.SteadyStateSynchronousResponseOptions)(self.wrapped.Options) if self.wrapped.Options else None
