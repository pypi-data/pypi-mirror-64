...
from mastapy.system_model.analyses_and_results.modal_analyses import _4825, _4824, _4751
...
class WormGearSetModalAnalysis(_4751.GearSetModalAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2338.WormGearSetSystemDeflection':
    ...
    @property
    def worm_gears_modal_analysis(self) -> 'List[_4825.WormGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsModalAnalysis, constructor.new(_4825.WormGearModalAnalysis))
        return value

    @property
    def worm_meshes_modal_analysis(self) -> 'List[_4824.WormGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesModalAnalysis, constructor.new(_4824.WormGearMeshModalAnalysis))
        return value
