...
class PerModeResultsReport(_1276.CustomReportChart):
    '''PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_1334.TableAndChartOptions':
    ...
    def display_option(self, value: '_1334.TableAndChartOptions'):
