...
class PartDynamicAnalysis(_6490.PartFEAnalysis):
    '''PartDynamicAnalysis
    ...
    @property
    def dynamic_analysis(self) -> '_5838.DynamicAnalysis':
        ...
        return constructor.new(_5838.DynamicAnalysis)(self.wrapped.DynamicAnalysis) if self.wrapped.DynamicAnalysis else None
