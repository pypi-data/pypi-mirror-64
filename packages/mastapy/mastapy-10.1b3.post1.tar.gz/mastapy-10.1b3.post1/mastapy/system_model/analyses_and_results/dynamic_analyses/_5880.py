...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5838, _5797
...
class RootAssemblyDynamicAnalysis(_5797.AssemblyDynamicAnalysis):
    '''RootAssemblyDynamicAnalysis
    ...
    @property
    def dynamic_analysis_inputs(self) -> '_5838.DynamicAnalysis':
        ...
        return constructor.new(_5838.DynamicAnalysis)(self.wrapped.DynamicAnalysisInputs) if self.wrapped.DynamicAnalysisInputs else None
