...
from mastapy.system_model.analyses_and_results.power_flows import _3295, _3218
...
class RootAssemblyPowerFlow(_3218.AssemblyPowerFlow):
    '''RootAssemblyPowerFlow
    ...
    @property
    def power_flow_inputs(self) -> '_3295.PowerFlow':
        ...
        return constructor.new(_3295.PowerFlow)(self.wrapped.PowerFlowInputs) if self.wrapped.PowerFlowInputs else None
