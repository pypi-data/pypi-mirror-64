...
from mastapy.system_model.analyses_and_results.power_flows import _3232, _3322
...
class SynchroniserHalfPowerFlow(_3322.SynchroniserPartPowerFlow):
    '''SynchroniserHalfPowerFlow
    ...
    @property
    def clutch_connection(self) -> '_3232.ClutchConnectionPowerFlow':
        ...
        return constructor.new(_3232.ClutchConnectionPowerFlow)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
