...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4012, _4011, _4017
...
class FaceGearSetModalAnalysesAtSpeeds(_4017.GearSetModalAnalysesAtSpeeds):
    '''FaceGearSetModalAnalysesAtSpeeds
    ...
    @property
    def face_gears_modal_analyses_at_speeds(self) -> 'List[_4012.FaceGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsModalAnalysesAtSpeeds, constructor.new(_4012.FaceGearModalAnalysesAtSpeeds))
        return value

    @property
    def face_meshes_modal_analyses_at_speeds(self) -> 'List[_4011.FaceGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesModalAnalysesAtSpeeds, constructor.new(_4011.FaceGearMeshModalAnalysesAtSpeeds))
        return value
