...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4058, _4057, _3979
...
class SpiralBevelGearSetModalAnalysesAtSpeeds(_3979.BevelGearSetModalAnalysesAtSpeeds):
    '''SpiralBevelGearSetModalAnalysesAtSpeeds
    ...
    @property
    def spiral_bevel_gears_modal_analyses_at_speeds(self) -> 'List[_4058.SpiralBevelGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsModalAnalysesAtSpeeds, constructor.new(_4058.SpiralBevelGearModalAnalysesAtSpeeds))
        return value

    @property
    def spiral_bevel_meshes_modal_analyses_at_speeds(self) -> 'List[_4057.SpiralBevelGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesModalAnalysesAtSpeeds, constructor.new(_4057.SpiralBevelGearMeshModalAnalysesAtSpeeds))
        return value
