...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6273, _6274, _6286
...
class CylindricalGearSetAdvancedSystemDeflection(_6286.GearSetAdvancedSystemDeflection):
    '''CylindricalGearSetAdvancedSystemDeflection
    ...
    @property
    def micro_geometry(self) -> '_849.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_849.CylindricalGearSetMicroGeometry)(self.wrapped.MicroGeometry) if self.wrapped.MicroGeometry else None
    ...
    @property
    def cylindrical_gears_advanced_system_deflection(self) -> 'List[_6273.CylindricalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsAdvancedSystemDeflection, constructor.new(_6273.CylindricalGearAdvancedSystemDeflection))
        return value

    @property
    def cylindrical_meshes_advanced_system_deflection(self) -> 'List[_6274.CylindricalGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesAdvancedSystemDeflection, constructor.new(_6274.CylindricalGearMeshAdvancedSystemDeflection))
        return value
