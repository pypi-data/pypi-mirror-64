...
class BevelDifferentialGearMeshAdvancedSystemDeflection(_6247.BevelGearMeshAdvancedSystemDeflection):
    '''BevelDifferentialGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6055.BevelDifferentialGearMeshLoadCase':
        ...
        return constructor.new(_6055.BevelDifferentialGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2213.BevelDifferentialGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2213.BevelDifferentialGearMeshSystemDeflection))
        return value
