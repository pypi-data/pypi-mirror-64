...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6325, _6326, _6248
...
class SpiralBevelGearSetAdvancedSystemDeflection(_6248.BevelGearSetAdvancedSystemDeflection):
    '''SpiralBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def spiral_bevel_gears_advanced_system_deflection(self) -> 'List[_6325.SpiralBevelGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsAdvancedSystemDeflection, constructor.new(_6325.SpiralBevelGearAdvancedSystemDeflection))
        return value

    @property
    def spiral_bevel_meshes_advanced_system_deflection(self) -> 'List[_6326.SpiralBevelGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesAdvancedSystemDeflection, constructor.new(_6326.SpiralBevelGearMeshAdvancedSystemDeflection))
        return value
