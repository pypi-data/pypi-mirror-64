...
class BearingAdvancedSystemDeflection(_6266.ConnectorAdvancedSystemDeflection):
    '''BearingAdvancedSystemDeflection
    ...
    @property
    def duty_cycle(self) -> '_1568.LoadedBearingDutyCycle':
        ...
        return constructor.new(_1568.LoadedBearingDutyCycle)(self.wrapped.DutyCycle) if self.wrapped.DutyCycle else None
