...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6231, _6237
...
class RootAssemblyAdvancedSystemDeflection(_6237.AssemblyAdvancedSystemDeflection):
    '''RootAssemblyAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection_inputs(self) -> '_6231.AdvancedSystemDeflection':
        ...
        return constructor.new(_6231.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionInputs) if self.wrapped.AdvancedSystemDeflectionInputs else None
