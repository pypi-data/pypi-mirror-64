...
class BeltConnectionAdvancedSystemDeflection(_6292.InterMountableComponentConnectionAdvancedSystemDeflection):
    '''BeltConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6052.BeltConnectionLoadCase':
        ...
        return constructor.new(_6052.BeltConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2211.BeltConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2211.BeltConnectionSystemDeflection))
        return value
