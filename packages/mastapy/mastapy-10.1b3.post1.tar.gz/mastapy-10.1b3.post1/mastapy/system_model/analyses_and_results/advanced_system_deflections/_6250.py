...
class BoltedJointAdvancedSystemDeflection(_6324.SpecialisedAssemblyAdvancedSystemDeflection):
    '''BoltedJointAdvancedSystemDeflection
    ...
    @property
    def assembly_load_case(self) -> '_6062.BoltedJointLoadCase':
        ...
        return constructor.new(_6062.BoltedJointLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None

    @property
    def assembly_system_deflection_results(self) -> 'List[_2221.BoltedJointSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2221.BoltedJointSystemDeflection))
        return value
