...
class PlanetaryConnectionAdvancedSystemDeflection(_6323.ShaftToMountableComponentConnectionAdvancedSystemDeflection):
    '''PlanetaryConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6156.PlanetaryConnectionLoadCase':
        ...
        return constructor.new(_6156.PlanetaryConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2293.PlanetaryConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2293.PlanetaryConnectionSystemDeflection))
        return value
