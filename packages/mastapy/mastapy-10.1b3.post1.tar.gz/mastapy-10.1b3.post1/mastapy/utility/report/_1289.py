...
from mastapy.utility.report import _1290, _1293
...
TItem = TypeVar('TItem', bound='_1293.CustomReportPropertyItem')


class CustomReportMultiPropertyItem(_1290.CustomReportMultiPropertyItemBase, Generic[TItem]):
    '''CustomReportMultiPropertyItem
