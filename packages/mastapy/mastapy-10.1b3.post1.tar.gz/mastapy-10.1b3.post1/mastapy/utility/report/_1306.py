...
from mastapy.utility.report import _1305, _1298
...
class UserTextRow(_1298.CustomRow):
    '''UserTextRow
    ...
    @property
    def heading_size(self) -> '_1305.HeadingSize':
        '''HeadingSize: 'HeadingSize' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingSize)
        return constructor.new(_1305.HeadingSize)(value) if value else None

    @heading_size.setter
    def heading_size(self, value: '_1305.HeadingSize'):
