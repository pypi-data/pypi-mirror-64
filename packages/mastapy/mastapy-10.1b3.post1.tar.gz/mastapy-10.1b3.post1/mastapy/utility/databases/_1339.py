...
from mastapy.utility.databases import _1340, _1342, _1341
...
TValue = TypeVar('TValue', bound='_1340.NamedDatabaseItem')


class NamedDatabase(_1342.SQLDatabase['_1341.NamedKey', 'TValue'], Generic[TValue]):
    '''NamedDatabase
    ...
    def rename(self, item: '_1340.NamedDatabaseItem', new_name: 'str') -> 'bool':
