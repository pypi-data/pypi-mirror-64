...
from mastapy.bearings.tolerances import _1547, _1535, _1540
...
class InterferenceFitHalfDesign(_969.DetailedRigidConnectorHalfDesign):
    '''InterferenceFitHalfDesign
    ...
    @property
    def stress_region(self) -> '_1028.StressRegions':
        ...
        return constructor.new(_1028.StressRegions)(value) if value else None
    ...
    @property
    def tolerance(self) -> '_1547.SupportTolerance':
        ...
        return constructor.new(_1547.SupportTolerance)(self.wrapped.Tolerance) if self.wrapped.Tolerance else None

    @property
    def tolerance_of_type_inner_support_tolerance(self) -> '_1535.InnerSupportTolerance':
        ...
        if _1535.InnerSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
        ...
        return constructor.new(_1535.InnerSupportTolerance)(self.wrapped.Tolerance) if self.wrapped.Tolerance else None

    @property
    def tolerance_of_type_outer_support_tolerance(self) -> '_1540.OuterSupportTolerance':
        ...
        if _1540.OuterSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
        ...
        return constructor.new(_1540.OuterSupportTolerance)(self.wrapped.Tolerance) if self.wrapped.Tolerance else None
