...
from mastapy.detailed_rigid_connectors.splines import _983, _992, _1000
...
class DIN5480SplineHalfDesign(_1000.StandardSplineHalfDesign):
    '''DIN5480SplineHalfDesign
    ...
    @property
    def manufacturing_type(self) -> '_983.ManufacturingTypes':
        ...
        return constructor.new(_983.ManufacturingTypes)(value) if value else None

    @manufacturing_type.setter
    def manufacturing_type(self, value: '_983.ManufacturingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ManufacturingType = value

    @property
    def finishing_method(self) -> '_992.FinishingMethods':
        ...
        return constructor.new(_992.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_992.FinishingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
