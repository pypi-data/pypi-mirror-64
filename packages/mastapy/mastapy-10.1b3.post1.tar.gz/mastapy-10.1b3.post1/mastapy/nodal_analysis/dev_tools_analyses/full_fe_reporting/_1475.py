...
from mastapy.fe_tools.enums import _966
...
class ElementPropertiesBase(_0.APIBase):
    ...
    @property
    def class_(self) -> '_966.ElementPropertyClass':
        ...
        return constructor.new(_966.ElementPropertyClass)(value) if value else None
