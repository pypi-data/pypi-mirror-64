...
from mastapy.nodal_analysis.system_solvers import _1405
...
class TransientSolver(_1405.DynamicSolver):
    '''TransientSolver
    ...
    @property
    def solver_status(self) -> '_1391.TransientSolverStatus':
        ...
        return constructor.new(_1391.TransientSolverStatus)(value) if value else None

    @solver_status.setter
    def solver_status(self, value: '_1391.TransientSolverStatus'):
