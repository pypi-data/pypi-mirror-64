...
from mastapy.bearings.bearing_designs.rolling import _1739, _1756
...
class BallBearing(_1756.RollingBearing):
    '''BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_1739.BallBearingShoulderDefinition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shoulders, constructor.new(_1739.BallBearingShoulderDefinition))
        return value
