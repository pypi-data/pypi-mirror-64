...
from mastapy.bearings import _1513
...
class LinearBearing(_1728.BearingDesign):
    '''LinearBearing
    ...
    @property
    def stiffness_options(self) -> '_1513.BearingStiffnessMatrixOption':
        ...
        return constructor.new(_1513.BearingStiffnessMatrixOption)(value) if value else None

    @stiffness_options.setter
    def stiffness_options(self, value: '_1513.BearingStiffnessMatrixOption'):
