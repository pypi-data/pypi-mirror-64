...
class GreaseLifeAndRelubricationInterval(_1703.SKFCalculationResult):
    '''GreaseLifeAndRelubricationInterval
    ...
    def grease(self) -> '_1695.Grease':
        ...
        return constructor.new(_1695.Grease)(self.wrapped.Grease) if self.wrapped.Grease else None

    @property
    def initial_fill(self) -> '_1698.InitialFill':
        ...
        return constructor.new(_1698.InitialFill)(self.wrapped.InitialFill) if self.wrapped.InitialFill else None

    @property
    def grease_quantity(self) -> '_1697.GreaseQuantity':
        ...
        return constructor.new(_1697.GreaseQuantity)(self.wrapped.GreaseQuantity) if self.wrapped.GreaseQuantity else None
