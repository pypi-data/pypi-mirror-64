...
from mastapy.bearings.bearing_results.rolling import _1606, _1634
...
class LoadedAxialThrustCylindricalRollerBearingRow(_1634.LoadedNonBarrelRollerBearingRow):
    '''LoadedAxialThrustCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1606.LoadedAxialThrustCylindricalRollerBearingResults':
