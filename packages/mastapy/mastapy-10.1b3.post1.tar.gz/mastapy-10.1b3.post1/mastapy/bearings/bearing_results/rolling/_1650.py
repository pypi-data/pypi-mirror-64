...
from mastapy.bearings.bearing_results.rolling import _1649, _1639
...
class LoadedSphericalRollerRadialBearingRow(_1639.LoadedRollerBearingRow):
    '''LoadedSphericalRollerRadialBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1649.LoadedSphericalRollerRadialBearingResults':
