...
from mastapy.bearings.bearing_results.rolling import _1678, _1623
...
class LoadedRollerBearingElement(_1623.LoadedElement):
    '''LoadedRollerBearingElement
    ...
    @property
    def results_at_roller_offsets(self) -> 'List[_1678.ResultsAtRollerOffset]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsAtRollerOffsets, constructor.new(_1678.ResultsAtRollerOffset))
        return value
