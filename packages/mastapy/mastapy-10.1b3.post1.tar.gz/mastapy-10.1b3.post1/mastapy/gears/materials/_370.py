...
from mastapy.gears.materials import _391, _377
...
class BevelGearMaterial(_377.GearMaterial):
    '''BevelGearMaterial
    ...
    @property
    def sn_curve_definition(self) -> '_391.SNCurveDefinition':
        ...
        return constructor.new(_391.SNCurveDefinition)(value) if value else None

    @sn_curve_definition.setter
    def sn_curve_definition(self, value: '_391.SNCurveDefinition'):
