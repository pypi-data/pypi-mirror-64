...
from mastapy.gears.gear_designs.conical import _900, _888
...
class KlingelnbergConicalGearSetDesign(_888.ConicalGearSetDesign):
    '''KlingelnbergConicalGearSetDesign
    ...
    @property
    def gear_finish(self) -> '_900.KlingelnbergFinishingMethods':
        ...
        return constructor.new(_900.KlingelnbergFinishingMethods)(value) if value else None

    @gear_finish.setter
    def gear_finish(self, value: '_900.KlingelnbergFinishingMethods'):
    ...
    @property
    def conical_meshes(self) -> 'List[_745.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_745.KlingelnbergConicalGearMeshDesign))
        return value

    @property
    def klingelnberg_conical_meshes(self) -> 'List[_745.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergConicalMeshes, constructor.new(_745.KlingelnbergConicalGearMeshDesign))
        return value
