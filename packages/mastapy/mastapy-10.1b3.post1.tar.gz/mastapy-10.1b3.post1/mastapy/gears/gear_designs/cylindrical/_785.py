...
class CylindricalGearSetDesign(_713.GearSetDesign):
    '''CylindricalGearSetDesign
    ...
    @property
    def profile_shift_distribution_rule(self) -> '_761.AddendumModificationDistributionRule':
        ...
        return constructor.new(_761.AddendumModificationDistributionRule)(value) if value else None

    @profile_shift_distribution_rule.setter
    def profile_shift_distribution_rule(self, value: '_761.AddendumModificationDistributionRule'):
    ...
    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_849.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_849.CylindricalGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry else None

    @property
    def scuffing(self) -> '_818.Scuffing':
        ...
        return constructor.new(_818.Scuffing)(self.wrapped.Scuffing) if self.wrapped.Scuffing else None

    @property
    def micropitting(self) -> '_813.Micropitting':
        ...
        return constructor.new(_813.Micropitting)(self.wrapped.Micropitting) if self.wrapped.Micropitting else None

    @property
    def usage(self) -> '_834.Usage':
        ...
        return constructor.new(_834.Usage)(self.wrapped.Usage) if self.wrapped.Usage else None

    @property
    def ltca_settings(self) -> '_811.LtcaSettings':
        ...
        return constructor.new(_811.LtcaSettings)(self.wrapped.LTCASettings) if self.wrapped.LTCASettings else None
    ...
    def create_optimiser(self, duty_cycle: '_264.CylindricalGearSetDutyCycleRating') -> '_786.CylindricalGearSetMacroGeometryOptimiser':
        ...
        return constructor.new(_786.CylindricalGearSetMacroGeometryOptimiser)(method_result) if method_result else None
