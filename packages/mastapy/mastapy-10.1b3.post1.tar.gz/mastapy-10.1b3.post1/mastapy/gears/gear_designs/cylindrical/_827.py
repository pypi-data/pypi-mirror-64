...
from mastapy.gears.gear_designs.cylindrical import _765
...
class TiffAnalysisSettings(_1132.IndependentReportablePropertiesBase['TiffAnalysisSettings']):
    '''TiffAnalysisSettings
    ...
    @property
    def case_hardening_properties_for_fe_analysis(self) -> '_765.CaseHardeningPropertiesForFEAnalysis':
        ...
        return constructor.new(_765.CaseHardeningPropertiesForFEAnalysis)(self.wrapped.CaseHardeningPropertiesForFEAnalysis) if self.wrapped.CaseHardeningPropertiesForFEAnalysis else None
