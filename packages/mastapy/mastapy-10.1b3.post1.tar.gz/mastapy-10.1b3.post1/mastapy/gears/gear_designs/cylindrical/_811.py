...
class LtcaSettings(_1132.IndependentReportablePropertiesBase['LtcaSettings']):
    '''LtcaSettings
    ...
    @property
    def load_case_modifiable_settings(self) -> '_810.LTCALoadCaseModifiableSettings':
        ...
        return constructor.new(_810.LTCALoadCaseModifiableSettings)(self.wrapped.LoadCaseModifiableSettings) if self.wrapped.LoadCaseModifiableSettings else None
