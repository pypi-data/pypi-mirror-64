...
from mastapy.gears.gear_designs.cylindrical import _815, _814, _774
...
class CylindricalPlanetGearDesign(_774.CylindricalGearDesign):
    ...
    @property
    def planetary_sidebands_amplitude_factors(self) -> 'List[_815.NamedPlanetSideBandAmplitudeFactor]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetarySidebandsAmplitudeFactors, constructor.new(_815.NamedPlanetSideBandAmplitudeFactor))
        return value

    @property
    def planet_assembly_indices(self) -> 'List[_814.NamedPlanetAssemblyIndex]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetAssemblyIndices, constructor.new(_814.NamedPlanetAssemblyIndex))
        return value
