...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _844, _842
...
class CylindricalGearSetMicroGeometry(_960.GearSetImplementationDetail):
    '''CylindricalGearSetMicroGeometry
    ...
    @property
    def cylindrical_gear_micro_geometries(self) -> 'List[_844.CylindricalGearMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearMicroGeometries, constructor.new(_844.CylindricalGearMicroGeometry))
        return value

    @property
    def cylindrical_mesh_micro_geometries(self) -> 'List[_842.CylindricalGearMeshMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshMicroGeometries, constructor.new(_842.CylindricalGearMeshMicroGeometry))
        return value
