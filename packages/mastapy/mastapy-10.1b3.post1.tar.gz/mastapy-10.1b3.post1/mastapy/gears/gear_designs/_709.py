...
from mastapy.utility.property import _1345
...
class DesignConstraintsCollection(_1340.NamedDatabaseItem):
    '''DesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> 'List[_1345.DeletableCollectionMember[_707.DesignConstraint]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignConstraints, constructor.new(_1345.DeletableCollectionMember)[_707.DesignConstraint])
        return value
