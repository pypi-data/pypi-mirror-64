...
class SelectedDesignConstraintsCollection(_1137.PerMachineSettings):
    '''SelectedDesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> '_709.DesignConstraintsCollection':
        ...
        return constructor.new(_709.DesignConstraintsCollection)(self.wrapped.DesignConstraints) if self.wrapped.DesignConstraints else None
