...
from mastapy.gears.gear_designs.zerol_bevel import _715, _716
...
class ZerolBevelGearSetDesign(_914.BevelGearSetDesign):
    '''ZerolBevelGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_715.ZerolBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_715.ZerolBevelGearDesign))
        return value
    ...
    @property
    def zerol_bevel_meshes(self) -> 'List[_716.ZerolBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshes, constructor.new(_716.ZerolBevelGearMeshDesign))
        return value
