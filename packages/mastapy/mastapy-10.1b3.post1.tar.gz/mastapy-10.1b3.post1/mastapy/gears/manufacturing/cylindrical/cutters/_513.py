...
class CylindricalGearRealCutterDesign(_506.CylindricalGearAbstractCutterDesign):
    ...
    @property
    def nominal_cutter_drawing(self) -> '_6501.SMTBitmap':
        ...
        return constructor.new(_6501.SMTBitmap)(self.wrapped.NominalCutterDrawing) if self.wrapped.NominalCutterDrawing else None
    ...
    def nominal_cutter_shape(self) -> '_523.CutterShapeDefinition':
        ...
        return constructor.new(_523.CutterShapeDefinition)(self.wrapped.NominalCutterShape) if self.wrapped.NominalCutterShape else None
    ...
    def nominal_cutter_shape_of_type_cylindrical_gear_formed_wheel_grinder_tangible(self) -> '_524.CylindricalGearFormedWheelGrinderTangible':
        ...
        return constructor.new(_524.CylindricalGearFormedWheelGrinderTangible)(self.wrapped.NominalCutterShape) if self.wrapped.NominalCutterShape else None
    ...
    def nominal_cutter_shape_of_type_cylindrical_gear_hob_shape(self) -> '_525.CylindricalGearHobShape':
        ...
        return constructor.new(_525.CylindricalGearHobShape)(self.wrapped.NominalCutterShape) if self.wrapped.NominalCutterShape else None
    ...
    def nominal_cutter_shape_of_type_cylindrical_gear_shaper_tangible(self) -> '_526.CylindricalGearShaperTangible':
        ...
        return constructor.new(_526.CylindricalGearShaperTangible)(self.wrapped.NominalCutterShape) if self.wrapped.NominalCutterShape else None
    ...
    def nominal_cutter_shape_of_type_cylindrical_gear_shaver_tangible(self) -> '_527.CylindricalGearShaverTangible':
        ...
        return constructor.new(_527.CylindricalGearShaverTangible)(self.wrapped.NominalCutterShape) if self.wrapped.NominalCutterShape else None
    ...
    def nominal_cutter_shape_of_type_cylindrical_gear_worm_grinder_shape(self) -> '_528.CylindricalGearWormGrinderShape':
        ...
        return constructor.new(_528.CylindricalGearWormGrinderShape)(self.wrapped.NominalCutterShape) if self.wrapped.NominalCutterShape else None
    ...
    def nominal_cutter_shape_of_type_rack_shape(self) -> '_530.RackShape':
        ...
        return constructor.new(_530.RackShape)(self.wrapped.NominalCutterShape) if self.wrapped.NominalCutterShape else None
