...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _444, _477
...
class WormGrindingProcessPitchCalculation(_477.WormGrindingProcessCalculation):
    '''WormGrindingProcessPitchCalculation
    ...
    @property
    def right_flank(self) -> '_444.CalculatePitchDeviationAccuracy':
        ...
        return constructor.new(_444.CalculatePitchDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def left_flank(self) -> '_444.CalculatePitchDeviationAccuracy':
        ...
        return constructor.new(_444.CalculatePitchDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None
