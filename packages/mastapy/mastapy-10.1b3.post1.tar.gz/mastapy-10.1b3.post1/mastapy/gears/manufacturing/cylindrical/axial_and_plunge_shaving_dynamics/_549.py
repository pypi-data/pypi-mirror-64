...
class ShavingDynamicsCalculationForDesignedGears(_548.ShavingDynamicsCalculation['T'], Generic[T]):
    ...
    def redressing(self) -> '_546.ShaverRedressing[T]':
        ...
        return constructor.new(_546.ShaverRedressing)[T](self.wrapped.Redressing) if self.wrapped.Redressing else None
    ...
    def redressing_of_type_axial_shaver_redressing(self) -> '_532.AxialShaverRedressing':
        ...
        return constructor.new(_532.AxialShaverRedressing)(self.wrapped.Redressing) if self.wrapped.Redressing else None
    ...
    def redressing_of_type_plunge_shaver_redressing(self) -> '_539.PlungeShaverRedressing':
        ...
        return constructor.new(_539.PlungeShaverRedressing)(self.wrapped.Redressing) if self.wrapped.Redressing else None
