...
from mastapy.gears.manufacturing.cylindrical import _414
...
class CylindricalGearHobDesign(_512.CylindricalGearRackDesign):
    ...
    @property
    def hob_edge_type(self) -> '_414.HobEdgeTypes':
        '''HobEdgeTypes: 'HobEdgeType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HobEdgeType)
        return constructor.new(_414.HobEdgeTypes)(value) if value else None

    @hob_edge_type.setter
    def hob_edge_type(self, value: '_414.HobEdgeTypes'):
    ...
    def nominal_rack_shape(self) -> '_530.RackShape':
        ...
        return constructor.new(_530.RackShape)(self.wrapped.NominalRackShape) if self.wrapped.NominalRackShape else None
    ...
    def nominal_rack_shape_of_type_cylindrical_gear_hob_shape(self) -> '_525.CylindricalGearHobShape':
        ...
        return constructor.new(_525.CylindricalGearHobShape)(self.wrapped.NominalRackShape) if self.wrapped.NominalRackShape else None
    ...
    def nominal_rack_shape_of_type_cylindrical_gear_worm_grinder_shape(self) -> '_528.CylindricalGearWormGrinderShape':
        ...
        return constructor.new(_528.CylindricalGearWormGrinderShape)(self.wrapped.NominalRackShape) if self.wrapped.NominalRackShape else None
