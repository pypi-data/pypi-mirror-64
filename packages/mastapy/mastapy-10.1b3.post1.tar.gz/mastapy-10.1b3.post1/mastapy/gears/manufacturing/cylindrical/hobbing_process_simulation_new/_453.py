...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _444, _449
...
class HobbingProcessPitchCalculation(_449.HobbingProcessCalculation):
    '''HobbingProcessPitchCalculation
