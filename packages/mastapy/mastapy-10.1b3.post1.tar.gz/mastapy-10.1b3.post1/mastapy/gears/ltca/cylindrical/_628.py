...
class CylindricalGearMeshLoadDistributionAnalysis(_614.GearMeshLoadDistributionAnalysis):
    ...
    @property
    def transmission_error_against_rotation(self) -> 'List[_1056.Vector2D]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TransmissionErrorAgainstRotation, constructor.new(_1056.Vector2D))
        return value
