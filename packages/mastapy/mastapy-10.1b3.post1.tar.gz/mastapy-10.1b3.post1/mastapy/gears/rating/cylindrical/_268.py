...
from mastapy.gears.gear_designs.cylindrical import _819, _818
...
class CylindricalMeshSingleFlankRating(_169.MeshSingleFlankRating):
    ...
    @property
    def coefficient_of_friction_method_flash_temperature_method(self) -> '_819.ScuffingCoefficientOfFrictionMethods':
        ...
        return constructor.new(_819.ScuffingCoefficientOfFrictionMethods)(value) if value else None
