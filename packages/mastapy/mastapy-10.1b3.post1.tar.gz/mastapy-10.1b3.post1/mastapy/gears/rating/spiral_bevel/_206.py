...
class SpiralBevelGearRating(_339.BevelGearRating):
    ...
    @property
    def spiral_bevel_gear(self) -> '_732.SpiralBevelGearDesign':
        ...
        return constructor.new(_732.SpiralBevelGearDesign)(self.wrapped.SpiralBevelGear) if self.wrapped.SpiralBevelGear else None
