...
class FaceGearMeshRating(_163.GearMeshRating):
    ...
    @property
    def face_gear_mesh(self) -> '_754.FaceGearMeshDesign':
        ...
        return constructor.new(_754.FaceGearMeshDesign)(self.wrapped.FaceGearMesh) if self.wrapped.FaceGearMesh else None
