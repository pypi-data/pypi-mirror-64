...
class ConicalMeshDutyCycleRating(_168.MeshDutyCycleRating):
    ...
    @property
    def conical_mesh_ratings(self) -> 'List[_323.ConicalGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshRatings, constructor.new(_323.ConicalGearMeshRating))
        return value
