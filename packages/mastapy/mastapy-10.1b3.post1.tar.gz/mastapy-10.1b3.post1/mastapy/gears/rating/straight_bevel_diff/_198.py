...
class StraightBevelDiffGearMeshRating(_323.ConicalGearMeshRating):
    ...
    @property
    def straight_bevel_diff_gear_mesh(self) -> '_725.StraightBevelDiffGearMeshDesign':
        ...
        return constructor.new(_725.StraightBevelDiffGearMeshDesign)(self.wrapped.StraightBevelDiffGearMesh) if self.wrapped.StraightBevelDiffGearMesh else None
