...
class HypoidGearMeshRating(_349.AGMAGleasonConicalGearMeshRating):
    ...
    @property
    def hypoid_gear_mesh(self) -> '_749.HypoidGearMeshDesign':
        ...
        return constructor.new(_749.HypoidGearMeshDesign)(self.wrapped.HypoidGearMesh) if self.wrapped.HypoidGearMesh else None
