...
from mastapy.gears.gear_designs.conical import _882, _892
...
class ConicalMeshLoadCase(_646.MeshLoadCase):
    ...
    @property
    def active_flank(self) -> '_882.ActiveConicalFlank':
    ...
    @property
    def user_specified_misalignments(self) -> '_892.ConicalMeshMisalignments':
        ...
        return constructor.new(_892.ConicalMeshMisalignments)(self.wrapped.UserSpecifiedMisalignments) if self.wrapped.UserSpecifiedMisalignments else None
