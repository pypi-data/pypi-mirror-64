...
from mastapy.math_utility.optimisation import _1109, _1108
...
class ParetoOptimisationVariableBase(_0.APIBase):
    ...
    @property
    def specification_type(self) -> '_1109.TargetingPropertyTo':
        ...
        return constructor.new(_1109.TargetingPropertyTo)(value) if value else None

    @specification_type.setter
    def specification_type(self, value: '_1109.TargetingPropertyTo'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SpecificationType = value

    @property
    def specify_input_range_as(self) -> '_1108.SpecifyOptimisationInputAs':
        ...
        return constructor.new(_1108.SpecifyOptimisationInputAs)(value) if value else None

    @specify_input_range_as.setter
    def specify_input_range_as(self, value: '_1108.SpecifyOptimisationInputAs'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
