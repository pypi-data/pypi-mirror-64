...
from mastapy.math_utility import _1066, _1084
...
class CoordinateSystem3D(_0.APIBase):
    ...
    def axis(self, degree_of_freedom: '_1066.DegreesOfFreedom') -> 'Vector3D':
    ...
    def transform_to_world_from_this(self) -> '_1084.TransformMatrix3D':
        ...
        return constructor.new(_1084.TransformMatrix3D)(method_result) if method_result else None

    def transform_from_world_to_this(self) -> '_1084.TransformMatrix3D':
    ...
    def transformed_by(self, transform: '_1084.TransformMatrix3D') -> 'CoordinateSystem3D':
