...
class ImportedFEWithSelection(_1891.BaseFEWithSelection):
    '''ImportedFEWithSelection
    ...
    @property
    def imported_fe(self) -> '_1912.ImportedFE':
        ...
        return constructor.new(_1912.ImportedFE)(self.wrapped.ImportedFE) if self.wrapped.ImportedFE else None

    @property
    def element_face_groups(self) -> 'List[_1904.ElementFaceGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_1904.ElementFaceGroupWithSelection))
        return value

    @property
    def node_groups(self) -> 'List[_1937.NodeGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeGroups, constructor.new(_1937.NodeGroupWithSelection))
        return value
