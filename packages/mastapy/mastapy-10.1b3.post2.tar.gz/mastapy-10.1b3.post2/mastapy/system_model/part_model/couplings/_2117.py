...
from mastapy.system_model.part_model.couplings import _2118, _2120, _2095
...
class TorqueConverter(_2095.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2118.TorqueConverterPump':
        ...
        return constructor.new(_2118.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump else None

    @property
    def turbine(self) -> '_2120.TorqueConverterTurbine':
        ...
        return constructor.new(_2120.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine else None
