...
class HypoidGear(_2029.AGMAGleasonConicalGear):
    '''HypoidGear
    ...
    @property
    def conical_gear_design(self) -> '_740.HypoidGearDesign':
    ...
    @property
    def hypoid_gear_design(self) -> '_740.HypoidGearDesign':
        ...
        return constructor.new(_740.HypoidGearDesign)(self.wrapped.HypoidGearDesign) if self.wrapped.HypoidGearDesign else None
