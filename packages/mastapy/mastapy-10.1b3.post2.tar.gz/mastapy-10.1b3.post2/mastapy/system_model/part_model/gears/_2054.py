...
class KlingelnbergCycloPalloidHypoidGear(_2052.KlingelnbergCycloPalloidConicalGear):
    '''KlingelnbergCycloPalloidHypoidGear
    ...
    @property
    def conical_gear_design(self) -> '_732.KlingelnbergCycloPalloidHypoidGearDesign':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_design(self) -> '_732.KlingelnbergCycloPalloidHypoidGearDesign':
        ...
        return constructor.new(_732.KlingelnbergCycloPalloidHypoidGearDesign)(self.wrapped.KlingelnbergCycloPalloidHypoidGearDesign) if self.wrapped.KlingelnbergCycloPalloidHypoidGearDesign else None
