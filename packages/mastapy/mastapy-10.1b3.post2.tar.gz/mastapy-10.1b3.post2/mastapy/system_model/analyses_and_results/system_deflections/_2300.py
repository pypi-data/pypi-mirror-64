...
class StraightBevelPlanetGearSystemDeflection(_2296.StraightBevelDiffGearSystemDeflection):
    '''StraightBevelPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3299.StraightBevelPlanetGearPowerFlow':
