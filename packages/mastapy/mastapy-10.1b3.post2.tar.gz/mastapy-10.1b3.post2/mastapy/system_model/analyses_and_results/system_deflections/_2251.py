...
from mastapy.math_utility.measured_vectors import _1104, _1099
...
class ImportedFEComponentSystemDeflection(_2185.AbstractShaftOrHousingSystemDeflection):
    '''ImportedFEComponentSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3252.ImportedFEComponentPowerFlow':
    ...
    @property
    def stiffness_in_world_coordinate_system_mn_rad(self) -> '_1364.NodalMatrix':
        ...
        return constructor.new(_1364.NodalMatrix)(self.wrapped.StiffnessInWorldCoordinateSystemMNRad) if self.wrapped.StiffnessInWorldCoordinateSystemMNRad else None

    @property
    def mass_in_world_coordinate_system_mn_rad_s_kg(self) -> '_1364.NodalMatrix':
        ...
        return constructor.new(_1364.NodalMatrix)(self.wrapped.MassInWorldCoordinateSystemMNRadSKg) if self.wrapped.MassInWorldCoordinateSystemMNRadSKg else None
    ...
    @property
    def applied_internal_forces_in_world_coordinate_system(self) -> 'List[_1104.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AppliedInternalForcesInWorldCoordinateSystem, constructor.new(_1104.VectorWithLinearAndAngularComponents))
        return value

    @property
    def node_results_in_shaft_coordinate_system(self) -> 'List[_1099.ForceAndDisplacementResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResultsInShaftCoordinateSystem, constructor.new(_1099.ForceAndDisplacementResults))
        return value
