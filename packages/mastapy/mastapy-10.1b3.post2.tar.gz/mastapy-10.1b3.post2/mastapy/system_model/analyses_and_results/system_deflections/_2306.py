...
class SystemDeflection(_6467.FEAnalysis):
    '''SystemDeflection
    ...
    @property
    def analysis_options(self) -> '_2308.SystemDeflectionOptions':
        ...
        return constructor.new(_2308.SystemDeflectionOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None
