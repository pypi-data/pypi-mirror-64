...
from mastapy.system_model.analyses_and_results.power_flows import _3302, _3301, _3304
...
class SynchroniserPartSystemDeflection(_2222.CouplingHalfSystemDeflection):
    '''SynchroniserPartSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3302.SynchroniserPartPowerFlow':
