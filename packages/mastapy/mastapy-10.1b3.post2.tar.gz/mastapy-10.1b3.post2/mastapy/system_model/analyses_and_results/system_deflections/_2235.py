...
class CylindricalGearSystemDeflectionWithLTCAResults(_2233.CylindricalGearSystemDeflection):
    '''CylindricalGearSystemDeflectionWithLTCAResults
    ...
    @property
    def cylindrical_gear_ltca_results(self) -> '_622.CylindricalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_622.CylindricalGearLoadDistributionAnalysis)(self.wrapped.CylindricalGearLTCAResults) if self.wrapped.CylindricalGearLTCAResults else None
