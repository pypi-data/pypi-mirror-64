...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3440
...
class SpecialisedAssemblyParametricStudyTool(_3440.AbstractAssemblyParametricStudyTool):
    '''SpecialisedAssemblyParametricStudyTool
