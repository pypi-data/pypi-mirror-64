...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3416
...
class StraightBevelPlanetGearCompoundPowerFlow(_3416.StraightBevelDiffGearCompoundPowerFlow):
    '''StraightBevelPlanetGearCompoundPowerFlow
