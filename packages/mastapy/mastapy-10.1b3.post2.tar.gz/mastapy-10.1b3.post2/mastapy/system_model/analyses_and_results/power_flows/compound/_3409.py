...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3318
...
class SpecialisedAssemblyCompoundPowerFlow(_3318.AbstractAssemblyCompoundPowerFlow):
    '''SpecialisedAssemblyCompoundPowerFlow
