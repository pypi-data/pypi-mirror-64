...
class ZerolBevelGearMeshCompoundSteadyStateSynchronousResponseOnAShaft(_2592.BevelGearMeshCompoundSteadyStateSynchronousResponseOnAShaft):
    '''ZerolBevelGearMeshCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_design(self) -> '_1870.ZerolBevelGearMesh':
    ...
    @property
    def connection_design(self) -> '_1870.ZerolBevelGearMesh':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2574.ZerolBevelGearMeshSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2574.ZerolBevelGearMeshSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def connection_steady_state_synchronous_response_on_a_shaft_load_cases(self) -> 'List[_2574.ZerolBevelGearMeshSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSteadyStateSynchronousResponseOnAShaftLoadCases, constructor.new(_2574.ZerolBevelGearMeshSteadyStateSynchronousResponseOnAShaft))
        return value
