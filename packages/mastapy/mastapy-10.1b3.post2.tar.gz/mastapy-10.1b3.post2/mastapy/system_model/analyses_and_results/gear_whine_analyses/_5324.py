...
class PartToPartShearCouplingConnectionGearWhineAnalysis(_5266.CouplingConnectionGearWhineAnalysis):
    '''PartToPartShearCouplingConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2270.PartToPartShearCouplingConnectionSystemDeflection':
