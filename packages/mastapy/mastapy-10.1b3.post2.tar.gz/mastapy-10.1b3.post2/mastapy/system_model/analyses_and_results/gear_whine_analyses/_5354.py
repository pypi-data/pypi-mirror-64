...
class StraightBevelGearMeshGearWhineAnalysis(_5245.BevelGearMeshGearWhineAnalysis):
    '''StraightBevelGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2297.StraightBevelGearMeshSystemDeflection':
