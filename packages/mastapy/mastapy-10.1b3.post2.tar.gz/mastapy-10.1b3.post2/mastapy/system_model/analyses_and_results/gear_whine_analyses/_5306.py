...
class HypoidGearMeshGearWhineAnalysis(_5233.AGMAGleasonConicalGearMeshGearWhineAnalysis):
    '''HypoidGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2248.HypoidGearMeshSystemDeflection':
