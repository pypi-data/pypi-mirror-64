...
class PlanetaryConnectionGearWhineAnalysis(_5340.ShaftToMountableComponentConnectionGearWhineAnalysis):
    '''PlanetaryConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2273.PlanetaryConnectionSystemDeflection':
