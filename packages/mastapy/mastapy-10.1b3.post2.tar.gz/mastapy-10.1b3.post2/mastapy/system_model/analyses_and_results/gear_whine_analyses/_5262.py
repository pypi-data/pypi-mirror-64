...
class ConicalGearMeshGearWhineAnalysis(_5296.GearMeshGearWhineAnalysis):
    '''ConicalGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2216.ConicalGearMeshSystemDeflection':
