...
class ZerolBevelGearMeshGearWhineAnalysis(_5245.BevelGearMeshGearWhineAnalysis):
    '''ZerolBevelGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2320.ZerolBevelGearMeshSystemDeflection':
