...
from mastapy.system_model.analyses_and_results.static_loads import _6067, _6033
...
class CVTLoadCase(_6033.BeltDriveLoadCase):
    '''CVTLoadCase
    ...
    @property
    def pulleys(self) -> 'List[_6067.CVTPulleyLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_6067.CVTPulleyLoadCase))
        return value
