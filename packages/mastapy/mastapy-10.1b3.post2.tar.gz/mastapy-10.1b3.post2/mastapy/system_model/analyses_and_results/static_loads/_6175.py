...
class TimeSeriesLoadCase(_6022.LoadCase):
    '''TimeSeriesLoadCase
    ...
    @property
    def driva_analysis_options(self) -> '_5022.MBDAnalysisOptions':
        ...
        return constructor.new(_5022.MBDAnalysisOptions)(self.wrapped.DRIVAAnalysisOptions) if self.wrapped.DRIVAAnalysisOptions else None
