...
class GearLoadCase(_6128.MountableComponentLoadCase):
    '''GearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6096.GearManufactureError':
        ...
        return constructor.new(_6096.GearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors else None

    @property
    def gear_manufacture_errors_of_type_conical_gear_manufacture_error(self) -> '_6056.ConicalGearManufactureError':
        ...
        if _6056.ConicalGearManufactureError.TYPE not in self.wrapped.GearManufactureErrors.__class__.__mro__:
        ...
        return constructor.new(_6056.ConicalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors else None

    @property
    def gear_manufacture_errors_of_type_cylindrical_gear_manufacture_error(self) -> '_6069.CylindricalGearManufactureError':
        ...
        if _6069.CylindricalGearManufactureError.TYPE not in self.wrapped.GearManufactureErrors.__class__.__mro__:
        ...
        return constructor.new(_6069.CylindricalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors else None
