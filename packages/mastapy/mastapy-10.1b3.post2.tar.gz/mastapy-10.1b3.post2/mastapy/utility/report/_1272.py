...
from mastapy.utility.report import _1273, _1274
...
T = TypeVar('T', bound='_1274.CustomReportItemContainerCollectionItem')


class CustomReportItemContainerCollection(_1273.CustomReportItemContainerCollectionBase, Generic[T]):
    '''CustomReportItemContainerCollection
