...
class CylindricalGearISOMaterialDatabase(_0.APIBase):
    '''CylindricalGearISOMaterialDatabase
    ...
    @property
    def item(self) -> '_376.ISOCylindricalGearMaterial':
        ...
        return constructor.new(_376.ISOCylindricalGearMaterial)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_376.ISOCylindricalGearMaterial':
        ...
        return constructor.new(_376.ISOCylindricalGearMaterial)(method_result) if method_result else None

    def can_be_removed(self, iso_cylindrical_gear_material: '_376.ISOCylindricalGearMaterial') -> 'bool':
    ...
    def rename(self, iso_cylindrical_gear_material: '_376.ISOCylindricalGearMaterial', new_name: 'str') -> 'bool':
    ...
    def remove(self, iso_cylindrical_gear_material: '_376.ISOCylindricalGearMaterial'):
    ...
    def get_all_items(self) -> 'Iterable[_376.ISOCylindricalGearMaterial]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_376.ISOCylindricalGearMaterial))

    def save_changes(self, iso_cylindrical_gear_material: '_376.ISOCylindricalGearMaterial'):
