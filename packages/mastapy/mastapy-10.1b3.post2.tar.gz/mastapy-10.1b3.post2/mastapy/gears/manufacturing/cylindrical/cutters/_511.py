...
class CylindricalGearShaverDatabase(_0.APIBase):
    '''CylindricalGearShaverDatabase
    ...
    @property
    def item(self) -> '_510.CylindricalGearShaver':
        ...
        return constructor.new(_510.CylindricalGearShaver)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_510.CylindricalGearShaver':
        ...
        return constructor.new(_510.CylindricalGearShaver)(method_result) if method_result else None

    def can_be_removed(self, cylindrical_gear_shaver: '_510.CylindricalGearShaver') -> 'bool':
    ...
    def rename(self, cylindrical_gear_shaver: '_510.CylindricalGearShaver', new_name: 'str') -> 'bool':
    ...
    def remove(self, cylindrical_gear_shaver: '_510.CylindricalGearShaver'):
    ...
    def get_all_items(self) -> 'Iterable[_510.CylindricalGearShaver]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_510.CylindricalGearShaver))

    def save_changes(self, cylindrical_gear_shaver: '_510.CylindricalGearShaver'):
