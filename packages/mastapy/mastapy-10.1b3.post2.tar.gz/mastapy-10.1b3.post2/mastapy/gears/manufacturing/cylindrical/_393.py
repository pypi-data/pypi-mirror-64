...
class CylindricalHobDatabase(_0.APIBase):
    '''CylindricalHobDatabase
    ...
    @property
    def item(self) -> '_504.CylindricalGearHobDesign':
        ...
        return constructor.new(_504.CylindricalGearHobDesign)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_504.CylindricalGearHobDesign':
        ...
        return constructor.new(_504.CylindricalGearHobDesign)(method_result) if method_result else None

    def can_be_removed(self, cylindrical_gear_hob_design: '_504.CylindricalGearHobDesign') -> 'bool':
    ...
    def rename(self, cylindrical_gear_hob_design: '_504.CylindricalGearHobDesign', new_name: 'str') -> 'bool':
    ...
    def remove(self, cylindrical_gear_hob_design: '_504.CylindricalGearHobDesign'):
    ...
    def get_all_items(self) -> 'Iterable[_504.CylindricalGearHobDesign]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_504.CylindricalGearHobDesign))

    def save_changes(self, cylindrical_gear_hob_design: '_504.CylindricalGearHobDesign'):
