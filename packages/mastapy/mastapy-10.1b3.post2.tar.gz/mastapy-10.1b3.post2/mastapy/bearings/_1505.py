...
from mastapy.bearings import _1483, _1507, _1497
...
class RollingBearingDatabase(_0.APIBase):
    '''RollingBearingDatabase
    ...
    def get_all_items(self) -> 'Iterable[_1736.RollingBearing]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_1736.RollingBearing))

    def save_changes(self, rolling_bearing: '_1736.RollingBearing'):
    ...
    def add_to_database(self, bearing: '_1736.RollingBearing'):
    ...
    def remove_from_database(self, bearing: '_1736.RollingBearing'):
    ...
    def search_for_rolling_bearing(self, designation: 'str', catalog: '_1483.BearingCatalog', type_: '_1507.RollingBearingType', bore_range: '_1046.Range', outer_diameter_range: '_1046.Range', width_range: '_1046.Range', dynamic_capacity_range: '_1046.Range', number_of_rows: 'int', material_type: '_1497.HybridSteelAll') -> 'List[_1736.RollingBearing]':
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(self, designation: 'str', catalog: '_1483.BearingCatalog', type_: '_1507.RollingBearingType') -> 'List[_1736.RollingBearing]':
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        type_ = conversion.mp_to_pn_enum(type_)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing(designation if designation else None, catalog, type_), constructor.new(_1736.RollingBearing))

    def search_for_rolling_bearing_with_name_and_catalog(self, designation: 'str', catalog: '_1483.BearingCatalog') -> '_1736.RollingBearing':
        ''' 'SearchForRollingBearing' is the original name of this method.
        ...
        return constructor.new(_1736.RollingBearing)(method_result) if method_result else None

    def search_for_rolling_bearing_with_catalog(self, catalog: '_1483.BearingCatalog') -> 'List[_1736.RollingBearing]':
        ''' 'SearchForRollingBearing' is the original name of this method.
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing(catalog), constructor.new(_1736.RollingBearing))

    def create_bearing(self, type_: '_1507.RollingBearingType', designation: Optional['str'] = 'None') -> '_1736.RollingBearing':
