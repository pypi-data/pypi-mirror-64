...
from mastapy.bearings.bearing_results.rolling import _1665, _1622
...
class LoadedBallBearingResults(_1622.LoadedRollingBearingResults):
    '''LoadedBallBearingResults
    ...
    @property
    def track_truncation(self) -> '_1665.TrackTruncationSafetyFactorResults':
        ...
        return constructor.new(_1665.TrackTruncationSafetyFactorResults)(self.wrapped.TrackTruncation) if self.wrapped.TrackTruncation else None
