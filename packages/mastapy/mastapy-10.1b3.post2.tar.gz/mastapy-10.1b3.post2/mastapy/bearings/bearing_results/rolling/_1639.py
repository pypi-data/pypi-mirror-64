...
from mastapy.bearings.bearing_results.rolling import _1638, _1614
...
class LoadedTaperRollerBearingRow(_1614.LoadedNonBarrelRollerBearingRow):
    '''LoadedTaperRollerBearingRow
    ...
    @property
    def major_rib_normal_contact_stress(self) -> '_6481.SMTBitmap':
        ...
        return constructor.new(_6481.SMTBitmap)(self.wrapped.MajorRibNormalContactStress) if self.wrapped.MajorRibNormalContactStress else None

    @property
    def loaded_bearing(self) -> '_1638.LoadedTaperRollerBearingResults':
