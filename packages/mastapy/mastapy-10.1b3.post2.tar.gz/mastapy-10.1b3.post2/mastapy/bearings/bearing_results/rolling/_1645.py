...
from mastapy.bearings.bearing_results.rolling import _1644, _1595
...
class LoadedThrustBallBearingRow(_1595.LoadedBallBearingRow):
    '''LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1644.LoadedThrustBallBearingResults':
