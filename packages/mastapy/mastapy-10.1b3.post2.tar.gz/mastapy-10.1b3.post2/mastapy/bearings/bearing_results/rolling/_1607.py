...
from mastapy.bearings.bearing_results.rolling import _1606, _1605, _1595
...
class LoadedFourPointContactBallBearingRow(_1595.LoadedBallBearingRow):
    '''LoadedFourPointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1606.LoadedFourPointContactBallBearingResults':
    ...
    @property
    def race_results(self) -> 'List[_1605.LoadedFourPointContactBallBearingRaceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RaceResults, constructor.new(_1605.LoadedFourPointContactBallBearingRaceResults))
        return value
