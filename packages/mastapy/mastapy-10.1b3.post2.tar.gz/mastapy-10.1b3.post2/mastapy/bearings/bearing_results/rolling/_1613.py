...
from mastapy.bearings.bearing_results.rolling import _1663, _1618
...
class LoadedNonBarrelRollerBearingResults(_1618.LoadedRollerBearingResults):
    '''LoadedNonBarrelRollerBearingResults
    ...
    @property
    def smt_rib_stress(self) -> '_1663.SMTRibStressResults':
        ...
        return constructor.new(_1663.SMTRibStressResults)(self.wrapped.SMTRibStress) if self.wrapped.SMTRibStress else None
