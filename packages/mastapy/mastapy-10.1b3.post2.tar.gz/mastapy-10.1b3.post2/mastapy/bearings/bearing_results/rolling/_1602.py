...
from mastapy.bearings.bearing_results.rolling import _1601, _1595
...
class LoadedDeepGrooveBallBearingRow(_1595.LoadedBallBearingRow):
    '''LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1601.LoadedDeepGrooveBallBearingResults':
