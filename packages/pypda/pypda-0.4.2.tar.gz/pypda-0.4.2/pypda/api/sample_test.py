...
def sample_test(plot_dir='plot', length=10, bpm=65, sampling_rate=49.8, png=False, seed=None):
    """
    ...
    wave = PulseWave(parameters=p, bpm=bpm, length=length, sampling_rate=sampling_rate, seed=seed)
    x, y, t = wave.sample()
    if png:
...
def sample(plot_dir='plot', length=10, bpm=65, sampling_rate=49.8, png=False, seed=None):
    """
