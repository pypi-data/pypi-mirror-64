...
def get_coordinates_pdb(filename, selection, ignore_selection, ignore_hydrogens, verbose=False):
    """
    ...
    with open(filename) as f:
        ...
        for line in lines:
            ...
            if line.startswith("ATOM"):
                ...
                if selection or ignore_selection:
                    take_all = True
                    if curr_chain_id in selection or take_all:
                        if curr_resi in selection[curr_chain_id] or take_all:
                                    if verbose:
                                        print(curr_chain_id, curr_resi, curr_atom_name)
