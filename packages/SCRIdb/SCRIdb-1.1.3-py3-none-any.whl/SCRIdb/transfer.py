...
def make_credentials(user: str = None, groupname: str = "collaborators") -> None:
    """\
    ...
    iam_.create_user(UserName=user)
    ...
    key_responses = pd.DataFrame(
        ...
        columns=["UserName", "password", "AccessKeyId", "SecretAccessKey", "link"],
    )
...
def data_transfer(
    ...
    try:
        ...
        try:
            ...
            db_connect.db_connect.cur.execute(res_df)
        ...
        if root_bucket == "collaborators":
            try:
                ...
                if e.response["Error"]["Code"] == "NoSuchEntity":
                    make_credentials(user, "collaborators")
