...
setup(
    ...
    install_requires=["mo-dots>=3.53.20059","mo-files>=3.51.20059","mo-future>=3.51.20059","mo-json>=3.57.20089","mo-kwargs>=3.54.20059","mo-logs>=3.57.20089","mo-threads>=3.57.20089","mo-times>=3.57.20089","requests"],
    license='MPL 2.0',
