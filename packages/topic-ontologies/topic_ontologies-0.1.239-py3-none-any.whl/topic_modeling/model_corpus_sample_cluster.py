...
def project_documents(topic_ontology):
    def project_document(argument):
        LOGGER.warn("Lok: preprocessing document %d"%random.randint(1,10000))
        import nltk
        ...
        LOGGER.warn("Lok: setting vector document %s"%str(vector))
    ...
    LOGGER.warn("Lok: loaded %d documents"%documents_df.size)
