...
def project_documents(topic_ontology):
    ...
    path_document_vectors= get_path_document_vectors('sample',topic_ontology+'-part1','word2vec-esa-10').replace(".csv","")
    ...
    ids_with_vectors.saveAsTextFile("/user/befi8957/topic-sub")
