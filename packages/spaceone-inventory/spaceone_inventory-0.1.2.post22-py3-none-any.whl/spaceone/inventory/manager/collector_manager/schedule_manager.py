...
class ScheduleManager(BaseManager):
    ...
    def delete_schedules_by_collector_id(self, collector_id, domain_id):
        ...
        _LOGGER.debug(f'[delete_schedules_by_collector_id] found: {total_count}')
        for schedule_vo in schedule_vos:
            _LOGGER.debug(f'[delete_schedules_by_collector_id] delete schedule: {schedule_vo.schedule_id}')
