...
def load_log_config(config_file_name):
    logger = get_logger()
    local_path = os.path.dirname(os.path.abspath(__file__))
    log_config_file = os.path.join(local_path, config_file_name)
    logging.config.fileConfig(log_config_file)
    logger.info("Beginning logging with configuration from:" + log_config_file)
