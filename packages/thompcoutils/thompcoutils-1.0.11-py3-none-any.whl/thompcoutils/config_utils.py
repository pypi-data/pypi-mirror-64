...
class EmailConnectionConfig:
    def __init__(self, cfg_mgr=None, username=None, password=None, from_user=None, smtp_host="smtp.gmail.com", port=587,
                 application_name="Application Name", filename=None, create=None, section_heading="email connection",
        ...
        if cfg_mgr is None:
            ...
            self.port = cfg_mgr.read_entry(section_heading, port_tag, port)
...
def _test_email_connection_config():
    file_name = "test.ini"
