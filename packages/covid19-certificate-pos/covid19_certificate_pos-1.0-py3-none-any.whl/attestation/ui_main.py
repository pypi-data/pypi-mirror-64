...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.setTabOrder(self.walk, self.addPeople)
    ...
    def retranslateUi(self, Form):
        ...
        self.family.setText(_translate("Form", "Pour aller voir la famille"))
        self.walk.setText(_translate("Form", "Pour pratiquer une activité physique"))
