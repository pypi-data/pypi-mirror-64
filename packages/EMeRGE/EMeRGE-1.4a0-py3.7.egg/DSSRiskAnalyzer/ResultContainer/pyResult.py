...
class ResultProcessor:
    ...
    def __init__(self,*argv):
        ...
        self.AssetLevelParameters['voltagemag'] = self.ProcessAssetLevelParameters(
            [NodeMetricDict[TimeStamp]['VoltageMag'] for TimeStamp in NodeMetricDict.keys()], TimeStampForRecordingData)
        ...
        self.AssetLevelParameters['transformerloading'] = self.ProcessAssetLevelParameters(
            [TransformerMetricDict[TimeStamp]['PULoading'] for TimeStamp in TransformerMetricDict.keys()],
            TimeStampForRecordingData)
