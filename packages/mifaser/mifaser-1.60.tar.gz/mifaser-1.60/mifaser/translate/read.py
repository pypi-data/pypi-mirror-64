...
"""
By Pavel Vaysberg (pvaysberg@gmail.com)

Updated: 4/8/2014 (czhu@bromberglab.org)
Revised: 3/18/2019 (mmiller@bromberglab.org)
"""
...
class Read:
    ...
    def annotate(self, pttFile, sequence):
        ...
        with proteinFile as f:
            for _ in range(3): #skip the header lines, go directly to data. Restricts to ptt file, is there a better way?
                f.next()
            for line in f:
				...
				# >>> change 4/8/2014
                # geneName = cols[4] 
                geneName = cols[3] #using PID instead of gene name 
				# <<< change 4/8/2014
                geneStrand = cols[1]
