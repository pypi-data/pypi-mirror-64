...
setup(
  ...
  long_description = "Geospatial data analytics on experimental treatment design and analysis of the treatment i.e. Latin Square, RCBD etc.",
  ...
  keywords = ['Experimental Design', 'Geospatial Data Science', 'Spatial Analytics'],   # Keywords that define your package best
