...
setup(
    ...
    install_requires=["jx-python>=3.57.20089","mo-collections>=3.60.20091","mo-dots>=3.53.20059","mo-files>=3.60.20091","mo-future>=3.51.20059","mo-http>=3.57.20089","mo-json>=3.57.20089","mo-kwargs>=3.54.20059","mo-logs>=3.57.20089","mo-math>=3.57.20089","mo-sql>=3.55.20074","mo-times>=3.57.20089","pyLibrary>=3.47.20042","pymysql"],
    license='MPL 2.0',
