...
typedef N_NIMCALL_PTR(void*, tyProc__iv6n7tcGawU401muvntJ9cA) (void* aX60gensym384241_, void* kwgX60gensym384242_);
struct TGenericSeq {
NI len;
NI reserved;
};
...
static N_NIMCALL(void, TM__VyW3eddtoFarRkBjlzPKrg_2)(void);
...
N_LIB_PRIVATE N_CDECL(void*, func1Py_wrapper__xTPl3LHEGGzFabwB10q1DA)(void* selfX60gensym384238_, void* args, void* kwargs);
static N_INLINE(void, updateStackBottom__FRn3WNsRdbdvfuL6O7x1BQnimpy)(void);
N_NOINLINE(void, nimGC_setStackBottom)(void* theStackBottom);
N_LIB_PRIVATE N_NIMCALL(void*, noinline__Nn55fTOucrM5Sa1ybThpWw)(void* args, void* kwargs);
...
N_LIB_PRIVATE N_NIMCALL(NI, func1__GxqC0ZbgwTL8LssaI8SS4Q)(void);
...
tyObject_PyModuleDesc__gBC8z6Ez5xj3dXoP0ylCRA gPythonLocalModuleDesc__qwE6rfVyuJ5p2tkBR5aiUQ;
...
STRING_LITERAL(TM__VyW3eddtoFarRkBjlzPKrg_3, "func1", 5);
static N_NIMCALL(void, TM__VyW3eddtoFarRkBjlzPKrg_2)(void) {
	nimGCvisit((void*)gPythonLocalModuleDesc__qwE6rfVyuJ5p2tkBR5aiUQ.methods, 0);
	nimGCvisit((void*)gPythonLocalModuleDesc__qwE6rfVyuJ5p2tkBR5aiUQ.types, 0);
	nimGCvisit((void*)gPythonLocalModuleDesc__qwE6rfVyuJ5p2tkBR5aiUQ.iterators, 0);
}
N_LIB_EXPORT N_CDECL(void, initbazzle)(void) {	initModule2__QOPr6RYgxP9c8n2lZVbiDwA((&gPythonLocalModuleDesc__qwE6rfVyuJ5p2tkBR5aiUQ));
}
N_LIB_EXPORT N_CDECL(void*, PyInit_bazzle)(void) {	void* result;
	result = (void*)0;
	result = initModule3__b5gVEAN0cbSksVFIpPmViA((&gPythonLocalModuleDesc__qwE6rfVyuJ5p2tkBR5aiUQ));
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(NI, func1__GxqC0ZbgwTL8LssaI8SS4Q)(void) {	NI result;
{	result = (NI)0;
	result = ((NI) 1);
	goto BeforeRet_;
	}BeforeRet_: ;
...
N_LIB_PRIVATE N_NIMCALL(void*, noinline__Nn55fTOucrM5Sa1ybThpWw)(void* args, void* kwargs) {	void* result;
	TSafePoint TM__VyW3eddtoFarRkBjlzPKrg_4;
{	result = (void*)0;
	{
		tyArray__z9ac6Ez5VSEHe9bC2NMwuc7Q T3_;
		NIM_BOOL T4_;
		T4_ = (NIM_BOOL)0;
		T4_ = verifyArgs__8sVYJT4zfbIXMNXtJ2cTng(args, kwargs, ((NI) 0), ((NI) 0), T3_, 0, ((NimStringDesc*) &TM__VyW3eddtoFarRkBjlzPKrg_3));
		if (!!(T4_)) goto LA5_;
		result = ((void*) (NIM_NIL));
		goto BeforeRet_;
	}
	LA5_: ;
	pushSafePoint(&TM__VyW3eddtoFarRkBjlzPKrg_4);
	TM__VyW3eddtoFarRkBjlzPKrg_4.status = _setjmp(TM__VyW3eddtoFarRkBjlzPKrg_4.context);
	if (TM__VyW3eddtoFarRkBjlzPKrg_4.status == 0) {
		NI T8_;
		T8_ = (NI)0;
		T8_ = func1__GxqC0ZbgwTL8LssaI8SS4Q();
		...
		if (isObj(getCurrentException()->Sup.m_type, (&NTI__XEycrCsme5C8CVWAYEcdBQ_))) {
			Exception* eX60gensym384239_;
			TM__VyW3eddtoFarRkBjlzPKrg_4.status = 0;
			eX60gensym384239_ = getCurrentException();
			result = pythonException__Zl8uxcjgHaQZB15tcqXlTA(eX60gensym384239_);
			popCurrentException();
		}
	}
	if (TM__VyW3eddtoFarRkBjlzPKrg_4.status != 0) reraiseException();
	}BeforeRet_: ;
	return result;
}
N_LIB_PRIVATE N_CDECL(void*, func1Py_wrapper__xTPl3LHEGGzFabwB10q1DA)(void* selfX60gensym384238_, void* args, void* kwargs) {	void* result;
	tyProc__iv6n7tcGawU401muvntJ9cA volatile pX60gensym384240_;
	result = (void*)0;
	updateStackBottom__FRn3WNsRdbdvfuL6O7x1BQnimpy();
	pX60gensym384240_ = noinline__Nn55fTOucrM5Sa1ybThpWw;
	result = pX60gensym384240_(args, kwargs);
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(void, NimMainModule)(void) {
{
	...
	nimRegisterGlobalMarker(TM__VyW3eddtoFarRkBjlzPKrg_2);

	initPythonModuleDesc__0f1AKGy9a6FMRjtYbL5nSQg((&gPythonLocalModuleDesc__qwE6rfVyuJ5p2tkBR5aiUQ), "bazzle", "");
	addMethod__TpUnmhxGlZgxTBTLPiE3nw((&gPythonLocalModuleDesc__qwE6rfVyuJ5p2tkBR5aiUQ), "func1", NIM_NIL, func1Py_wrapper__xTPl3LHEGGzFabwB10q1DA);
}
}
