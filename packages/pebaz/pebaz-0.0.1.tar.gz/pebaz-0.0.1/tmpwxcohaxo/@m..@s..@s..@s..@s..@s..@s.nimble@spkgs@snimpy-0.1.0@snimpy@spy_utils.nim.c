...
N_LIB_PRIVATE N_NIMCALL(void, conversionToStringError__2YA4NXAzmPMdXt3hDLwaKQ)(void) {	Exception* eX60gensym365150_;
	(*pyLib__nxKBiAukGMNwnUq9bpn9adyw).PyErr_Clear();
	eX60gensym365150_ = (Exception*)0;
	eX60gensym365150_ = (Exception*) newObj((&NTI__vU9aO9cTqOMn6CBzhV8rX7Sw_), sizeof(Exception));
	(*eX60gensym365150_).Sup.m_type = (&NTI__XEycrCsme5C8CVWAYEcdBQ_);
	(*eX60gensym365150_).name = "Exception";
	(*eX60gensym365150_).message = copyString(((NimStringDesc*) &TM__yNJ2G9b01RlVILlUjgj0ESA_2));
	(*eX60gensym365150_).parent = NIM_NIL;
	raiseExceptionEx((Exception*)eX60gensym365150_, "Exception", "conversionToStringError", "py_utils.nim", 25);
}
