...
def encode_and_embed_spectra(model, prj, input_file, refrence_spectra):
    ...
    if input_file.endswith(".mgf"):
        output_embedded_file = dirname + str(filename.strip(".mgf")) + "_embedded_txt"
    elif input_file.endswith(".mzML"):
        output_embedded_file = dirname + str(filename.strip(".mzML")) + "_embedded_txt"
    else:
        output_embedded_file = dirname + str(filename.strip(".json")) + "_embedded_txt"
