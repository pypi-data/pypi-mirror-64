...
def encode_and_embed_spectra(model, prj, input_file_path, refrence_spectra):
    """
    ...
    if str(input_file_path).endswith("\\"):
        dir_path = input_file_path
    else:
        dir_path = input_file_path + "\\"
    for input_file in input_file_list:
        if input_file.endswith(".mgf"):
            output_embedded_file = dir_path + str(input_file.strip(".mgf")) + "_embedded_txt"
        elif input_file.endswith(".mzML"):
            output_embedded_file = dir_path + str(input_file.strip(".mzML")) + "_embedded_txt"
        else:
            output_embedded_file = dir_path + str(input_file.strip(".json")) + "_embedded_txt"
