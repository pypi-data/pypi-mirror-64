...
_COREWORKERSTATS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='object_refs', full_name='ray.rpc.CoreWorkerStats.object_refs', index=14,
