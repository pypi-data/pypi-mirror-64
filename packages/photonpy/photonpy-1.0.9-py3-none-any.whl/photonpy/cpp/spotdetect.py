...
#	int numDetectionThreads, Context* ctx)
    ...
    def CreateQueue(self, imgshape, roishape, spotDetector:SpotDetector,
    ...
    def ProcessFrame(self, image, spotDetector:SpotDetector, roisize, maxSpotsPerFrame, calib=None):
