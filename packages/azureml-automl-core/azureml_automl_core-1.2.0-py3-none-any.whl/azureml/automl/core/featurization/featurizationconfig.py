...
class FeaturizationConfig:
    ...
    def _convert_timeseries_target_column_name(self, label_column_name: str):
        if self.transformer_params is not None:
            if self.transformer_params.get(TimeSeriesInternal.IMPUTER) is not None:
                for cols, params in self.transformer_params[TimeSeriesInternal.IMPUTER]:
