...
from . import (PLM, DimmableLightingControl, DimmableLightingControl_DinRail,
               ...
               DimmableLightingControl_SwitchLinc, GeneralController,
...
class IPDB:
    ...
    _products = [
        ...
        Product(0x05, 0x03, 0x00001F, "Thermostat Adapter", "2441V", Thermostat),
        Product(0x05, 0x04, 0x000024, "EZTherm", "", UnknownDevice),
        Product(0x05, 0x05, 0x000038, "Broan, Venmar, BEST Rangehoods", "", UnknownDevice),
        Product(0x05, 0x07, None, 'Wireless Thermostat', '2441ZTH', Thermostat),
        Product(0x05, 0x08, None, 'Thermostat', '2441TH', Thermostat),
        Product(0x05, 0x09, 0x000094, "7 Day Thermostat", "4715", UnknownDevice),
        Product(0x05, 0x0A, None, 'Wireless Thermostat', '2441ZTH', Thermostat),
        Product(0x05, 0x0B, None, 'Thermostat', '2441TH', Thermostat),
        Product(0x05, 0x0E, None, "Integrated Remote Control Thermostat", "2491T1E", UnknownDevice,),
        Product(0x05, 0x0F, None, "Thermostat", "2732-422", Thermostat),
        Product(0x05, 0x10, None, "Thermostat", "2732-522", Thermostat),
        Product(0x05, 0x11, None, "Wireless Thermostat", "2732-432", Thermostat),
        Product(0x05, 0x12, None, "Wireless Thermostat", "2732-532", Thermostat),
