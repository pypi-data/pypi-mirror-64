...
class ImportTabularDataModule:
    ...
    def generate_dataflow(cls) -> 'Dataflow':
        ...
        try:
            ...
            elif "Operation returned an invalid status code 'Http request failed.'" in error_message:
                hint_message = 'Input httpUrl issue. ' + error_message
                ErrorMapping.rethrow(exceptions, UserError(hint_message))
            else:
                raise exceptions
