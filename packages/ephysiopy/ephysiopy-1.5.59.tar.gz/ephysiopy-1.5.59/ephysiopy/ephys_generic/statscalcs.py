...
class StatsCalcs():
	...
	def V_test(self, angles, test_direction):
		...
		This test is also known as the modified Rayleigh test.

		Parameters
		----------
		angles : array_like
			A vector of angular values in degrees
		test_direction : array_like
	...
	def watsonsU2n(self, angles):
		"""
		Test whether the given distribution fits a random sample of angular values
