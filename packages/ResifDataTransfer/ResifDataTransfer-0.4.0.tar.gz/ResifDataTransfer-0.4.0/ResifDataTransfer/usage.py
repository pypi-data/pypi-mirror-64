...
\t{bold}-n, --network{clear}\t\tprovide extended network ID (eg 3C2019). Mandatory for seismic_data_ph5 data type.
...
\t{bold}seismic_data_ph5{clear}\t\tvalidated seismic data (PH5 format). You must also provide the extended network name with --network option.
