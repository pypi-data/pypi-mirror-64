...
static PyObject* firebaseMLKit_Init(firebaseMLKit_obj* self)
{
	FirebaseMLKit::Instance()->init();
...
PyMethodDef firebaseMLKit_methods[] = {
	{ "init", (PyCFunction)firebaseMLKit_Init, METH_NOARGS, firebaseMLKitInit_doc },
