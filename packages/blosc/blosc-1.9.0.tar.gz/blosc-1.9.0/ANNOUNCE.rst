...
In this release we got rid of support for Python 2.7 and 3.5.  Also, we fixed
the copy of the leftovers of a chunk when its size is not a multiple of the
typesize.  Although this is a very unusual situation, it can certainly happen
(e.g. https://github.com/Blosc/python-blosc/issues/220).
Finally, sources for recently released C-Blosc v1.18.1 have been included.
