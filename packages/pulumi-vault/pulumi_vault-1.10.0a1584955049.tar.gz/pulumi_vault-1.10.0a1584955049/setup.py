...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', 'v1.10.0-alpha.1584955049+g04c1d60'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault v1.10.0-alpha.1584955049+g04c1d60`
                """)
            else:
                raise
