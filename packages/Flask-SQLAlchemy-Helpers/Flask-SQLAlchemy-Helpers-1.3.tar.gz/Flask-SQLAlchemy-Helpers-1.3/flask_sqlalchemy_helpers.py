...
class ModelUUID(SAModel):
    ...
    def id(cls):
        ...
        if JoinedInheritanceMixin in cls.mro() and JoinedInheritanceMixin not in cldes.__bases__:
    ...
    @declared_attr
    def created_at(cls):        
        return Column(db.DateTime, default=datetime.now, nullable=False, index=True)
