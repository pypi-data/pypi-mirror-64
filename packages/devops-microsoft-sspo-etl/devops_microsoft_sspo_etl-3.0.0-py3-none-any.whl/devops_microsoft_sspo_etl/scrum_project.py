        ...
        try:
            ...
            for tfs_project in projects:
                ...
                if (len(teams) > 1):
                    ...
                    scrum_project_application = factories.ScrumComplexProjectFactory(organization=self.organization, application=self.application)
                else:
                    logging.info ("Creating a Scrum Atomic Project")
                    scrum_project_application = factories.ScrumAtomicProjectFactory(organization=self.organization, application=self.application)
