...
class Polygon(object):
    def __init__(self, no_of_polygons, bond_length = 1, print_with_index = True, 
...
class Polygon_walk(Polygon):
    def __init__(self, walk_length, no_of_polygons, bond_length = 1, 
        ...
        """
        super().__init__(no_of_polygons, bond_length, print_with_index, file_prefix, 
...
class Polygon_loop(Polygon):
    def __init__(self, loop_length, no_of_polygons, bond_length=1,
        ...
        <file_prefix><file_num>.xyz        
        """
        super().__init__(no_of_polygons, bond_length, print_with_index,
