...
def test_lasso():
    ...
    res = lasso_type('data/lassos/lasso_00.xyz', loop_indices=[1, 30])
    count += verify(res, good_out2)

    res = lasso_type('data/lassos/L1L1.xyz', loop_indices=[3, 6], min_dist=[0, 0, 0])
    count += verify(res, good_out3)

    res = lasso_type('data/lassos/L1L1.xyz', loop_indices=[[3, 6], [7, 10]], min_dist=[0, 0, 0])
