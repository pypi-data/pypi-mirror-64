...
class GlnGraph(Graph):
    ...
    def calculate(self, chain2=None, boundary=(-1, -1), boundary2=(-1, -1), mode = GlnMode.BASIC,
        ...
        matrix_plot = (matrix_plot_format != PlotFormat.DONTPLOT)
        ...
        elif mode == GlnMode.AVE:
            if debug:
                print("Calculating the average GLN value on " + str(ave_tries) + " tries.")
            return round(c_gln_average(arc1, arc2, boundary[0], boundary[1], boundary2[0], boundary2[1], ave_tries),
                         precision)
