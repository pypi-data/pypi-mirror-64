    ...
    *Parent class for computationnal shells*
    ...
    def __init__(self, n_axe_1, n_axe_2):
        ...
        *Initialize a Shell object*
        ...
        self._dlu = np.empty(self.shape)
        self._dlv = np.empty(self.shape)
    ...
    def dump_shell(self, name='shell'):
        ...
        *Dump shell geometrical properties into hdf file*
        ...
        xmdf.add_field(self._abs_curv, 'abs_curv')
        xmdf.add_field(self._dwu, 'dlu')
        xmdf.add_field(self._dwv, 'dlv')
    ...
    def average_on_shell_over_dirs(self, variable, directions):
        """
        *Performs an integration (min, average, max) over one or multiple directions*
        ...
        scaled = np.multiply(variable, self.surf)
