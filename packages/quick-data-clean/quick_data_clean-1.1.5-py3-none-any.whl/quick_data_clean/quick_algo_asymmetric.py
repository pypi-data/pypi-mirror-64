...
class AsymmetricAlgo(object):
    ...
    def __init__(self, likes_spam=False):
        ...
        try:
            ...
            os.chdir(path)
            path = os.path.join(path, "asymmetric_algo.dll")
            self.asymmetric_lib = ctypes.cdll.LoadLibrary(path)
...
class RSA(object):
    ...
    def encrypt(self, msg, padding=3):
    ...
    def decrypt(self, msg, padding=3):
