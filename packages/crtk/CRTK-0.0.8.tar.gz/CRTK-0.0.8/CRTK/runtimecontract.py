...
from CRTK.utilities import get_function_signatures_list, check_ERC_standard, get_opcode_list


class RuntimeContract(Contract):
    def __init__(self, bytecode, address=''):
        super(RuntimeContract, self).__init__()
        self.runtime_contract = True
        ...
        self.opcode = get_opcode_list(self.bytecode[2:])
