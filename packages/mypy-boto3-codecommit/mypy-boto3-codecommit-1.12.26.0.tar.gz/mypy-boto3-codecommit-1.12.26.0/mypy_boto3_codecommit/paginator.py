...
class DescribePullRequestEventsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribePullRequestEvents.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.26/reference/services/codecommit.html#CodeCommit.Paginator.DescribePullRequestEvents.paginate)
        """
...
class GetCommentsForComparedCommitPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [GetCommentsForComparedCommit.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.26/reference/services/codecommit.html#CodeCommit.Paginator.GetCommentsForComparedCommit.paginate)
        """
...
class GetCommentsForPullRequestPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [GetCommentsForPullRequest.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.26/reference/services/codecommit.html#CodeCommit.Paginator.GetCommentsForPullRequest.paginate)
        """
...
class GetDifferencesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [GetDifferences.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.26/reference/services/codecommit.html#CodeCommit.Paginator.GetDifferences.paginate)
        """
...
class ListBranchesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListBranches.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.26/reference/services/codecommit.html#CodeCommit.Paginator.ListBranches.paginate)
        """
...
class ListPullRequestsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListPullRequests.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.26/reference/services/codecommit.html#CodeCommit.Paginator.ListPullRequests.paginate)
        """
...
class ListRepositoriesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListRepositories.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.26/reference/services/codecommit.html#CodeCommit.Paginator.ListRepositories.paginate)
        """
