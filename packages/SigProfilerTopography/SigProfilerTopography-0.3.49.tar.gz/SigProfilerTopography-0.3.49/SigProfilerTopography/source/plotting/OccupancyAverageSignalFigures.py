...
def calculate_fold_change(output_dir,numberofSimulations,signature,cancer_type,encode_hm):
    ...
    if (numberofSimulations > 0):
        ...
        if ((listofSimulationsSignatureBased is not None) and listofSimulationsSignatureBased):
            ...
            print('After np.vstack --- stackedSimulationsSignatureBased rows:%d cols:%d' % (rows, cols))
            ...
            print('After get part interested in --- stackedSimulationsSignatureBased_of_interest rows:%d cols:%d' % (rows, cols))
            ...
            (rows, cols) = stackedSimulationsSignatureBased_of_interest.shape
            print('After removing all nan rows --- stackedSimulationsSignatureBased_of_interest rows:%d cols:%d' % (rows, cols))
