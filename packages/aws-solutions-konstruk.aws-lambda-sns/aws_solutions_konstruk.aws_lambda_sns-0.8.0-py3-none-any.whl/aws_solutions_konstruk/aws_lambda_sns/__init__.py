...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-solutions-konstruk/aws-lambda-sns", "0.8.0", __name__, "aws-lambda-sns@0.8.0.jsii.tgz")
...
__all__ = ["LambdaToSns", "LambdaToSnsProps", "__jsii_assembly__"]
