...
class Trainer:
    ...
    def encode_classes(self, classes=None, label_encoder=None):
        """
        ...
        if label_encoder is None:
            if self.label_encoder is None:
                ...
                if self.label_encoder.classes_:
                    y = self.label_encoder.transform(classes)
                else:
                    y = self.label_encoder.fit_transform(classes)
            return to_categorical(y), self.label_encoder
        else:
            y = label_encoder.transform(classes)   

            return to_categorical(y), label_encoder
