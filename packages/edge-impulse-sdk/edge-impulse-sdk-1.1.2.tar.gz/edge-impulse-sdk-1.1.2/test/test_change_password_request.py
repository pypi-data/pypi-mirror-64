...
from edge_impulse_sdk.models.change_password_request import ChangePasswordRequest  # noqa: E501
...
class TestChangePasswordRequest(unittest.TestCase):
    ...
    def testChangePasswordRequest(self):
        ...
        # model = edge_impulse_sdk.models.change_password_request.ChangePasswordRequest()  # noqa: E501
        pass
