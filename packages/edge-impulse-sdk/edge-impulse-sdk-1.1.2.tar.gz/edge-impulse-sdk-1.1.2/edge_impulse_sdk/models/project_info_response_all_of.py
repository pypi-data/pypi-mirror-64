...
class ProjectInfoResponseAllOf(object):
    ...
    def __init__(self, project=None, downloads=None, development_keys=None, impulse=None, devices=None, data_summary=None, data_summary_per_category=None, compute_time=None, acquisition_settings=None, collaborators=None, local_vars_configuration=None):  # noqa: E501
