...
class Commands:
	...
	def RenameNavigatorItem(self, navigatorItemId: NavigatorItemId, newName: Optional[str] = None, newId: Optional[str] = None):
		...
		RenameNavigatorItem_parameters1.get_classinfo().add_field('newName', Optional[str])
		...
		RenameNavigatorItem_parameters2.get_classinfo().add_field('newId', Optional[str])
