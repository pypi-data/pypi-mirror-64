...
class DataFrame(object):#pylint: disable=too-many-public-methods
    ...
    def drop(self, cols):
        ...
        -------
        DataFrame
            The new DataFrame that retains only the columns not listed in ``cols``.
    ...
    def agg(self, agg_list, group_by=None):
        ...
        agg_list : A list of tuples
            ...
            The triplet consists of (aggregate_operator, expression, name) where:
                ...
                The operator name is identical to HANA sql naming.
...
object_type_as_bin=False, table_structure=None, drop_exist_tab=False):
    """
    ...
    if force is True:
        ...
        if tab_exist is True and drop_exist_tab is False:
