...
class Discretize(PALBase):
    ...
    def __init__(self,#pylint: disable=too-many-arguments
                 ...
                 smoothing=None,
                 save_model=True):
        super(Discretize, self).__init__(conn_context)
    ...
    def fit(self, data, binning_variable, key=None, features=None, col_smoothing=None,#pylint:disable=too-many-arguments,too-many-locals,too-many-branches,too-many-statements
        ...
        try:
            self._call_pal_auto('PAL_DISCRETIZE',
                                data_,
        ...
        self.assign_ = self.conn_context.table(assign_tbl)# pylint: disable=attribute-defined-outside-init
        self.stats_ = self.conn_context.table(statistic_tbl)# pylint: disable=attribute-defined-outside-init
    ...
    def predict(self, data):
        ...
        if self.col_smoothing is not None:
            param_rows.extend([('SMOOTHING_METHOD', self.smoothing_method_map[var[1]], None, var[0])
                               for var in self.col_smoothing])
        try:
            self._call_pal_auto('PAL_DISCRETIZE_APPLY',
                                data_,
                                self.model_,
                                ParameterTable().with_data(param_rows),
                                *tables)
            ...
            self._try_drop(tables)
            raise
        return self.conn_context.table(result_tbl), self.conn_context.table(assign_tbl), self.conn_context.table(stats_tbl)#pylint:disable=line-too-long
...
class MDS(PALBase):
    ...
    """
    def __init__(self, conn_context, matrix_type, thread_ratio=None, dim=None, metric=None, minkowski_power=None):#pylint:disable=too-many-arguments, too-many-locals
        super(MDS, self).__init__(conn_context)
    ...
    def fit_transform(self, data, key=None, features=None):
        ...
        try:
            ...
            self._try_drop(tables)
            raise
        return self.conn_context.table(res_tbl), self.conn_context.table(stats_tbl)
...
class Sampling(PALBase):#pylint:disable=too-many-arguments, too-many-locals
    ...
    >>> res.collect()
        ...
        4     25  female  8794.9
    """
    def __init__(self, conn_context, method, interval=None, sampling_size=None, random_state=None, percentage=None):#pylint:disable=too-many-arguments, too-many-locals
        super(Sampling, self).__init__(conn_context)
    ...
    def fit_transform(self, data, features=None):
        ...
        try:
            self._call_pal_auto("PAL_SAMPLING",
                                data,
                                ParameterTable().with_data(param_rows),
                                res_tbl)
        except dbapi.Error as db_err:
            self._try_drop(res_tbl)
            logger.exception(str(db_err))
            raise
        return self.conn_context.table(res_tbl)
...
class SMOTE(PALBase): #pylint:disable=too-many-arguments, too-many-locals
    ...
    """
    def __init__(self, conn_context, smote_amount=None, k_nearest_neighbours=None, minority_class=None, thread_ratio=None, random_seed=None, method=None):#pylint:disable=too-many-arguments, too-many-locals
        super(SMOTE, self).__init__(conn_context)
...
def mds(conn_context, data, matrix_type, thread_ratio=None,#pylint:disable=too-many-arguments, too-many-locals
...
def sampling(conn_context, data, method, interval=None, features=None, sampling_size=None, random_state=None, percentage=None): #pylint:disable=too-many-arguments, too-many-locals
    """
...
def variance_test(conn_context, data, sigma_num, thread_ratio=None, key=None, data_col=None):#pylint:disable=too-many-arguments
    """
