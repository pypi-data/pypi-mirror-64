...
class Hierarchical_Forecast(PALBase):#pylint:disable=too-few-public-methods, too-many-instance-attributes
    ...
    >>> hr = Hierarchical_Forecast(self.conn, method='optimal_combination',
    ...
    def __init__(self,
                 ...
                 method=None,
                 weights=None):
        super(Hierarchical_Forecast, self).__init__(conn_context)
    ...
    def fit_predict(self, orig_data, pred_data, stru_data, orig_name=None, orig_key=None, orig_endog=None,
        ...
        try:
            ...
            self._call_pal_auto("PAL_HIERARCHICAL_FORECAST",
                                orig_data,
                                pred_data,
                                stru_data,
        ...
        return self.conn_context.table(stats_tbl), self.conn_context.table(result_tbl)
