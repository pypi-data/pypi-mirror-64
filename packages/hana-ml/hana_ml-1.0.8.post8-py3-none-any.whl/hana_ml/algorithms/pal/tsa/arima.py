...
class ARIMA(_ARIMABase):#pylint: disable=too-many-instance-attributes
    ...
    >>> arima = ARIMA(conn_context=conn, order=(0, 0, 1), seasonal_order=(1, 0, 0, 4), method='mle', thread_ratio=1.0)
    ...
    >>> arimax = ARIMA(conn_context=cc, order=(1, 0, 1), method='mle', thread_ratio=1.0, dependent_variable ='Y')
