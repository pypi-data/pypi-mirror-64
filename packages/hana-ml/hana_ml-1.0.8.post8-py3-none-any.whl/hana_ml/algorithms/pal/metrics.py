...
def confusion_matrix(conn_context, data, key, label_true=None, label_pred=None,
...
def binary_classification_debriefing(conn_context, data, label_true, label_pred, auc_data=None):
    """
    ...
    if auc_data is not None:
        auc_ = auc(conn_context=conn_context, data=auc_data)
        ki = 2 * auc_ - 1
    return {
