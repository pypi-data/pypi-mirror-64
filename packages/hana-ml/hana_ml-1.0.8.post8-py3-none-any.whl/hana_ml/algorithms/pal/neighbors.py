...
class _KNNBase(PALBase):#pylint: disable=too-many-instance-attributes, too-few-public-methods
    ...
    def __init__(self,#pylint:disable=too-many-branches, too-many-statements, too-many-locals, too-many-arguments
                 ...
                 param_values=None,
                 param_range=None):
        super(_KNNBase, self).__init__(conn_context)
    ...
    def _fit(self, data, key=None, features=None, label=None, categorical_variable=None):#pylint: disable=too-many-locals, too-many-statements, too-many-branches, too-many-arguments
        ...
        if self.resampling_method is not None:
            ...
            try:
                self._call_pal_auto('PAL_KNN_CV', self._training_set, ParameterTable().with_data(param_rows), *tables)#pylint:disable=line-too-long
    ...
    def _predict(self, data, key, features=None, categorical_variable=None):#pylint:disable=too-many-locals,too-many-branches,too-many-statements,inconsistent-return-statements
        ...
        try:
            self._call_pal_auto('PAL_KNN', self._training_set, data_, ParameterTable().with_data(param_rows), res_tbl, stats_tbl)#pylint:disable=line-too-long
        except dbapi.Error as db_err:
            logger.exception(str(db_err))
            self._try_drop(tables)
            raise
        return self.conn_context.table(tables[0]), self.conn_context.table(tables[1])
...
class KNNClassifier(_KNNBase):
    ...
    """
    def __init__(self, conn_context, n_neighbors=None, thread_ratio=None, stat_info=None,#pylint: disable=too-many-arguments, too-many-locals, too-many-branches, too-many-statements, line-too-long
        ...
        super(KNNClassifier, self).__init__(conn_context=conn_context,
                                            functionality='classification',
...
class KNNRegressor(_KNNBase):
    ...
    9         3  1         4  14000.999849
    """
    def __init__(self, conn_context, n_neighbors=None, thread_ratio=None, stat_info=None, aggregate_type=None,#pylint: disable=too-many-arguments, too-many-locals, too-many-branches, too-many-statements, line-too-long
        ...
        super(KNNRegressor, self).__init__(conn_context=conn_context,
