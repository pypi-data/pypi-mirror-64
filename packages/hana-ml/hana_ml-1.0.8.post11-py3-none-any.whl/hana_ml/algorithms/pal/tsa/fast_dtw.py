...
def fast_dtw(conn_context,
    ...
    Examples
    --------
    >>> result, align, stats = fast_dtw(conn_context, data, 5)
    ...
    try:
        ...
        try_drop(conn_context, align_tbl)
        try_drop(conn_context, stats_tbl)
        raise

    #pylint: disable=attribute-defined-outside-init, unused-variable
    return conn_context.table(res_tbl), conn_context.table(align_tbl), conn_context.table(stats_tbl)
