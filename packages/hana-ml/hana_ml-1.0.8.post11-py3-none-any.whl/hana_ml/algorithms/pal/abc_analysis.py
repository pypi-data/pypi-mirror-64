...
def abc_analysis(conn_context, data, key, percent_A, percent_B, percent_C,#pylint: disable=too-many-arguments, too-many-locals, invalid-name
    ...
    >>> res = abc_analysis(self.conn, data = self.df_train, key = 'ITEM', thread_ratio = 0.3,
    ...
    try:
        ...
        try_drop(result_tbl)#pylint: disable=no-value-for-parameter
        raise
