...
class PolynomialRegression(PALBase):
    ...
    def predict(self, data, key, features=None, model_format=None):
        r"""
    ...
    def score(self, data, key, features=None, label=None):
        ...
        return metrics.r2_score(self.conn_context, joined,
                                label_true='ACTUAL',
...
class GLM(PALBase):
    ...
    def fit(self, data, key=None, features=None, label=None, categorical_variable=None, dependent_variable=None, excluded_feature=None):
        ...
        self.fitted_ = self.conn_context.table(fit_tbl) if self.output_fitted else None
