...
def weighted_score_table(conn_context, data, maps, weights, key, features=None, thread_ratio=None):#pylint: disable=too-many-arguments
    """
    ...
    >>> res = weighted_score_table(self.conn, data = self.df_train,
