...
class ALS(PALBase):#pylint:disable=too-many-arguments, too-few-public-methods, too-many-instance-attributes
    ...
    def __init__(self,#pylint: disable=too-many-arguments, too-many-locals, too-many-branches, too-many-statements
                 ...
                 lamb=None,
                 alpha=None):
        super(ALS, self).__init__(conn_context)
    ...
    def fit(self, data, usr=None, item=None, feedback=None, key=None):#pylint: disable=too-many-locals, too-many-statements, too-many-branches, too-many-arguments
        ...
        try:
            ...
            raise
        self.metadata_ = self.conn_context.table(metadata_tbl)#pylint:disable=attribute-defined-outside-init
        self.map_ = self.conn_context.table(map_tbl)#pylint:disable=attribute-defined-outside-init
        self.factors_ = self.conn_context.table(factors_tbl)#pylint:disable=attribute-defined-outside-init
        self.optim_param_ = self.conn_context.table(optim_param_tbl)#pylint:disable=attribute-defined-outside-init
        self.stats_ = self.conn_context.table(stat_tbl)#pylint:disable=attribute-defined-outside-init
        self.iter_info_ = self.conn_context.table(iter_info_tbl)#pylint:disable=attribute-defined-outside-init
    ...
    def predict(self, data, key, usr=None, item=None, thread_ratio=None):#pylint:disable=too-many-arguments
        ...
        try:
            self._call_pal_auto('PAL_ALS_PREDICT',
                                data[cols_left],
                                self.metadata_,
                                self.map_,
                                self.factors_,
...
class FRM(PALBase):#pylint:disable=too-many-arguments, too-few-public-methods, too-many-instance-attributes
    ...
    def __init__(self,#pylint: disable=too-many-arguments, too-many-locals, too-many-branches, too-many-statements
                 ...
                 param_values=None,
                 param_range=None):
        super(FRM, self).__init__(conn_context)
    ...
    def predict(self, data, usr_info, item_info, key, usr=None, item=None, features=None, thread_ratio=None):#pylint: disable=too-many-locals, too-many-statements, too-many-branches, too-many-arguments
        ...
        param_rows = [('THREAD_RATIO', None, thread_ratio, None)]
        try:
            self._call_pal_auto('PAL_FRM_PREDICT', data_, usr_info, item_info,
...
class _FFMBase(PALBase):#pylint: disable=too-many-instance-attributes, too-few-public-methods
    ...
    def __init__(self,#pylint: disable=too-many-arguments, too-many-locals, too-many-branches, too-many-statements
                 ...
                 exit_interval=None,
                 handle_missing=None):
        super(_FFMBase, self).__init__(conn_context)
    ...
    def _fit(self, data, key=None, features=None, label=None, categorical_variable=None, delimiter=None):#pylint: disable=too-many-locals, too-many-statements, too-many-branches, too-many-arguments
        ...
        try:
            ...
            self._try_drop(tables)
            raise
        self.meta_ = self.conn_context.table(meta_tbl)#pylint:disable=attribute-defined-outside-init
        self.coef_ = self.conn_context.table(coef_tbl)#pylint:disable=attribute-defined-outside-init
        self.stats_ = self.conn_context.table(stat_tbl)#pylint:disable=attribute-defined-outside-init
        self.cross_valid_ = self.conn_context.table(cross_valid_tbl)#pylint:disable=attribute-defined-outside-init
    ...
    def _predict(self, data, key, features=None, thread_ratio=None, handle_missing=None):#pylint: disable=too-many-locals, too-many-statements, too-many-branches, too-many-arguments
        ...
        try:
            self._call_pal_auto('PAL_FFM_PREDICT',
                                data_,
                                self.meta_,
                                self.coef_,
                                ParameterTable().with_data(param_rows),
...
class FFMClassifier(_FFMBase):
    ...
    """
    def __init__(self, conn_context, ordering=None, normalise=None, include_linear=None, include_constant=None,#pylint: disable=too-many-arguments, too-many-locals, too-many-branches, too-many-statements
        ...
        super(FFMClassifier, self).__init__(conn_context=conn_context,
...
class FFMRegressor(_FFMBase):
    ...
    def __init__(self, conn_context, ordering=None, normalise=None, include_linear=None, include_constant=None,#pylint: disable=too-many-arguments, too-many-locals, too-many-branches, too-many-statements
        ...
        super(FFMRegressor, self).__init__(conn_context=conn_context,
...
class FFMRanker(_FFMBase):
    ...
    >>> res.collect()
        ...
        8   9      high    0.282633
    """
    def __init__(self, conn_context, ordering=None, normalise=None, include_linear=None,#pylint: disable=too-many-arguments, too-many-locals, too-many-branches, too-many-statements
                 early_stop=None, random_state=None, factor_num=None, max_iter=None, train_size=None, learning_rate=None,#pylint: disable=too-many-arguments, too-many-locals, too-many-branches, too-many-statements
                 linear_lamb=None, poly2_lamb=None, tol=None, exit_interval=None, handle_missing=None):#pylint: disable=too-many-arguments, too-many-locals, too-many-branches, too-many-statements

        super(FFMRanker, self).__init__(conn_context=conn_context,
