...
def check_internet(emiter, language):
    ...
    app.connected_to_internet = scripts.check_internet(app.language)
    app.connected_to_internet["network_name"] = ssid
...
def update_firmware():
    ...
    time.sleep(1)
    version = re.findall('[0-9]+.[0-9]+', app.connected_to_internet["dashboard_version"])[0]
...
def add_user(usr_name):
    ...
    if os.path.isdir(add_usr_dir):
        ...
        subprocess.Popen(['cp', '-r', '/home/pi/Dashboard/Zumi_Content_'+app.language, add_usr_dir])
