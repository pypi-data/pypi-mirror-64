...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-solutions-konstruk/aws-iot-lambda-dynamodb", "0.8.0", __name__, "aws-iot-lambda-dynamodb@0.8.0.jsii.tgz")
...
__all__ = ["IotToLambdaToDynamoDB", "IotToLambdaToDynamoDBProps", "__jsii_assembly__"]
