...
def parse_args():
    ...
    parser.add_argument(
        "--path1",
        help="Path of the first image list file",
        default=None,
        type=str,
    )
    parser.add_argument(
        "--list1",
        help="Paths of the first list of images",
        default=None,
        nargs="+",
    )
    parser.add_argument(
        "--path2",
        help="Path of the second image list file",
        default=None,
        type=str)
    parser.add_argument(
        "--list2",
        help="Paths of the second list of images",
        default=None,
        nargs="+",
    )
    parser.add_argument(
        "--out",
        help="Folder path to save the results (default ./ddup_output)",
        default="./ddup_output",
        type=str)
    parser.add_argument(
        "--verbose",
...
def load_config(args):
    ...
    return input1, input2, args.out, args.verbose
