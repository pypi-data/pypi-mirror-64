...
def draw_mask_on_image_array(image, mask, color='red', alpha=0.4):
  ...
  solid_color = numpy.expand_dims(
    numpy.ones_like(mask), axis=2) * numpy.reshape(list(rgb), [1, 1, 3])
  ...
  numpy.copyto(image, numpy.array(pil_image.convert('RGB')))
