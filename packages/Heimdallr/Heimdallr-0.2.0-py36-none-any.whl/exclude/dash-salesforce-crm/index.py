...
from app import app, sf_manager
from apps import cases, leads, opportunities
...
app.layout = html.Div(
  [
    ...
    html.Div([
      ...
      html.Div(
        html.Img(
          src='https://s3-us-west-1.amazonaws.com/plotly-tutorials/logo/new-branding/dash-logo-by'
              '-plotly-stripe-inverted.png',
          height="100%")
