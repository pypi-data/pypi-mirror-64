...
def list(project_idx,shot_idx):
    api = "/api/project/%s/shot/%s/task/list"%(project_idx,shot_idx)
...
def create(project_idx,shot_idx,tasktype_name):
    api = "/api/project/%s/shot/%s/task/create"%(project_idx,shot_idx)
    api_url = wh.Wh.url + api
...
def status_change(project_idx,task_idx,status_idx):
    api = "/api/project/%s/shot/task/%s/status/update"%(project_idx,task_idx)
    api_url = wh.Wh.url + api
...
def start(project_idx,task_idx):
    api = "/api/project/%s/shot/task/%s/start"%(project_idx,task_idx)
    api_url = wh.Wh.url + api
...
def stop(project_idx,task_idx):
    api = "/api/project/%s/shot/task/%s/stop"%(project_idx,task_idx)
    api_url = wh.Wh.url + api
