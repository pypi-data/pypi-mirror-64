 ...
 * 1. Fix some path bugs.

 * 2.Change the ip server address to local IP 127.0.0.1.
...
I specially built a tool called "hydraulic Sketcher" for drawing oil diagram, which is included in this package. Similar to Visio, it can draw the hydraulic schematic diagram simply.
