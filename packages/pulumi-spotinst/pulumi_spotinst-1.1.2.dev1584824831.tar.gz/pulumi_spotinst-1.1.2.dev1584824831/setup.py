...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', 'v1.1.2-dev.1584824831+g636a8a5'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst v1.1.2-dev.1584824831+g636a8a5`
                """)
            else:
                raise
