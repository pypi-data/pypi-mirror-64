...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'fi', 'hu', 'sh', 'cs', 'ro', 'eu', 'tr', 'zh-min-nan', 'ms', 'eo',
        'hy', 'he', 'bg', 'da', 'ce', 'sk', 'kk', 'min', 'azb', 'arz', 'hr',
        'et', 'lt', 'be', 'el', 'sl', 'gl', 'simple', 'az', 'ur', 'nn', 'hi',
        'th', 'ka', 'uz', 'la', 'ta', 'vo', 'cy', 'mk', 'ast', 'lv', 'tg',
        'mg', 'af', 'tt', 'oc', 'bn', 'bs', 'ky', 'sq', 'zh-yue', 'new', 'tl',
        'te', 'be-tarask', 'ml', 'br', 'pms', 'nds', 'su', 'ht', 'lb', 'sw',
        'jv', 'sco', 'mr', 'pnb', 'ga', 'szl', 'ba', 'is', 'my', 'fy', 'cv',
        'lmo', 'an', 'ne', 'pa', 'yo', 'bar', 'wuu', 'io', 'gu', 'als', 'ku',
        'scn', 'kn', 'ckb', 'bpy', 'ia', 'vec', 'qu', 'mn', 'bat-smg', 'wa',
        'or', 'si', 'cdo', 'gd', 'yi', 'am', 'nap', 'ilo', 'bug', 'xmf', 'hsb',
        'mai', 'diq', 'map-bms', 'fo', 'sd', 'mzn', 'nv', 'li', 'eml', 'sah',
        'os', 'sa', 'ps', 'frr', 'ace', 'mrj', 'zh-classical', 'bcl', 'mhr',
        'hak', 'hif', 'roa-tara', 'pam', 'nso', 'km', 'hyw', 'se', 'rue', 'mi',
        'crh', 'vls', 'bh', 'shn', 'nah', 'nds-nl', 'sc', 'gan', 'vep', 'as',
        'ab', 'glk', 'myv', 'bo', 'co', 'so', 'tk', 'fiu-vro', 'lrc', 'kv',
        'csb', 'sn', 'gv', 'udm', 'ie', 'zea', 'ha', 'pcd', 'ay', 'kab', 'nrm',
        'ug', 'lez', 'stq', 'kw', 'haw', 'gor', 'lfn', 'mwl', 'gn', 'gom',
        'lij', 'rm', 'lo', 'lad', 'frp', 'koi', 'mt', 'fur', 'olo', 'dsb',
        'dty', 'ang', 'ext', 'ln', 'cbk-zam', 'dv', 'bjn', 'ksh', 'gag', 'sat',
        'pfl', 'pi', 'pag', 'ban', 'av', 'bxr', 'tyv', 'xal', 'krc', 'za',
        'pap', 'kaa', 'pdc', 'rw', 'szy', 'to', 'arc', 'nov', 'kl', 'jam',
        'tpi', 'kbp', 'kbd', 'tet', 'ig', 'zu', 'wo', 'ki', 'na', 'tcy', 'inh',
        'jbo', 'roa-rup', 'bi', 'lbe', 'kg', 'ty', 'mdf', 'lg', 'atj', 'srn',
        'xh', 'gcr', 'ltg', 'fj', 'chr', 'sm', 'got', 'ak', 'pih', 'om', 'tn',
        'cu', 'tw', 'ts', 'st', 'rmy', 'bm', 'chy', 'rn', 'tum', 'nqo', 'ny',
