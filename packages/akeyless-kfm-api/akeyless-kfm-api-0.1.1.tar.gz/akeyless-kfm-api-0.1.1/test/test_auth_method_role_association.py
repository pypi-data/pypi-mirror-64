...
from akeyless_kfm_api.models.auth_method_role_association import AuthMethodRoleAssociation  # noqa: E501
...
class TestAuthMethodRoleAssociation(unittest.TestCase):
    ...
    def testAuthMethodRoleAssociation(self):
        ...
        # model = akeyless_kfm_api.models.auth_method_role_association.AuthMethodRoleAssociation()  # noqa: E501
        pass
